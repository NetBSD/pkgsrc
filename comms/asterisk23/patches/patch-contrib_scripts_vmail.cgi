$NetBSD: patch-contrib_scripts_vmail.cgi,v 1.1 2025/10/27 06:58:38 jnemeth Exp $

--- contrib/scripts/vmail.cgi.orig	2025-10-15 17:01:28.000000000 +0000
...
@@ -985,7 +985,7 @@ sub message_delete_or_move()
 	$context = &untaint($context);
 	$mbox = &untaint($mbox);
