...
BUILDLINK_API_DEPENDS.mysql-client+=	mariadb-client>=10.6.0<10.7.0
BUILDLINK_ABI_DEPENDS.mysql-client+=	mariadb-client>=10.6.0<10.7.0
BUILDLINK_PKGSRCDIR.mysql-client?=	../../databases/mariadb106-client
