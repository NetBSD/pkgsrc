$NetBSD: patch-buildtools_wafsamba_samba__conftests.py,v 1.1 2019/01/29 23:33:54 jperkin Exp $

Ensure defines are strings to avoid assertion failure, some
returned values are unicode.

--- buildtools/wafsamba/samba_conftests.py.orig	2019-01-29 23:12:58.026242040 +0000
