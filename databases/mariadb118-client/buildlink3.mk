# $NetBSD: buildlink3.mk,v 1.1 2025/06/07 08:58:42 nia Exp $
...
BUILDLINK_API_DEPENDS.mysql-client+=	mariadb-client>=11.8.0<11.9.0
BUILDLINK_ABI_DEPENDS.mysql-client+=	mariadb-client>=11.8.0
BUILDLINK_PKGSRCDIR.mysql-client?=	../../databases/mariadb118-client
