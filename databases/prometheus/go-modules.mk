# $NetBSD: go-modules.mk,v 1.3 2021/10/03 19:12:46 tnn Exp $
...
GO_MODULE_FILES+=	cloud.google.com/go/@v/v0.93.3.zip
...
GO_MODULE_FILES+=	github.com/containerd/containerd/@v/v1.5.4.zip
...
GO_MODULE_FILES+=	github.com/prometheus/common/@v/v0.30.1.mod
GO_MODULE_FILES+=	github.com/prometheus/common/@v/v0.30.1.zip
...
GO_MODULE_FILES+=	github.com/prometheus/exporter-toolkit/@v/v0.6.1.zip
...
GO_MODULE_FILES+=	golang.org/x/sys/@v/v0.0.0-20210906170528-6f6e22806c34.zip
...
GO_MODULE_FILES+=	google.golang.org/api/@v/v0.56.0.zip
...
GO_MODULE_FILES+=	google.golang.org/genproto/@v/v0.0.0-20210903162649-d08c68adba83.zip
