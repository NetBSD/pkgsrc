# $NetBSD: buildlink3.mk,v 1.6 2026/04/17 09:38:54 adam Exp $
...
BUILDLINK_ABI_DEPENDS.postgresql15-client+=	postgresql15-client>=15.12nb2
...
.if ${PKG_BUILD_OPTIONS.postgresql15-client:Micu}
