# $NetBSD: cargo-depends.mk,v 1.11 2026/04/30 11:45:03 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.32
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.10
CARGO_CRATE_DEPENDS+=	accesskit-0.19.0
CARGO_CRATE_DEPENDS+=	accesskit_atspi_common-0.12.0
CARGO_CRATE_DEPENDS+=	accesskit_consumer-0.28.0
CARGO_CRATE_DEPENDS+=	accesskit_macos-0.20.0
CARGO_CRATE_DEPENDS+=	accesskit_unix-0.15.0
CARGO_CRATE_DEPENDS+=	accesskit_windows-0.27.0
CARGO_CRATE_DEPENDS+=	accesskit_winit-0.27.0
...
CARGO_CRATE_DEPENDS+=	cosmic-text-0.14.2
...
CARGO_CRATE_DEPENDS+=	ecolor-0.32.3
CARGO_CRATE_DEPENDS+=	eframe-0.32.3
CARGO_CRATE_DEPENDS+=	egui-0.32.3
CARGO_CRATE_DEPENDS+=	egui-wgpu-0.32.3
CARGO_CRATE_DEPENDS+=	egui-winit-0.32.3
CARGO_CRATE_DEPENDS+=	egui_extras-0.32.3
CARGO_CRATE_DEPENDS+=	egui_glow-0.32.3
CARGO_CRATE_DEPENDS+=	either-1.15.0
CARGO_CRATE_DEPENDS+=	emath-0.32.3
...
CARGO_CRATE_DEPENDS+=	epaint-0.32.3
CARGO_CRATE_DEPENDS+=	epaint_default_fonts-0.32.3
...
CARGO_CRATE_DEPENDS+=	glyphon-0.9.0
...
CARGO_CRATE_DEPENDS+=	swash-0.2.6
...
CARGO_CRATE_DEPENDS+=	wayland-protocols-misc-0.3.11
