# $NetBSD: cargo-depends.mk,v 1.7 2024/07/30 14:09:34 vins Exp $
...
CARGO_CRATE_DEPENDS+=	bufstream-fresh-0.3.1
...
CARGO_CRATE_DEPENDS+=	mailin-0.6.4
CARGO_CRATE_DEPENDS+=	mailin-embedded-0.8.2
