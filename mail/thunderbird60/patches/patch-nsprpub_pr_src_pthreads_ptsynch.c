$NetBSD: patch-nsprpub_pr_src_pthreads_ptsynch.c,v 1.1 2020/02/08 22:30:18 kamil Exp $

Workaround buggy usage of pthread_equal().

--- nsprpub/pr/src/pthreads/ptsynch.c.orig	2019-10-31 12:34:24.000000000 +0000
