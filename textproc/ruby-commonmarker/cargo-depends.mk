# $NetBSD: cargo-depends.mk,v 1.1 2025/11/03 09:07:30 taca Exp $
...
CARGO_CRATE_DEPENDS+=	bon-3.7.2
CARGO_CRATE_DEPENDS+=	bon-macros-3.7.2
...
CARGO_CRATE_DEPENDS+=	comrak-0.44.0
...
CARGO_CRATE_DEPENDS+=	rb-sys-0.9.117
CARGO_CRATE_DEPENDS+=	rb-sys-build-0.9.117
CARGO_CRATE_DEPENDS+=	rb-sys-env-0.2.2
