# $NetBSD: cargo-depends.mk,v 1.2 2026/01/18 13:55:45 taca Exp $
...
CARGO_CRATE_DEPENDS+=	bon-3.8.1
CARGO_CRATE_DEPENDS+=	bon-macros-3.8.1
...
CARGO_CRATE_DEPENDS+=	rb-sys-0.9.123
CARGO_CRATE_DEPENDS+=	rb-sys-build-0.9.123
