# $NetBSD: cargo-depends.mk,v 1.7 2021/12/12 09:57:46 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	clap-3.0.0-rc.4
CARGO_CRATE_DEPENDS+=	clap_generate-3.0.0-rc.4
...
CARGO_CRATE_DEPENDS+=	filedescriptor-0.8.1
