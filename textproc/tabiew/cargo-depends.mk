# $NetBSD: cargo-depends.mk,v 1.10 2026/09/13 12:54:18 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	clap_mangen-0.3.3
...
CARGO_CRATE_DEPENDS+=	fast-float2-0.2.4
...
CARGO_CRATE_DEPENDS+=	fwf-rs-0.2.2
...
CARGO_CRATE_DEPENDS+=	libsqlite3-sys-0.38.2
...
CARGO_CRATE_DEPENDS+=	logfmt-zerocopy-0.1.3
...
CARGO_CRATE_DEPENDS+=	polars-0.55.2
CARGO_CRATE_DEPENDS+=	polars-arrow-0.55.2
CARGO_CRATE_DEPENDS+=	polars-arrow-format-0.2.1
CARGO_CRATE_DEPENDS+=	polars-async-0.55.2
CARGO_CRATE_DEPENDS+=	polars-buffer-0.55.2
CARGO_CRATE_DEPENDS+=	polars-compute-0.55.2
CARGO_CRATE_DEPENDS+=	polars-config-0.55.2
CARGO_CRATE_DEPENDS+=	polars-core-0.55.2
CARGO_CRATE_DEPENDS+=	polars-dtype-0.55.2
CARGO_CRATE_DEPENDS+=	polars-error-0.55.2
CARGO_CRATE_DEPENDS+=	polars-expr-0.55.2
CARGO_CRATE_DEPENDS+=	polars-io-0.55.2
CARGO_CRATE_DEPENDS+=	polars-json-0.55.2
CARGO_CRATE_DEPENDS+=	polars-lazy-0.55.2
CARGO_CRATE_DEPENDS+=	polars-mem-engine-0.55.2
CARGO_CRATE_DEPENDS+=	polars-ooc-0.55.2
CARGO_CRATE_DEPENDS+=	polars-ops-0.55.2
CARGO_CRATE_DEPENDS+=	polars-parquet-0.55.2
CARGO_CRATE_DEPENDS+=	polars-parquet-format-0.1.0
CARGO_CRATE_DEPENDS+=	polars-plan-0.55.2
CARGO_CRATE_DEPENDS+=	polars-row-0.55.2
CARGO_CRATE_DEPENDS+=	polars-schema-0.55.2
CARGO_CRATE_DEPENDS+=	polars-sql-0.55.2
CARGO_CRATE_DEPENDS+=	polars-stream-0.55.2
CARGO_CRATE_DEPENDS+=	polars-time-0.55.2
CARGO_CRATE_DEPENDS+=	polars-utils-0.55.2
...
CARGO_CRATE_DEPENDS+=	rusqlite-0.40.2
...
CARGO_CRATE_DEPENDS+=	sqlparser-0.62.0
CARGO_CRATE_DEPENDS+=	sqlparser_derive-0.5.0
...
CARGO_CRATE_DEPENDS+=	tui-input-0.15.4
CARGO_CRATE_DEPENDS+=	tui-scrollview-0.6.7
