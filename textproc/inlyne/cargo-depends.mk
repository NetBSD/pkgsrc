# $NetBSD: cargo-depends.mk,v 1.8 2025/02/06 11:26:29 pin Exp $
...
CARGO_CRATE_DEPENDS+=	metrics-0.24.0
CARGO_CRATE_DEPENDS+=	metrics-exporter-tcp-0.11.0
...
CARGO_CRATE_DEPENDS+=	resvg-0.39.0
...
CARGO_CRATE_DEPENDS+=	usvg-0.39.0
