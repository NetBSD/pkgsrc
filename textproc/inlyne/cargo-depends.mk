# $NetBSD: cargo-depends.mk,v 1.9 2026/05/20 12:49:13 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ashpd-0.10.3
...
CARGO_CRATE_DEPENDS+=	dark-light-2.0.0
...
CARGO_CRATE_DEPENDS+=	lz4_flex-0.13.1
...
CARGO_CRATE_DEPENDS+=	metrics-exporter-tcp-0.11.2
...
CARGO_CRATE_DEPENDS+=	taffy-0.3.19
