# $NetBSD: cargo-depends.mk,v 1.9 2023/12/09 22:01:45 pin Exp $
...
CARGO_CRATE_DEPENDS+=	biblatex-0.9.0
...
CARGO_CRATE_DEPENDS+=	chinese-variant-1.1.2
...
CARGO_CRATE_DEPENDS+=	citationberg-0.1.1
...
CARGO_CRATE_DEPENDS+=	comemo-0.3.1
CARGO_CRATE_DEPENDS+=	comemo-macros-0.3.1
...
CARGO_CRATE_DEPENDS+=	hayagriva-0.5.1
...
CARGO_CRATE_DEPENDS+=	svg2pdf-0.9.1
