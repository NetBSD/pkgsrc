# $NetBSD: cargo-depends.mk,v 1.7 2023/10/07 18:44:56 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap_complete-4.4.1
CARGO_CRATE_DEPENDS+=	clap_derive-4.4.2
CARGO_CRATE_DEPENDS+=	clap_lex-0.5.1
CARGO_CRATE_DEPENDS+=	clap_mangen-0.2.13
...
CARGO_CRATE_DEPENDS+=	ecow-0.1.2
...
CARGO_CRATE_DEPENDS+=	inferno-0.11.16
...
CARGO_CRATE_DEPENDS+=	pdf-writer-0.8.1
...
CARGO_CRATE_DEPENDS+=	postcard-1.0.7
...
CARGO_CRATE_DEPENDS+=	svg2pdf-0.7.0
