# $NetBSD: cargo-depends.mk,v 1.2 2025/04/12 06:47:07 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	hifijson-0.2.1
...
CARGO_CRATE_DEPENDS+=	jaq-core-1.2.1
CARGO_CRATE_DEPENDS+=	jaq-interpret-1.2.1
CARGO_CRATE_DEPENDS+=	jaq-parse-1.0.2
CARGO_CRATE_DEPENDS+=	jaq-std-1.2.1
CARGO_CRATE_DEPENDS+=	jaq-syn-1.1.0
...
CARGO_CRATE_DEPENDS+=	promkit-core-0.1.0
CARGO_CRATE_DEPENDS+=	promkit-widgets-0.1.0
