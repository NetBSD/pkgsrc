# $NetBSD: buildlink3.mk,v 1.13 2024/05/01 08:16:52 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-megaparsec+=	hs-megaparsec>=9.6.1
BUILDLINK_ABI_DEPENDS.hs-megaparsec+=	hs-megaparsec>=9.6.1
