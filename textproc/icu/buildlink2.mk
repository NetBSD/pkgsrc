...
BUILDLINK_DEPENDS.icu?=		icu>=2.4
BUILDLINK_PKGSRCDIR.icu?=		../../textproc/icu

EVAL_PREFIX+=	BUILDLINK_PREFIX.icu=icu
BUILDLINK_PREFIX.icu_DEFAULT=	${LOCALBASE}
BUILDLINK_FILES.icu+=	include/layout/ArabicLayoutEngine.h
BUILDLINK_FILES.icu+=	include/layout/GXLayoutEngine.h
BUILDLINK_FILES.icu+=	include/layout/IndicLayoutEngine.h
BUILDLINK_FILES.icu+=	include/layout/LEFontInstance.h
BUILDLINK_FILES.icu+=	include/layout/LEGlyphFilter.h
BUILDLINK_FILES.icu+=	include/layout/LEScripts.h
BUILDLINK_FILES.icu+=	include/layout/LESwaps.h
BUILDLINK_FILES.icu+=	include/layout/LETypes.h
BUILDLINK_FILES.icu+=	include/layout/LayoutEngine.h
BUILDLINK_FILES.icu+=	include/layout/OpenTypeLayoutEngine.h
BUILDLINK_FILES.icu+=	include/layout/ThaiLayoutEngine.h
...
BUILDLINK_FILES.icu+=	include/unicode/caniter.h
...
BUILDLINK_FILES.icu+=	include/unicode/loengine.h
...
BUILDLINK_FILES.icu+=	include/unicode/rbnf.h
BUILDLINK_FILES.icu+=	include/unicode/rbt.h
BUILDLINK_FILES.icu+=	include/unicode/regex.h
...
BUILDLINK_FILES.icu+=	include/unicode/search.h
...
BUILDLINK_FILES.icu+=	include/unicode/strenum.h
BUILDLINK_FILES.icu+=	include/unicode/stsearch.h
...
BUILDLINK_FILES.icu+=	include/unicode/uclean.h
...
BUILDLINK_FILES.icu+=	include/unicode/ucoleitr.h
BUILDLINK_FILES.icu+=	include/unicode/uconfig.h
BUILDLINK_FILES.icu+=	include/unicode/ucurr.h
BUILDLINK_FILES.icu+=	include/unicode/udat.h
BUILDLINK_FILES.icu+=	include/unicode/udata.h
BUILDLINK_FILES.icu+=	include/unicode/uenum.h
BUILDLINK_FILES.icu+=	include/unicode/uiter.h
...
BUILDLINK_FILES.icu+=	include/unicode/unifunct.h
BUILDLINK_FILES.icu+=	include/unicode/unimatch.h
BUILDLINK_FILES.icu+=	include/unicode/unirepl.h
...
BUILDLINK_FILES.icu+=	include/unicode/uobject.h
BUILDLINK_FILES.icu+=	include/unicode/urename.h
BUILDLINK_FILES.icu+=	include/unicode/urep.h
BUILDLINK_FILES.icu+=	include/unicode/ures.h
BUILDLINK_FILES.icu+=	include/unicode/uscript.h
BUILDLINK_FILES.icu+=	include/unicode/usearch.h
BUILDLINK_FILES.icu+=	include/unicode/uset.h
BUILDLINK_FILES.icu+=	include/unicode/usetiter.h
BUILDLINK_FILES.icu+=	include/unicode/ushape.h
BUILDLINK_FILES.icu+=	include/unicode/ustdio.h
BUILDLINK_FILES.icu+=	include/unicode/ustream.h
...
BUILDLINK_FILES.icu+=	include/unicode/utf_old.h
BUILDLINK_FILES.icu+=	include/unicode/utrans.h
BUILDLINK_FILES.icu+=	include/unicode/utypes.h
BUILDLINK_FILES.icu+=	include/unicode/uversion.h
BUILDLINK_FILES.icu+=	lib/libicuctestfw.*
