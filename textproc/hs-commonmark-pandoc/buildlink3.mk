# $NetBSD: buildlink3.mk,v 1.18 2025/03/05 03:39:57 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-commonmark-pandoc+=	hs-commonmark-pandoc>=0.2.3
BUILDLINK_ABI_DEPENDS.hs-commonmark-pandoc+=	hs-commonmark-pandoc>=0.2.3nb1
