...
CARGO_CRATE_DEPENDS+=	backtrace-0.3.58
...
CARGO_CRATE_DEPENDS+=	bzip2-sys-0.1.10+1.0.8
...
CARGO_CRATE_DEPENDS+=	comfy-table-3.0.0
...
CARGO_CRATE_DEPENDS+=	curl-0.4.36
CARGO_CRATE_DEPENDS+=	curl-sys-0.4.42+curl-7.76.0
SITES.curl-sys-0.4.42+curl-7.76.0.crate+= ${MASTER_SITE_CRATESIO:S,^,-,:=curl-sys/0.4.42+curl-7.76.0/download}
...
CARGO_CRATE_DEPENDS+=	flexi_logger-0.18.0
...
CARGO_CRATE_DEPENDS+=	http-client-6.3.5
CARGO_CRATE_DEPENDS+=	http-types-2.11.0
...
CARGO_CRATE_DEPENDS+=	openssl-sys-0.9.62
...
CARGO_CRATE_DEPENDS+=	spinning_top-0.2.3
