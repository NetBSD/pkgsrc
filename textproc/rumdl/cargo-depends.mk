# $NetBSD: cargo-depends.mk,v 1.24 2026/09/25 08:57:30 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fraction-0.15.3
...
CARGO_CRATE_DEPENDS+=	jsonschema-0.46.0
...
CARGO_CRATE_DEPENDS+=	oxc_allocator-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_ast-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_ast_macros-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_data_structures-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_diagnostics-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_ecmascript-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_estree-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_index-5.0.0
CARGO_CRATE_DEPENDS+=	oxc_parser-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_regular_expression-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_span-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_str-0.137.0
CARGO_CRATE_DEPENDS+=	oxc_syntax-0.137.0
...
CARGO_CRATE_DEPENDS+=	referencing-0.46.0
...
CARGO_CRATE_DEPENDS+=	ureq-proto-0.6.3
