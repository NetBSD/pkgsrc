# $NetBSD: cargo-depends.mk,v 1.11 2026/04/25 19:08:02 pin Exp $
...
CARGO_CRATE_DEPENDS+=	core_extensions-1.5.4
CARGO_CRATE_DEPENDS+=	core_extensions_proc_macros-1.5.4
...
CARGO_CRATE_DEPENDS+=	generic_singleton-0.5.1
...
CARGO_CRATE_DEPENDS+=	icu_casemap-2.1.1
CARGO_CRATE_DEPENDS+=	icu_casemap_data-2.1.1
...
CARGO_CRATE_DEPENDS+=	im-lists-0.11.4
...
CARGO_CRATE_DEPENDS+=	log4rs-1.4.0
CARGO_CRATE_DEPENDS+=	lru-0.16.4
CARGO_CRATE_DEPENDS+=	lru-0.17.0
...
CARGO_CRATE_DEPENDS+=	mock_instant-0.6.0
...
CARGO_CRATE_DEPENDS+=	pretty-0.12.5
...
CARGO_CRATE_DEPENDS+=	shared_vector-0.4.5
...
CARGO_CRATE_DEPENDS+=	steel-core-0.8.2
CARGO_CRATE_DEPENDS+=	steel-derive-0.8.2
CARGO_CRATE_DEPENDS+=	steel-gen-0.8.2
CARGO_CRATE_DEPENDS+=	steel-parser-0.8.2
CARGO_CRATE_DEPENDS+=	steel-quickscope-0.3.2
...
CARGO_CRATE_DEPENDS+=	thread-id-5.1.0
...
CARGO_CRATE_DEPENDS+=	two-face-0.5.1
