# $NetBSD: cargo-depends.mk,v 1.2 2026/08/30 15:05:45 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	hifijson-0.5.0
...
CARGO_CRATE_DEPENDS+=	jaq-core-3.1.0
CARGO_CRATE_DEPENDS+=	jaq-json-2.0.2
CARGO_CRATE_DEPENDS+=	jaq-std-3.0.2
...
CARGO_CRATE_DEPENDS+=	regex-bites-0.1.6
