# $NetBSD: cargo-depends.mk,v 1.39 2022/07/06 06:31:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	onig-6.3.2
CARGO_CRATE_DEPENDS+=	onig_sys-69.8.0
...
CARGO_CRATE_DEPENDS+=	terminal-light-0.8.1
