# $NetBSD: cargo-depends.mk,v 1.21 2021/09/11 21:05:46 pin Exp $
...
CARGO_CRATE_DEPENDS+=	argh-0.1.5
CARGO_CRATE_DEPENDS+=	argh_derive-0.1.5
CARGO_CRATE_DEPENDS+=	argh_shared-0.1.5
...
CARGO_CRATE_DEPENDS+=	plist-1.2.0
...
CARGO_CRATE_DEPENDS+=	termimad-0.14.0
