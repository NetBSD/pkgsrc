# $NetBSD: cargo-depends.mk,v 1.17 2021/05/11 14:06:43 pin Exp $

CARGO_CRATE_DEPENDS+=	adler-1.0.2
CARGO_CRATE_DEPENDS+=	adler32-1.2.0
CARGO_CRATE_DEPENDS+=	ahash-0.4.7
CARGO_CRATE_DEPENDS+=	ahash-0.7.2
...
CARGO_CRATE_DEPENDS+=	cli-log-1.2.0
CARGO_CRATE_DEPENDS+=	clipboard-win-4.1.0
...
CARGO_CRATE_DEPENDS+=	deser-hjson-0.1.12
...
CARGO_CRATE_DEPENDS+=	error-code-2.1.0
...
CARGO_CRATE_DEPENDS+=	git2-0.13.18
...
CARGO_CRATE_DEPENDS+=	minimad-0.7.0
...
CARGO_CRATE_DEPENDS+=	secular-1.0.0
...
CARGO_CRATE_DEPENDS+=	str-buf-2.0.0
...
CARGO_CRATE_DEPENDS+=	termimad-0.10.2
