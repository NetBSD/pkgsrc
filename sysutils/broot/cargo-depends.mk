# $NetBSD: cargo-depends.mk,v 1.66 2023/11/14 21:04:28 pin Exp $
...
CARGO_CRATE_DEPENDS+=	coolor-0.5.1
...
CARGO_CRATE_DEPENDS+=	glassbench-0.3.6
...
CARGO_CRATE_DEPENDS+=	termimad-0.25.7
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.7.23
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.7.23
