# $NetBSD: cargo-depends.mk,v 1.61 2023/08/19 21:04:23 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-help-0.6.1
...
CARGO_CRATE_DEPENDS+=	termimad-0.23.2
CARGO_CRATE_DEPENDS+=	termimad-0.24.1
