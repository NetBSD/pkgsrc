# $NetBSD: cargo-depends.mk,v 1.73 2024/02/26 18:59:13 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-help-1.1.0
...
CARGO_CRATE_DEPENDS+=	csv2svg-0.2.0
...
CARGO_CRATE_DEPENDS+=	termimad-0.28.2
...
CARGO_CRATE_DEPENDS+=	trash-3.2.0
