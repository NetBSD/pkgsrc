# $NetBSD: cargo-depends.mk,v 1.34 2022/03/14 10:19:15 pin Exp $
...
CARGO_CRATE_DEPENDS+=	crokey-0.4.0
...
CARGO_CRATE_DEPENDS+=	csv2svg-0.1.6
...
CARGO_CRATE_DEPENDS+=	glassbench-0.3.1
...
CARGO_CRATE_DEPENDS+=	open-2.1.0
