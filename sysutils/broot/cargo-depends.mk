# $NetBSD: cargo-depends.mk,v 1.44 2022/11/05 15:51:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bytemuck-1.12.2
...
CARGO_CRATE_DEPENDS+=	snafu-0.7.3
CARGO_CRATE_DEPENDS+=	snafu-derive-0.7.3
...
CARGO_CRATE_DEPENDS+=	termimad-0.20.3
