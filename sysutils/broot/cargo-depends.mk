# $NetBSD: cargo-depends.mk,v 1.11 2021/02/06 08:20:12 pin Exp $
...
CARGO_CRATE_DEPENDS+=	git2-0.13.14
...
CARGO_CRATE_DEPENDS+=	libgit2-sys-0.12.16+1.1.0
...
CARGO_CRATE_DEPENDS+=	minimad-0.6.9
...
CARGO_CRATE_DEPENDS+=	termimad-0.9.5
