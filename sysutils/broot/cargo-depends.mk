# $NetBSD: cargo-depends.mk,v 1.50 2023/01/23 21:08:29 pin Exp $
...
CARGO_CRATE_DEPENDS+=	lazy-regex-2.3.2
CARGO_CRATE_DEPENDS+=	lazy-regex-proc_macros-2.3.2
...
CARGO_CRATE_DEPENDS+=	terminal-light-1.0.1
