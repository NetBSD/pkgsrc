# $NetBSD: cargo-depends.mk,v 1.1 2021/01/05 12:58:31 pin Exp $
...
CARGO_CRATE_DEPENDS+=	assert_fs-1.0.0
...
CARGO_CRATE_DEPENDS+=	chrono-humanize-0.0.11
...
CARGO_CRATE_DEPENDS+=	globwalk-0.7.3
