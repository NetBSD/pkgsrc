# $NetBSD: cargo-depends.mk,v 1.12 2024/08/28 06:53:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ansi-to-tui-5.0.0-rc.1
...
CARGO_CRATE_DEPENDS+=	notify-fork-6.1.1
CARGO_CRATE_DEPENDS+=	notify-types-fork-1.0.0
...
CARGO_CRATE_DEPENDS+=	trash-5.1.0
