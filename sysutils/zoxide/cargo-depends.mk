# $NetBSD: cargo-depends.mk,v 1.5 2021/08/06 09:50:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap_generate-3.0.0-beta.2
...
CARGO_CRATE_DEPENDS+=	ordered-float-2.7.0
CARGO_CRATE_DEPENDS+=	os_str_bytes-2.4.0
CARGO_CRATE_DEPENDS+=	ppv-lite86-0.2.10
CARGO_CRATE_DEPENDS+=	predicates-2.0.1
