# $NetBSD: cargo-depends.mk,v 1.16 2023/08/04 09:02:48 pin Exp $
...
CARGO_CRATE_DEPENDS+=	color-print-0.3.4
CARGO_CRATE_DEPENDS+=	color-print-proc-macro-0.3.4
...
CARGO_CRATE_DEPENDS+=	ouroboros-0.17.2
CARGO_CRATE_DEPENDS+=	ouroboros_macro-0.17.2
...
CARGO_CRATE_DEPENDS+=	serde-1.0.181
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.181
