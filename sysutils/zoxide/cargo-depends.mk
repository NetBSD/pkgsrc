# $NetBSD: cargo-depends.mk,v 1.2 2021/04/09 09:00:57 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bincode-1.3.2
...
CARGO_CRATE_DEPENDS+=	ordered-float-2.1.1
...
CARGO_CRATE_DEPENDS+=	seq-macro-0.2.1
