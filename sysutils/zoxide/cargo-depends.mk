# $NetBSD: cargo-depends.mk,v 1.9 2021/12/29 05:54:01 pin Exp $

CARGO_CRATE_DEPENDS+=	aho-corasick-0.7.18
CARGO_CRATE_DEPENDS+=	anyhow-1.0.52
CARGO_CRATE_DEPENDS+=	askama-0.11.0
CARGO_CRATE_DEPENDS+=	askama_derive-0.11.0
CARGO_CRATE_DEPENDS+=	askama_escape-0.10.2
CARGO_CRATE_DEPENDS+=	askama_shared-0.12.0
...
CARGO_CRATE_DEPENDS+=	clap_generate_fig-3.0.0-rc.8
...
CARGO_CRATE_DEPENDS+=	syn-1.0.83
