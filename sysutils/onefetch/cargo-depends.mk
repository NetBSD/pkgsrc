# $NetBSD: cargo-depends.mk,v 1.17 2023/04/27 18:16:41 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo_toml-0.15.2
...
CARGO_CRATE_DEPENDS+=	gix-0.44.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.17.2
CARGO_CRATE_DEPENDS+=	gix-actor-0.20.0
CARGO_CRATE_DEPENDS+=	gix-attributes-0.8.3
CARGO_CRATE_DEPENDS+=	gix-attributes-0.11.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.3
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.1
CARGO_CRATE_DEPENDS+=	gix-command-0.2.4
CARGO_CRATE_DEPENDS+=	gix-config-0.21.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.11.0
CARGO_CRATE_DEPENDS+=	gix-credentials-0.13.0
CARGO_CRATE_DEPENDS+=	gix-date-0.4.3
CARGO_CRATE_DEPENDS+=	gix-date-0.5.0
CARGO_CRATE_DEPENDS+=	gix-diff-0.29.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.13.1
CARGO_CRATE_DEPENDS+=	gix-discover-0.17.0
...
CARGO_CRATE_DEPENDS+=	gix-glob-0.6.0
CARGO_CRATE_DEPENDS+=	gix-hash-0.10.3
CARGO_CRATE_DEPENDS+=	gix-hash-0.11.1
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.1.1
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.2.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.1.0
CARGO_CRATE_DEPENDS+=	gix-index-0.12.4
CARGO_CRATE_DEPENDS+=	gix-index-0.16.0
CARGO_CRATE_DEPENDS+=	gix-lock-3.0.2
CARGO_CRATE_DEPENDS+=	gix-lock-5.0.1
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.12.0
CARGO_CRATE_DEPENDS+=	gix-object-0.26.2
CARGO_CRATE_DEPENDS+=	gix-object-0.29.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.44.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.34.0
CARGO_CRATE_DEPENDS+=	gix-path-0.7.4
CARGO_CRATE_DEPENDS+=	gix-prompt-0.4.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.3
CARGO_CRATE_DEPENDS+=	gix-ref-0.24.1
CARGO_CRATE_DEPENDS+=	gix-ref-0.28.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.10.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.13.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.6.2
CARGO_CRATE_DEPENDS+=	gix-sec-0.7.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-3.0.2
CARGO_CRATE_DEPENDS+=	gix-tempfile-5.0.3
CARGO_CRATE_DEPENDS+=	gix-testtools-0.11.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.22.1
CARGO_CRATE_DEPENDS+=	gix-traverse-0.25.0
CARGO_CRATE_DEPENDS+=	gix-url-0.17.0
CARGO_CRATE_DEPENDS+=	gix-utils-0.1.1
CARGO_CRATE_DEPENDS+=	gix-validate-0.7.4
CARGO_CRATE_DEPENDS+=	gix-worktree-0.12.3
CARGO_CRATE_DEPENDS+=	gix-worktree-0.16.0
...
CARGO_CRATE_DEPENDS+=	human-panic-1.1.0
...
CARGO_CRATE_DEPENDS+=	os_info-2.0.8
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.19.6
