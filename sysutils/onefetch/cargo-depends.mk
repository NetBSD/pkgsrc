# $NetBSD: cargo-depends.mk,v 1.12 2022/10/31 21:28:03 pin Exp $
...
CARGO_CRATE_DEPENDS+=	git-credentials-0.4.0
...
CARGO_CRATE_DEPENDS+=	git-hash-0.9.10
CARGO_CRATE_DEPENDS+=	git-index-0.4.3
CARGO_CRATE_DEPENDS+=	git-index-0.5.0
CARGO_CRATE_DEPENDS+=	git-lock-2.1.0
CARGO_CRATE_DEPENDS+=	git-mailmap-0.3.2
...
CARGO_CRATE_DEPENDS+=	git-sec-0.4.0
