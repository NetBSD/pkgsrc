# $NetBSD: cargo-depends.mk,v 1.13 2022/11/28 09:50:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	compact_str-0.4.0
...
CARGO_CRATE_DEPENDS+=	enable-ansi-support-0.1.2
...
CARGO_CRATE_DEPENDS+=	git-actor-0.12.0
CARGO_CRATE_DEPENDS+=	git-actor-0.13.0
CARGO_CRATE_DEPENDS+=	git-attributes-0.4.0
...
CARGO_CRATE_DEPENDS+=	git-config-0.10.0
CARGO_CRATE_DEPENDS+=	git-config-value-0.8.1
CARGO_CRATE_DEPENDS+=	git-credentials-0.6.1
CARGO_CRATE_DEPENDS+=	git-date-0.2.0
CARGO_CRATE_DEPENDS+=	git-diff-0.22.0
CARGO_CRATE_DEPENDS+=	git-discover-0.5.0
CARGO_CRATE_DEPENDS+=	git-discover-0.7.0
CARGO_CRATE_DEPENDS+=	git-features-0.22.6
CARGO_CRATE_DEPENDS+=	git-features-0.23.1
CARGO_CRATE_DEPENDS+=	git-glob-0.4.1
CARGO_CRATE_DEPENDS+=	git-hash-0.9.11
CARGO_CRATE_DEPENDS+=	git-index-0.5.0
CARGO_CRATE_DEPENDS+=	git-index-0.7.1
CARGO_CRATE_DEPENDS+=	git-lock-2.1.1
CARGO_CRATE_DEPENDS+=	git-mailmap-0.5.0
CARGO_CRATE_DEPENDS+=	git-object-0.21.0
CARGO_CRATE_DEPENDS+=	git-object-0.22.1
CARGO_CRATE_DEPENDS+=	git-odb-0.36.0
CARGO_CRATE_DEPENDS+=	git-pack-0.26.0
CARGO_CRATE_DEPENDS+=	git-path-0.5.0
CARGO_CRATE_DEPENDS+=	git-prompt-0.1.1
CARGO_CRATE_DEPENDS+=	git-quote-0.3.0
CARGO_CRATE_DEPENDS+=	git-ref-0.16.0
CARGO_CRATE_DEPENDS+=	git-ref-0.18.0
CARGO_CRATE_DEPENDS+=	git-refspec-0.3.1
CARGO_CRATE_DEPENDS+=	git-repository-0.27.0
CARGO_CRATE_DEPENDS+=	git-revision-0.6.0
CARGO_CRATE_DEPENDS+=	git-sec-0.4.2
CARGO_CRATE_DEPENDS+=	git-tempfile-2.0.1
CARGO_CRATE_DEPENDS+=	git-testtools-0.9.0
CARGO_CRATE_DEPENDS+=	git-traverse-0.17.0
CARGO_CRATE_DEPENDS+=	git-traverse-0.18.0
CARGO_CRATE_DEPENDS+=	git-url-0.10.1
CARGO_CRATE_DEPENDS+=	git-validate-0.6.0
CARGO_CRATE_DEPENDS+=	git-worktree-0.5.0
CARGO_CRATE_DEPENDS+=	git-worktree-0.7.0
...
CARGO_CRATE_DEPENDS+=	prodash-21.0.0
