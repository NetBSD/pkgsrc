# $NetBSD: cargo-depends.mk,v 1.25 2025/04/13 15:23:41 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo_toml-0.22.1
...
CARGO_CRATE_DEPENDS+=	gix-features-0.41.0
...
CARGO_CRATE_DEPENDS+=	tokei-13.0.0-alpha.8
