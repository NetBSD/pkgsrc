# $NetBSD: cargo-depends.mk,v 1.28 2025/12/22 09:42:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	flate2-1.1.7
...
CARGO_CRATE_DEPENDS+=	gix-0.75.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.35.6
CARGO_CRATE_DEPENDS+=	gix-actor-0.36.0
...
CARGO_CRATE_DEPENDS+=	gix-config-0.48.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.15.3
CARGO_CRATE_DEPENDS+=	gix-date-0.10.7
CARGO_CRATE_DEPENDS+=	gix-date-0.11.0
CARGO_CRATE_DEPENDS+=	gix-diff-0.55.0
CARGO_CRATE_DEPENDS+=	gix-dir-0.17.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.40.1
CARGO_CRATE_DEPENDS+=	gix-discover-0.43.0
CARGO_CRATE_DEPENDS+=	gix-features-0.42.1
CARGO_CRATE_DEPENDS+=	gix-features-0.44.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.22.0
...
CARGO_CRATE_DEPENDS+=	libz-rs-sys-0.5.3
...
CARGO_CRATE_DEPENDS+=	zlib-rs-0.5.3
