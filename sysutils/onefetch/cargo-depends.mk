# $NetBSD: cargo-depends.mk,v 1.24 2025/01/01 19:42:30 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo_toml-0.21.0
...
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.25.1
...
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.18.1
...
CARGO_CRATE_DEPENDS+=	os_info-3.9.1
...
CARGO_CRATE_DEPENDS+=	tokei-13.0.0-alpha.7
