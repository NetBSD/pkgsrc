# $NetBSD: cargo-depends.mk,v 1.27 2022/12/05 11:25:23 pin Exp $
...
CARGO_CRATE_DEPENDS+=	humansize-2.1.2
...
CARGO_CRATE_DEPENDS+=	luajit-src-210.4.3+resty8384278
...
CARGO_CRATE_DEPENDS+=	mlua-0.8.6
