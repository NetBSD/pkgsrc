# $NetBSD: cargo-depends.mk,v 1.26 2022/10/29 20:34:43 pin Exp $
...
CARGO_CRATE_DEPENDS+=	humansize-2.1.0
...
CARGO_CRATE_DEPENDS+=	mlua-0.8.4
...
CARGO_CRATE_DEPENDS+=	tui-input-0.6.0
