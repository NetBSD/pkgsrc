# $NetBSD: cargo-depends.mk,v 1.33 2024/01/04 12:29:33 pin Exp $
...
CARGO_CRATE_DEPENDS+=	luajit-src-210.5.3+29b0b28
...
CARGO_CRATE_DEPENDS+=	mlua-0.9.2
CARGO_CRATE_DEPENDS+=	mlua-sys-0.4.0
