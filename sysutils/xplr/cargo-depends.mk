# $NetBSD: cargo-depends.mk,v 1.10 2021/08/02 15:06:45 pin Exp $

CARGO_CRATE_DEPENDS+=	ansi-to-tui-0.3.0
...
CARGO_CRATE_DEPENDS+=	luajit-src-210.2.0+resty5f13855
...
CARGO_CRATE_DEPENDS+=	mlua-0.6.2
...
CARGO_CRATE_DEPENDS+=	serde_json-1.0.65
