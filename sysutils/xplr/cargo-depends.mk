# $NetBSD: cargo-depends.mk,v 1.3 2021/04/11 18:55:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-stream-0.3.0
CARGO_CRATE_DEPENDS+=	async-stream-impl-0.3.0
...
CARGO_CRATE_DEPENDS+=	cucumber_rust-0.8.4
CARGO_CRATE_DEPENDS+=	cute_custom_default-2.1.0
...
CARGO_CRATE_DEPENDS+=	gherkin_rust-0.10.1
...
CARGO_CRATE_DEPENDS+=	tokio-1.4.0
...
CARGO_CRATE_DEPENDS+=	typed-builder-0.7.1
