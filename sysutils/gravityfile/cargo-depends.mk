# $NetBSD: cargo-depends.mk,v 1.4 2026/08/03 14:05:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	libc-1.0.0-alpha.3
...
CARGO_CRATE_DEPENDS+=	lua-src-550.1.0
CARGO_CRATE_DEPENDS+=	luajit-src-210.7.1+18b087c
...
CARGO_CRATE_DEPENDS+=	mlua-0.12.0-rc.1
...
CARGO_CRATE_DEPENDS+=	rhai-1.24.0
