# $NetBSD: buildlink3.mk,v 1.6 2022/02/26 03:58:23 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-hslua-module-path+=	hs-hslua-module-path>=1.0.1
BUILDLINK_ABI_DEPENDS.hs-hslua-module-path+=	hs-hslua-module-path>=1.0.1nb2
