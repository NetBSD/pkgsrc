# $NetBSD: cargo-depends.mk,v 1.16 2024/02/15 20:54:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	snapbox-0.4.16
CARGO_CRATE_DEPENDS+=	snapbox-macros-0.3.7
...
CARGO_CRATE_DEPENDS+=	trycmd-0.14.20
