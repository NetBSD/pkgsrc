# $NetBSD: cargo-depends.mk,v 1.1 2026/08/18 18:13:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	html-to-markdown-rs-3.4.0
...
CARGO_CRATE_DEPENDS+=	limner-0.5.0
...
CARGO_CRATE_DEPENDS+=	readability-0.3.0
...
CARGO_CRATE_DEPENDS+=	tui-scrollbar-0.2.4
CARGO_CRATE_DEPENDS+=	tui-skeleton-0.3.0
