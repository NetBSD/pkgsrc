# $NetBSD: cargo-depends.mk,v 1.1 2023/09/03 07:10:45 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bson-2.6.1
...
CARGO_CRATE_DEPENDS+=	crc64fast-1.0.0
...
CARGO_CRATE_DEPENDS+=	polodb_core-4.4.0
...
CARGO_CRATE_DEPENDS+=	reqwest-0.11.19
CARGO_CRATE_DEPENDS+=	rss-2.0.6
...
CARGO_CRATE_DEPENDS+=	serde_bytes-0.11.12
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.185
...
CARGO_CRATE_DEPENDS+=	time-0.3.27
CARGO_CRATE_DEPENDS+=	time-core-0.1.1
CARGO_CRATE_DEPENDS+=	time-macros-0.2.13
