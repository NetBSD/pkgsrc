# $NetBSD: cargo-depends.mk,v 1.7 2026/06/22 15:08:22 pin Exp $
...
CARGO_CRATE_DEPENDS+=	config-0.15.24
...
CARGO_CRATE_DEPENDS+=	libxml-0.3.11
...
CARGO_CRATE_DEPENDS+=	news-flash-3.1.0
...
CARGO_CRATE_DEPENDS+=	ratatui-image-11.0.4
...
CARGO_CRATE_DEPENDS+=	sqlite-wasm-rs-0.5.4
