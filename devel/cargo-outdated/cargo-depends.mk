# $NetBSD: cargo-depends.mk,v 1.3 2024/03/23 19:08:38 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.76.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.4
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.8
...
CARGO_CRATE_DEPENDS+=	crates-io-0.39.1
...
CARGO_CRATE_DEPENDS+=	gix-attributes-0.20.1
...
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.3
CARGO_CRATE_DEPENDS+=	gix-credentials-0.21.0
CARGO_CRATE_DEPENDS+=	gix-date-0.8.3
...
CARGO_CRATE_DEPENDS+=	gix-filter-0.6.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.8.1
CARGO_CRATE_DEPENDS+=	gix-glob-0.14.1
CARGO_CRATE_DEPENDS+=	gix-hash-0.13.2
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.4.1
CARGO_CRATE_DEPENDS+=	gix-ignore-0.9.1
CARGO_CRATE_DEPENDS+=	gix-index-0.26.0
CARGO_CRATE_DEPENDS+=	gix-lock-11.0.1
CARGO_CRATE_DEPENDS+=	gix-macros-0.1.3
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.9.0
...
CARGO_CRATE_DEPENDS+=	gix-path-0.10.3
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.4.1
CARGO_CRATE_DEPENDS+=	gix-prompt-0.7.0
CARGO_CRATE_DEPENDS+=	gix-protocol-0.41.1
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.10
...
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.3
CARGO_CRATE_DEPENDS+=	gix-submodule-0.5.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-11.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.6
CARGO_CRATE_DEPENDS+=	gix-transport-0.38.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.34.0
CARGO_CRATE_DEPENDS+=	gix-url-0.25.2
CARGO_CRATE_DEPENDS+=	gix-utils-0.1.8
CARGO_CRATE_DEPENDS+=	gix-validate-0.8.3
CARGO_CRATE_DEPENDS+=	gix-worktree-0.27.0
...
CARGO_CRATE_DEPENDS+=	serde-untagged-0.1.4
...
CARGO_CRATE_DEPENDS+=	winnow-0.5.31
