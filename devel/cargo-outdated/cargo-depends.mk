# $NetBSD: cargo-depends.mk,v 1.7 2025/10/29 18:07:27 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.87.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.7
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.12
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.12
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.12
CARGO_CRATE_DEPENDS+=	cargo-platform-0.2.0
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.19
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.7.3
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.9
...
CARGO_CRATE_DEPENDS+=	curl-sys-0.4.80+curl-8.12.1
...
CARGO_CRATE_DEPENDS+=	pasetors-0.7.2
...
CARGO_CRATE_DEPENDS+=	rustfix-0.9.0
