# $NetBSD: cargo-depends.mk,v 1.6 2025/03/17 20:57:15 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.86.0
...
CARGO_CRATE_DEPENDS+=	gix-attributes-0.23.1
...
CARGO_CRATE_DEPENDS+=	gix-ignore-0.12.1
CARGO_CRATE_DEPENDS+=	gix-index-0.37.0
CARGO_CRATE_DEPENDS+=	gix-lock-15.0.1
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.17.0
...
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.8.1
...
CARGO_CRATE_DEPENDS+=	gix-submodule-0.16.0
