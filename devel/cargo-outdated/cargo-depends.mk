# $NetBSD: cargo-depends.mk,v 1.8 2026/04/15 06:45:11 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.91.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.9
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.5.1
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.16
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.16
CARGO_CRATE_DEPENDS+=	cargo-platform-0.3.2
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.23
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.10.0
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.13
...
CARGO_CRATE_DEPENDS+=	curl-sys-0.4.87+curl-8.19.0
...
CARGO_CRATE_DEPENDS+=	libsqlite3-sys-0.34.0
...
CARGO_CRATE_DEPENDS+=	orion-0.17.13
