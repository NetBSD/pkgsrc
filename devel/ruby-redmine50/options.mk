# $NetBSD: options.mk,v 1.2 2024/05/05 14:42:01 taca Exp $

PKG_OPTIONS_VAR=	PKG_OPTIONS.redmine50
...
DEPENDS+=	${RUBY_PKGPREFIX}-sqlite3>=1.4.0:../../databases/ruby-sqlite3
.endif
...
RCD_SCRIPTS+=	redmine50_unicorn${RUBY_SUFFIX}
RCD_SCRIPT_SRC.redmine50_unicorn${RUBY_SUFFIX}=	${FILESDIR}/redmine50_unicorn.sh
