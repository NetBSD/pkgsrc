# $NetBSD: buildlink3.mk,v 1.10 2025/01/31 04:51:16 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-ghc-exactprint+=	hs-ghc-exactprint>=1.10.0
BUILDLINK_ABI_DEPENDS.hs-ghc-exactprint+=	hs-ghc-exactprint>=1.10.0.0
