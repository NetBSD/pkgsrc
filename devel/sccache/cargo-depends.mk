# $NetBSD: cargo-depends.mk,v 1.1 2025/09/15 14:32:53 adam Exp $
...
CARGO_CRATE_DEPENDS+=	backon-1.2.0
...
CARGO_CRATE_DEPENDS+=	hyper-1.1.0
...
CARGO_CRATE_DEPENDS+=	opendal-0.52.0
...
CARGO_CRATE_DEPENDS+=	redis-0.27.5
...
CARGO_CRATE_DEPENDS+=	tokio-retry2-0.5.6
...
CARGO_CRATE_DEPENDS+=	uuid-1.9.0
