# $NetBSD: cargo-depends.mk,v 1.34 2024/09/13 09:53:36 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-0.3.43
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-macro-0.3.43
