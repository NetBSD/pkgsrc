# $NetBSD: cargo-depends.mk,v 1.12 2024/02/18 08:23:00 adam Exp $
...
CARGO_CRATE_DEPENDS+=	hoot-0.1.3
CARGO_CRATE_DEPENDS+=	hootbin-0.1.1
...
CARGO_CRATE_DEPENDS+=	ureq-2.9.5
