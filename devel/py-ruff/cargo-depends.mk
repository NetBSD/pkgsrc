# $NetBSD: cargo-depends.mk,v 1.64 2025/07/13 10:44:42 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	codspeed-3.0.2
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-3.0.2
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-walltime-3.0.2
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-3.0.2
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-macros-3.0.2
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-walltime-3.0.2
CARGO_CRATE_DEPENDS+=	collection_literals-1.0.1
...
CARGO_CRATE_DEPENDS+=	derive-where-1.5.0
...
CARGO_CRATE_DEPENDS+=	get-size-derive2-0.5.1
CARGO_CRATE_DEPENDS+=	get-size2-0.5.1
...
CARGO_CRATE_DEPENDS+=	ordermap-0.5.8
CARGO_CRATE_DEPENDS+=	os_pipe-1.2.1
CARGO_CRATE_DEPENDS+=	os_str_bytes-7.1.0
CARGO_CRATE_DEPENDS+=	overload-0.1.1
CARGO_CRATE_DEPENDS+=	papaya-0.2.3
...
#CARGO_CRATE_DEPENDS+=	salsa-macros-0.23.0
...
CARGO_CRATE_DEPENDS+=	seize-0.5.0
...
CARGO_CRATE_DEPENDS+=	tracing-indicatif-0.3.11
