# $NetBSD: buildlink3.mk,v 1.6 2023/05/13 02:44:05 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.1.5
BUILDLINK_ABI_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.1.5
