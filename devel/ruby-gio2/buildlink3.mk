# $NetBSD: buildlink3.mk,v 1.8 2023/08/12 08:37:19 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.1.9
BUILDLINK_ABI_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.1.9
