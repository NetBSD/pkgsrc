# $NetBSD: buildlink3.mk,v 1.18 2025/09/12 14:04:47 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.3.3
BUILDLINK_ABI_DEPENDS.ruby-gio2+=	${RUBY_PKGPREFIX}-gio2>=4.3.3
