# $NetBSD: cargo-depends.mk,v 1.8 2025/02/06 11:20:22 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-test-macro-0.3.0
CARGO_CRATE_DEPENDS+=	cargo-test-support-0.4.0
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.14
...
CARGO_CRATE_DEPENDS+=	clap-cargo-0.15.0
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.4
...
CARGO_CRATE_DEPENDS+=	tame-index-0.16.0
