# $NetBSD: cargo-depends.mk,v 1.9 2025/04/13 15:20:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-test-macro-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-test-support-0.7.1
...
CARGO_CRATE_DEPENDS+=	clap-cargo-0.15.2
...
CARGO_CRATE_DEPENDS+=	smol_str-0.3.1
