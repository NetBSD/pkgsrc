$NetBSD: patch-setup.py,v 1.3 2022/01/10 21:54:14 wiz Exp $

Allow standard installation.

--- setup.py.orig	2021-07-04 13:27:34.000000000 +0000
+++ setup.py
@@ -327,13 +327,6 @@ class NameSpacePackager(object):
