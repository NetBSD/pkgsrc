# $NetBSD: buildlink3.mk,v 1.9 2023/05/13 02:44:05 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.5
BUILDLINK_ABI_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.5
