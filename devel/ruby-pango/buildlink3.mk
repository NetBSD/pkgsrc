# $NetBSD: buildlink3.mk,v 1.8 2023/05/04 21:55:45 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.4
BUILDLINK_ABI_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.4
