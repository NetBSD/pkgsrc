# $NetBSD: buildlink3.mk,v 1.21 2025/02/09 09:19:09 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.2.7
BUILDLINK_ABI_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.2.7
