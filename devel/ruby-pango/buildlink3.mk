# $NetBSD: buildlink3.mk,v 1.18 2024/09/21 06:39:34 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.2.3
BUILDLINK_ABI_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.2.3
