# $NetBSD: buildlink3.mk,v 1.11 2023/08/12 08:37:20 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.9
BUILDLINK_ABI_DEPENDS.ruby-pango+=	${RUBY_PKGPREFIX}-pango>=4.1.9
