# $NetBSD: cargo-depends.mk,v 1.40 2025/02/24 08:37:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aligned-vec-0.6.1
...
CARGO_CRATE_DEPENDS+=	config-0.15.6
...
CARGO_CRATE_DEPENDS+=	equator-0.2.2
CARGO_CRATE_DEPENDS+=	equator-macro-0.2.1
...
CARGO_CRATE_DEPENDS+=	git-conventional-0.12.7
...
CARGO_CRATE_DEPENDS+=	include-flate-0.3.0
CARGO_CRATE_DEPENDS+=	include-flate-codegen-0.2.0
...
CARGO_CRATE_DEPENDS+=	next_version-0.2.21
...
CARGO_CRATE_DEPENDS+=	pprof-0.14.0
...
CARGO_CRATE_DEPENDS+=	reflink-copy-0.1.19
...
CARGO_CRATE_DEPENDS+=	reqwest-middleware-0.4.0
...
CARGO_CRATE_DEPENDS+=	symbolic-common-12.11.1
CARGO_CRATE_DEPENDS+=	symbolic-demangle-12.11.1
CARGO_CRATE_DEPENDS+=	syn-2.0.96
CARGO_CRATE_DEPENDS+=	sync_wrapper-1.0.2
CARGO_CRATE_DEPENDS+=	synstructure-0.13.1
CARGO_CRATE_DEPENDS+=	temp-dir-0.1.14
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.22.21
