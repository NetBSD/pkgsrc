# $NetBSD: cargo-depends.mk,v 1.32 2024/04/11 08:55:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cacache-12.0.0
...
CARGO_CRATE_DEPENDS+=	http-cache-0.18.0
CARGO_CRATE_DEPENDS+=	http-cache-reqwest-0.13.0
CARGO_CRATE_DEPENDS+=	http-cache-semantics-1.0.2
...
CARGO_CRATE_DEPENDS+=	next_version-0.2.15
...
CARGO_CRATE_DEPENDS+=	reflink-copy-0.1.15
...
CARGO_CRATE_DEPENDS+=	reqwest-middleware-0.2.5
...
CARGO_CRATE_DEPENDS+=	task-local-extensions-0.1.4
...
CARGO_CRATE_DEPENDS+=	time-0.3.35
