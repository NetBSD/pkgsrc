# $NetBSD: cargo-depends.mk,v 1.41 2025/06/04 07:47:24 pin Exp $
...
CARGO_CRATE_DEPENDS+=	config-0.15.11
...
CARGO_CRATE_DEPENDS+=	next_version-0.2.24
...
CARGO_CRATE_DEPENDS+=	yaml-rust2-0.10.1
