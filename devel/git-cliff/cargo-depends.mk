# $NetBSD: cargo-depends.mk,v 1.43 2025/09/24 12:48:31 pin Exp $
...
CARGO_CRATE_DEPENDS+=	config-0.15.15
...
CARGO_CRATE_DEPENDS+=	next_version-0.2.25
...
CARGO_CRATE_DEPENDS+=	serde-1.0.221
CARGO_CRATE_DEPENDS+=	serde_core-1.0.221
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.221
CARGO_CRATE_DEPENDS+=	serde_json-1.0.144
...
CARGO_CRATE_DEPENDS+=	yaml-rust2-0.10.3
