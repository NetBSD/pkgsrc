# $NetBSD: cargo-depends.mk,v 1.18 2022/11/21 09:19:41 pin Exp $
...
CARGO_CRATE_DEPENDS+=	config-0.13.2
...
CARGO_CRATE_DEPENDS+=	git-conventional-0.12.0
...
CARGO_CRATE_DEPENDS+=	lazy-regex-2.3.1
CARGO_CRATE_DEPENDS+=	lazy-regex-proc_macros-2.3.1
