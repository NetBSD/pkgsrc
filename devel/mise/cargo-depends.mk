# $NetBSD: cargo-depends.mk,v 1.52 2025/02/02 18:11:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bzip2-0.5.0
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.8.14
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.7.35
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.8.14
