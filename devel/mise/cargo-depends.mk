# $NetBSD: cargo-depends.mk,v 1.116 2026/09/07 18:57:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aube-2.2.4
CARGO_CRATE_DEPENDS+=	aube-codes-2.2.4
CARGO_CRATE_DEPENDS+=	aube-linker-2.2.4
CARGO_CRATE_DEPENDS+=	aube-lockfile-2.2.4
CARGO_CRATE_DEPENDS+=	aube-manifest-2.2.4
CARGO_CRATE_DEPENDS+=	aube-registry-2.2.4
CARGO_CRATE_DEPENDS+=	aube-resolver-2.2.4
CARGO_CRATE_DEPENDS+=	aube-runtime-2.2.4
CARGO_CRATE_DEPENDS+=	aube-scripts-2.2.4
CARGO_CRATE_DEPENDS+=	aube-settings-2.2.4
CARGO_CRATE_DEPENDS+=	aube-store-2.2.4
CARGO_CRATE_DEPENDS+=	aube-util-2.2.4
CARGO_CRATE_DEPENDS+=	aube-workspace-2.2.4
CARGO_CRATE_DEPENDS+=	autocfg-1.5.1
CARGO_CRATE_DEPENDS+=	aws-config-1.11.0
CARGO_CRATE_DEPENDS+=	aws-credential-types-1.3.0
CARGO_CRATE_DEPENDS+=	aws-lc-fips-sys-0.14.1
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.18.0
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.44.0
CARGO_CRATE_DEPENDS+=	aws-runtime-1.9.1
CARGO_CRATE_DEPENDS+=	aws-sdk-s3-1.144.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sso-1.108.0
CARGO_CRATE_DEPENDS+=	aws-sdk-ssooidc-1.110.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sts-1.113.0
...
CARGO_CRATE_DEPENDS+=	crc32fast-1.5.1
...
CARGO_CRATE_DEPENDS+=	gix-dir-0.29.1
...
CARGO_CRATE_DEPENDS+=	gix-imara-diff-0.2.5
CARGO_CRATE_DEPENDS+=	gix-index-0.55.0
CARGO_CRATE_DEPENDS+=	gix-lock-24.0.0
CARGO_CRATE_DEPENDS+=	gix-macros-0.1.6
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.34.1
CARGO_CRATE_DEPENDS+=	gix-merge-0.20.1
...
CARGO_CRATE_DEPENDS+=	gix-status-0.34.1
...
CARGO_CRATE_DEPENDS+=	libredox-0.1.21
...
CARGO_CRATE_DEPENDS+=	lru-0.18.3
CARGO_CRATE_DEPENDS+=	lru-slab-0.1.2
CARGO_CRATE_DEPENDS+=	lua-src-551.0.1
...
CARGO_CRATE_DEPENDS+=	pest-2.9.0
CARGO_CRATE_DEPENDS+=	pest_derive-2.9.0
CARGO_CRATE_DEPENDS+=	pest_generator-2.9.0
CARGO_CRATE_DEPENDS+=	pest_meta-2.9.0
...
CARGO_CRATE_DEPENDS+=	platforms-4.1.1
...
CARGO_CRATE_DEPENDS+=	rattler-0.48.4
CARGO_CRATE_DEPENDS+=	rattler_cache-0.10.7
CARGO_CRATE_DEPENDS+=	rattler_conda_types-0.51.0
CARGO_CRATE_DEPENDS+=	rattler_digest-1.3.2
CARGO_CRATE_DEPENDS+=	rattler_macros-1.1.2
CARGO_CRATE_DEPENDS+=	rattler_menuinst-0.2.75
CARGO_CRATE_DEPENDS+=	rattler_networking-0.30.6
CARGO_CRATE_DEPENDS+=	rattler_package_streaming-0.27.2
CARGO_CRATE_DEPENDS+=	rattler_pty-0.2.16
CARGO_CRATE_DEPENDS+=	rattler_redaction-0.2.3
CARGO_CRATE_DEPENDS+=	rattler_repodata_gateway-0.33.0
CARGO_CRATE_DEPENDS+=	rattler_shell-0.27.15
CARGO_CRATE_DEPENDS+=	rattler_solve-9.0.3
CARGO_CRATE_DEPENDS+=	rattler_virtual_packages-5.1.0
...
CARGO_CRATE_DEPENDS+=	rmcp-3.1.4
CARGO_CRATE_DEPENDS+=	rmcp-macros-3.1.4
...
CARGO_CRATE_DEPENDS+=	tera-2.3.0
...
CARGO_CRATE_DEPENDS+=	usage-argv-6.6.1
CARGO_CRATE_DEPENDS+=	usage-cli-6.6.1
CARGO_CRATE_DEPENDS+=	usage-derive-6.6.1
CARGO_CRATE_DEPENDS+=	usage-lib-6.6.1
CARGO_CRATE_DEPENDS+=	usage-rs-6.6.1
CARGO_CRATE_DEPENDS+=	usage-test-6.6.1
CARGO_CRATE_DEPENDS+=	usage-validation-6.6.1
CARGO_CRATE_DEPENDS+=	utf8-zero-0.8.1
CARGO_CRATE_DEPENDS+=	utf8_iter-1.0.4
CARGO_CRATE_DEPENDS+=	utf8parse-0.2.2
CARGO_CRATE_DEPENDS+=	uuid-1.26.0
