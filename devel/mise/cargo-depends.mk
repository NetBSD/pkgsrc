# $NetBSD: cargo-depends.mk,v 1.111 2026/05/20 14:15:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	astral_async_http_range_reader-0.9.1
...
CARGO_CRATE_DEPENDS+=	file_url-0.3.0
...
CARGO_CRATE_DEPENDS+=	link-section-0.17.1
...
CARGO_CRATE_DEPENDS+=	path_resolver-0.2.8
...
CARGO_CRATE_DEPENDS+=	rattler-0.42.0
CARGO_CRATE_DEPENDS+=	rattler_cache-0.7.1
CARGO_CRATE_DEPENDS+=	rattler_conda_types-0.46.1
CARGO_CRATE_DEPENDS+=	rattler_digest-1.2.4
CARGO_CRATE_DEPENDS+=	rattler_macros-1.0.13
CARGO_CRATE_DEPENDS+=	rattler_menuinst-0.2.59
CARGO_CRATE_DEPENDS+=	rattler_networking-0.26.12
CARGO_CRATE_DEPENDS+=	rattler_package_streaming-0.25.1
CARGO_CRATE_DEPENDS+=	rattler_pty-0.2.10
CARGO_CRATE_DEPENDS+=	rattler_redaction-0.1.15
CARGO_CRATE_DEPENDS+=	rattler_repodata_gateway-0.28.2
CARGO_CRATE_DEPENDS+=	rattler_shell-0.26.12
CARGO_CRATE_DEPENDS+=	rattler_solve-6.0.2
CARGO_CRATE_DEPENDS+=	rattler_virtual_packages-2.3.21
...
CARGO_CRATE_DEPENDS+=	sigstore-bundle-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-crypto-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-merkle-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-rekor-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-trust-root-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-tsa-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-types-0.7.0
CARGO_CRATE_DEPENDS+=	sigstore-verify-0.7.0
