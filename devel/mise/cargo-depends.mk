# $NetBSD: cargo-depends.mk,v 1.94 2025/11/17 11:24:50 pin Exp $
...
CARGO_CRATE_DEPENDS+=	age-0.11.1
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.33
...
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.15.0
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.33.0
...
CARGO_CRATE_DEPENDS+=	compression-codecs-0.4.32
CARGO_CRATE_DEPENDS+=	compression-core-0.4.30
...
CARGO_CRATE_DEPENDS+=	demand-1.7.2
...
CARGO_CRATE_DEPENDS+=	gix-0.74.1
CARGO_CRATE_DEPENDS+=	gix-actor-0.35.6
CARGO_CRATE_DEPENDS+=	gix-archive-0.23.1
CARGO_CRATE_DEPENDS+=	gix-attributes-0.28.1
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.15
CARGO_CRATE_DEPENDS+=	gix-blame-0.4.0
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.12
CARGO_CRATE_DEPENDS+=	gix-command-0.6.3
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.30.1
CARGO_CRATE_DEPENDS+=	gix-config-0.47.1
CARGO_CRATE_DEPENDS+=	gix-config-value-0.15.3
CARGO_CRATE_DEPENDS+=	gix-credentials-0.31.1
CARGO_CRATE_DEPENDS+=	gix-date-0.10.7
CARGO_CRATE_DEPENDS+=	gix-diff-0.54.1
CARGO_CRATE_DEPENDS+=	gix-dir-0.16.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.42.0
CARGO_CRATE_DEPENDS+=	gix-features-0.44.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.21.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.17.0
CARGO_CRATE_DEPENDS+=	gix-glob-0.22.1
CARGO_CRATE_DEPENDS+=	gix-hash-0.20.1
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.10.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.17.1
CARGO_CRATE_DEPENDS+=	gix-index-0.42.1
CARGO_CRATE_DEPENDS+=	gix-lock-19.0.0
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.27.4
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.22.0
CARGO_CRATE_DEPENDS+=	gix-object-0.51.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.71.1
CARGO_CRATE_DEPENDS+=	gix-pack-0.61.1
CARGO_CRATE_DEPENDS+=	gix-packetline-0.19.3
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.19.3
CARGO_CRATE_DEPENDS+=	gix-path-0.10.21
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.13.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.11.2
CARGO_CRATE_DEPENDS+=	gix-protocol-0.52.1
CARGO_CRATE_DEPENDS+=	gix-quote-0.6.1
CARGO_CRATE_DEPENDS+=	gix-ref-0.54.1
CARGO_CRATE_DEPENDS+=	gix-refspec-0.32.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.36.1
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.22.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.12.2
CARGO_CRATE_DEPENDS+=	gix-shallow-0.6.0
CARGO_CRATE_DEPENDS+=	gix-status-0.21.1
CARGO_CRATE_DEPENDS+=	gix-submodule-0.21.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-19.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.15
CARGO_CRATE_DEPENDS+=	gix-transport-0.49.1
CARGO_CRATE_DEPENDS+=	gix-traverse-0.48.0
CARGO_CRATE_DEPENDS+=	gix-url-0.33.1
CARGO_CRATE_DEPENDS+=	gix-utils-0.3.1
CARGO_CRATE_DEPENDS+=	gix-validate-0.10.1
CARGO_CRATE_DEPENDS+=	gix-worktree-0.43.1
CARGO_CRATE_DEPENDS+=	gix-worktree-state-0.21.0
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.23.0
...
CARGO_CRATE_DEPENDS+=	impl-tools-0.10.3
...
CARGO_CRATE_DEPENDS+=	luajit-src-210.6.3+eba91fc
CARGO_CRATE_DEPENDS+=	lzma-rs-0.3.0
CARGO_CRATE_DEPENDS+=	lzma-rust-0.1.7
CARGO_CRATE_DEPENDS+=	lzma-rust2-0.6.1
...
CARGO_CRATE_DEPENDS+=	mlua-0.11.4
...
CARGO_CRATE_DEPENDS+=	oci-spec-0.8.3
...
CARGO_CRATE_DEPENDS+=	rops-0.1.5
...
CARGO_CRATE_DEPENDS+=	rustls-native-certs-0.8.2
...
CARGO_CRATE_DEPENDS+=	self_cell-1.2.1
...
CARGO_CRATE_DEPENDS+=	sevenz-rust2-0.17.1
...
CARGO_CRATE_DEPENDS+=	sigstore-verification-0.1.7
...
CARGO_CRATE_DEPENDS+=	usage-lib-2.8.0
