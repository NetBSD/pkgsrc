# $NetBSD: cargo-depends.mk,v 1.93 2025/09/25 06:56:46 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aws-lc-fips-sys-0.13.7
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.14.0
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.31.0
...
CARGO_CRATE_DEPENDS+=	demand-1.7.0
...
CARGO_CRATE_DEPENDS+=	duct-1.1.0
...
CARGO_CRATE_DEPENDS+=	erased-serde-0.4.8
...
CARGO_CRATE_DEPENDS+=	gix-0.73.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.35.4
CARGO_CRATE_DEPENDS+=	gix-archive-0.22.0
CARGO_CRATE_DEPENDS+=	gix-attributes-0.27.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.14
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.11
CARGO_CRATE_DEPENDS+=	gix-command-0.6.2
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.29.0
CARGO_CRATE_DEPENDS+=	gix-config-0.46.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.15.1
CARGO_CRATE_DEPENDS+=	gix-credentials-0.30.0
CARGO_CRATE_DEPENDS+=	gix-date-0.10.5
CARGO_CRATE_DEPENDS+=	gix-diff-0.53.0
CARGO_CRATE_DEPENDS+=	gix-dir-0.15.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.41.0
CARGO_CRATE_DEPENDS+=	gix-features-0.43.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.20.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.16.1
CARGO_CRATE_DEPENDS+=	gix-glob-0.21.0
CARGO_CRATE_DEPENDS+=	gix-hash-0.19.0
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.9.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.16.0
CARGO_CRATE_DEPENDS+=	gix-index-0.41.0
CARGO_CRATE_DEPENDS+=	gix-lock-18.0.0
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.27.2
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.21.0
CARGO_CRATE_DEPENDS+=	gix-object-0.50.2
CARGO_CRATE_DEPENDS+=	gix-odb-0.70.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.60.0
CARGO_CRATE_DEPENDS+=	gix-packetline-0.19.1
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.19.1
CARGO_CRATE_DEPENDS+=	gix-path-0.10.20
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.12.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.11.1
CARGO_CRATE_DEPENDS+=	gix-protocol-0.51.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.6.0
CARGO_CRATE_DEPENDS+=	gix-ref-0.53.1
CARGO_CRATE_DEPENDS+=	gix-refspec-0.31.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.35.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.21.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.12.0
CARGO_CRATE_DEPENDS+=	gix-shallow-0.5.0
CARGO_CRATE_DEPENDS+=	gix-status-0.20.0
CARGO_CRATE_DEPENDS+=	gix-submodule-0.20.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-18.0.0
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.13
CARGO_CRATE_DEPENDS+=	gix-transport-0.48.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.47.0
CARGO_CRATE_DEPENDS+=	gix-url-0.32.0
CARGO_CRATE_DEPENDS+=	gix-utils-0.3.0
CARGO_CRATE_DEPENDS+=	gix-validate-0.10.0
CARGO_CRATE_DEPENDS+=	gix-worktree-0.42.0
CARGO_CRATE_DEPENDS+=	gix-worktree-state-0.20.0
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.22.0
...
CARGO_CRATE_DEPENDS+=	lexical-7.0.4
CARGO_CRATE_DEPENDS+=	lexical-core-1.0.5
...
CARGO_CRATE_DEPENDS+=	lexical-write-float-1.0.5
CARGO_CRATE_DEPENDS+=	lexical-write-integer-1.0.5
...
CARGO_CRATE_DEPENDS+=	oci-spec-0.8.2
...
CARGO_CRATE_DEPENDS+=	petgraph-0.8.2
...
CARGO_CRATE_DEPENDS+=	platforms-3.6.0
...
CARGO_CRATE_DEPENDS+=	usage-lib-2.2.2
