# $NetBSD: cargo-depends.mk,v 1.114 2026/06/22 13:15:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	astral_async_zip-0.0.18
...
CARGO_CRATE_DEPENDS+=	bytesize-2.4.0
...
CARGO_CRATE_DEPENDS+=	path_resolver-0.2.11
...
CARGO_CRATE_DEPENDS+=	rattler-0.44.4
CARGO_CRATE_DEPENDS+=	rattler_cache-0.9.2
CARGO_CRATE_DEPENDS+=	rattler_conda_types-0.47.1
CARGO_CRATE_DEPENDS+=	rattler_digest-1.3.1
CARGO_CRATE_DEPENDS+=	rattler_macros-1.1.1
CARGO_CRATE_DEPENDS+=	rattler_menuinst-0.2.66
CARGO_CRATE_DEPENDS+=	rattler_networking-0.28.1
CARGO_CRATE_DEPENDS+=	rattler_package_streaming-0.26.4
CARGO_CRATE_DEPENDS+=	rattler_pty-0.2.13
CARGO_CRATE_DEPENDS+=	rattler_redaction-0.2.1
CARGO_CRATE_DEPENDS+=	rattler_repodata_gateway-0.29.5
CARGO_CRATE_DEPENDS+=	rattler_shell-0.27.6
CARGO_CRATE_DEPENDS+=	rattler_solve-7.1.3
CARGO_CRATE_DEPENDS+=	rattler_virtual_packages-3.0.1
...
CARGO_CRATE_DEPENDS+=	usage-lib-3.5.2
