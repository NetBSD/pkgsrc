# $NetBSD: cargo-depends.mk,v 1.8 2024/04/14 18:50:10 schmonz Exp $
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.8
...
CARGO_CRATE_DEPENDS+=	jobserver-0.1.29
...
CARGO_CRATE_DEPENDS+=	usage-lib-0.1.18
