# $NetBSD: cargo-depends.mk,v 1.82 2025/08/05 19:02:54 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-actor-0.35.2
...
CARGO_CRATE_DEPENDS+=	gix-object-0.50.0
...
CARGO_CRATE_DEPENDS+=	mlua-0.11.1
CARGO_CRATE_DEPENDS+=	mlua-sys-0.8.2
