# $NetBSD: cargo-depends.mk,v 1.6 2024/03/23 19:01:36 schmonz Exp $
...
CARGO_CRATE_DEPENDS+=	demand-1.1.0
...
CARGO_CRATE_DEPENDS+=	reqwest-0.12.1
...
CARGO_CRATE_DEPENDS+=	rustls-pemfile-2.1.1
CARGO_CRATE_DEPENDS+=	rustls-pki-types-1.4.0
...
CARGO_CRATE_DEPENDS+=	usage-lib-0.1.17
