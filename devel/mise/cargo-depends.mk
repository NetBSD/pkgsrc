# $NetBSD: cargo-depends.mk,v 1.25 2024/08/23 07:31:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	rustls-native-certs-0.7.2
...
CARGO_CRATE_DEPENDS+=	system-configuration-0.6.0
...
CARGO_CRATE_DEPENDS+=	vfox-0.1.2
