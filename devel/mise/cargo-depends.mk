# $NetBSD: cargo-depends.mk,v 1.56 2025/02/21 14:33:14 pin Exp $
...
CARGO_CRATE_DEPENDS+=				bzip2-0.5.1
CARGO_CRATE_DEPENDS+=				bzip2-sys-0.1.12+1.0.8
...
CARGO_CRATE_DEPENDS+=				clap-4.5.30
CARGO_CRATE_DEPENDS+=				clap_builder-4.5.30
...
CARGO_CRATE_DEPENDS+=				demand-1.6.3
...
CARGO_CRATE_DEPENDS+=				expr-lang-0.2.2
...
CARGO_CRATE_DEPENDS+=				gix-0.70.0
CARGO_CRATE_DEPENDS+=				gix-actor-0.33.2
CARGO_CRATE_DEPENDS+=				gix-archive-0.19.0
CARGO_CRATE_DEPENDS+=				gix-attributes-0.24.0
CARGO_CRATE_DEPENDS+=				gix-bitmap-0.2.14
CARGO_CRATE_DEPENDS+=				gix-chunk-0.4.11
CARGO_CRATE_DEPENDS+=				gix-command-0.4.1
CARGO_CRATE_DEPENDS+=				gix-commitgraph-0.26.0
CARGO_CRATE_DEPENDS+=				gix-config-0.43.0
CARGO_CRATE_DEPENDS+=				gix-config-value-0.14.11
CARGO_CRATE_DEPENDS+=				gix-credentials-0.27.0
CARGO_CRATE_DEPENDS+=				gix-date-0.9.3
CARGO_CRATE_DEPENDS+=				gix-diff-0.50.0
CARGO_CRATE_DEPENDS+=				gix-dir-0.12.0
CARGO_CRATE_DEPENDS+=				gix-discover-0.38.0
CARGO_CRATE_DEPENDS+=				gix-features-0.40.0
CARGO_CRATE_DEPENDS+=				gix-filter-0.17.0
CARGO_CRATE_DEPENDS+=				gix-fs-0.13.0
CARGO_CRATE_DEPENDS+=				gix-glob-0.18.0
CARGO_CRATE_DEPENDS+=				gix-hash-0.16.0
CARGO_CRATE_DEPENDS+=				gix-hashtable-0.7.0
CARGO_CRATE_DEPENDS+=				gix-ignore-0.13.0
CARGO_CRATE_DEPENDS+=				gix-index-0.38.0
CARGO_CRATE_DEPENDS+=				gix-lock-16.0.0
CARGO_CRATE_DEPENDS+=				gix-mailmap-0.25.2
CARGO_CRATE_DEPENDS+=				gix-negotiate-0.18.0
CARGO_CRATE_DEPENDS+=				gix-object-0.47.0
CARGO_CRATE_DEPENDS+=				gix-odb-0.67.0
CARGO_CRATE_DEPENDS+=				gix-pack-0.57.0
CARGO_CRATE_DEPENDS+=				gix-packetline-0.18.3
CARGO_CRATE_DEPENDS+=				gix-packetline-blocking-0.18.2
CARGO_CRATE_DEPENDS+=				gix-path-0.10.14
CARGO_CRATE_DEPENDS+=				gix-pathspec-0.9.0
CARGO_CRATE_DEPENDS+=				gix-prompt-0.9.1
CARGO_CRATE_DEPENDS+=				gix-protocol-0.48.0
CARGO_CRATE_DEPENDS+=				gix-quote-0.4.15
CARGO_CRATE_DEPENDS+=				gix-ref-0.50.0
CARGO_CRATE_DEPENDS+=				gix-refspec-0.28.0
CARGO_CRATE_DEPENDS+=				gix-revision-0.32.0
CARGO_CRATE_DEPENDS+=				gix-revwalk-0.18.0
CARGO_CRATE_DEPENDS+=				gix-sec-0.10.11
CARGO_CRATE_DEPENDS+=				gix-shallow-0.2.0
CARGO_CRATE_DEPENDS+=				gix-status-0.17.0
CARGO_CRATE_DEPENDS+=				gix-submodule-0.17.0
CARGO_CRATE_DEPENDS+=				gix-tempfile-16.0.0
CARGO_CRATE_DEPENDS+=				gix-trace-0.1.12
CARGO_CRATE_DEPENDS+=				gix-transport-0.45.0
CARGO_CRATE_DEPENDS+=				gix-traverse-0.44.0
CARGO_CRATE_DEPENDS+=				gix-url-0.29.0
CARGO_CRATE_DEPENDS+=				gix-utils-0.1.14
CARGO_CRATE_DEPENDS+=				gix-validate-0.9.3
CARGO_CRATE_DEPENDS+=				gix-worktree-0.39.0
CARGO_CRATE_DEPENDS+=				gix-worktree-state-0.17.0
CARGO_CRATE_DEPENDS+=				gix-worktree-stream-0.19.0
...
CARGO_CRATE_DEPENDS+=				insta-1.42.1
...
CARGO_CRATE_DEPENDS+=				jiff-0.1.29
...
CARGO_CRATE_DEPENDS+=				rand_core-0.9.1
...
CARGO_CRATE_DEPENDS+=				usage-lib-2.0.5
...
CARGO_CRATE_DEPENDS+=				zerocopy-0.8.18
CARGO_CRATE_DEPENDS+=				zerocopy-derive-0.7.35
CARGO_CRATE_DEPENDS+=				zerocopy-derive-0.8.18
