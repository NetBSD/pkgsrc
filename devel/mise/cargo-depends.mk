# $NetBSD: cargo-depends.mk,v 1.2 2024/03/05 06:04:18 schmonz Exp $
...
CARGO_CRATE_DEPENDS+=	bumpalo-3.15.2
...
CARGO_CRATE_DEPENDS+=	pest-2.7.7
...
CARGO_CRATE_DEPENDS+=	usage-lib-0.1.9
