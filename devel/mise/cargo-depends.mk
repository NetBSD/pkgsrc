# $NetBSD: cargo-depends.mk,v 1.36 2024/10/28 10:17:13 pin Exp $
...
CARGO_CRATE_DEPENDS+=	insta-1.41.0
...
CARGO_CRATE_DEPENDS+=	libm-0.2.9
...
CARGO_CRATE_DEPENDS+=	mlua-0.10.0
CARGO_CRATE_DEPENDS+=	mlua-sys-0.6.4
...
CARGO_CRATE_DEPENDS+=	usage-lib-0.12.1
...
CARGO_CRATE_DEPENDS+=	vfox-0.2.1
