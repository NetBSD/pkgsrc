# $NetBSD: cargo-depends.mk,v 1.98 2026/01/29 14:23:03 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aws-config-1.8.12
CARGO_CRATE_DEPENDS+=	aws-credential-types-1.2.11
CARGO_CRATE_DEPENDS+=	aws-lc-fips-sys-0.13.11
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.15.4
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.37.0
CARGO_CRATE_DEPENDS+=	aws-runtime-1.5.18
CARGO_CRATE_DEPENDS+=	aws-sdk-s3-1.119.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sts-1.96.0
CARGO_CRATE_DEPENDS+=	aws-sigv4-1.3.7
CARGO_CRATE_DEPENDS+=	aws-smithy-async-1.2.7
CARGO_CRATE_DEPENDS+=	aws-smithy-checksums-0.63.12
CARGO_CRATE_DEPENDS+=	aws-smithy-eventstream-0.60.14
CARGO_CRATE_DEPENDS+=	aws-smithy-http-0.62.6
CARGO_CRATE_DEPENDS+=	aws-smithy-http-client-1.1.5
CARGO_CRATE_DEPENDS+=	aws-smithy-json-0.61.9
CARGO_CRATE_DEPENDS+=	aws-smithy-observability-0.2.0
CARGO_CRATE_DEPENDS+=	aws-smithy-query-0.60.9
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-1.9.8
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-api-1.10.0
CARGO_CRATE_DEPENDS+=	aws-smithy-types-1.3.6
...
CARGO_CRATE_DEPENDS+=	confique-0.3.1
CARGO_CRATE_DEPENDS+=	confique-macro-0.0.12
...
CARGO_CRATE_DEPENDS+=	deflate64-0.1.10
CARGO_CRATE_DEPENDS+=	demand-1.8.1
...
CARGO_CRATE_DEPENDS+=	expr-lang-1.1.0
...
CARGO_CRATE_DEPENDS+=	gix-dir-0.20.0
...
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.30.0
...
CARGO_CRATE_DEPENDS+=	gix-status-0.25.0
...
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.27.0
...
CARGO_CRATE_DEPENDS+=	junction-1.4.1
...
CARGO_CRATE_DEPENDS+=	lzma-rust2-0.15.7
...
CARGO_CRATE_DEPENDS+=	platforms-3.7.0
...
CARGO_CRATE_DEPENDS+=	prost-reflect-build-0.15.2
CARGO_CRATE_DEPENDS+=	prost-reflect-derive-0.14.0
CARGO_CRATE_DEPENDS+=	prost-reflect-derive-0.15.1
...
CARGO_CRATE_DEPENDS+=	rops-0.1.6
CARGO_CRATE_DEPENDS+=	rowan-0.15.17
...
CARGO_CRATE_DEPENDS+=	sevenz-rust2-0.19.4
...
CARGO_CRATE_DEPENDS+=	sigstore-0.12.1
CARGO_CRATE_DEPENDS+=	sigstore-protobuf-specs-derive-0.0.1
CARGO_CRATE_DEPENDS+=	sigstore-verification-0.1.8
CARGO_CRATE_DEPENDS+=	sigstore_protobuf_specs-0.4.3
...
CARGO_CRATE_DEPENDS+=	usage-lib-2.15.0
