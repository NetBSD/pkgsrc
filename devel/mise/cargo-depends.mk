# $NetBSD: cargo-depends.mk,v 1.102 2026/04/13 16:07:24 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ctor-0.9.1
...
CARGO_CRATE_DEPENDS+=	demand-1.8.2
...
CARGO_CRATE_DEPENDS+=	dtor-0.6.0
...
CARGO_CRATE_DEPENDS+=	file_url-0.2.7
...
CARGO_CRATE_DEPENDS+=	link-section-0.0.12
...
CARGO_CRATE_DEPENDS+=	rattler-0.40.5
CARGO_CRATE_DEPENDS+=	rattler_cache-0.6.20
CARGO_CRATE_DEPENDS+=	rattler_conda_types-0.44.5
CARGO_CRATE_DEPENDS+=	rattler_digest-1.2.3
CARGO_CRATE_DEPENDS+=	rattler_macros-1.0.12
CARGO_CRATE_DEPENDS+=	rattler_menuinst-0.2.55
CARGO_CRATE_DEPENDS+=	rattler_networking-0.26.8
CARGO_CRATE_DEPENDS+=	rattler_package_streaming-0.24.8
CARGO_CRATE_DEPENDS+=	rattler_pty-0.2.9
CARGO_CRATE_DEPENDS+=	rattler_redaction-0.1.13
CARGO_CRATE_DEPENDS+=	rattler_repodata_gateway-0.27.5
CARGO_CRATE_DEPENDS+=	rattler_shell-0.26.8
CARGO_CRATE_DEPENDS+=	rattler_solve-5.2.1
CARGO_CRATE_DEPENDS+=	rattler_virtual_packages-2.3.17
...
CARGO_CRATE_DEPENDS+=	rmcp-0.3.2
CARGO_CRATE_DEPENDS+=	rmcp-macros-0.3.2
...
CARGO_CRATE_DEPENDS+=	sigstore-verification-0.2.2
