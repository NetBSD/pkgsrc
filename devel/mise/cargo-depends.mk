...
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.15.3
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.36.0
CARGO_CRATE_DEPENDS+=	aws-runtime-1.5.18
CARGO_CRATE_DEPENDS+=	aws-sdk-s3-1.120.0
...
CARGO_CRATE_DEPENDS+=	expr-lang-0.3.2
...
CARGO_CRATE_DEPENDS+=	gix-0.77.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.37.1
CARGO_CRATE_DEPENDS+=	gix-archive-0.26.0
CARGO_CRATE_DEPENDS+=	gix-attributes-0.29.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.15
CARGO_CRATE_DEPENDS+=	gix-blame-0.7.0
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.12
CARGO_CRATE_DEPENDS+=	gix-command-0.6.5
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.31.0
CARGO_CRATE_DEPENDS+=	gix-config-0.50.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.16.0
CARGO_CRATE_DEPENDS+=	gix-credentials-0.34.1
CARGO_CRATE_DEPENDS+=	gix-date-0.12.1
CARGO_CRATE_DEPENDS+=	gix-diff-0.57.1
CARGO_CRATE_DEPENDS+=	gix-dir-0.19.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.45.0
CARGO_CRATE_DEPENDS+=	gix-features-0.45.2
CARGO_CRATE_DEPENDS+=	gix-filter-0.24.1
CARGO_CRATE_DEPENDS+=	gix-fs-0.18.2
CARGO_CRATE_DEPENDS+=	gix-glob-0.23.0
CARGO_CRATE_DEPENDS+=	gix-hash-0.21.2
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.11.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.18.0
CARGO_CRATE_DEPENDS+=	gix-index-0.45.1
CARGO_CRATE_DEPENDS+=	gix-lock-20.0.1
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.29.0
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.25.0
CARGO_CRATE_DEPENDS+=	gix-object-0.54.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.74.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.64.1
CARGO_CRATE_DEPENDS+=	gix-packetline-0.20.0
CARGO_CRATE_DEPENDS+=	gix-path-0.10.22
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.14.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.12.0
CARGO_CRATE_DEPENDS+=	gix-protocol-0.55.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.6.1
CARGO_CRATE_DEPENDS+=	gix-ref-0.57.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.35.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.39.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.25.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.12.2
CARGO_CRATE_DEPENDS+=	gix-shallow-0.7.0
CARGO_CRATE_DEPENDS+=	gix-status-0.24.0
CARGO_CRATE_DEPENDS+=	gix-submodule-0.24.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-20.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.17
CARGO_CRATE_DEPENDS+=	gix-transport-0.52.1
CARGO_CRATE_DEPENDS+=	gix-traverse-0.51.1
CARGO_CRATE_DEPENDS+=	gix-url-0.34.0
CARGO_CRATE_DEPENDS+=	gix-utils-0.3.1
CARGO_CRATE_DEPENDS+=	gix-validate-0.10.1
CARGO_CRATE_DEPENDS+=	gix-worktree-0.46.0
CARGO_CRATE_DEPENDS+=	gix-worktree-state-0.24.0
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.26.0
...
CARGO_CRATE_DEPENDS+=	ppmd-rust-1.3.0
...
CARGO_CRATE_DEPENDS+=	usage-lib-2.13.1
