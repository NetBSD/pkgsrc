# $NetBSD: cargo-depends.mk,v 1.58 2025/04/11 12:16:05 pin Exp $
...
CARGO_CRATE_DEPENDS+=	age-0.10.1
CARGO_CRATE_DEPENDS+=	age-core-0.10.0
...
CARGO_CRATE_DEPENDS+=	ctor-0.4.1
...
CARGO_CRATE_DEPENDS+=	demand-1.6.5
...
CARGO_CRATE_DEPENDS+=	deunicode-1.6.1
...
CARGO_CRATE_DEPENDS+=	dtor-0.0.5
...
CARGO_CRATE_DEPENDS+=	expr-lang-0.3.0
...
CARGO_CRATE_DEPENDS+=	gix-0.71.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.34.0
CARGO_CRATE_DEPENDS+=	gix-archive-0.20.0
CARGO_CRATE_DEPENDS+=	gix-attributes-0.25.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.14
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.11
CARGO_CRATE_DEPENDS+=	gix-command-0.5.0
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.27.0
CARGO_CRATE_DEPENDS+=	gix-config-0.44.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.12
CARGO_CRATE_DEPENDS+=	gix-credentials-0.28.0
CARGO_CRATE_DEPENDS+=	gix-date-0.9.4
CARGO_CRATE_DEPENDS+=	gix-diff-0.51.0
CARGO_CRATE_DEPENDS+=	gix-dir-0.13.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.39.0
CARGO_CRATE_DEPENDS+=	gix-features-0.41.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.18.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.14.0
CARGO_CRATE_DEPENDS+=	gix-glob-0.19.0
CARGO_CRATE_DEPENDS+=	gix-hash-0.17.0
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.8.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.14.0
CARGO_CRATE_DEPENDS+=	gix-index-0.39.0
CARGO_CRATE_DEPENDS+=	gix-lock-17.0.0
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.26.0
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.19.0
CARGO_CRATE_DEPENDS+=	gix-object-0.48.0
CARGO_CRATE_DEPENDS+=	gix-odb-0.68.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.58.0
CARGO_CRATE_DEPENDS+=	gix-packetline-0.18.4
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.18.3
CARGO_CRATE_DEPENDS+=	gix-path-0.10.15
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.10.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.10.0
CARGO_CRATE_DEPENDS+=	gix-protocol-0.49.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.5.0
CARGO_CRATE_DEPENDS+=	gix-ref-0.51.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.29.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.33.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.19.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.12
CARGO_CRATE_DEPENDS+=	gix-shallow-0.3.0
CARGO_CRATE_DEPENDS+=	gix-status-0.18.0
CARGO_CRATE_DEPENDS+=	gix-submodule-0.18.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-17.0.0
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.12
CARGO_CRATE_DEPENDS+=	gix-transport-0.46.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.45.0
CARGO_CRATE_DEPENDS+=	gix-url-0.30.0
CARGO_CRATE_DEPENDS+=	gix-utils-0.2.0
CARGO_CRATE_DEPENDS+=	gix-validate-0.9.4
CARGO_CRATE_DEPENDS+=	gix-worktree-0.40.0
CARGO_CRATE_DEPENDS+=	gix-worktree-state-0.18.0
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.20.0
CARGO_CRATE_DEPENDS+=	glob-0.3.2
CARGO_CRATE_DEPENDS+=	globset-0.4.16
CARGO_CRATE_DEPENDS+=	globwalk-0.9.1
CARGO_CRATE_DEPENDS+=	h2-0.4.8
...
CARGO_CRATE_DEPENDS+=	i18n-embed-0.14.1
CARGO_CRATE_DEPENDS+=	i18n-embed-fl-0.7.0
...
CARGO_CRATE_DEPENDS+=	impl-tools-lib-0.11.1
...
CARGO_CRATE_DEPENDS+=	jiff-0.2.6
CARGO_CRATE_DEPENDS+=	jiff-static-0.2.6
...
CARGO_CRATE_DEPENDS+=	minisign-verify-0.2.3
...
CARGO_CRATE_DEPENDS+=	platforms-3.5.0
...
CARGO_CRATE_DEPENDS+=	prodash-29.0.1
...
CARGO_CRATE_DEPENDS+=	rops-0.1.4
...
CARGO_CRATE_DEPENDS+=	serde_ignored-0.1.11
...
CARGO_CRATE_DEPENDS+=	tabled_derive-0.9.0
...
CARGO_CRATE_DEPENDS+=	usage-lib-2.0.7
...
CARGO_CRATE_DEPENDS+=	vfox-1.0.1
...
CARGO_CRATE_DEPENDS+=	zipsign-api-0.1.3
