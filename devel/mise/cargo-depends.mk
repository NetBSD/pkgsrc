# $NetBSD: cargo-depends.mk,v 1.51 2024/12/19 09:43:57 pin Exp $
...
CARGO_CRATE_DEPENDS+=	demand-1.5.0
...
CARGO_CRATE_DEPENDS+=	hyper-rustls-0.27.4
...
CARGO_CRATE_DEPENDS+=	impl-tools-0.10.2
CARGO_CRATE_DEPENDS+=	impl-tools-lib-0.11.0
...
CARGO_CRATE_DEPENDS+=	luajit-src-210.5.11+97813fb
...
CARGO_CRATE_DEPENDS+=	usage-lib-1.7.2
...
CARGO_CRATE_DEPENDS+=	vfox-0.3.4
