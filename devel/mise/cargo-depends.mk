# $NetBSD: cargo-depends.mk,v 1.32 2024/10/16 10:09:18 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.15
...
CARGO_CRATE_DEPENDS+=	confique-0.2.6
CARGO_CRATE_DEPENDS+=	confique-macro-0.0.10
...
CARGO_CRATE_DEPENDS+=	demand-1.2.4
...
CARGO_CRATE_DEPENDS+=	mlua-sys-0.6.3
CARGO_CRATE_DEPENDS+=	mlua_derive-0.9.3
...
CARGO_CRATE_DEPENDS+=	platforms-3.2.0
...
CARGO_CRATE_DEPENDS+=	tabled_derive-0.8.0
...
CARGO_CRATE_DEPENDS+=	usage-lib-0.11.0
...
CARGO_CRATE_DEPENDS+=	vfox-0.1.6
...
CARGO_CRATE_DEPENDS+=	xx-1.1.8
CARGO_CRATE_DEPENDS+=	xz-0.1.0
