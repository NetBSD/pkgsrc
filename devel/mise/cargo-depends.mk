...
CARGO_CRATE_DEPENDS+=	astral-tokio-tar-0.6.2
...
CARGO_CRATE_DEPENDS+=	coalesced_map-0.1.3
...
CARGO_CRATE_DEPENDS+=	ctor-1.0.7
...
CARGO_CRATE_DEPENDS+=	demand-2.0.2
...
CARGO_CRATE_DEPENDS+=	file_url-0.3.1
...
CARGO_CRATE_DEPENDS+=	gix-credentials-0.38.1
CARGO_CRATE_DEPENDS+=	gix-date-0.15.4
CARGO_CRATE_DEPENDS+=	gix-diff-0.64.0
CARGO_CRATE_DEPENDS+=	gix-dir-0.26.0
...
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.33.1
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.32.0
...
CARGO_CRATE_DEPENDS+=	gix-prompt-0.15.1
...
CARGO_CRATE_DEPENDS+=	gix-status-0.31.0
...
CARGO_CRATE_DEPENDS+=	gix-worktree-state-0.31.0
...
CARGO_CRATE_DEPENDS+=	landlock-0.4.5
...
CARGO_CRATE_DEPENDS+=	link-section-0.18.2
CARGO_CRATE_DEPENDS+=	linktime-proc-macro-0.2.0
...
CARGO_CRATE_DEPENDS+=	lzma-rust2-0.16.4
...
CARGO_CRATE_DEPENDS+=	path_resolver-0.2.10
...
CARGO_CRATE_DEPENDS+=	platforms-3.11.0
...
CARGO_CRATE_DEPENDS+=	rattler-0.43.2
CARGO_CRATE_DEPENDS+=	rattler_cache-0.8.2
CARGO_CRATE_DEPENDS+=	rattler_conda_types-0.46.4
CARGO_CRATE_DEPENDS+=	rattler_digest-1.3.0
CARGO_CRATE_DEPENDS+=	rattler_macros-1.1.0
CARGO_CRATE_DEPENDS+=	rattler_menuinst-0.2.62
CARGO_CRATE_DEPENDS+=	rattler_networking-0.27.2
CARGO_CRATE_DEPENDS+=	rattler_package_streaming-0.26.2
CARGO_CRATE_DEPENDS+=	rattler_pty-0.2.12
CARGO_CRATE_DEPENDS+=	rattler_redaction-0.2.1
CARGO_CRATE_DEPENDS+=	rattler_repodata_gateway-0.29.2
CARGO_CRATE_DEPENDS+=	rattler_shell-0.27.2
CARGO_CRATE_DEPENDS+=	rattler_solve-7.1.1
CARGO_CRATE_DEPENDS+=	rattler_virtual_packages-2.4.1
...
CARGO_CRATE_DEPENDS+=	resolvo-0.10.3
CARGO_CRATE_DEPENDS+=	retry-policies-0.5.2
CARGO_CRATE_DEPENDS+=	ring-0.17.14
CARGO_CRATE_DEPENDS+=	rkyv-0.8.16
CARGO_CRATE_DEPENDS+=	rkyv_derive-0.8.16
...
CARGO_CRATE_DEPENDS+=	sigstore-bundle-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-crypto-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-merkle-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-rekor-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-trust-root-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-tsa-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-types-0.8.0
CARGO_CRATE_DEPENDS+=	sigstore-verify-0.8.0
...
CARGO_CRATE_DEPENDS+=	tough-0.22.0
...
CARGO_CRATE_DEPENDS+=	web-sys-0.3.100
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.8.50
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.8.50
