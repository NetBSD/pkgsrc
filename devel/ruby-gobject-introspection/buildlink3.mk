# $NetBSD: buildlink3.mk,v 1.24 2026/08/11 23:14:00 tsutsui Exp $
...
BUILDLINK_ABI_DEPENDS.ruby-gobject-introspection+=	${RUBY_PKGPREFIX}-gobject-introspection>=4.3.7
