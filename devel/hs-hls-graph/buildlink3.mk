# $NetBSD: buildlink3.mk,v 1.13 2025/02/02 13:05:10 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-hls-graph+=	hs-hls-graph>=2.9.0
BUILDLINK_ABI_DEPENDS.hs-hls-graph+=	hs-hls-graph>=2.9.0.0nb1
