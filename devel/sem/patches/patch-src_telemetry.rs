$NetBSD: patch-src_telemetry.rs,v 1.1 2026/06/23 09:03:37 pin Exp $

Set telemetry as opt-in instead of opt-out.
Patch taken from FreeBSD ports.

--- src/telemetry.rs.orig	2026-06-23 08:19:43.373694926 +0000
+++ src/telemetry.rs
