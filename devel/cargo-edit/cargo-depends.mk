# $NetBSD: cargo-depends.mk,v 1.4 2025/05/30 10:56:52 pin Exp $
...
CARGO_CRATE_DEPENDS+=	borsh-1.5.5
...
CARGO_CRATE_DEPENDS+=	cargo-test-support-0.6.0
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.15
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.5
...
CARGO_CRATE_DEPENDS+=	ct-codecs-1.1.3
...
CARGO_CRATE_DEPENDS+=	pasetors-0.7.1
...
CARGO_CRATE_DEPENDS+=	rustls-0.23.17
...
CARGO_CRATE_DEPENDS+=	tame-index-0.17.0
