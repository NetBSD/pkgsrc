# $NetBSD: options.mk,v 1.1 2026/02/11 07:53:37 taca Exp $
...
DEPENDS+=	${RUBY_PKGPREFIX}-sqlite3>=2.5.0:../../databases/ruby-sqlite3
.endif
...
RCD_SCRIPTS+=	redmine61_unicorn${RUBY_SUFFIX}
RCD_SCRIPT_SRC.redmine61_unicorn${RUBY_SUFFIX}=	${FILESDIR}/redmine_unicorn.sh
