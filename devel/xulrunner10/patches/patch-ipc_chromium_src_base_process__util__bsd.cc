$NetBSD: patch-ipc_chromium_src_base_process__util__bsd.cc,v 1.1.1.1 2012/03/15 08:58:28 ryoon Exp $


--- ipc/chromium/src/base/process_util_bsd.cc.orig	2012-03-14 10:20:41.000000000 +0000
