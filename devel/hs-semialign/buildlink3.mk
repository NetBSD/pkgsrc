# $NetBSD: buildlink3.mk,v 1.11 2025/02/02 13:05:22 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-semialign+=	hs-semialign>=1.3.1
BUILDLINK_ABI_DEPENDS.hs-semialign+=	hs-semialign>=1.3.1nb1
