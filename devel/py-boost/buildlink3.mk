# $NetBSD: buildlink3.mk,v 1.33 2026/05/15 09:13:49 adam Exp $
...
BUILDLINK_API_DEPENDS.py-boost+=	${PYPKGPREFIX}-boost-1.91.*
BUILDLINK_ABI_DEPENDS.py-boost+=	${PYPKGPREFIX}-boost>=1.91.0
