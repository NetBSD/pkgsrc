# $NetBSD: buildlink3.mk,v 1.34 2026/08/24 07:41:50 adam Exp $
...
BUILDLINK_API_DEPENDS.py-boost+=	${PYPKGPREFIX}-boost-1.92.*
BUILDLINK_ABI_DEPENDS.py-boost+=	${PYPKGPREFIX}-boost>=1.92.0
