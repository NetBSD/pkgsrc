# $NetBSD: cargo-depends.mk,v 1.1 2024/01/13 19:30:50 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ast-grep-tree-sitter-c-sharp-0.20.0
CARGO_CRATE_DEPENDS+=	async-trait-0.1.57
CARGO_CRATE_DEPENDS+=	atty-0.2.14
CARGO_CRATE_DEPENDS+=	auto_impl-1.0.1
...
CARGO_CRATE_DEPENDS+=	inquire-0.6.2
...
CARGO_CRATE_DEPENDS+=	napi-2.14.2
CARGO_CRATE_DEPENDS+=	napi-build-2.0.1
CARGO_CRATE_DEPENDS+=	napi-derive-2.14.6
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.58
CARGO_CRATE_DEPENDS+=	napi-sys-2.3.0
CARGO_CRATE_DEPENDS+=	newline-converter-0.2.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-bash-0.20.3
CARGO_CRATE_DEPENDS+=	tree-sitter-c-0.20.6
CARGO_CRATE_DEPENDS+=	tree-sitter-cpp-0.20.3
CARGO_CRATE_DEPENDS+=	tree-sitter-css-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-dart-0.0.3
CARGO_CRATE_DEPENDS+=	tree-sitter-elixir-0.1.1
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.9.2
CARGO_CRATE_DEPENDS+=	tree-sitter-go-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-html-dvdb-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-java-0.20.2
CARGO_CRATE_DEPENDS+=	tree-sitter-javascript-0.20.1
CARGO_CRATE_DEPENDS+=	tree-sitter-json-0.20.1
CARGO_CRATE_DEPENDS+=	tree-sitter-kotlin-0.3.1
CARGO_CRATE_DEPENDS+=	tree-sitter-lua-0.0.19
CARGO_CRATE_DEPENDS+=	tree-sitter-php-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-python-0.20.4
CARGO_CRATE_DEPENDS+=	tree-sitter-ruby-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-rust-0.20.4
CARGO_CRATE_DEPENDS+=	tree-sitter-scala-0.20.2
CARGO_CRATE_DEPENDS+=	tree-sitter-swift-0.3.6
CARGO_CRATE_DEPENDS+=	tree-sitter-typescript-0.20.3
...
CARGO_CRATE_DEPENDS+=	web-tree-sitter-sg-1.3.4
