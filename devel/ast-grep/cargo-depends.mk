# $NetBSD: cargo-depends.mk,v 1.32 2024/10/30 18:48:19 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.16.12
...
CARGO_CRATE_DEPENDS+=	tree-sitter-css-0.21.1
...
CARGO_CRATE_DEPENDS+=	tree-sitter-go-0.21.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-scala-0.22.1
