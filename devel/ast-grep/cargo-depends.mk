# $NetBSD: cargo-depends.mk,v 1.66 2025/11/16 16:56:05 pin Exp $
...
CARGO_CRATE_DEPENDS+=	convert_case-0.9.0
...
CARGO_CRATE_DEPENDS+=	napi-3.5.2
CARGO_CRATE_DEPENDS+=	napi-build-2.3.1
CARGO_CRATE_DEPENDS+=	napi-derive-3.3.3
CARGO_CRATE_DEPENDS+=	napi-derive-backend-3.0.2
CARGO_CRATE_DEPENDS+=	napi-sys-3.1.1
