...
CARGO_CRATE_DEPENDS+=	bit-set-0.11.1
CARGO_CRATE_DEPENDS+=	bit-vec-0.10.1
...
CARGO_CRATE_DEPENDS+=	ls-types-0.0.6
CARGO_CRATE_DEPENDS+=	matchers-0.2.0
CARGO_CRATE_DEPENDS+=	memchr-2.8.3
CARGO_CRATE_DEPENDS+=	minicov-0.3.9
CARGO_CRATE_DEPENDS+=	minimad-0.16.0
CARGO_CRATE_DEPENDS+=	mio-1.2.2
CARGO_CRATE_DEPENDS+=	napi-3.12.2
CARGO_CRATE_DEPENDS+=	napi-build-2.4.1
CARGO_CRATE_DEPENDS+=	napi-derive-3.6.3
CARGO_CRATE_DEPENDS+=	napi-derive-backend-6.1.2
...
CARGO_CRATE_DEPENDS+=	pythonize-0.29.0
...
CARGO_CRATE_DEPENDS+=	target-triple-1.0.1
...
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-0.3.77
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-macro-0.3.77
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-shared-0.2.127
