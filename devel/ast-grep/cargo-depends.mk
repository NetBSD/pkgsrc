# $NetBSD: cargo-depends.mk,v 1.4 2024/02/23 09:58:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.15.2
CARGO_CRATE_DEPENDS+=	napi-build-2.1.2
CARGO_CRATE_DEPENDS+=	napi-derive-2.15.2
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.61
