# $NetBSD: cargo-depends.mk,v 1.21 2024/07/26 10:08:22 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.16.8
CARGO_CRATE_DEPENDS+=	napi-build-2.1.3
CARGO_CRATE_DEPENDS+=	napi-derive-2.16.9
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.71
...
CARGO_CRATE_DEPENDS+=	tree-sitter-c-sharp-0.21.3
CARGO_CRATE_DEPENDS+=	tree-sitter-cpp-0.22.3
...
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.21.5
...
CARGO_CRATE_DEPENDS+=	tree-sitter-php-0.22.7
...
CARGO_CRATE_DEPENDS+=	tree-sitter-sql-bigquery-0.8.0
