# $NetBSD: cargo-depends.mk,v 1.59 2025/07/28 10:54:34 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-3.1.3
CARGO_CRATE_DEPENDS+=	napi-build-2.2.3
CARGO_CRATE_DEPENDS+=	napi-derive-3.1.1
CARGO_CRATE_DEPENDS+=	napi-derive-backend-2.0.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-solidity-1.2.12
