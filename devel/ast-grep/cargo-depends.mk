# $NetBSD: cargo-depends.mk,v 1.62 2025/09/21 18:31:16 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	napi-3.2.4
CARGO_CRATE_DEPENDS+=	napi-build-2.2.3
CARGO_CRATE_DEPENDS+=	napi-derive-3.2.4
CARGO_CRATE_DEPENDS+=	napi-derive-backend-2.1.4
