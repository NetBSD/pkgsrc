# $NetBSD: cargo-depends.mk,v 1.2 2024/02/01 11:18:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.15.0
CARGO_CRATE_DEPENDS+=	napi-build-2.0.1
CARGO_CRATE_DEPENDS+=	napi-derive-2.15.0
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.59
...
CARGO_CRATE_DEPENDS+=	tree-sitter-c-0.20.7
...
CARGO_CRATE_DEPENDS+=	tree-sitter-json-0.20.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-swift-0.4.0
