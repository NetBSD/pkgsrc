# $NetBSD: cargo-depends.mk,v 1.24 2024/08/08 17:27:32 pin Exp $
...
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.22.2
...
CARGO_CRATE_DEPENDS+=	web-tree-sitter-sg-0.22.2
