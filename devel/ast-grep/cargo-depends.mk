# $NetBSD: cargo-depends.mk,v 1.22 2024/08/02 10:13:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-derive-2.16.10
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.72
...
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.22.0
...
CARGO_CRATE_DEPENDS+=	tree-sitter-scala-0.22.0
CARGO_CRATE_DEPENDS+=	tree-sitter-sequel-0.3.3
...
CARGO_CRATE_DEPENDS+=	web-tree-sitter-sg-0.22.0
