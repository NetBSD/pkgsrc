# $NetBSD: cargo-depends.mk,v 1.3 2024/02/15 20:53:22 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.15.1
CARGO_CRATE_DEPENDS+=	napi-build-2.0.1
CARGO_CRATE_DEPENDS+=	napi-derive-2.15.1
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.60
...
CARGO_CRATE_DEPENDS+=	tree-sitter-bash-0.20.5
CARGO_CRATE_DEPENDS+=	tree-sitter-c-0.20.7
CARGO_CRATE_DEPENDS+=	tree-sitter-cpp-0.20.4
...
CARGO_CRATE_DEPENDS+=	tree-sitter-javascript-0.20.3
...
CARGO_CRATE_DEPENDS+=	tree-sitter-php-0.22.0
CARGO_CRATE_DEPENDS+=	tree-sitter-python-0.20.4
CARGO_CRATE_DEPENDS+=	tree-sitter-ruby-0.20.1
...
CARGO_CRATE_DEPENDS+=	tree-sitter-typescript-0.20.5
