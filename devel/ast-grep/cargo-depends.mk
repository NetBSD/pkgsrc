# $NetBSD: cargo-depends.mk,v 1.50 2025/04/17 12:28:05 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.16.17
CARGO_CRATE_DEPENDS+=	napi-build-2.1.6
CARGO_CRATE_DEPENDS+=	napi-derive-2.16.13
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.75
...
CARGO_CRATE_DEPENDS+=	pythonize-0.24.0
...
CARGO_CRATE_DEPENDS+=	rustix-1.0.0
...
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.25.3
...
CARGO_CRATE_DEPENDS+=	web-tree-sitter-sg-0.25.3
