# $NetBSD: cargo-depends.mk,v 1.11 2024/05/02 09:33:50 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.16.4
CARGO_CRATE_DEPENDS+=	napi-build-2.1.3
CARGO_CRATE_DEPENDS+=	napi-derive-2.16.3
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.65
...
CARGO_CRATE_DEPENDS+=	tree-sitter-c-sharp-0.20.0
...
CARGO_CRATE_DEPENDS+=	tree-sitter-html-0.20.0
