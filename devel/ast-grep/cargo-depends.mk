# $NetBSD: cargo-depends.mk,v 1.49 2025/04/14 13:50:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	tree-sitter-0.24.4
...
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.24.5
...
CARGO_CRATE_DEPENDS+=	web-tree-sitter-sg-0.24.5
