# $NetBSD: cargo-depends.mk,v 1.60 2025/08/06 06:32:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-3.1.4
CARGO_CRATE_DEPENDS+=	napi-build-2.2.3
CARGO_CRATE_DEPENDS+=	napi-derive-3.1.2
CARGO_CRATE_DEPENDS+=	napi-derive-backend-2.0.3
