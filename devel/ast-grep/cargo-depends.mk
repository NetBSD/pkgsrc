# $NetBSD: cargo-depends.mk,v 1.7 2024/03/24 15:29:37 pin Exp $
...
CARGO_CRATE_DEPENDS+=	auto_impl-1.1.2
...
CARGO_CRATE_DEPENDS+=	inquire-0.7.3
...
CARGO_CRATE_DEPENDS+=	napi-2.16.0
CARGO_CRATE_DEPENDS+=	napi-build-2.1.2
CARGO_CRATE_DEPENDS+=	napi-derive-2.16.0
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.62
...
CARGO_CRATE_DEPENDS+=	tree-sitter-c-0.20.8
CARGO_CRATE_DEPENDS+=	tree-sitter-cpp-0.20.5
...
CARGO_CRATE_DEPENDS+=	tree-sitter-javascript-0.20.4
CARGO_CRATE_DEPENDS+=	tree-sitter-json-0.20.2
CARGO_CRATE_DEPENDS+=	tree-sitter-kotlin-0.3.5
CARGO_CRATE_DEPENDS+=	tree-sitter-lua-0.0.19
CARGO_CRATE_DEPENDS+=	tree-sitter-php-0.22.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-scala-0.20.3
CARGO_CRATE_DEPENDS+=	tree-sitter-swift-0.4.3
