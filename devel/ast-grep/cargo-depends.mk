# $NetBSD: cargo-depends.mk,v 1.41 2025/01/13 20:26:14 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-2.16.13
...
CARGO_CRATE_DEPENDS+=	tree-sitter-elixir-0.3.3
...
CARGO_CRATE_DEPENDS+=	tree-sitter-sequel-0.3.7
CARGO_CRATE_DEPENDS+=	tree-sitter-swift-0.6.0
