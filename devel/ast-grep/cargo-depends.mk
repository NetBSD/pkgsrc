# $NetBSD: cargo-depends.mk,v 1.58 2025/07/22 13:48:49 pin Exp $
...
CARGO_CRATE_DEPENDS+=	napi-3.0.0
CARGO_CRATE_DEPENDS+=	napi-build-2.2.2
CARGO_CRATE_DEPENDS+=	napi-derive-3.0.0
CARGO_CRATE_DEPENDS+=	napi-derive-backend-2.0.0
...
CARGO_CRATE_DEPENDS+=	tree-sitter-solidity-1.2.11
