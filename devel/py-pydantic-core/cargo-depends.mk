# $NetBSD: cargo-depends.mk,v 1.6 2024/07/04 11:20:48 adam Exp $
...
CARGO_CRATE_DEPENDS+=	pyo3-0.22.0
CARGO_CRATE_DEPENDS+=	pyo3-build-config-0.22.0
CARGO_CRATE_DEPENDS+=	pyo3-ffi-0.22.0
CARGO_CRATE_DEPENDS+=	pyo3-macros-0.22.0
CARGO_CRATE_DEPENDS+=	pyo3-macros-backend-0.22.0
