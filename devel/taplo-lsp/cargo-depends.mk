# $NetBSD: cargo-depends.mk,v 1.1 2021/12/21 15:10:51 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	lsp-types-0.90.1
...
CARGO_CRATE_DEPENDS+=	pretty-lint-0.1.1
...
CARGO_CRATE_DEPENDS+=	tamasfe-clap-3.0.0-beta.2
...
CARGO_CRATE_DEPENDS+=	verify-0.3.2
CARGO_CRATE_DEPENDS+=	verify-macros-0.1.0
...
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-0.3.28
CARGO_CRATE_DEPENDS+=	wasm-bindgen-test-macro-0.3.28
