# $NetBSD: buildlink3.mk,v 1.2 2023/11/02 06:36:39 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-overloaded-record-dot-plugin+=	hs-hls-overloaded-record-dot-plugin>=2.4.0.0nb1
