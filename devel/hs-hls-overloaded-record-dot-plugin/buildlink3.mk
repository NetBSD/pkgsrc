# $NetBSD: buildlink3.mk,v 1.3 2023/11/08 13:18:47 wiz Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-overloaded-record-dot-plugin+=	hs-hls-overloaded-record-dot-plugin>=2.4.0.0nb2
