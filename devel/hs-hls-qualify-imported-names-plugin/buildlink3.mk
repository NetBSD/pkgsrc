# $NetBSD: buildlink3.mk,v 1.11 2023/10/31 13:05:41 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-qualify-imported-names-plugin+=	hs-hls-qualify-imported-names-plugin>=2.4.0.0
