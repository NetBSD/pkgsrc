# $NetBSD: buildlink3.mk,v 1.12 2023/11/02 06:36:40 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-qualify-imported-names-plugin+=	hs-hls-qualify-imported-names-plugin>=2.4.0.0nb1
