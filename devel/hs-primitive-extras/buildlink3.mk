# $NetBSD: buildlink3.mk,v 1.11 2025/03/05 03:39:24 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-primitive-extras+=	hs-primitive-extras>=0.10.2
BUILDLINK_ABI_DEPENDS.hs-primitive-extras+=	hs-primitive-extras>=0.10.2.1nb2
