# $NetBSD: cargo-depends.mk,v 1.6 2023/05/28 10:50:24 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.14.3
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.16.10
...
CARGO_CRATE_DEPENDS+=	keyring-2.0.3
...
CARGO_CRATE_DEPENDS+=	minijinja-0.33.0
...
CARGO_CRATE_DEPENDS+=	platform-info-2.0.1
