# $NetBSD: cargo-depends.mk,v 1.18 2024/08/22 09:54:18 adam Exp $
...
CARGO_CRATE_DEPENDS+=	pep508_rs-0.6.0
...
CARGO_CRATE_DEPENDS+=	python-pkginfo-0.6.2
...
CARGO_CRATE_DEPENDS+=	snapbox-0.6.10
