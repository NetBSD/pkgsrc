# $NetBSD: cargo-depends.mk,v 1.1 2023/03/01 18:35:29 adam Exp $
...
CARGO_CRATE_DEPENDS+=	goblin-0.6.0
...
CARGO_CRATE_DEPENDS+=	minijinja-0.30.2
CARGO_CRATE_DEPENDS+=	minimal-lexical-0.2.1
CARGO_CRATE_DEPENDS+=	miniz_oxide-0.6.4
