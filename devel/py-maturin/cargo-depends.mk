# $NetBSD: cargo-depends.mk,v 1.19 2024/10/01 08:48:03 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.16.5
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.19.3
...
CARGO_CRATE_DEPENDS+=	lddtree-0.3.5
...
CARGO_CRATE_DEPENDS+=	minijinja-1.0.21
...
CARGO_CRATE_DEPENDS+=	xwin-0.5.1
