# $NetBSD: cargo-depends.mk,v 1.30 2025/11/16 20:59:55 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	cbindgen-0.29.0
...
CARGO_CRATE_DEPENDS+=	fat-macho-0.4.9
...
CARGO_CRATE_DEPENDS+=	lddtree-0.3.7
...
CARGO_CRATE_DEPENDS+=	rustls-0.23.33
