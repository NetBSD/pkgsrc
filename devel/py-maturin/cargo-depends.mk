# $NetBSD: cargo-depends.mk,v 1.38 2026/08/26 07:43:51 adam Exp $
...
CARGO_CRATE_DEPENDS+=	libmimalloc-sys-0.1.46
...
CARGO_CRATE_DEPENDS+=	pyo3-introspection-0.29.0
...
CARGO_CRATE_DEPENDS+=	version-ranges-0.1.3
...
CARGO_CRATE_DEPENDS+=	xwin-0.10.0
