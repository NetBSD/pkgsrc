# $NetBSD: cargo-depends.mk,v 1.4 2023/05/07 08:08:22 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-config2-0.1.7
CARGO_CRATE_DEPENDS+=	cargo-options-0.6.0
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.2
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.14.2
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.16.7
...
CARGO_CRATE_DEPENDS+=	clap-4.1.10
CARGO_CRATE_DEPENDS+=	clap_complete-4.1.6
CARGO_CRATE_DEPENDS+=	clap_complete_command-0.5.1
CARGO_CRATE_DEPENDS+=	clap_complete_fig-4.1.2
CARGO_CRATE_DEPENDS+=	clap_complete_nushell-0.1.10
...
CARGO_CRATE_DEPENDS+=	keyring-2.0.2
...
CARGO_CRATE_DEPENDS+=	minijinja-0.31.1
...
CARGO_CRATE_DEPENDS+=	pep508_rs-0.1.5
...
CARGO_CRATE_DEPENDS+=	pyproject-toml-0.6.0
...
CARGO_CRATE_DEPENDS+=	trycmd-0.14.11
...
CARGO_CRATE_DEPENDS+=	xwin-0.2.12
