# $NetBSD: cargo-depends.mk,v 1.13 2023/12/07 18:14:17 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-config2-0.1.16
CARGO_CRATE_DEPENDS+=	cargo-options-0.7.2
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.5
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.16.2
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.18.0
...
CARGO_CRATE_DEPENDS+=	clap_complete_fig-4.3.1
...
CARGO_CRATE_DEPENDS+=	configparser-3.0.3
...
CARGO_CRATE_DEPENDS+=	minijinja-1.0.10
...
CARGO_CRATE_DEPENDS+=	pep508_rs-0.2.3
...
CARGO_CRATE_DEPENDS+=	pyproject-toml-0.8.1
...
CARGO_CRATE_DEPENDS+=	rustls-pemfile-2.0.0
CARGO_CRATE_DEPENDS+=	rustls-pki-types-1.0.0
...
CARGO_CRATE_DEPENDS+=	snapbox-0.4.14
...
CARGO_CRATE_DEPENDS+=	trycmd-0.14.19
