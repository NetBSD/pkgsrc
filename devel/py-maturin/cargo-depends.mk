# $NetBSD: cargo-depends.mk,v 1.22 2024/12/02 20:37:09 adam Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-config2-0.1.26
CARGO_CRATE_DEPENDS+=	cargo-options-0.7.4
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.8
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.17.5
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.19.5
CARGO_CRATE_DEPENDS+=	cargo_metadata-0.19.0
CARGO_CRATE_DEPENDS+=	cbindgen-0.27.0
...
CARGO_CRATE_DEPENDS+=	fs-err-3.0.0
CARGO_CRATE_DEPENDS+=	fs4-0.11.1
...
CARGO_CRATE_DEPENDS+=	lzxd-0.2.5
CARGO_CRATE_DEPENDS+=	mailparse-0.15.0
...
CARGO_CRATE_DEPENDS+=	minijinja-2.5.0
...
CARGO_CRATE_DEPENDS+=	pep440_rs-0.6.6
CARGO_CRATE_DEPENDS+=	pep508_rs-0.6.1
...
CARGO_CRATE_DEPENDS+=	pyproject-toml-0.11.0
CARGO_CRATE_DEPENDS+=	python-pkginfo-0.6.3
...
CARGO_CRATE_DEPENDS+=	tempfile-3.11.0
...
CARGO_CRATE_DEPENDS+=	ureq-2.11.0
