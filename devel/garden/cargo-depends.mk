# $NetBSD: cargo-depends.mk,v 1.21 2025/02/24 08:36:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=				ecolor-0.31.0
CARGO_CRATE_DEPENDS+=				eframe-0.31.0
CARGO_CRATE_DEPENDS+=				egui-0.31.0
CARGO_CRATE_DEPENDS+=				egui-wgpu-0.31.0
CARGO_CRATE_DEPENDS+=				egui-winit-0.31.0
CARGO_CRATE_DEPENDS+=				egui_extras-0.31.0
CARGO_CRATE_DEPENDS+=				egui_glow-0.31.0
CARGO_CRATE_DEPENDS+=				either-1.14.0
CARGO_CRATE_DEPENDS+=				emath-0.31.0
...
CARGO_CRATE_DEPENDS+=				epaint-0.31.0
CARGO_CRATE_DEPENDS+=				epaint_default_fonts-0.31.0
...
CARGO_CRATE_DEPENDS+=				stacker-0.1.19
...
CARGO_CRATE_DEPENDS+=				wayland-protocols-plasma-0.3.6
...
CARGO_CRATE_DEPENDS+=				yaml-rust2-0.10.0
