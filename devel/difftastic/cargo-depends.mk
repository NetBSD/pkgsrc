# $NetBSD: cargo-depends.mk,v 1.34 2026/03/17 11:09:17 pin Exp $
...
CARGO_CRATE_DEPENDS+=	tree-sitter-clojure-orchard-0.2.0
CARGO_CRATE_DEPENDS+=	tree-sitter-cmake-0.7.1
CARGO_CRATE_DEPENDS+=	tree-sitter-cpp-0.23.4
CARGO_CRATE_DEPENDS+=	tree-sitter-css-0.23.1
CARGO_CRATE_DEPENDS+=	tree-sitter-dart-orchard-0.2.1
...
CARGO_CRATE_DEPENDS+=	tree-sitter-erlang-0.13.0
CARGO_CRATE_DEPENDS+=	tree-sitter-fortran-0.5.1
CARGO_CRATE_DEPENDS+=	tree-sitter-fsharp-0.1.0
...
CARGO_CRATE_DEPENDS+=	tree-sitter-ocaml-0.23.2
CARGO_CRATE_DEPENDS+=	tree-sitter-pascal-0.10.0
CARGO_CRATE_DEPENDS+=	tree-sitter-perl-1.1.2
...
CARGO_CRATE_DEPENDS+=	tree-sitter-rust-orchard-0.16.2
