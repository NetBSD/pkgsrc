$NetBSD: patch-ipc_chromium_src_base_debug__util__posix.cc,v 1.1.4.1 2013/01/13 17:44:58 tron Exp $

# Reported upstream: https://bugzilla.mozilla.org/show_bug.cgi?id=753046

--- ipc/chromium/src/base/debug_util_posix.cc.orig	2013-01-07 20:52:27.000000000 +0000
