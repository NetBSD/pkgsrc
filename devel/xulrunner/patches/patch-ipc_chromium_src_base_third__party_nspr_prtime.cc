$NetBSD: patch-ipc_chromium_src_base_third__party_nspr_prtime.cc,v 1.4 2012/08/28 23:27:10 ryoon Exp $

--- ipc/chromium/src/base/third_party/nspr/prtime.cc.orig	2012-08-24 22:55:37.000000000 +0000
