# $NetBSD: buildlink3.mk,v 1.23 2025/09/27 09:57:12 wiz Exp $
...
BUILDLINK_API_DEPENDS.boost-mpi+=	boost-mpi-1.89.*
BUILDLINK_ABI_DEPENDS.boost-mpi+=	boost-mpi>=1.89.0nb1
