...
RA_NEON_DEPS = subversion/libsvn_ra_neon/libsvn_ra_neon-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
RA_NEON_LINK = ../../subversion/libsvn_ra_neon/libsvn_ra_neon-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la
...
javahl_javah_CLASSES = org.tigris.subversion.javahl.NativeResources org.tigris.subversion.javahl.SVNClientSynchronized org.tigris.subversion.javahl.Operation org.tigris.subversion.javahl.SVNInputStream org.tigris.subversion.javahl.JNIError org.tigris.subversion.javahl.RevisionRange org.tigris.subversion.javahl.Depth org.tigris.subversion.javahl.BlameCallback org.tigris.subversion.javahl.OutputInterface org.tigris.subversion.javahl.NotifyStatus org.tigris.subversion.javahl.CopySource org.tigris.subversion.javahl.SVNOutputStream org.tigris.subversion.javahl.BlameCallbackImpl org.tigris.subversion.javahl.Notify org.tigris.subversion.javahl.Notify2 org.tigris.subversion.javahl.ChangePath org.tigris.subversion.javahl.CommitItemStateFlags org.tigris.subversion.javahl.PromptUserPassword2 org.tigris.subversion.javahl.Version org.tigris.subversion.javahl.Mergeinfo org.tigris.subversion.javahl.ProplistCallbackImpl org.tigris.subversion.javahl.LogDate org.tigris.subversion.javahl.NotifyAction org.tigris.subversion.javahl.SVNClient org.tigris.subversion.javahl.PromptUserPassword org.tigris.subversion.javahl.CommitItem org.tigris.subversion.javahl.StatusKind org.tigris.subversion.javahl.MergeinfoLogKind org.tigris.subversion.javahl.SubversionException org.tigris.subversion.javahl.ConflictVersion org.tigris.subversion.javahl.ChangelistCallback org.tigris.subversion.javahl.ClientException org.tigris.subversion.javahl.NotifyInformation org.tigris.subversion.javahl.LogMessageCallback org.tigris.subversion.javahl.ConflictResolverCallback org.tigris.subversion.javahl.SVNClientLogLevel org.tigris.subversion.javahl.SVNClientInterface org.tigris.subversion.javahl.LogMessage org.tigris.subversion.javahl.DiffSummary org.tigris.subversion.javahl.RevisionKind org.tigris.subversion.javahl.ScheduleKind org.tigris.subversion.javahl.LockStatus org.tigris.subversion.javahl.StatusCallback org.tigris.subversion.javahl.DirEntry org.tigris.subversion.javahl.Info2 org.tigris.subversion.javahl.ProgressEvent org.tigris.subversion.javahl.ErrorCodes org.tigris.subversion.javahl.ConflictDescriptor org.tigris.subversion.javahl.NativeException org.tigris.subversion.javahl.Path org.tigris.subversion.javahl.PropertyData org.tigris.subversion.javahl.Lock org.tigris.subversion.javahl.InputInterface org.tigris.subversion.javahl.CommitMessage org.tigris.subversion.javahl.InfoCallback org.tigris.subversion.javahl.BlameCallback2 org.tigris.subversion.javahl.ConflictResult org.tigris.subversion.javahl.PromptUserPassword3 org.tigris.subversion.javahl.ProplistCallback org.tigris.subversion.javahl.ProgressListener org.tigris.subversion.javahl.Info org.tigris.subversion.javahl.NodeKind org.tigris.subversion.javahl.SVNAdmin org.tigris.subversion.javahl.ListCallback org.tigris.subversion.javahl.Status org.tigris.subversion.javahl.Revision org.tigris.subversion.javahl.DiffSummaryReceiver
...
key_test_DEPS =  subversion/tests/libsvn_fs_base/key-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_fs_base/libsvn_fs_base-1.la subversion/libsvn_subr/libsvn_subr-1.la
key_test_OBJECTS = key-test.o
subversion/tests/libsvn_fs_base/key-test$(EXEEXT): $(key_test_DEPS)
	cd subversion/tests/libsvn_fs_base && $(LINK) -o key-test$(EXEEXT)  $(key_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_fs_base/libsvn_fs_base-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)
...
subversion/libsvn_auth_kwallet/libsvn_auth_kwallet-1.la: $(libsvn_auth_kwallet_DEPS)
	cd subversion/libsvn_auth_kwallet && $(LINK_CXX) -o libsvn_auth_kwallet-1.la $(LT_NO_UNDEFINED) $(libsvn_auth_kwallet_OBJECTS) $(SVN_APR_LIBS) $(SVN_KWALLET_LIBS) ../../subversion/libsvn_subr/libsvn_subr-1.la $(LIBS)
...
locks_test_DEPS =  subversion/tests/libsvn_fs/locks-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
locks_test_OBJECTS = locks-test.o
subversion/tests/libsvn_fs/locks-test$(EXEEXT): $(locks_test_DEPS)
	cd subversion/tests/libsvn_fs && $(LINK) -o locks-test$(EXEEXT)  $(locks_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

mergeinfo_test_PATH = subversion/tests/libsvn_subr
mergeinfo_test_DEPS =  subversion/tests/libsvn_subr/mergeinfo-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
mergeinfo_test_OBJECTS = mergeinfo-test.o
subversion/tests/libsvn_subr/mergeinfo-test$(EXEEXT): $(mergeinfo_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o mergeinfo-test$(EXEEXT)  $(mergeinfo_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/tests/libsvn_subr/opt-test$(EXEEXT): $(opt_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o opt-test$(EXEEXT)  $(opt_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/tests/libsvn_subr/path-test$(EXEEXT): $(path_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o path-test$(EXEEXT)  $(path_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Client.la: $(perl_client_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Client.la $(LT_NO_UNDEFINED) $(perl_client_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_client/libsvn_client-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Core.la: $(perl_core_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Core.la $(LT_NO_UNDEFINED) $(perl_core_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Delta.la: $(perl_delta_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Delta.la $(LT_NO_UNDEFINED) $(perl_delta_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Diff.la: $(perl_diff_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Diff.la $(LT_NO_UNDEFINED) $(perl_diff_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Fs.la: $(perl_fs_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Fs.la $(LT_NO_UNDEFINED) $(perl_fs_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Ra.la: $(perl_ra_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Ra.la $(LT_NO_UNDEFINED) $(perl_ra_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_ra/libsvn_ra-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Repos.la: $(perl_repos_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Repos.la $(LT_NO_UNDEFINED) $(perl_repos_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_repos/libsvn_repos-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/perl/native/_Wc.la: $(perl_wc_DEPS)
	cd subversion/bindings/swig/perl/native && $(LINK_PL_WRAPPER) -o _Wc.la $(LT_NO_UNDEFINED) $(perl_wc_OBJECTS) ../../../../../subversion/bindings/swig/perl/libsvn_swig_perl/libsvn_swig_perl-1.la ../../../../../subversion/libsvn_wc/libsvn_wc-1.la ../../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_client.la: $(python_client_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _client.la $(LT_NO_UNDEFINED) $(python_client_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_client/libsvn_client-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_core.la: $(python_core_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _core.la $(LT_NO_UNDEFINED) $(python_core_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_delta.la: $(python_delta_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _delta.la $(LT_NO_UNDEFINED) $(python_delta_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_diff.la: $(python_diff_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _diff.la $(LT_NO_UNDEFINED) $(python_diff_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_fs.la: $(python_fs_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _fs.la $(LT_NO_UNDEFINED) $(python_fs_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_ra.la: $(python_ra_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _ra.la $(LT_NO_UNDEFINED) $(python_ra_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_ra/libsvn_ra-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_repos.la: $(python_repos_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _repos.la $(LT_NO_UNDEFINED) $(python_repos_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_repos/libsvn_repos-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/python/_wc.la: $(python_wc_DEPS)
	cd subversion/bindings/swig/python && $(LINK_PY_WRAPPER) -o _wc.la $(LT_NO_UNDEFINED) $(python_wc_OBJECTS) ../../../../subversion/bindings/swig/python/libsvn_swig_py/libsvn_swig_py-1.la ../../../../subversion/libsvn_wc/libsvn_wc-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
random_test_DEPS =  subversion/tests/libsvn_delta/random-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
random_test_OBJECTS = random-test.o
subversion/tests/libsvn_delta/random-test$(EXEEXT): $(random_test_DEPS)
	cd subversion/tests/libsvn_delta && $(LINK) -o random-test$(EXEEXT)  $(random_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

repos_test_PATH = subversion/tests/libsvn_repos
repos_test_DEPS =  subversion/tests/libsvn_repos/dir-delta-editor.o subversion/tests/libsvn_repos/repos-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
repos_test_OBJECTS = dir-delta-editor.o repos-test.o
subversion/tests/libsvn_repos/repos-test$(EXEEXT): $(repos_test_DEPS)
	cd subversion/tests/libsvn_repos && $(LINK) -o repos-test$(EXEEXT)  $(repos_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_repos/libsvn_repos-1.la ../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

revision_test_PATH = subversion/tests/libsvn_subr
revision_test_DEPS =  subversion/tests/libsvn_subr/revision-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
revision_test_OBJECTS = revision-test.o
subversion/tests/libsvn_subr/revision-test$(EXEEXT): $(revision_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o revision-test$(EXEEXT)  $(revision_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/client.la: $(ruby_client_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o client.la $(LT_NO_UNDEFINED) $(ruby_client_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_client/libsvn_client-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/core.la: $(ruby_core_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o core.la $(LT_NO_UNDEFINED) $(ruby_core_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/delta.la: $(ruby_delta_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o delta.la $(LT_NO_UNDEFINED) $(ruby_delta_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/diff.la: $(ruby_diff_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o diff.la $(LT_NO_UNDEFINED) $(ruby_diff_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_diff/libsvn_diff-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/fs.la: $(ruby_fs_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o fs.la $(LT_NO_UNDEFINED) $(ruby_fs_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/ra.la: $(ruby_ra_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o ra.la $(LT_NO_UNDEFINED) $(ruby_ra_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_ra/libsvn_ra-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/repos.la: $(ruby_repos_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o repos.la $(LT_NO_UNDEFINED) $(ruby_repos_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_repos/libsvn_repos-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)
...
subversion/bindings/swig/ruby/wc.la: $(ruby_wc_DEPS)
	cd subversion/bindings/swig/ruby && $(LINK_RB_WRAPPER) -o wc.la $(LT_NO_UNDEFINED) $(ruby_wc_OBJECTS) ../../../../subversion/bindings/swig/ruby/libsvn_swig_ruby/libsvn_swig_ruby-1.la ../../../../subversion/libsvn_wc/libsvn_wc-1.la ../../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)

skel_test_PATH = subversion/tests/libsvn_subr
skel_test_DEPS =  subversion/tests/libsvn_subr/skel-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
skel_test_OBJECTS = skel-test.o
subversion/tests/libsvn_subr/skel-test$(EXEEXT): $(skel_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o skel-test$(EXEEXT)  $(skel_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

stream_test_PATH = subversion/tests/libsvn_subr
stream_test_DEPS =  subversion/tests/libsvn_subr/stream-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
stream_test_OBJECTS = stream-test.o
subversion/tests/libsvn_subr/stream-test$(EXEEXT): $(stream_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o stream-test$(EXEEXT)  $(stream_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

string_test_PATH = subversion/tests/libsvn_subr
string_test_DEPS =  subversion/tests/libsvn_subr/string-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
string_test_OBJECTS = string-test.o
subversion/tests/libsvn_subr/string-test$(EXEEXT): $(string_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o string-test$(EXEEXT)  $(string_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

strings_reps_test_PATH = subversion/tests/libsvn_fs_base
strings_reps_test_DEPS =  subversion/tests/libsvn_fs_base/strings-reps-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_fs_base/libsvn_fs_base-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
...
subversion/tests/libsvn_fs_base/strings-reps-test$(EXEEXT): $(strings_reps_test_DEPS)
	cd subversion/tests/libsvn_fs_base && $(LINK) -o strings-reps-test$(EXEEXT)  $(strings_reps_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_fs/libsvn_fs-1.la ../../../subversion/libsvn_fs_base/libsvn_fs_base-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

svn_PATH = subversion/svn
svn_DEPS =  subversion/svn/add-cmd.o subversion/svn/blame-cmd.o subversion/svn/cat-cmd.o subversion/svn/changelist-cmd.o subversion/svn/checkout-cmd.o subversion/svn/cleanup-cmd.o subversion/svn/commit-cmd.o subversion/svn/conflict-callbacks.o subversion/svn/copy-cmd.o subversion/svn/delete-cmd.o subversion/svn/diff-cmd.o subversion/svn/export-cmd.o subversion/svn/help-cmd.o subversion/svn/import-cmd.o subversion/svn/info-cmd.o subversion/svn/list-cmd.o subversion/svn/lock-cmd.o subversion/svn/log-cmd.o subversion/svn/main.o subversion/svn/merge-cmd.o subversion/svn/mergeinfo-cmd.o subversion/svn/mkdir-cmd.o subversion/svn/move-cmd.o subversion/svn/notify.o subversion/svn/propdel-cmd.o subversion/svn/propedit-cmd.o subversion/svn/propget-cmd.o subversion/svn/proplist-cmd.o subversion/svn/props.o subversion/svn/propset-cmd.o subversion/svn/resolve-cmd.o subversion/svn/resolved-cmd.o subversion/svn/revert-cmd.o subversion/svn/status-cmd.o subversion/svn/status.o subversion/svn/switch-cmd.o subversion/svn/tree-conflicts.o subversion/svn/unlock-cmd.o subversion/svn/update-cmd.o subversion/svn/util.o subversion/libsvn_client/libsvn_client-1.la subversion/libsvn_wc/libsvn_wc-1.la subversion/libsvn_ra/libsvn_ra-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_diff/libsvn_diff-1.la subversion/libsvn_subr/libsvn_subr-1.la
...
subversion/svn/svn$(EXEEXT): $(svn_DEPS)
	cd subversion/svn && $(LINK) -o svn$(EXEEXT)  $(svn_OBJECTS) ../../subversion/libsvn_client/libsvn_client-1.la ../../subversion/libsvn_wc/libsvn_wc-1.la ../../subversion/libsvn_ra/libsvn_ra-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_diff/libsvn_diff-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(NEON_LIBS) $(LIBS)

svn_populate_node_origins_index_PATH = tools/server-side
svn_populate_node_origins_index_DEPS =  tools/server-side/svn-populate-node-origins-index.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_subr/libsvn_subr-1.la
...
tools/server-side/svn-populate-node-origins-index$(EXEEXT): $(svn_populate_node_origins_index_DEPS)
	cd tools/server-side && $(LINK) -o svn-populate-node-origins-index$(EXEEXT)  $(svn_populate_node_origins_index_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_fs/libsvn_fs-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)

svn_push_PATH = contrib/client-side/svn-push
svn_push_DEPS =  contrib/client-side/svn-push/svn-push.o subversion/libsvn_ra/libsvn_ra-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
svn_push_OBJECTS = svn-push.o
contrib/client-side/svn-push/svn-push$(EXEEXT): $(svn_push_DEPS)
	cd contrib/client-side/svn-push && $(LINK) -o svn-push$(EXEEXT)  $(svn_push_OBJECTS) ../../../subversion/libsvn_ra/libsvn_ra-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(NEON_LIBS) $(LIBS)

svnadmin_PATH = subversion/svnadmin
svnadmin_DEPS =  subversion/svnadmin/main.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
svnadmin_OBJECTS = main.o
subversion/svnadmin/svnadmin$(EXEEXT): $(svnadmin_DEPS)
	cd subversion/svnadmin && $(LINK) -o svnadmin$(EXEEXT)  $(svnadmin_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_fs/libsvn_fs-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

svnauthz_validate_PATH = tools/server-side
svnauthz_validate_DEPS =  tools/server-side/svnauthz-validate.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_subr/libsvn_subr-1.la
svnauthz_validate_OBJECTS = svnauthz-validate.o
tools/server-side/svnauthz-validate$(EXEEXT): $(svnauthz_validate_DEPS)
	cd tools/server-side && $(LINK) -o svnauthz-validate$(EXEEXT)  $(svnauthz_validate_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(LIBS)

svndiff_test_PATH = subversion/tests/libsvn_delta
svndiff_test_DEPS =  subversion/tests/libsvn_delta/svndiff-test.o subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
svndiff_test_OBJECTS = svndiff-test.o
subversion/tests/libsvn_delta/svndiff-test$(EXEEXT): $(svndiff_test_DEPS)
	cd subversion/tests/libsvn_delta && $(LINK) -o svndiff-test$(EXEEXT)  $(svndiff_test_OBJECTS) ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

svndumpfilter_PATH = subversion/svndumpfilter
svndumpfilter_DEPS =  subversion/svndumpfilter/main.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
svndumpfilter_OBJECTS = main.o
subversion/svndumpfilter/svndumpfilter$(EXEEXT): $(svndumpfilter_DEPS)
	cd subversion/svndumpfilter && $(LINK) -o svndumpfilter$(EXEEXT)  $(svndumpfilter_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_fs/libsvn_fs-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

svnlook_PATH = subversion/svnlook
svnlook_DEPS =  subversion/svnlook/main.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_diff/libsvn_diff-1.la subversion/libsvn_subr/libsvn_subr-1.la
svnlook_OBJECTS = main.o
subversion/svnlook/svnlook$(EXEEXT): $(svnlook_DEPS)
	cd subversion/svnlook && $(LINK) -o svnlook$(EXEEXT)  $(svnlook_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_fs/libsvn_fs-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_diff/libsvn_diff-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

svnmucc_PATH = tools/client-side/svnmucc
svnmucc_DEPS =  tools/client-side/svnmucc/svnmucc.o subversion/libsvn_client/libsvn_client-1.la subversion/libsvn_ra/libsvn_ra-1.la subversion/libsvn_subr/libsvn_subr-1.la subversion/libsvn_delta/libsvn_delta-1.la
svnmucc_OBJECTS = svnmucc.o
tools/client-side/svnmucc/svnmucc$(EXEEXT): $(svnmucc_DEPS)
	cd tools/client-side/svnmucc && $(LINK) -o svnmucc$(EXEEXT)  $(svnmucc_OBJECTS) ../../../subversion/libsvn_client/libsvn_client-1.la ../../../subversion/libsvn_ra/libsvn_ra-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(NEON_LIBS) $(LIBS)

svnserve_PATH = subversion/svnserve
svnserve_DEPS =  subversion/svnserve/cyrus_auth.o subversion/svnserve/log-escape.o subversion/svnserve/main.o subversion/svnserve/serve.o subversion/svnserve/winservice.o subversion/libsvn_repos/libsvn_repos-1.la subversion/libsvn_fs/libsvn_fs-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la subversion/libsvn_ra_svn/libsvn_ra_svn-1.la
svnserve_OBJECTS = cyrus_auth.o log-escape.o main.o serve.o winservice.o
subversion/svnserve/svnserve$(EXEEXT): $(svnserve_DEPS)
	cd subversion/svnserve && $(LINK) -o svnserve$(EXEEXT)  $(svnserve_OBJECTS) ../../subversion/libsvn_repos/libsvn_repos-1.la ../../subversion/libsvn_fs/libsvn_fs-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la ../../subversion/libsvn_ra_svn/libsvn_ra_svn-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(SVN_SASL_LIBS) $(LIBS)

svnsync_PATH = subversion/svnsync
svnsync_DEPS =  subversion/svnsync/main.o subversion/libsvn_ra/libsvn_ra-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
svnsync_OBJECTS = main.o
subversion/svnsync/svnsync$(EXEEXT): $(svnsync_DEPS)
	cd subversion/svnsync && $(LINK) -o svnsync$(EXEEXT)  $(svnsync_OBJECTS) ../../subversion/libsvn_ra/libsvn_ra-1.la ../../subversion/libsvn_delta/libsvn_delta-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APR_LIBS) $(NEON_LIBS) $(LIBS)

svnversion_PATH = subversion/svnversion
svnversion_DEPS =  subversion/svnversion/main.o subversion/libsvn_wc/libsvn_wc-1.la subversion/libsvn_subr/libsvn_subr-1.la
svnversion_OBJECTS = main.o
subversion/svnversion/svnversion$(EXEEXT): $(svnversion_DEPS)
	cd subversion/svnversion && $(LINK) -o svnversion$(EXEEXT)  $(svnversion_OBJECTS) ../../subversion/libsvn_wc/libsvn_wc-1.la ../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

target_test_PATH = subversion/tests/libsvn_subr
target_test_DEPS =  subversion/tests/libsvn_subr/target-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
target_test_OBJECTS = target-test.o
subversion/tests/libsvn_subr/target-test$(EXEEXT): $(target_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o target-test$(EXEEXT)  $(target_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

time_test_PATH = subversion/tests/libsvn_subr
time_test_DEPS =  subversion/tests/libsvn_subr/time-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
time_test_OBJECTS = time-test.o
subversion/tests/libsvn_subr/time-test$(EXEEXT): $(time_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o time-test$(EXEEXT)  $(time_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

translate_test_PATH = subversion/tests/libsvn_subr
translate_test_DEPS =  subversion/tests/libsvn_subr/translate-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
translate_test_OBJECTS = translate-test.o
subversion/tests/libsvn_subr/translate-test$(EXEEXT): $(translate_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o translate-test$(EXEEXT)  $(translate_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

tree_conflict_data_test_PATH = subversion/tests/libsvn_wc
tree_conflict_data_test_DEPS =  subversion/tests/libsvn_wc/tree-conflict-data-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_wc/libsvn_wc-1.la subversion/libsvn_subr/libsvn_subr-1.la
...
subversion/tests/libsvn_wc/tree-conflict-data-test$(EXEEXT): $(tree_conflict_data_test_DEPS)
	cd subversion/tests/libsvn_wc && $(LINK) -o tree-conflict-data-test$(EXEEXT)  $(tree_conflict_data_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_wc/libsvn_wc-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

utf_test_PATH = subversion/tests/libsvn_subr
utf_test_DEPS =  subversion/tests/libsvn_subr/utf-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_subr/libsvn_subr-1.la
utf_test_OBJECTS = utf-test.o
subversion/tests/libsvn_subr/utf-test$(EXEEXT): $(utf_test_DEPS)
	cd subversion/tests/libsvn_subr && $(LINK) -o utf-test$(EXEEXT)  $(utf_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

vdelta_test_PATH = subversion/tests/libsvn_delta
vdelta_test_DEPS =  subversion/tests/libsvn_delta/vdelta-test.o subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
vdelta_test_OBJECTS = vdelta-test.o
subversion/tests/libsvn_delta/vdelta-test$(EXEEXT): $(vdelta_test_DEPS)
	cd subversion/tests/libsvn_delta && $(LINK) -o vdelta-test$(EXEEXT)  $(vdelta_test_OBJECTS) ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)

window_test_PATH = subversion/tests/libsvn_delta
window_test_DEPS =  subversion/tests/libsvn_delta/window-test.o subversion/tests/libsvn_test-1.la subversion/libsvn_delta/libsvn_delta-1.la subversion/libsvn_subr/libsvn_subr-1.la
window_test_OBJECTS = window-test.o
subversion/tests/libsvn_delta/window-test$(EXEEXT): $(window_test_DEPS)
	cd subversion/tests/libsvn_delta && $(LINK) -o window-test$(EXEEXT)  $(window_test_OBJECTS) ../../../subversion/tests/libsvn_test-1.la ../../../subversion/libsvn_delta/libsvn_delta-1.la ../../../subversion/libsvn_subr/libsvn_subr-1.la $(SVN_APRUTIL_LIBS) $(SVN_APR_LIBS) $(LIBS)
...
install-include: subversion/include/svn_time.h subversion/include/svn_auth.h subversion/include/svn_quoprint.h subversion/include/svn_cmdline.h subversion/include/svn_client.h subversion/include/svn_hash.h subversion/include/svn_path.h subversion/include/svn_ctype.h subversion/include/mod_authz_svn.h subversion/include/svn_error_codes.h subversion/include/svn_ra_svn.h subversion/include/svn_subst.h subversion/include/svn_props.h subversion/include/svn_md5.h subversion/include/mod_dav_svn.h subversion/include/svn_dirent_uri.h subversion/include/svn_checksum.h subversion/include/svn_ra.h subversion/include/svn_version.h subversion/include/svn_repos.h subversion/include/svn_utf.h subversion/include/svn_sorts.h subversion/include/svn_io.h subversion/include/svn_dav.h subversion/include/svn_string.h subversion/include/svn_config.h subversion/include/svn_nls.h subversion/include/svn_base64.h subversion/include/svn_opt.h subversion/include/svn_wc.h subversion/include/svn_diff.h subversion/include/svn_compat.h subversion/include/svn_pools.h subversion/include/svn_delta.h subversion/include/svn_error.h subversion/include/svn_dso.h subversion/include/svn_types.h subversion/include/svn_xml.h subversion/include/svn_fs.h subversion/include/svn_user.h subversion/include/svn_iter.h subversion/include/svn_mergeinfo.h
...
subversion/libsvn_repos/log.lo: subversion/libsvn_repos/log.c subversion/include/svn_checksum.h subversion/include/svn_compat.h subversion/include/svn_delta.h subversion/include/svn_error.h subversion/include/svn_error_codes.h subversion/include/svn_fs.h subversion/include/svn_io.h subversion/include/svn_mergeinfo.h subversion/include/svn_path.h subversion/include/svn_pools.h subversion/include/svn_props.h subversion/include/svn_repos.h subversion/include/svn_sorts.h subversion/include/svn_string.h subversion/include/svn_types.h subversion/include/svn_version.h subversion/libsvn_repos/repos.h subversion/svn_private_config.h
...
subversion/libsvn_subr/io.lo: subversion/libsvn_subr/io.c subversion/include/svn_checksum.h subversion/include/svn_config.h subversion/include/svn_error.h subversion/include/svn_error_codes.h subversion/include/svn_io.h subversion/include/svn_path.h subversion/include/svn_pools.h subversion/include/svn_string.h subversion/include/svn_types.h subversion/include/svn_utf.h subversion/svn_private_config.h
...
subversion/mod_dav_svn/version.lo: subversion/mod_dav_svn/version.c subversion/include/mod_authz_svn.h subversion/include/private/svn_dav_protocol.h subversion/include/private/svn_log.h subversion/include/svn_base64.h subversion/include/svn_checksum.h subversion/include/svn_dav.h subversion/include/svn_delta.h subversion/include/svn_error.h subversion/include/svn_error_codes.h subversion/include/svn_fs.h subversion/include/svn_io.h subversion/include/svn_mergeinfo.h subversion/include/svn_path.h subversion/include/svn_pools.h subversion/include/svn_props.h subversion/include/svn_repos.h subversion/include/svn_string.h subversion/include/svn_time.h subversion/include/svn_types.h subversion/include/svn_version.h subversion/include/svn_xml.h subversion/mod_dav_svn/dav_svn.h
...
subversion/svn/export-cmd.o: subversion/svn/export-cmd.c subversion/include/svn_auth.h subversion/include/svn_checksum.h subversion/include/svn_client.h subversion/include/svn_cmdline.h subversion/include/svn_config.h subversion/include/svn_delta.h subversion/include/svn_diff.h subversion/include/svn_error.h subversion/include/svn_error_codes.h subversion/include/svn_io.h subversion/include/svn_mergeinfo.h subversion/include/svn_opt.h subversion/include/svn_path.h subversion/include/svn_ra.h subversion/include/svn_string.h subversion/include/svn_types.h subversion/include/svn_version.h subversion/include/svn_wc.h subversion/svn/cl.h subversion/svn_private_config.h
