# $NetBSD: buildlink3.mk,v 1.7 2023/01/31 08:03:51 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-alternate-number-format-plugin+=	hs-hls-alternate-number-format-plugin>=1.3.0.0
