# $NetBSD: buildlink3.mk,v 1.10 2023/10/09 04:54:17 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-alternate-number-format-plugin+=	hs-hls-alternate-number-format-plugin>=1.3.0.0nb3
