# $NetBSD: buildlink3.mk,v 1.11 2023/10/31 14:32:29 pho Exp $
...
BUILDLINK_ABI_DEPENDS.hs-hls-alternate-number-format-plugin+=	hs-hls-alternate-number-format-plugin>=2.4.0.0
