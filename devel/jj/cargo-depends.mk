# $NetBSD: cargo-depends.mk,v 1.25 2025/09/17 13:46:33 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	datatest-stable-0.3.2
...
CARGO_CRATE_DEPENDS+=	jsonschema-0.32.1
...
CARGO_CRATE_DEPENDS+=	proptest-1.7.0
CARGO_CRATE_DEPENDS+=	proptest-derive-0.6.0
CARGO_CRATE_DEPENDS+=	proptest-state-machine-0.3.1
...
CARGO_CRATE_DEPENDS+=	referencing-0.32.1
