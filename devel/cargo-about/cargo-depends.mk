# $NetBSD: cargo-depends.mk,v 1.1 2024/01/26 08:08:31 pin Exp $
...
CARGO_CRATE_DEPENDS+=	handlebars-5.1.1
...
CARGO_CRATE_DEPENDS+=	krates-0.16.4
...
CARGO_CRATE_DEPENDS+=	spdx-0.10.3
