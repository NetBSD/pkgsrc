# $NetBSD: cargo-depends.mk,v 1.4 2024/11/24 17:09:52 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cfg-expr-0.17.1
...
CARGO_CRATE_DEPENDS+=	handlebars-6.2.0
...
CARGO_CRATE_DEPENDS+=	krates-0.17.5
...
CARGO_CRATE_DEPENDS+=	twox-hash-2.0.1
