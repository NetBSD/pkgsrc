# $NetBSD: Makefile,v 1.61 2023/03/15 14:07:39 schmonz Exp $

DISTNAME=	approvaltests-8.2.4
...
DEPENDS+=	${PYPKGPREFIX}-approval-utilities>=8.2.4:../../devel/py-approval-utilities
