# $NetBSD: Makefile,v 1.62 2023/04/11 15:36:22 schmonz Exp $

DISTNAME=	approvaltests-8.2.5
...
DEPENDS+=	${PYPKGPREFIX}-approval-utilities>=${PKGVERSION_NOREV}:../../devel/py-approval-utilities
