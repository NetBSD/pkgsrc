# $NetBSD: cargo-depends.mk,v 1.4 2025/12/30 12:29:12 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fs-err-3.2.1
...
CARGO_CRATE_DEPENDS+=	guppy-0.17.23
...
CARGO_CRATE_DEPENDS+=	target-spec-3.5.4
...
CARGO_CRATE_DEPENDS+=	toml_datetime-0.7.4+spec-1.0.0
CARGO_CRATE_DEPENDS+=	toml_edit-0.22.27
CARGO_CRATE_DEPENDS+=	toml_edit-0.23.10+spec-1.0.0
CARGO_CRATE_DEPENDS+=	toml_parser-1.0.5+spec-1.0.0
CARGO_CRATE_DEPENDS+=	toml_write-0.1.2
CARGO_CRATE_DEPENDS+=	toml_writer-1.0.5+spec-1.0.0
