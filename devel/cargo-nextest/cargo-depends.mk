# $NetBSD: cargo-depends.mk,v 1.25 2026/09/22 06:56:04 adam Exp $
...
CARGO_CRATE_DEPENDS+=	camino-1.2.6
...
CARGO_CRATE_DEPENDS+=	char_index-0.1.5
...
CARGO_CRATE_DEPENDS+=	eazip-0.2.6
...
CARGO_CRATE_DEPENDS+=	guppy-0.17.26
...
CARGO_CRATE_DEPENDS+=	iddqd-0.5.0
...
CARGO_CRATE_DEPENDS+=	jsonschema-0.49.9
CARGO_CRATE_DEPENDS+=	jsonschema-regex-0.49.9
CARGO_CRATE_DEPENDS+=	jsonschema-value-0.49.9
...
CARGO_CRATE_DEPENDS+=	newtype-uuid-1.4.0
...
CARGO_CRATE_DEPENDS+=	quick-junit-0.8.0
...
CARGO_CRATE_DEPENDS+=	referencing-0.49.9
...
CARGO_CRATE_DEPENDS+=	synoptic-2.2.9
CARGO_CRATE_DEPENDS+=	tar-0.4.46
CARGO_CRATE_DEPENDS+=	target-lexicon-0.13.3
CARGO_CRATE_DEPENDS+=	target-spec-3.6.0
CARGO_CRATE_DEPENDS+=	target-spec-miette-0.4.8
