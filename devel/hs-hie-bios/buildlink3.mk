# $NetBSD: buildlink3.mk,v 1.9 2023/10/30 17:01:39 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-hie-bios+=	hs-hie-bios>=0.13.0
BUILDLINK_ABI_DEPENDS.hs-hie-bios+=	hs-hie-bios>=0.13.0
