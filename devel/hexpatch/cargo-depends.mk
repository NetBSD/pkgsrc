# $NetBSD: cargo-depends.mk,v 1.10 2025/05/04 15:25:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	hexpatch-keystone-0.9.4-1
CARGO_CRATE_DEPENDS+=	hexpatch-keystone-sys-0.9.4-1
...
CARGO_CRATE_DEPENDS+=	russh-0.52.0
