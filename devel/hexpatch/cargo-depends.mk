# $NetBSD: cargo-depends.mk,v 1.4 2024/11/08 09:03:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	russh-0.46.0
CARGO_CRATE_DEPENDS+=	russh-cryptovec-0.7.3
CARGO_CRATE_DEPENDS+=	russh-keys-0.46.0
CARGO_CRATE_DEPENDS+=	russh-sftp-2.0.5
CARGO_CRATE_DEPENDS+=	russh-util-0.46.0
...
CARGO_CRATE_DEPENDS+=	thiserror-1.0.67
CARGO_CRATE_DEPENDS+=	thiserror-impl-1.0.67
