# $NetBSD: cargo-depends.mk,v 1.6 2024/12/12 21:57:18 pin Exp $
...
CARGO_CRATE_DEPENDS+=	delegate-0.12.0
CARGO_CRATE_DEPENDS+=	delegate-0.13.1
...
CARGO_CRATE_DEPENDS+=	pageant-0.0.1-beta.3
...
CARGO_CRATE_DEPENDS+=	russh-0.48.2
CARGO_CRATE_DEPENDS+=	russh-cryptovec-0.48.0
CARGO_CRATE_DEPENDS+=	russh-keys-0.48.1
...
CARGO_CRATE_DEPENDS+=	symbolic-common-12.12.3
CARGO_CRATE_DEPENDS+=	symbolic-demangle-12.12.3
CARGO_CRATE_DEPENDS+=	syn-2.0.90
CARGO_CRATE_DEPENDS+=	tempfile-3.14.0
CARGO_CRATE_DEPENDS+=	termbg-0.6.1
