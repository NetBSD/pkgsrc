# $NetBSD: cargo-depends.mk,v 1.12 2025/06/12 08:06:36 pin Exp $
...
CARGO_CRATE_DEPENDS+=	const-str-0.6.2
...
CARGO_CRATE_DEPENDS+=	internal-russh-forked-ssh-key-0.6.10+upstream-0.6.7
...
CARGO_CRATE_DEPENDS+=	object-0.37.0
...
CARGO_CRATE_DEPENDS+=	pageant-0.0.3
...
CARGO_CRATE_DEPENDS+=	russh-0.52.1
...
CARGO_CRATE_DEPENDS+=	symbolic-common-12.15.5
CARGO_CRATE_DEPENDS+=	symbolic-demangle-12.15.5
