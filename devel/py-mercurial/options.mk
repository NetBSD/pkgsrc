# $NetBSD: options.mk,v 1.3 2020/10/06 17:50:47 wiz Exp $

PKG_OPTIONS_VAR=		PKG_OPTIONS.mercurial
# 5.5.2 needs some "*-pre" crates that are not available
...
#CARGO_CRATE_DEPENDS+=	pyembed-0.7.0-pre
#CARGO_CRATE_DEPENDS+=	python-packed-resources-0.1.0-pre
