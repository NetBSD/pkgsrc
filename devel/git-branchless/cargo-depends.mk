# $NetBSD: cargo-depends.mk,v 1.7 2026/05/22 08:19:34 pin Exp $

CARGO_CRATE_DEPENDS+=	abomonation_derive-0.5.0
...
CARGO_CRATE_DEPENDS+=	bugreport-0.6.0
...
CARGO_CRATE_DEPENDS+=	chrono-english-0.1.8
CARGO_CRATE_DEPENDS+=	chronoutil-0.2.7
...
CARGO_CRATE_DEPENDS+=	lalrpop-0.23.1
CARGO_CRATE_DEPENDS+=	lalrpop-util-0.23.1
...
CARGO_CRATE_DEPENDS+=	sapling-atomicfile-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-dag-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-dag-types-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-drawdag-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-indexedlog-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-mincode-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-minibytes-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-nonblocking-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-renderdag-0.1.0
CARGO_CRATE_DEPENDS+=	sapling-vlqencoding-0.1.0
CARGO_CRATE_DEPENDS+=	scanlex-0.1.4
CARGO_CRATE_DEPENDS+=	scm-diff-editor-0.10.1
...
CARGO_CRATE_DEPENDS+=	skim-0.15.7
...
CARGO_CRATE_DEPENDS+=	term-1.2.1
