# $NetBSD: cargo-depends.mk,v 1.22 2026/08/31 08:30:01 pin Exp $
...
CARGO_CRATE_DEPENDS+=	mockall-0.15.0
CARGO_CRATE_DEPENDS+=	mockall_derive-0.15.0
...
CARGO_CRATE_DEPENDS+=	serial_test-4.0.1
CARGO_CRATE_DEPENDS+=	serial_test_derive-4.0.1
