# $NetBSD: cargo-depends.mk,v 1.4 2023/07/25 10:05:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	human-panic-1.1.5
...
CARGO_CRATE_DEPENDS+=	jemalloc-sys-0.5.3+5.3.0-patched
...
CARGO_CRATE_DEPENDS+=	libz-sys-1.1.10
...
CARGO_CRATE_DEPENDS+=	mockall-0.11.4
CARGO_CRATE_DEPENDS+=	mockall_derive-0.11.4
...
CARGO_CRATE_DEPENDS+=	pest-2.7.1
CARGO_CRATE_DEPENDS+=	pest_derive-2.7.1
CARGO_CRATE_DEPENDS+=	pest_generator-2.7.1
CARGO_CRATE_DEPENDS+=	pest_meta-2.7.1
...
CARGO_CRATE_DEPENDS+=	serde-1.0.174
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.174
...
CARGO_CRATE_DEPENDS+=	tzdb-0.5.7
