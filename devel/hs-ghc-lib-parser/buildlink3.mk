# $NetBSD: buildlink3.mk,v 1.11 2025/01/31 02:13:46 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-ghc-lib-parser+=	hs-ghc-lib-parser>=9.12.1
BUILDLINK_ABI_DEPENDS.hs-ghc-lib-parser+=	hs-ghc-lib-parser>=9.12.1.20250105
