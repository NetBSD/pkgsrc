$NetBSD: patch-pylib_gyp_generator_make.py,v 1.3 2014/08/21 14:49:43 he Exp $
...
@@ -167,9 +167,46 @@ quiet_cmd_solink_module = SOLINK_MODULE(
...
@@ -350,7 +387,7 @@ sed -e "s|^$(notdir $@)|$@|" $(depfile).
...
+env NL=`printf "\n"` sed -e 's|\\||' -e 's| |${NL}|g' $(depfile).raw |\
   ...
   sed -e 1d -e 's|$$|:|'                     \
     >> $(depfile)
@@ -2056,6 +2093,11 @@ def GenerateOutput(target_list, target_d
