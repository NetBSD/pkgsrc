# $NetBSD: cargo-depends.mk,v 1.10 2024/08/14 09:30:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-help-1.3.0
...
CARGO_CRATE_DEPENDS+=	gix-credentials-0.24.4
...
CARGO_CRATE_DEPENDS+=	serde-1.0.206
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.206
...
CARGO_CRATE_DEPENDS+=	termimad-0.30.0
CARGO_CRATE_DEPENDS+=	terminal-light-1.5.0
