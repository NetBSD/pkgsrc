# $NetBSD: cargo-depends.mk,v 1.24 2025/03/15 15:58:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-help-1.3.2
...
CARGO_CRATE_DEPENDS+=	gix-0.67.0
...
CARGO_CRATE_DEPENDS+=	gix-config-0.41.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.11
CARGO_CRATE_DEPENDS+=	gix-date-0.9.3
CARGO_CRATE_DEPENDS+=	gix-diff-0.47.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.36.0
...
CARGO_CRATE_DEPENDS+=	gix-index-0.36.0
CARGO_CRATE_DEPENDS+=	gix-lock-15.0.1
CARGO_CRATE_DEPENDS+=	gix-object-0.45.0
CARGO_CRATE_DEPENDS+=	gix-odb-0.64.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.54.0
CARGO_CRATE_DEPENDS+=	gix-path-0.10.14
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.15
CARGO_CRATE_DEPENDS+=	gix-ref-0.48.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.26.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.30.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.16.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.11
CARGO_CRATE_DEPENDS+=	gix-tempfile-15.0.0
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.12
CARGO_CRATE_DEPENDS+=	gix-traverse-0.42.0
...
CARGO_CRATE_DEPENDS+=	jiff-tzdb-0.1.3
...
CARGO_CRATE_DEPENDS+=	termimad-0.31.2
...
CARGO_CRATE_DEPENDS+=	xterm-query-0.5.1
