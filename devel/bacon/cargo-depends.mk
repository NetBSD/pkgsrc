# $NetBSD: cargo-depends.mk,v 1.9 2024/08/07 08:41:51 pin Exp $
...
CARGO_CRATE_DEPENDS+=	crokey-1.0.1
CARGO_CRATE_DEPENDS+=	crokey-proc_macros-0.6.4
CARGO_CRATE_DEPENDS+=	crokey-proc_macros-1.0.1
...
CARGO_CRATE_DEPENDS+=	gix-attributes-0.22.3
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.11
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.8
CARGO_CRATE_DEPENDS+=	gix-command-0.3.8
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.24.3
CARGO_CRATE_DEPENDS+=	gix-config-0.34.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.7
CARGO_CRATE_DEPENDS+=	gix-credentials-0.24.3
...
CARGO_CRATE_DEPENDS+=	gix-path-0.10.9
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.6.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.8.6
...
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.7
...
CARGO_CRATE_DEPENDS+=	gix-url-0.27.4
...
CARGO_CRATE_DEPENDS+=	termimad-0.29.4
...
CARGO_CRATE_DEPENDS+=	xterm-query-0.4.1
