# $NetBSD: cargo-depends.mk,v 1.18 2024/12/15 21:53:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-actor-0.33.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.12
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.9
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.25.0
...
CARGO_CRATE_DEPENDS+=	gix-fs-0.12.0
CARGO_CRATE_DEPENDS+=	gix-glob-0.17.0
CARGO_CRATE_DEPENDS+=	gix-hash-0.15.0
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.6.0
CARGO_CRATE_DEPENDS+=	gix-ignore-0.12.0
CARGO_CRATE_DEPENDS+=	gix-index-0.36.0
CARGO_CRATE_DEPENDS+=	gix-lock-15.0.0
...
CARGO_CRATE_DEPENDS+=	gix-url-0.28.0
