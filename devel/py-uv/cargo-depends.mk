# $NetBSD: cargo-depends.mk,v 1.38 2026/09/22 11:08:49 adam Exp $
...
CARGO_CRATE_DEPENDS+=	archive-trait-0.0.14
...
CARGO_CRATE_DEPENDS+=	astral-tl-0.8.0
CARGO_CRATE_DEPENDS+=	astral-tokio-tar-0.7.0
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.19
...
CARGO_CRATE_DEPENDS+=	axoupdater-0.10.2
...
CARGO_CRATE_DEPENDS+=	blake3-1.8.6
...
CARGO_CRATE_DEPENDS+=	cap-primitives-4.0.3
CARGO_CRATE_DEPENDS+=	cap-std-4.0.3
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.30
...
CARGO_CRATE_DEPENDS+=	codspeed-5.0.1
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-5.0.1
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-walltime-5.0.1
...
CARGO_CRATE_DEPENDS+=	diskus-0.9.0
...
CARGO_CRATE_DEPENDS+=	encoding_rs_io-0.1.8
...
CARGO_CRATE_DEPENDS+=	fs-set-times-0.20.3
...
CARGO_CRATE_DEPENDS+=	goblin-0.10.7
...
CARGO_CRATE_DEPENDS+=	io-extras-0.19.0
CARGO_CRATE_DEPENDS+=	io-lifetimes-2.0.4
CARGO_CRATE_DEPENDS+=	io-lifetimes-3.0.1
...
CARGO_CRATE_DEPENDS+=	papaya-0.2.5
...
CARGO_CRATE_DEPENDS+=	rcgen-0.14.9
...
CARGO_CRATE_DEPENDS+=	reqsign-0.20.3
CARGO_CRATE_DEPENDS+=	reqsign-aws-core-3.0.3
CARGO_CRATE_DEPENDS+=	reqsign-aws-v4-3.1.0
CARGO_CRATE_DEPENDS+=	reqsign-azure-storage-3.1.2
CARGO_CRATE_DEPENDS+=	reqsign-command-execute-tokio-3.0.4
CARGO_CRATE_DEPENDS+=	reqsign-core-3.2.1
CARGO_CRATE_DEPENDS+=	reqsign-file-read-tokio-3.0.4
CARGO_CRATE_DEPENDS+=	reqsign-google-3.0.4
CARGO_CRATE_DEPENDS+=	reqsign-http-send-reqwest-4.0.4
...
CARGO_CRATE_DEPENDS+=	tar-codec-0.0.14
CARGO_CRATE_DEPENDS+=	tar-framing-0.0.14
...
CARGO_CRATE_DEPENDS+=	tracing-durations-export-0.3.5
...
CARGO_CRATE_DEPENDS+=	winx-0.36.4
