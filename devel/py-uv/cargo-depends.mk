# $NetBSD: cargo-depends.mk,v 1.2 2025/09/26 13:50:33 adam Exp $
...
CARGO_CRATE_DEPENDS+=	ambient-id-0.0.5
...
CARGO_CRATE_DEPENDS+=	astral-tokio-tar-0.5.5
...
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-3.0.5
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-walltime-3.0.5
...
CARGO_CRATE_DEPENDS+=	goblin-0.10.1
...
#CARGO_CRATE_DEPENDS+=	pubgrub-0.3.0
...
CARGO_CRATE_DEPENDS+=	reqsign-0.17.0
CARGO_CRATE_DEPENDS+=	reqsign-aws-v4-1.0.0
CARGO_CRATE_DEPENDS+=	reqsign-command-execute-tokio-1.0.0
CARGO_CRATE_DEPENDS+=	reqsign-core-1.0.0
CARGO_CRATE_DEPENDS+=	reqsign-file-read-tokio-1.0.0
CARGO_CRATE_DEPENDS+=	reqsign-http-send-reqwest-1.0.0
...
CARGO_CRATE_DEPENDS+=	rkyv-0.8.11
CARGO_CRATE_DEPENDS+=	rkyv_derive-0.8.11
...
CARGO_CRATE_DEPENDS+=	serde-1.0.223
CARGO_CRATE_DEPENDS+=	serde-untagged-0.1.9
CARGO_CRATE_DEPENDS+=	serde_core-1.0.223
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.223
