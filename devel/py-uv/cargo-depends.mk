# $NetBSD: cargo-depends.mk,v 1.14 2026/02/24 08:02:17 adam Exp $

CARGO_CRATE_DEPENDS+=	adler2-2.0.1
CARGO_CRATE_DEPENDS+=	aes-0.8.4
CARGO_CRATE_DEPENDS+=	aho-corasick-1.1.3
CARGO_CRATE_DEPENDS+=	allocator-api2-0.2.21
CARGO_CRATE_DEPENDS+=	ambient-id-0.0.10
...
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.26
...
CARGO_CRATE_DEPENDS+=	codspeed-4.3.0
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-4.3.0
CARGO_CRATE_DEPENDS+=	codspeed-criterion-compat-walltime-4.3.0
...
CARGO_CRATE_DEPENDS+=	http-content-range-0.2.3
...
CARGO_CRATE_DEPENDS+=	lzma-rust2-0.16.1
...
CARGO_CRATE_DEPENDS+=	munge-0.4.5
CARGO_CRATE_DEPENDS+=	munge_macro-0.4.5
...
CARGO_CRATE_DEPENDS+=	reqsign-0.18.1
CARGO_CRATE_DEPENDS+=	reqsign-aws-v4-2.0.1
CARGO_CRATE_DEPENDS+=	reqsign-command-execute-tokio-2.0.1
CARGO_CRATE_DEPENDS+=	reqsign-core-2.0.1
CARGO_CRATE_DEPENDS+=	reqsign-file-read-tokio-2.0.1
CARGO_CRATE_DEPENDS+=	reqsign-google-2.0.1
...
CARGO_CRATE_DEPENDS+=	rustls-pki-types-1.13.3
...
CARGO_CRATE_DEPENDS+=	scroll_derive-0.13.0
...
CARGO_CRATE_DEPENDS+=	simple_asn1-0.6.3
...
CARGO_CRATE_DEPENDS+=	spdx-0.13.3
...
CARGO_CRATE_DEPENDS+=	wasmtimer-0.4.2
...
CARGO_CRATE_DEPENDS+=	whoami-2.1.0
...
CARGO_CRATE_DEPENDS+=	wmi-0.16.0
...
CARGO_CRATE_DEPENDS+=	zbus-5.8.0
CARGO_CRATE_DEPENDS+=	zbus_macros-5.8.0
