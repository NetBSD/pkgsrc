# $NetBSD: cargo-depends.mk,v 1.13 2023/12/22 16:41:07 wiz Exp $

CARGO_CRATE_DEPENDS+=	aho-corasick-0.7.6
CARGO_CRATE_DEPENDS+=	always-assert-0.1.2
CARGO_CRATE_DEPENDS+=	anstream-0.6.0
CARGO_CRATE_DEPENDS+=	anstyle-0.3.0
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.95.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.95.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.95.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.95.0
...
CARGO_CRATE_DEPENDS+=	doc-comment-0.3.0
...
CARGO_CRATE_DEPENDS+=	encode_unicode-0.3.0
...
CARGO_CRATE_DEPENDS+=	hermit-abi-0.2.0
...
CARGO_CRATE_DEPENDS+=	inotify-0.9.0
...
CARGO_CRATE_DEPENDS+=	itoa-1.0.0
...
CARGO_CRATE_DEPENDS+=	line-index-0.1.0-pre.1
CARGO_CRATE_DEPENDS+=	linked-hash-map-0.5.6
CARGO_CRATE_DEPENDS+=	linux-raw-sys-0.1.2
CARGO_CRATE_DEPENDS+=	lock_api-0.4.8
CARGO_CRATE_DEPENDS+=	log-0.4.20
CARGO_CRATE_DEPENDS+=	matches-0.1.2
...
CARGO_CRATE_DEPENDS+=	ntapi-0.3.0
...
CARGO_CRATE_DEPENDS+=	perf-event-open-sys-1.0.0
...
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_abi-0.20.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_index-0.20.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_index_macros-0.20.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_lexer-0.20.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_parse_format-0.20.0
CARGO_CRATE_DEPENDS+=	ra_ap_base_db-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_cfg-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_hir-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_hir_def-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_hir_expand-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_hir_ty-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide_assists-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide_completion-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide_db-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide_diagnostics-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_ide_ssr-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_intern-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_limit-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_load-cargo-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_mbe-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_parser-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_paths-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_proc_macro_api-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_profile-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_project_model-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_rustc-dependencies-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_stdx-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_syntax-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_test_utils-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_text_edit-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_toolchain-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_tt-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-0.0.188
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-notify-0.0.188
CARGO_CRATE_DEPENDS+=	radium-0.7.0
CARGO_CRATE_DEPENDS+=	rayon-1.8.0
CARGO_CRATE_DEPENDS+=	rayon-core-1.12.0
CARGO_CRATE_DEPENDS+=	redox_syscall-0.1.38
CARGO_CRATE_DEPENDS+=	redox_syscall-0.2.8
CARGO_CRATE_DEPENDS+=	redox_syscall-0.3.5
CARGO_CRATE_DEPENDS+=	regex-1.3.9
CARGO_CRATE_DEPENDS+=	regex-automata-0.1.5
CARGO_CRATE_DEPENDS+=	regex-syntax-0.6.18
CARGO_CRATE_DEPENDS+=	rowan-0.15.11
CARGO_CRATE_DEPENDS+=	rust-analyzer-salsa-0.17.0-pre.3
CARGO_CRATE_DEPENDS+=	rust-analyzer-salsa-macros-0.17.0-pre.3
CARGO_CRATE_DEPENDS+=	rustc-hash-1.1.0
CARGO_CRATE_DEPENDS+=	rustix-0.36.0
CARGO_CRATE_DEPENDS+=	ryu-1.0.0
CARGO_CRATE_DEPENDS+=	same-file-1.0.1
...
CARGO_CRATE_DEPENDS+=	tinyvec-1.0.0
...
CARGO_CRATE_DEPENDS+=	unicode-bidi-0.3.0
...
CARGO_CRATE_DEPENDS+=	version_check-0.9.0
...
CARGO_CRATE_DEPENDS+=	windows-sys-0.36.0
...
CARGO_CRATE_DEPENDS+=	windows_x86_64_msvc-0.36.0
