# $NetBSD: cargo-depends.mk,v 1.30 2024/08/18 16:14:59 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_pattern_analysis-0.53.0
CARGO_CRATE_DEPENDS+=	ra_ap_base_db-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_cfg-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_hir-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_hir_def-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_hir_expand-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_hir_ty-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide_assists-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide_completion-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide_db-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide_diagnostics-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_ide_ssr-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_intern-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_limit-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_load-cargo-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_mbe-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_parser-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_paths-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_proc_macro_api-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_profile-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_project_model-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_salsa-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_salsa-macros-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_span-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_stdx-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_syntax-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_syntax-bridge-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_text_edit-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_toolchain-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_tt-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-0.0.229
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-notify-0.0.229
