# $NetBSD: cargo-depends.mk,v 1.38 2026/04/19 17:36:48 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cov-mark-2.0.0
...
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_abi-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_ast_ir-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_hashes-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_index-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_index_macros-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_lexer-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_next_trait_solver-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_parse_format-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_pattern_analysis-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_type_ir-0.143.0
CARGO_CRATE_DEPENDS+=	ra-ap-rustc_type_ir_macros-0.143.0
CARGO_CRATE_DEPENDS+=	ra_ap_base_db-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_cfg-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_edition-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_hir-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_hir_def-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_hir_expand-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_hir_ty-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide_assists-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide_completion-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide_db-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide_diagnostics-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_ide_ssr-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_intern-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_load-cargo-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_macros-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_mbe-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_parser-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_paths-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_proc_macro_api-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_profile-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_project_model-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_query-group-macro-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_span-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_stdx-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_syntax-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_syntax-bridge-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_test_fixture-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_test_utils-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_text_edit-0.0.241
CARGO_CRATE_DEPENDS+=	ra_ap_toolchain-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_tt-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-0.0.328
CARGO_CRATE_DEPENDS+=	ra_ap_vfs-notify-0.0.328
...
CARGO_CRATE_DEPENDS+=	rustc-literal-escaper-0.0.5
...
CARGO_CRATE_DEPENDS+=	sugar_path-2.0.1
