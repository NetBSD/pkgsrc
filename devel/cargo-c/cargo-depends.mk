# $NetBSD: cargo-depends.mk,v 1.13 2024/02/10 21:46:03 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.77.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.2
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.2
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.2
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.2
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.7
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.9
...
CARGO_CRATE_DEPENDS+=	crates-io-0.39.2
...
CARGO_CRATE_DEPENDS+=	curl-0.4.45
...
CARGO_CRATE_DEPENDS+=	gix-credentials-0.22.0
...
CARGO_CRATE_DEPENDS+=	gix-filter-0.7.0
...
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.10.0
...
CARGO_CRATE_DEPENDS+=	gix-protocol-0.42.0
...
CARGO_CRATE_DEPENDS+=	gix-submodule-0.6.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-11.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.7
CARGO_CRATE_DEPENDS+=	gix-transport-0.39.0
...
CARGO_CRATE_DEPENDS+=	gix-worktree-0.28.0
...
CARGO_CRATE_DEPENDS+=	openssl-src-300.2.2+3.2.1
...
CARGO_CRATE_DEPENDS+=	rustfix-0.7.0
