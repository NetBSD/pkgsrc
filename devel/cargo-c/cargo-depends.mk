# $NetBSD: cargo-depends.mk,v 1.11 2023/11/21 12:51:38 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.75.1
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.1
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.0
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.0
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.0
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.5
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.7
...
CARGO_CRATE_DEPENDS+=	crates-io-0.39.0
...
CARGO_CRATE_DEPENDS+=	openssl-0.10.59
...
CARGO_CRATE_DEPENDS+=	serde-untagged-0.1.1
