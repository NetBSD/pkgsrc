# $NetBSD: cargo-depends.mk,v 1.19 2025/07/01 21:18:51 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.89.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.8
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.14
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.14
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.14
...
CARGO_CRATE_DEPENDS+=	pasetors-0.7.6
