# $NetBSD: cargo-depends.mk,v 1.12 2024/01/01 19:39:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	curl-sys-0.4.70+curl-8.5.0
...
CARGO_CRATE_DEPENDS+=	ed25519-compact-2.0.6
...
CARGO_CRATE_DEPENDS+=	erased-serde-0.4.1
...
CARGO_CRATE_DEPENDS+=	syn-2.0.44
