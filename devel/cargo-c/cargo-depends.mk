# $NetBSD: cargo-depends.mk,v 1.18 2025/05/19 09:07:06 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.88.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.8
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.13
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.13
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.13
CARGO_CRATE_DEPENDS+=	cargo-platform-0.2.0
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.20
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.8.1
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.10
...
CARGO_CRATE_DEPENDS+=	ct-codecs-1.1.5
...
CARGO_CRATE_DEPENDS+=	implib-0.3.5
...
CARGO_CRATE_DEPENDS+=	orion-0.17.10
CARGO_CRATE_DEPENDS+=	os_info-3.11.0
...
CARGO_CRATE_DEPENDS+=	pasetors-0.7.4
