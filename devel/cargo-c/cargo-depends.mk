# $NetBSD: cargo-depends.mk,v 1.7 2023/08/28 08:20:15 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.73.1
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.3
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.5
...
CARGO_CRATE_DEPENDS+=	gix-0.45.1
...
CARGO_CRATE_DEPENDS+=	gix-index-0.17.0
...
CARGO_CRATE_DEPENDS+=	gix-odb-0.46.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.36.0
CARGO_CRATE_DEPENDS+=	gix-packetline-0.16.5
CARGO_CRATE_DEPENDS+=	gix-path-0.8.4
CARGO_CRATE_DEPENDS+=	gix-prompt-0.5.5
CARGO_CRATE_DEPENDS+=	gix-protocol-0.33.2
...
CARGO_CRATE_DEPENDS+=	gix-transport-0.32.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.26.0
CARGO_CRATE_DEPENDS+=	gix-url-0.19.0
CARGO_CRATE_DEPENDS+=	gix-utils-0.1.5
CARGO_CRATE_DEPENDS+=	gix-validate-0.7.7
CARGO_CRATE_DEPENDS+=	gix-worktree-0.18.0
...
CARGO_CRATE_DEPENDS+=	orion-0.17.5
...
CARGO_CRATE_DEPENDS+=	prodash-25.0.2
