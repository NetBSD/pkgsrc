# $NetBSD: cargo-depends.mk,v 1.4 2023/07/13 20:32:57 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.5
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.3
CARGO_CRATE_DEPENDS+=	gix-command-0.2.6
...
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.5
...
CARGO_CRATE_DEPENDS+=	serde_ignored-0.1.8
