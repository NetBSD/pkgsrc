# $NetBSD: cargo-depends.mk,v 1.28 2026/06/01 13:04:37 pin Exp $
...
CARGO_CRATE_DEPENDS+=	anstyle-progress-0.1.0
...
CARGO_CRATE_DEPENDS+=	cargo-0.97.1
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.10
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.5.7
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.22
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.22
CARGO_CRATE_DEPENDS+=	cargo-platform-0.3.3
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.29
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.14.0
CARGO_CRATE_DEPENDS+=	cargo-util-terminal-0.1.0
CARGO_CRATE_DEPENDS+=	cbindgen-0.29.3
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.19
...
CARGO_CRATE_DEPENDS+=	ed25519-compact-2.3.0
...
CARGO_CRATE_DEPENDS+=	gix-command-0.8.1
...
CARGO_CRATE_DEPENDS+=	gix-credentials-0.37.2
...
CARGO_CRATE_DEPENDS+=	gix-prompt-0.14.2
...
CARGO_CRATE_DEPENDS+=	rustfix-0.9.6
