# $NetBSD: cargo-depends.mk,v 1.30 2026/09/07 07:06:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	anstyle-hyperlink-1.0.2
CARGO_CRATE_DEPENDS+=	anstyle-parse-1.0.0
CARGO_CRATE_DEPENDS+=	anstyle-progress-0.1.4
...
CARGO_CRATE_DEPENDS+=	cargo-0.99.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.10
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.5.9
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.24
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.24
CARGO_CRATE_DEPENDS+=	cargo-platform-0.3.3
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.31
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.14.2
CARGO_CRATE_DEPENDS+=	cargo-util-terminal-0.1.1
...
CARGO_CRATE_DEPENDS+=	crates-io-0.41.1
...
CARGO_CRATE_DEPENDS+=	ct-codecs-1.1.7
CARGO_CRATE_DEPENDS+=	ctutils-0.4.2
CARGO_CRATE_DEPENDS+=	curl-0.4.50
CARGO_CRATE_DEPENDS+=	curl-sys-0.4.90+curl-8.21.0
...
CARGO_CRATE_DEPENDS+=	ed25519-compact-2.4.2
...
CARGO_CRATE_DEPENDS+=	git2-curl-0.22.0
CARGO_CRATE_DEPENDS+=	gix-0.85.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.41.2
CARGO_CRATE_DEPENDS+=	gix-attributes-0.33.2
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.3.3
CARGO_CRATE_DEPENDS+=	gix-chunk-0.7.3
CARGO_CRATE_DEPENDS+=	gix-command-0.9.2
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.37.1
CARGO_CRATE_DEPENDS+=	gix-config-0.58.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.18.1
CARGO_CRATE_DEPENDS+=	gix-credentials-0.38.2
CARGO_CRATE_DEPENDS+=	gix-date-0.15.6
CARGO_CRATE_DEPENDS+=	gix-diff-0.65.0
CARGO_CRATE_DEPENDS+=	gix-dir-0.27.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.53.0
CARGO_CRATE_DEPENDS+=	gix-error-0.2.5
CARGO_CRATE_DEPENDS+=	gix-features-0.48.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.32.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.21.2
CARGO_CRATE_DEPENDS+=	gix-glob-0.26.1
CARGO_CRATE_DEPENDS+=	gix-hash-0.25.1
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.15.2
CARGO_CRATE_DEPENDS+=	gix-ignore-0.21.1
CARGO_CRATE_DEPENDS+=	gix-imara-diff-0.2.5
CARGO_CRATE_DEPENDS+=	gix-index-0.53.0
CARGO_CRATE_DEPENDS+=	gix-lock-23.0.1
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.33.0
CARGO_CRATE_DEPENDS+=	gix-object-0.62.0
CARGO_CRATE_DEPENDS+=	gix-odb-0.82.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.72.0
...
CARGO_CRATE_DEPENDS+=	gix-protocol-0.63.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.7.2
CARGO_CRATE_DEPENDS+=	gix-ref-0.65.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.43.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.47.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.33.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.14.2
CARGO_CRATE_DEPENDS+=	gix-shallow-0.12.1
CARGO_CRATE_DEPENDS+=	gix-status-0.32.0
CARGO_CRATE_DEPENDS+=	gix-submodule-0.32.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-23.0.2
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.21
CARGO_CRATE_DEPENDS+=	gix-transport-0.57.2
CARGO_CRATE_DEPENDS+=	gix-traverse-0.59.0
CARGO_CRATE_DEPENDS+=	gix-url-0.36.2
CARGO_CRATE_DEPENDS+=	gix-utils-0.3.6
CARGO_CRATE_DEPENDS+=	gix-validate-0.11.4
CARGO_CRATE_DEPENDS+=	gix-worktree-0.54.0
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.34.0
...
CARGO_CRATE_DEPENDS+=	object-0.40.0
...
CARGO_CRATE_DEPENDS+=	orion-0.17.15
...
CARGO_CRATE_DEPENDS+=	rustfix-0.9.7
