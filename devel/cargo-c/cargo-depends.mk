...
CARGO_CRATE_DEPENDS+=	cargo-0.78.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.4
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.3
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.3
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.3
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.8
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.10
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.0
...
CARGO_CRATE_DEPENDS+=	gix-ignore-0.10.1
CARGO_CRATE_DEPENDS+=	gix-index-0.28.2
CARGO_CRATE_DEPENDS+=	gix-lock-12.0.1
CARGO_CRATE_DEPENDS+=	gix-macros-0.1.4
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.11.1
...
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.5.1
CARGO_CRATE_DEPENDS+=	gix-prompt-0.8.4
CARGO_CRATE_DEPENDS+=	gix-protocol-0.43.1
...
CARGO_CRATE_DEPENDS+=	libnghttp2-sys-0.1.9+1.58.0
...
CARGO_CRATE_DEPENDS+=	rustfix-0.8.1
