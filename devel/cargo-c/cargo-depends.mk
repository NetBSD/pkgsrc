# $NetBSD: cargo-depends.mk,v 1.10 2023/10/19 11:08:09 tnn Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.74.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.3.0
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.3.1
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.3.0
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.3.0
...
CARGO_CRATE_DEPENDS+=	crates-io-0.38.0
...
CARGO_CRATE_DEPENDS+=	fiat-crypto-0.2.1
