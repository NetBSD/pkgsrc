# $NetBSD: cargo-depends.mk,v 1.5 2023/07/18 20:51:40 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cargo-0.72.1
...
CARGO_CRATE_DEPENDS+=	clap-4.3.15
CARGO_CRATE_DEPENDS+=	clap_builder-4.3.15
...
CARGO_CRATE_DEPENDS+=	gix-config-value-0.12.3
...
CARGO_CRATE_DEPENDS+=	gix-hash-0.11.3
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.2.3
...
CARGO_CRATE_DEPENDS+=	gix-packetline-0.16.3
CARGO_CRATE_DEPENDS+=	gix-path-0.8.3
CARGO_CRATE_DEPENDS+=	gix-prompt-0.5.2
...
CARGO_CRATE_DEPENDS+=	signal-hook-0.3.16
