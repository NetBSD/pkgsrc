$NetBSD: patch-.._vendor_memchr-2.7.5_src_memmem_searcher.rs,v 1.1 2025/07/01 21:18:51 wiz Exp $

Don't try to use neon / SIMD on big-endian aarch64.

--- ../vendor/memchr-2.7.5/src/memmem/searcher.rs.orig	2025-02-15 09:20:25.984377323 +0000
