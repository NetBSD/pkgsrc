# $NetBSD: cargo-depends.mk,v 1.5 2023/08/28 08:23:05 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cpp_demangle-0.4.2
...
CARGO_CRATE_DEPENDS+=	pprof-0.12.1
...
CARGO_CRATE_DEPENDS+=	symbolic-common-12.2.0
CARGO_CRATE_DEPENDS+=	symbolic-demangle-12.2.0
