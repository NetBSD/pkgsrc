# $NetBSD: cargo-depends.mk,v 1.1 2026/06/22 05:35:10 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	ashpd-0.13.11
...
CARGO_CRATE_DEPENDS+=	gettext-rs-0.7.7
CARGO_CRATE_DEPENDS+=	gettext-sys-0.26.0
CARGO_CRATE_DEPENDS+=	gio-0.22.6
CARGO_CRATE_DEPENDS+=	gio-sys-0.22.0
CARGO_CRATE_DEPENDS+=	git2-0.21.0
CARGO_CRATE_DEPENDS+=	glib-0.22.7
CARGO_CRATE_DEPENDS+=	glib-macros-0.22.6
CARGO_CRATE_DEPENDS+=	glib-sys-0.22.6
...
CARGO_CRATE_DEPENDS+=	gtk4-0.11.3
CARGO_CRATE_DEPENDS+=	gtk4-macros-0.11.0
CARGO_CRATE_DEPENDS+=	gtk4-sys-0.11.3
...
CARGO_CRATE_DEPENDS+=	libadwaita-0.9.1
CARGO_CRATE_DEPENDS+=	libadwaita-sys-0.9.1
...
CARGO_CRATE_DEPENDS+=	pango-0.22.6
...
CARGO_CRATE_DEPENDS+=	relm4-components-0.11.0
...
CARGO_CRATE_DEPENDS+=	tracker-0.2.2
CARGO_CRATE_DEPENDS+=	tracker-macros-0.2.2
