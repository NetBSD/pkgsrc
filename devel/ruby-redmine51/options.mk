# $NetBSD: options.mk,v 1.1 2023/11/29 16:10:19 taca Exp $
...
RCD_SCRIPTS+=	redmine51_unicorn${RUBY_SUFFIX}
RCD_SCRIPT_SRC.redmine51_unicorn${RUBY_SUFFIX}=	${FILESDIR}/redmine51_unicorn.sh
