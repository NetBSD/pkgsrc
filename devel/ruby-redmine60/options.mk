# $NetBSD: options.mk,v 1.3 2026/08/11 15:54:04 taca Exp $

PKG_OPTIONS_VAR=	PKG_OPTIONS.redmine60

PKG_OPTIONS_REQUIRED_GROUPS=	db
PKG_OPTIONS_GROUP.db=		mysql pgsql sqlite3 # mssql
...
DEPENDS+=	${RUBY_PKGPREFIX}-with_advisory_lock>=5.3.0:../../databases/ruby-with_advisory_lock
.elif !empty(PKG_OPTIONS:Mpgsql)
DEPENDS+=	${RUBY_PKGPREFIX}-pg>=1.5.3<2.0:../../databases/ruby-pg
.elif !empty(PKG_OPTIONS:Msqlite3)
DEPENDS+=	${RUBY_PKGPREFIX}-sqlite3>=1.7.0:../../databases/ruby-sqlite3
.endif
...
RCD_SCRIPTS+=	redmine60_unicorn${RUBY_SUFFIX}
RCD_SCRIPT_SRC.redmine60_unicorn${RUBY_SUFFIX}=	${FILESDIR}/redmine60_unicorn.sh
