# $NetBSD: cargo-depends.mk,v 1.14 2026/01/12 11:54:47 pin Exp $
...
CARGO_CRATE_DEPENDS+=	diesel-2.3.5
...
CARGO_CRATE_DEPENDS+=	rfd-0.17.1
...
CARGO_CRATE_DEPENDS+=	sqlite-wasm-rs-0.4.3
...
CARGO_CRATE_DEPENDS+=	wasm-array-cp-0.1.1
