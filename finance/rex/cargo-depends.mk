# $NetBSD: cargo-depends.mk,v 1.11 2025/10/12 12:28:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	zbus-5.11.0
CARGO_CRATE_DEPENDS+=	zbus_macros-5.11.0
...
CARGO_CRATE_DEPENDS+=	zvariant-5.7.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-5.7.0
