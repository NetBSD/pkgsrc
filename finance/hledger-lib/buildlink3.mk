# $NetBSD: buildlink3.mk,v 1.14 2023/11/02 06:37:06 pho Exp $
...
BUILDLINK_API_DEPENDS.hledger-lib+=	hledger-lib>=1.31
BUILDLINK_ABI_DEPENDS.hledger-lib+=	hledger-lib>=1.31nb1
