# $NetBSD: cargo-depends.mk,v 1.3 2022/09/14 08:39:01 adam Exp $
...
CARGO_CRATE_DEPENDS+=	peg-0.8.0
CARGO_CRATE_DEPENDS+=	peg-macros-0.8.0
CARGO_CRATE_DEPENDS+=	peg-runtime-0.8.0
...
CARGO_CRATE_DEPENDS+=	trybuild-1.0.63
