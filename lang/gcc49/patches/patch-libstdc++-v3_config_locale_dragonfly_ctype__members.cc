$NetBSD: patch-libstdc++-v3_config_locale_dragonfly_ctype__members.cc,v 1.1 2014/09/04 18:43:11 jperkin Exp $

Support DragonFly.

--- libstdc++-v3/config/locale/dragonfly/ctype_members.cc.orig	2014-09-04 10:04:50.938450582 +0000
