# $NetBSD: buildlink3.mk,v 1.76 2026/07/16 19:01:23 wiz Exp $
...
.endfor
# Prevent p5-* etc. packages built for 5.44.0 to be used
# with the next incompatible version of perl:
BUILDLINK_API_DEPENDS.perl+=	perl<5.45.0

BUILDLINK_ABI_DEPENDS.perl?=	perl>=5.44.0
