# $NetBSD: buildlink3.mk,v 1.6 2026/07/24 05:18:38 dkazankov Exp $
...
BUILDLINK_ABI_DEPENDS.gcc15-gnat+=	gcc15-gnat>=15.3.0
...
ADALIB_BASE=		lib/gcc/${MACHINE_GNU_PLATFORM}/15.3.0
