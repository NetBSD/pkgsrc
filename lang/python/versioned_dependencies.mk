# $NetBSD: versioned_dependencies.mk,v 1.106 2024/04/30 11:12:04 wiz Exp $
#
...
#
#       Possible values: OpenSSL Pillow cffi coverage cryptography dns pip setuptools setuptools_scm test
#       Default: (nothing)
#
