# $NetBSD: versioned_dependencies.mk,v 1.103 2024/04/30 09:28:37 wiz Exp $
#
...
#
#       Possible values: OpenSSL Pillow X cairo cffi coverage cryptography dns hypothesis pip setuptools setuptools_scm test
#       Default: (nothing)
#
