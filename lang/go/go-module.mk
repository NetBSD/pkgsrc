# $NetBSD: go-module.mk,v 1.28 2026/07/30 22:11:56 jperkin Exp $
#
...
ALL_ENV+=	GOMAXPROCS=${_MAKE_JOBS_N}
...
_DEF_VARS.go=		GO14_VERSION GO19_VERSION GO110_VERSION \
			GO111_VERSION INSTALLATION_DIRS _MAKE_JOBS_N \
			MAKE_JOBS_METHOD NOT_FOR_PLATFORM ONLY_FOR_PLATFORM \
			SSP_SUPPORTED WRKSRC
