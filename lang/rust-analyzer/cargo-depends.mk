...
CARGO_CRATE_DEPENDS+=	arbitrary-1.1.7
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.86.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.86.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.86.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.86.0
...
CARGO_CRATE_DEPENDS+=	derive_arbitrary-1.1.6
...
CARGO_CRATE_DEPENDS+=	mimalloc-0.1.30
...
CARGO_CRATE_DEPENDS+=	protobuf-3.1.0
CARGO_CRATE_DEPENDS+=	protobuf-support-3.1.0
...
CARGO_CRATE_DEPENDS+=	scip-0.1.1
...
CARGO_CRATE_DEPENDS+=	tikv-jemalloc-sys-0.5.2+5.3.0-patched
...
CARGO_CRATE_DEPENDS+=	xflags-0.3.0
CARGO_CRATE_DEPENDS+=	xflags-macros-0.3.0
