# $NetBSD: cargo-depends.mk,v 1.3 2022/01/22 22:44:43 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.75.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.75.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.75.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.75.0
...
CARGO_CRATE_DEPENDS+=	pulldown-cmark-to-cmark-7.1.1
