# $NetBSD: cargo-depends.mk,v 1.9 2022/04/15 17:39:42 adam Exp $
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.81.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.81.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.81.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.81.0
...
CARGO_CRATE_DEPENDS+=	notify-5.0.0-pre.14
