# $NetBSD: cargo-depends.mk,v 1.1 2021/11/28 14:07:31 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	arbitrary-1.0.2
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.73.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.73.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.73.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.73.0
...
CARGO_CRATE_DEPENDS+=	expect-test-1.2.0-pre.1
...
CARGO_CRATE_DEPENDS+=	pulldown-cmark-to-cmark-6.0.4
...
CARGO_CRATE_DEPENDS+=	tracing-tree-0.1.10
