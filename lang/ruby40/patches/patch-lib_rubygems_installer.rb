$NetBSD: patch-lib_rubygems_installer.rb,v 1.1 2026/02/03 16:00:34 taca Exp $

* Add install_root option for pkgsrc's rubygems support.
* Tweak build_info directory with destdir to store build_args.

--- lib/rubygems/installer.rb.orig	2025-12-25 03:20:40.000000000 +0000
+++ lib/rubygems/installer.rb
@@ -140,6 +140,9 @@ class Gem::Installer
   #                      foo_exec18.
...
@@ -637,12 +640,20 @@ class Gem::Installer
...
@@ -890,6 +901,9 @@ class Gem::Installer
