$NetBSD: patch-lib_rubygems.rb,v 1.1 2026/02/03 16:00:33 taca Exp $

* Add install_root option for pkgsrc's rubygems support.

--- lib/rubygems.rb.orig	2025-12-25 03:20:40.000000000 +0000
+++ lib/rubygems.rb
@@ -328,10 +328,16 @@ module Gem
   ##
...
+    install_dir
   ...
   ##
@@ -612,7 +618,7 @@ An Array (#{env.inspect}) was passed in 
...
@@ -812,6 +818,7 @@ An Array (#{env.inspect}) was passed in 
