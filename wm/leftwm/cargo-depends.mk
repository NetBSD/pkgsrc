# $NetBSD: cargo-depends.mk,v 1.7 2023/11/16 08:00:24 pin Exp $
...
CARGO_CRATE_DEPENDS+=	lefthk-core-0.2.0
CARGO_CRATE_DEPENDS+=	leftwm-layouts-0.8.4
...
CARGO_CRATE_DEPENDS+=	syslog-tracing-0.2.0
