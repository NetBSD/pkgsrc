# $NetBSD: cargo-depends.mk,v 1.3 2022/10/02 06:15:59 pin Exp $

CARGO_CRATE_DEPENDS+=	aho-corasick-0.7.19
CARGO_CRATE_DEPENDS+=	ansi_term-0.12.1
CARGO_CRATE_DEPENDS+=	anyhow-1.0.64
...
CARGO_CRATE_DEPENDS+=	liquid-core-0.24.1
...
CARGO_CRATE_DEPENDS+=	pest-2.3.0
CARGO_CRATE_DEPENDS+=	pest_derive-2.3.0
CARGO_CRATE_DEPENDS+=	pest_generator-2.3.0
CARGO_CRATE_DEPENDS+=	pest_meta-2.3.0
...
CARGO_CRATE_DEPENDS+=	thiserror-1.0.34
CARGO_CRATE_DEPENDS+=	thiserror-impl-1.0.34
CARGO_CRATE_DEPENDS+=	thread_local-1.1.4
CARGO_CRATE_DEPENDS+=	time-0.3.14
CARGO_CRATE_DEPENDS+=	time-macros-0.2.4
CARGO_CRATE_DEPENDS+=	tokio-1.21.0
