# $NetBSD: cargo-depends.mk,v 1.34 2023/09/03 14:37:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	jxl-frame-0.4.0
CARGO_CRATE_DEPENDS+=	jxl-grid-0.1.1
CARGO_CRATE_DEPENDS+=	jxl-image-0.4.1
CARGO_CRATE_DEPENDS+=	jxl-modular-0.2.2
CARGO_CRATE_DEPENDS+=	jxl-oxide-0.3.0
CARGO_CRATE_DEPENDS+=	jxl-render-0.3.0
CARGO_CRATE_DEPENDS+=	jxl-vardct-0.2.1
...
CARGO_CRATE_DEPENDS+=	libdav1d-sys-0.5.0
...
CARGO_CRATE_DEPENDS+=	libwebp-sys-0.9.2
...
CARGO_CRATE_DEPENDS+=	notan-0.9.5
CARGO_CRATE_DEPENDS+=	notan_app-0.9.5
CARGO_CRATE_DEPENDS+=	notan_backend-0.9.5
CARGO_CRATE_DEPENDS+=	notan_core-0.9.5
CARGO_CRATE_DEPENDS+=	notan_draw-0.9.5
CARGO_CRATE_DEPENDS+=	notan_egui-0.9.5
CARGO_CRATE_DEPENDS+=	notan_glow-0.9.5
CARGO_CRATE_DEPENDS+=	notan_glyph-0.9.5
CARGO_CRATE_DEPENDS+=	notan_graphics-0.9.5
CARGO_CRATE_DEPENDS+=	notan_input-0.9.5
CARGO_CRATE_DEPENDS+=	notan_macro-0.9.5
CARGO_CRATE_DEPENDS+=	notan_math-0.9.5
CARGO_CRATE_DEPENDS+=	notan_text-0.9.5
CARGO_CRATE_DEPENDS+=	notan_utils-0.9.5
CARGO_CRATE_DEPENDS+=	notan_web-0.9.5
CARGO_CRATE_DEPENDS+=	notan_winit-0.9.5
...
CARGO_CRATE_DEPENDS+=	num-derive-0.4.0
...
CARGO_CRATE_DEPENDS+=	ordered-float-3.9.1
...
CARGO_CRATE_DEPENDS+=	syn-2.0.30
