# $NetBSD: cargo-depends.mk,v 1.21 2023/02/13 10:30:51 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fast_image_resize-2.5.0
...
CARGO_CRATE_DEPENDS+=	glutin-0.30.5
...
CARGO_CRATE_DEPENDS+=	notan-0.9.2
CARGO_CRATE_DEPENDS+=	notan_app-0.9.2
CARGO_CRATE_DEPENDS+=	notan_backend-0.9.2
CARGO_CRATE_DEPENDS+=	notan_core-0.9.2
CARGO_CRATE_DEPENDS+=	notan_draw-0.9.2
CARGO_CRATE_DEPENDS+=	notan_egui-0.9.2
CARGO_CRATE_DEPENDS+=	notan_glow-0.9.2
CARGO_CRATE_DEPENDS+=	notan_glyph-0.9.2
CARGO_CRATE_DEPENDS+=	notan_graphics-0.9.2
CARGO_CRATE_DEPENDS+=	notan_input-0.9.2
CARGO_CRATE_DEPENDS+=	notan_macro-0.9.2
CARGO_CRATE_DEPENDS+=	notan_math-0.9.2
CARGO_CRATE_DEPENDS+=	notan_text-0.9.2
CARGO_CRATE_DEPENDS+=	notan_utils-0.9.2
CARGO_CRATE_DEPENDS+=	notan_web-0.9.2
CARGO_CRATE_DEPENDS+=	notan_winit-0.9.2
...
CARGO_CRATE_DEPENDS+=	rgb-0.8.35
...
CARGO_CRATE_DEPENDS+=	wide-0.7.6
...
CARGO_CRATE_DEPENDS+=	zune-inflate-0.2.42
