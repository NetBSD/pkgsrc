# $NetBSD: cargo-depends.mk,v 1.51 2024/04/30 03:20:57 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fixed-1.25.1
...
CARGO_CRATE_DEPENDS+=	imageproc-0.23.0
...
CARGO_CRATE_DEPENDS+=	nalgebra-0.30.1
CARGO_CRATE_DEPENDS+=	nalgebra-0.32.4
