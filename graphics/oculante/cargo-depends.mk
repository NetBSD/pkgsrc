# $NetBSD: cargo-depends.mk,v 1.14 2022/12/03 17:19:47 pin Exp $
...
CARGO_CRATE_DEPENDS+=	calloop-0.10.3
...
CARGO_CRATE_DEPENDS+=	gif-dispose-3.1.1
...
CARGO_CRATE_DEPENDS+=	lyon_geom-1.0.3
CARGO_CRATE_DEPENDS+=	lyon_path-1.0.2
CARGO_CRATE_DEPENDS+=	lyon_tessellation-1.0.6
...
CARGO_CRATE_DEPENDS+=	portable-atomic-0.3.15
...
CARGO_CRATE_DEPENDS+=	resvg-0.25.0
...
CARGO_CRATE_DEPENDS+=	tiff-0.8.0
...
CARGO_CRATE_DEPENDS+=	usvg-0.25.0
