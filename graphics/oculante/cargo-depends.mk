# $NetBSD: cargo-depends.mk,v 1.37 2023/10/09 08:09:28 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.22
...
CARGO_CRATE_DEPENDS+=	aom-decode-0.2.6
...
CARGO_CRATE_DEPENDS+=	async-signal-0.2.3
...
CARGO_CRATE_DEPENDS+=	atomic_refcell-0.1.12
...
CARGO_CRATE_DEPENDS+=	bitstream-io-1.7.0
...
CARGO_CRATE_DEPENDS+=	ecolor-0.22.0
CARGO_CRATE_DEPENDS+=	egui-0.22.0
CARGO_CRATE_DEPENDS+=	either-1.9.0
CARGO_CRATE_DEPENDS+=	emath-0.22.0
...
CARGO_CRATE_DEPENDS+=	epaint-0.22.0
...
CARGO_CRATE_DEPENDS+=	evalexpr-11.1.0
...
CARGO_CRATE_DEPENDS+=	libaom-sys-0.14.0
CARGO_CRATE_DEPENDS+=	libavif-0.11.0
CARGO_CRATE_DEPENDS+=	libavif-image-0.10.0
CARGO_CRATE_DEPENDS+=	libavif-sys-0.14.3
CARGO_CRATE_DEPENDS+=	libc-0.2.149
CARGO_CRATE_DEPENDS+=	libdav1d-sys-0.5.2
...
CARGO_CRATE_DEPENDS+=	linux-raw-sys-0.4.9
...
CARGO_CRATE_DEPENDS+=	notan-0.10.0
CARGO_CRATE_DEPENDS+=	notan_app-0.10.0
CARGO_CRATE_DEPENDS+=	notan_backend-0.10.0
CARGO_CRATE_DEPENDS+=	notan_core-0.10.0
CARGO_CRATE_DEPENDS+=	notan_draw-0.10.0
CARGO_CRATE_DEPENDS+=	notan_egui-0.10.0
CARGO_CRATE_DEPENDS+=	notan_glow-0.10.0
CARGO_CRATE_DEPENDS+=	notan_glyph-0.10.0
CARGO_CRATE_DEPENDS+=	notan_graphics-0.10.0
CARGO_CRATE_DEPENDS+=	notan_input-0.10.0
CARGO_CRATE_DEPENDS+=	notan_macro-0.10.0
CARGO_CRATE_DEPENDS+=	notan_math-0.10.0
CARGO_CRATE_DEPENDS+=	notan_text-0.10.0
CARGO_CRATE_DEPENDS+=	notan_utils-0.10.0
CARGO_CRATE_DEPENDS+=	notan_web-0.10.0
CARGO_CRATE_DEPENDS+=	notan_winit-0.10.0
...
CARGO_CRATE_DEPENDS+=	ordered-float-4.1.0
...
CARGO_CRATE_DEPENDS+=	proc-macro2-1.0.68
...
CARGO_CRATE_DEPENDS+=	rfd-0.12.0
...
CARGO_CRATE_DEPENDS+=	rustix-0.38.17
...
CARGO_CRATE_DEPENDS+=	wide-0.7.12
...
CARGO_CRATE_DEPENDS+=	zune-core-0.2.14
CARGO_CRATE_DEPENDS+=	zune-inflate-0.2.54
CARGO_CRATE_DEPENDS+=	zune-png-0.2.1
