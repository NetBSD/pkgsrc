...
CARGO_CRATE_DEPENDS+=	notan-0.7.0
CARGO_CRATE_DEPENDS+=	notan_app-0.7.0
CARGO_CRATE_DEPENDS+=	notan_backend-0.7.0
CARGO_CRATE_DEPENDS+=	notan_core-0.7.0
CARGO_CRATE_DEPENDS+=	notan_draw-0.7.0
CARGO_CRATE_DEPENDS+=	notan_egui-0.7.0
CARGO_CRATE_DEPENDS+=	notan_glow-0.7.0
CARGO_CRATE_DEPENDS+=	notan_glyph-0.7.0
CARGO_CRATE_DEPENDS+=	notan_graphics-0.7.0
CARGO_CRATE_DEPENDS+=	notan_input-0.7.0
CARGO_CRATE_DEPENDS+=	notan_log-0.7.0
CARGO_CRATE_DEPENDS+=	notan_macro-0.7.0
CARGO_CRATE_DEPENDS+=	notan_math-0.7.0
CARGO_CRATE_DEPENDS+=	notan_random-0.7.0
CARGO_CRATE_DEPENDS+=	notan_text-0.7.0
CARGO_CRATE_DEPENDS+=	notan_utils-0.7.0
CARGO_CRATE_DEPENDS+=	notan_web-0.7.0
CARGO_CRATE_DEPENDS+=	notan_winit-0.7.0
