# $NetBSD: cargo-depends.mk,v 1.24 2023/03/29 19:26:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fast_image_resize-2.7.0
...
CARGO_CRATE_DEPENDS+=   jpegxl-rs-0.8.1+libjxl-0.8.1
SITES.jpegxl-rs-0.8.1+libjxl-0.8.1.crate+= ${MASTER_SITE_CRATESIO:S,^,-,:=jpegxl-rs/0.8.1+libjxl-0.8.1/download}
CARGO_CRATE_DEPENDS+=	jpegxl-src-0.8.1
CARGO_CRATE_DEPENDS+=	jpegxl-sys-0.8.1+libjxl-0.8.1
SITES.jpegxl-sys-0.8.1+libjxl-0.8.1.crate+= ${MASTER_SITE_CRATESIO:S,^,-,:=jpegxl-sys/0.8.1+libjxl-0.8.1/download}
...
CARGO_CRATE_DEPENDS+=	libavif-sys-0.14.1
...
CARGO_CRATE_DEPENDS+=	libwebp-sys-0.9.0
...
CARGO_CRATE_DEPENDS+=	notan-0.9.4
CARGO_CRATE_DEPENDS+=	notan_app-0.9.4
CARGO_CRATE_DEPENDS+=	notan_backend-0.9.4
CARGO_CRATE_DEPENDS+=	notan_core-0.9.4
CARGO_CRATE_DEPENDS+=	notan_draw-0.9.4
CARGO_CRATE_DEPENDS+=	notan_egui-0.9.4
CARGO_CRATE_DEPENDS+=	notan_glow-0.9.4
CARGO_CRATE_DEPENDS+=	notan_glyph-0.9.4
CARGO_CRATE_DEPENDS+=	notan_graphics-0.9.4
CARGO_CRATE_DEPENDS+=	notan_input-0.9.4
CARGO_CRATE_DEPENDS+=	notan_macro-0.9.4
CARGO_CRATE_DEPENDS+=	notan_math-0.9.4
CARGO_CRATE_DEPENDS+=	notan_text-0.9.4
CARGO_CRATE_DEPENDS+=	notan_utils-0.9.4
CARGO_CRATE_DEPENDS+=	notan_web-0.9.4
CARGO_CRATE_DEPENDS+=	notan_winit-0.9.4
...
CARGO_CRATE_DEPENDS+=	rav1e-0.6.3
...
CARGO_CRATE_DEPENDS+=	resvg-0.30.0
CARGO_CRATE_DEPENDS+=	rfd-0.11.3
CARGO_CRATE_DEPENDS+=	rgb-0.8.36
CARGO_CRATE_DEPENDS+=	ring-0.16.20
CARGO_CRATE_DEPENDS+=	rosvgtree-0.2.0
...
CARGO_CRATE_DEPENDS+=	self_update-0.36.0
...
CARGO_CRATE_DEPENDS+=	simba-0.8.0
...
CARGO_CRATE_DEPENDS+=	usvg-0.30.0
CARGO_CRATE_DEPENDS+=	usvg-parser-0.30.0
CARGO_CRATE_DEPENDS+=	usvg-text-layout-0.30.0
CARGO_CRATE_DEPENDS+=	usvg-tree-0.30.0
