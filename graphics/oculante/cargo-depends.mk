# $NetBSD: cargo-depends.mk,v 1.11 2022/10/28 07:47:03 pin Exp $
...
CARGO_CRATE_DEPENDS+=	arboard-3.1.1
...
CARGO_CRATE_DEPENDS+=	fontdb-0.9.2
...
CARGO_CRATE_DEPENDS+=	lyon-1.0.0
CARGO_CRATE_DEPENDS+=	lyon_algorithms-1.0.1
CARGO_CRATE_DEPENDS+=	lyon_geom-1.0.1
CARGO_CRATE_DEPENDS+=	lyon_path-1.0.1
CARGO_CRATE_DEPENDS+=	lyon_tessellation-1.0.4
...
CARGO_CRATE_DEPENDS+=	nalgebra-0.31.2
...
CARGO_CRATE_DEPENDS+=	owned_ttf_parser-0.17.0
...
CARGO_CRATE_DEPENDS+=	rustybuzz-0.5.3
...
CARGO_CRATE_DEPENDS+=	simba-0.7.2
...
CARGO_CRATE_DEPENDS+=	winit-0.27.4
