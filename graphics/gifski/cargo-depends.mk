# $NetBSD: cargo-depends.mk,v 1.12 2025/07/23 10:21:22 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	gif-dispose-5.0.1
CARGO_CRATE_DEPENDS+=	glob-0.3.2
CARGO_CRATE_DEPENDS+=	hermit-abi-0.5.2
CARGO_CRATE_DEPENDS+=	imagequant-4.4.1
...
CARGO_CRATE_DEPENDS+=	ordered-channel-1.2.0
...
CARGO_CRATE_DEPENDS+=	resize-0.8.8
