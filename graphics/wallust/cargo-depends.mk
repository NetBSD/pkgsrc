# $NetBSD: cargo-depends.mk,v 1.18 2024/08/07 06:42:48 pin Exp $
...
CARGO_CRATE_DEPENDS+=	documented-0.5.0
CARGO_CRATE_DEPENDS+=	documented-derive-0.5.0
...
CARGO_CRATE_DEPENDS+=	fast_image_resize-4.2.1
...
CARGO_CRATE_DEPENDS+=	minijinja-2.1.1
...
CARGO_CRATE_DEPENDS+=	new_string_template-1.5.3
...
CARGO_CRATE_DEPENDS+=	ravif-0.11.9
...
CARGO_CRATE_DEPENDS+=	vergen-9.0.0
CARGO_CRATE_DEPENDS+=	vergen-git2-1.0.0
CARGO_CRATE_DEPENDS+=	vergen-lib-0.1.3
