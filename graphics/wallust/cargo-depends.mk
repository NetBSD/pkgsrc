# $NetBSD: cargo-depends.mk,v 1.21 2025/03/30 16:57:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	avif-serialize-0.8.3
...
CARGO_CRATE_DEPENDS+=	documented-0.9.1
CARGO_CRATE_DEPENDS+=	documented-macros-0.9.1
...
CARGO_CRATE_DEPENDS+=	fast_image_resize-5.1.2
...
CARGO_CRATE_DEPENDS+=	minijinja-2.8.0
...
CARGO_CRATE_DEPENDS+=	optfield-0.3.0
...
CARGO_CRATE_DEPENDS+=	time-macros-0.2.21
...
CARGO_CRATE_DEPENDS+=	vergen-git2-1.0.5
