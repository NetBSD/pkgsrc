# $NetBSD: cargo-depends.mk,v 1.1 2022/09/17 15:54:23 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.17
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.6
...
CARGO_CRATE_DEPENDS+=	webp-animation-0.6.0
...
CARGO_CRATE_DEPENDS+=	winit-0.27.2
