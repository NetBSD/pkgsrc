# $NetBSD: cargo-depends.mk,v 1.2 2022/10/09 19:20:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	arboard-3.1.0
...
CARGO_CRATE_DEPENDS+=	confy-0.5.0
...
CARGO_CRATE_DEPENDS+=	cxx-1.0.78
CARGO_CRATE_DEPENDS+=	cxx-build-1.0.78
CARGO_CRATE_DEPENDS+=	cxxbridge-flags-1.0.78
CARGO_CRATE_DEPENDS+=	cxxbridge-macro-1.0.78
...
CARGO_CRATE_DEPENDS+=	egui-winit-0.19.0
CARGO_CRATE_DEPENDS+=	egui_glium-0.19.0
CARGO_CRATE_DEPENDS+=	either-1.8.0
CARGO_CRATE_DEPENDS+=	emath-0.19.0
CARGO_CRATE_DEPENDS+=	enumn-0.1.5
...
CARGO_CRATE_DEPENDS+=	fallible_collections-0.4.5
...
CARGO_CRATE_DEPENDS+=	iana-time-zone-haiku-0.1.0
...
CARGO_CRATE_DEPENDS+=	libwebp-sys2-0.1.2
...
CARGO_CRATE_DEPENDS+=	mp4parse-0.12.0
...
CARGO_CRATE_DEPENDS+=	sctk-adwaita-0.4.2
...
CARGO_CRATE_DEPENDS+=	svgtypes-0.8.1
...
CARGO_CRATE_DEPENDS+=	webbrowser-0.8.0
CARGO_CRATE_DEPENDS+=	webp-animation-0.7.0
...
CARGO_CRATE_DEPENDS+=	winit-0.27.3
