# $NetBSD: cargo-depends.mk,v 1.12 2024/06/20 09:03:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=				async-process-2.2.3
...
CARGO_CRATE_DEPENDS+=				clap_mangen-0.2.21
...
CARGO_CRATE_DEPENDS+=				jpegxl-rs-0.10.3+libjxl-0.10.2
SITES.jpegxl-rs-0.10.3+libjxl-0.10.2.crate=	https://static.crates.io/crates/jpegxl-rs/
CARGO_CRATE_DEPENDS+=				jpegxl-src-0.10.4
CARGO_CRATE_DEPENDS+=				jpegxl-sys-0.10.3+libjxl-0.10.2
SITES.jpegxl-sys-0.10.3+libjxl-0.10.2.crate=	https://static.crates.io/crates/jpegxl-sys/
...
CARGO_CRATE_DEPENDS+=				libheif-rs-1.0.2
...
CARGO_CRATE_DEPENDS+=				polling-3.7.1
...
CARGO_CRATE_DEPENDS+=				resvg-0.41.0
...
CARGO_CRATE_DEPENDS+=				rustybuzz-0.13.0
...
CARGO_CRATE_DEPENDS+=				trash-4.1.1
...
CARGO_CRATE_DEPENDS+=				usvg-0.41.0
...
CARGO_CRATE_DEPENDS+=				xdg-home-1.2.0
