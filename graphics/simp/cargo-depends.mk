# $NetBSD: cargo-depends.mk,v 1.22 2026/09/12 17:41:29 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.32
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.10
CARGO_CRATE_DEPENDS+=	accesskit-0.24.1
...
CARGO_CRATE_DEPENDS+=	bit-set-0.10.0
...
CARGO_CRATE_DEPENDS+=	cfg-expr-0.20.9
...
CARGO_CRATE_DEPENDS+=	crevice-0.18.0
CARGO_CRATE_DEPENDS+=	crevice-derive-0.18.0
...
CARGO_CRATE_DEPENDS+=	ecolor-0.36.1
CARGO_CRATE_DEPENDS+=	egui-0.36.1
CARGO_CRATE_DEPENDS+=	egui-wgpu-0.36.1
CARGO_CRATE_DEPENDS+=	egui-winit-0.36.1
CARGO_CRATE_DEPENDS+=	either-1.18.0
CARGO_CRATE_DEPENDS+=	emath-0.36.1
CARGO_CRATE_DEPENDS+=	enumn-0.1.14
CARGO_CRATE_DEPENDS+=	epaint-0.36.1
CARGO_CRATE_DEPENDS+=	epaint_default_fonts-0.36.1
...
CARGO_CRATE_DEPENDS+=	fearless_simd-0.4.1
...
CARGO_CRATE_DEPENDS+=	font-types-0.12.4
CARGO_CRATE_DEPENDS+=	fontconfig-parser-0.5.8
CARGO_CRATE_DEPENDS+=	fontdb-0.24.0
...
CARGO_CRATE_DEPENDS+=	four-cc-0.4.0
...
CARGO_CRATE_DEPENDS+=	glifo-0.2.0
...
CARGO_CRATE_DEPENDS+=	harfrust-0.12.0
...
CARGO_CRATE_DEPENDS+=	imagepipe-0.5.1
CARGO_CRATE_DEPENDS+=	imagesize-0.15.0
...
CARGO_CRATE_DEPENDS+=	jpegxl-rs-0.11.2+libjxl-0.11.1
CARGO_CRATE_DEPENDS+=	jpegxl-src-0.11.4
CARGO_CRATE_DEPENDS+=	jpegxl-sys-0.11.2+libjxl-0.11.1
...
CARGO_CRATE_DEPENDS+=	libheif-rs-3.0.0
CARGO_CRATE_DEPENDS+=	libheif-sys-5.3.1+1.23.1
...
CARGO_CRATE_DEPENDS+=	libwebp-sys2-0.1.11
...
CARGO_CRATE_DEPENDS+=	naga-30.0.1
CARGO_CRATE_DEPENDS+=	naga-types-30.0.1
...
CARGO_CRATE_DEPENDS+=	orbclient-0.3.55
...
CARGO_CRATE_DEPENDS+=	system-deps-8.0.0
...
CARGO_CRATE_DEPENDS+=	usvg-0.48.1
CARGO_CRATE_DEPENDS+=	utf8_iter-1.0.4
CARGO_CRATE_DEPENDS+=	uuid-1.25.0
CARGO_CRATE_DEPENDS+=	v_frame-0.3.9
CARGO_CRATE_DEPENDS+=	vcpkg-0.2.15
CARGO_CRATE_DEPENDS+=	vello_common-0.1.0
CARGO_CRATE_DEPENDS+=	vello_cpu-0.1.0
...
CARGO_CRATE_DEPENDS+=	wgpu-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-core-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-core-deps-apple-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-core-deps-emscripten-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-core-deps-wasm-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-core-deps-windows-linux-android-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-hal-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-naga-bridge-30.0.1
CARGO_CRATE_DEPENDS+=	wgpu-types-30.0.1
