# $NetBSD: cargo-depends.mk,v 1.3 2023/01/23 21:14:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cxx-1.0.84
CARGO_CRATE_DEPENDS+=	cxx-build-1.0.84
CARGO_CRATE_DEPENDS+=	cxxbridge-flags-1.0.84
CARGO_CRATE_DEPENDS+=	cxxbridge-macro-1.0.84
...
CARGO_CRATE_DEPENDS+=	enumn-0.1.6
...
CARGO_CRATE_DEPENDS+=	proc-macro2-1.0.48
CARGO_CRATE_DEPENDS+=	psd-0.3.4
CARGO_CRATE_DEPENDS+=	quote-1.0.22
...
CARGO_CRATE_DEPENDS+=	semver-1.0.15
...
CARGO_CRATE_DEPENDS+=	syn-1.0.106
