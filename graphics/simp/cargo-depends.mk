# $NetBSD: cargo-depends.mk,v 1.13 2024/10/13 20:22:52 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ashpd-0.9.1
...
CARGO_CRATE_DEPENDS+=	av-data-0.4.3
...
CARGO_CRATE_DEPENDS+=	blake3-1.5.4
...
CARGO_CRATE_DEPENDS+=	crevice-0.16.0
...
CARGO_CRATE_DEPENDS+=	derive_builder-0.20.1
CARGO_CRATE_DEPENDS+=	derive_builder_core-0.20.1
CARGO_CRATE_DEPENDS+=	derive_builder_macro-0.20.1
...
CARGO_CRATE_DEPENDS+=	ecolor-0.29.0
CARGO_CRATE_DEPENDS+=	egui-0.29.0
CARGO_CRATE_DEPENDS+=	egui-wgpu-0.29.0
CARGO_CRATE_DEPENDS+=	egui-winit-0.29.0
CARGO_CRATE_DEPENDS+=	either-1.13.0
CARGO_CRATE_DEPENDS+=	emath-0.29.0
...
CARGO_CRATE_DEPENDS+=	epaint-0.29.0
CARGO_CRATE_DEPENDS+=	epaint_default_fonts-0.29.0
...
CARGO_CRATE_DEPENDS+=	jpegxl-rs-0.11.0+libjxl-0.11.0
SITES.jpegxl-rs-0.11.0+libjxl-0.11.0.crate=     https://static.crates.io/crates/jpegxl-rs/
CARGO_CRATE_DEPENDS+=	jpegxl-src-0.11.1
CARGO_CRATE_DEPENDS+=	jpegxl-sys-0.11.0+libjxl-0.11.0
SITES.jpegxl-sys-0.11.0+libjxl-0.11.0.crate=    https://static.crates.io/crates/jpegxl-sys/
...
CARGO_CRATE_DEPENDS+=	rexif-0.7.4
...
CARGO_CRATE_DEPENDS+=	trash-5.1.1
