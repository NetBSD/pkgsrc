# $NetBSD: buildlink3.mk,v 1.38 2026/02/07 08:41:19 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.3.5
BUILDLINK_ABI_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.3.5
