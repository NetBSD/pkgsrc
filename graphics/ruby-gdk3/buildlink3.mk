# $NetBSD: buildlink3.mk,v 1.12 2023/05/13 02:44:05 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.1.5
BUILDLINK_ABI_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.1.5
