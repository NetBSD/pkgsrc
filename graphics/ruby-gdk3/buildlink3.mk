# $NetBSD: buildlink3.mk,v 1.13 2023/06/02 16:43:29 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.1.7
BUILDLINK_ABI_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.1.7
