# $NetBSD: buildlink3.mk,v 1.30 2025/05/31 20:18:17 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.2.9
BUILDLINK_ABI_DEPENDS.ruby-gdk3+=	${RUBY_PKGPREFIX}-gdk3>=4.2.9
