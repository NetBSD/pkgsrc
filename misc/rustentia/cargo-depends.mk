# $NetBSD: cargo-depends.mk,v 1.1 2023/05/07 06:49:03 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.21
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.8
CARGO_CRATE_DEPENDS+=	accesskit-0.9.0
CARGO_CRATE_DEPENDS+=	accesskit_consumer-0.13.0
CARGO_CRATE_DEPENDS+=	accesskit_macos-0.5.0
CARGO_CRATE_DEPENDS+=	accesskit_unix-0.2.0
CARGO_CRATE_DEPENDS+=	accesskit_windows-0.12.0
CARGO_CRATE_DEPENDS+=	accesskit_winit-0.10.0
...
CARGO_CRATE_DEPENDS+=	atspi-0.8.7
CARGO_CRATE_DEPENDS+=	atspi-macros-0.1.4
...
CARGO_CRATE_DEPENDS+=	ecolor-0.21.0
CARGO_CRATE_DEPENDS+=	eframe-0.21.3
CARGO_CRATE_DEPENDS+=	egui-0.21.0
CARGO_CRATE_DEPENDS+=	egui-notify-0.6.0
CARGO_CRATE_DEPENDS+=	egui-winit-0.21.1
CARGO_CRATE_DEPENDS+=	egui_glow-0.21.0
CARGO_CRATE_DEPENDS+=	emath-0.21.0
CARGO_CRATE_DEPENDS+=	enumflags2-0.7.7
CARGO_CRATE_DEPENDS+=	enumflags2_derive-0.7.7
CARGO_CRATE_DEPENDS+=	env_logger-0.10.0
CARGO_CRATE_DEPENDS+=	epaint-0.21.0
...
CARGO_CRATE_DEPENDS+=	webbrowser-0.8.9
...
CARGO_CRATE_DEPENDS+=	windows-implement-0.42.0
...
CARGO_CRATE_DEPENDS+=	zbus-3.12.0
CARGO_CRATE_DEPENDS+=	zbus_macros-3.12.0
