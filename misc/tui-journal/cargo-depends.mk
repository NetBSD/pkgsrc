# $NetBSD: cargo-depends.mk,v 1.30 2025/04/11 12:21:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	sqlx-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-core-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-macros-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-macros-core-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-mysql-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-postgres-0.8.3
CARGO_CRATE_DEPENDS+=	sqlx-sqlite-0.8.3
