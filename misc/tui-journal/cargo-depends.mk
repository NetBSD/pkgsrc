# $NetBSD: cargo-depends.mk,v 1.22 2024/07/23 08:08:41 pin Exp $
...
CARGO_CRATE_DEPENDS+=	sqlformat-0.2.4
...
CARGO_CRATE_DEPENDS+=	tui-textarea-0.5.1
...
CARGO_CRATE_DEPENDS+=	wayland-backend-0.3.5
CARGO_CRATE_DEPENDS+=	wayland-client-0.31.4
CARGO_CRATE_DEPENDS+=	wayland-protocols-0.31.2
CARGO_CRATE_DEPENDS+=	wayland-protocols-wlr-0.2.0
CARGO_CRATE_DEPENDS+=	wayland-scanner-0.31.3
CARGO_CRATE_DEPENDS+=	wayland-sys-0.31.3
