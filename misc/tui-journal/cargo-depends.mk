# $NetBSD: cargo-depends.mk,v 1.13 2023/12/17 07:05:13 pin Exp $
...
CARGO_CRATE_DEPENDS+=	atomic-write-file-0.1.2
...
CARGO_CRATE_DEPENDS+=	sqlx-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-core-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-macros-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-macros-core-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-mysql-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-postgres-0.7.3
CARGO_CRATE_DEPENDS+=	sqlx-sqlite-0.7.3
