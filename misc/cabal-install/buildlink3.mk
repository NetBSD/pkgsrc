# $NetBSD: buildlink3.mk,v 1.10 2025/08/13 11:07:16 pho Exp $
...
BUILDLINK_API_DEPENDS.cabal-install+=	cabal-install>=3.12.1
BUILDLINK_ABI_DEPENDS.cabal-install+=	cabal-install>=3.12.1.0nb3
