# $NetBSD: cargo-depends.mk,v 1.8 2022/11/02 21:04:34 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cmark-syntax-0.3.1
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.9.0
...
CARGO_CRATE_DEPENDS+=	webbrowser-0.8.1
