# $NetBSD: cargo-depends.mk,v 1.20 2022/12/29 08:04:40 pin Exp $
...
CARGO_CRATE_DEPENDS+=	pest-2.5.2
CARGO_CRATE_DEPENDS+=	pest_derive-2.5.2
CARGO_CRATE_DEPENDS+=	pest_generator-2.5.2
CARGO_CRATE_DEPENDS+=	pest_meta-2.5.2
