# $NetBSD: cargo-depends.mk,v 1.30 2023/06/20 18:55:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	compact_str-0.7.0
...
CARGO_CRATE_DEPENDS+=	pest-2.6.1
CARGO_CRATE_DEPENDS+=	pest_derive-2.6.1
CARGO_CRATE_DEPENDS+=	pest_generator-2.6.1
CARGO_CRATE_DEPENDS+=	pest_meta-2.6.1
...
CARGO_CRATE_DEPENDS+=	tauri-winrt-notification-0.1.1
...
CARGO_CRATE_DEPENDS+=	tracing-attributes-0.1.25
...
CARGO_CRATE_DEPENDS+=	zvariant-3.13.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-3.13.0
