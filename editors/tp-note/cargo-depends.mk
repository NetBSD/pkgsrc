# $NetBSD: cargo-depends.mk,v 1.77 2025/06/23 08:30:54 pin Exp $
...
CARGO_CRATE_DEPENDS+=	tpnote-html2md-0.3.0
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.44.1
...
CARGO_CRATE_DEPENDS+=	web_atoms-0.1.2
