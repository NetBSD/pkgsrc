# $NetBSD: cargo-depends.mk,v 1.53 2023/11/17 07:44:56 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fraction-0.14.0
...
CARGO_CRATE_DEPENDS+=	lingua-1.6.0
...
CARGO_CRATE_DEPENDS+=	self_cell-1.0.2
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.30.6
