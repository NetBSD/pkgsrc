# $NetBSD: cargo-depends.mk,v 1.42 2023/09/29 19:09:14 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-process-1.8.0
CARGO_CRATE_DEPENDS+=	async-recursion-1.0.5
CARGO_CRATE_DEPENDS+=	async-signal-0.2.2
...
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-0.24.1
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-extras-0.24.1
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.25.0
