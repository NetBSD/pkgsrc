# $NetBSD: cargo-depends.mk,v 1.81 2025/10/27 12:09:14 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clipboard-rs-0.3.0
...
CARGO_CRATE_DEPENDS+=	moxcms-0.7.7
...
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-0.29.0
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-extras-0.29.0
...
CARGO_CRATE_DEPENDS+=	tpnote-html2md-0.3.3
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.45.4
...
CARGO_CRATE_DEPENDS+=	winresource-0.1.23
