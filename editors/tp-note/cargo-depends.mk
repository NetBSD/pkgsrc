# $NetBSD: cargo-depends.mk,v 1.48 2023/10/31 18:36:31 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-io-2.1.0
...
CARGO_CRATE_DEPENDS+=	const-random-0.1.16
...
CARGO_CRATE_DEPENDS+=	deunicode-0.4.5
...
CARGO_CRATE_DEPENDS+=	system-deps-6.1.2
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.28.5
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.7.18
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.7.18
