# $NetBSD: cargo-depends.mk,v 1.56 2024/02/12 14:17:38 pin Exp $
...
CARGO_CRATE_DEPENDS+=	event-listener-5.0.0
...
CARGO_CRATE_DEPENDS+=	polling-3.4.0
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.30.8
