# $NetBSD: cargo-depends.mk,v 1.83 2026/03/26 19:41:01 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clipboard-rs-0.3.3
...
CARGO_CRATE_DEPENDS+=	counter-0.7.0
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.25.5+spec-1.1.0
CARGO_CRATE_DEPENDS+=	toml_parser-1.0.10+spec-1.1.0
CARGO_CRATE_DEPENDS+=	toml_writer-1.0.7+spec-1.1.0
CARGO_CRATE_DEPENDS+=	tpnote-html2md-0.3.5
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.45.8
