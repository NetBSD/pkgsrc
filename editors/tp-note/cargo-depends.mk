# $NetBSD: cargo-depends.mk,v 1.34 2023/08/18 10:47:17 pin Exp $
...
CARGO_CRATE_DEPENDS+=	mac-notification-sys-0.5.9
...
CARGO_CRATE_DEPENDS+=	notify-debouncer-mini-0.3.0
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.22.2
...
CARGO_CRATE_DEPENDS+=	winresource-0.1.16
