# $NetBSD: cargo-depends.mk,v 1.44 2023/10/12 10:49:02 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-signal-0.2.4
...
CARGO_CRATE_DEPENDS+=	event-listener-3.0.0
...
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-0.26.2
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-extras-0.26.2
CARGO_CRATE_DEPENDS+=	parse-zoneinfo-0.3.0
CARGO_CRATE_DEPENDS+=	percent-encoding-2.3.0
CARGO_CRATE_DEPENDS+=	pest-2.7.4
CARGO_CRATE_DEPENDS+=	pest_derive-2.7.4
CARGO_CRATE_DEPENDS+=	pest_generator-2.7.4
CARGO_CRATE_DEPENDS+=	pest_meta-2.7.4
...
CARGO_CRATE_DEPENDS+=	regex-1.10.0
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.27.0
