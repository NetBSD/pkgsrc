# $NetBSD: cargo-depends.mk,v 1.43 2023/10/01 18:48:11 pin Exp $
...
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-0.24.2
CARGO_CRATE_DEPENDS+=	parse-hyperlinks-extras-0.24.2
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.26.0
