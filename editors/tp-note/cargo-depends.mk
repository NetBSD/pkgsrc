# $NetBSD: cargo-depends.mk,v 1.25 2023/05/05 22:02:07 pin Exp $
...
CARGO_CRATE_DEPENDS+=	system-deps-6.0.5
...
CARGO_CRATE_DEPENDS+=	tpnote-lib-0.18.3
...
CARGO_CRATE_DEPENDS+=	xml-rs-0.8.5
