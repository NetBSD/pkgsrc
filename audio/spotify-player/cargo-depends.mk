# $NetBSD: cargo-depends.mk,v 1.18 2023/02/21 13:14:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	libmdns-0.7.4
...
CARGO_CRATE_DEPENDS+=	memmap2-0.5.9
...
CARGO_CRATE_DEPENDS+=	notify-rust-4.7.1
...
CARGO_CRATE_DEPENDS+=	num_enum-0.5.10
CARGO_CRATE_DEPENDS+=	num_enum_derive-0.5.10
...
CARGO_CRATE_DEPENDS+=	orbclient-0.3.42
...
CARGO_CRATE_DEPENDS+=	redox_syscall-0.3.4
...
CARGO_CRATE_DEPENDS+=	time-0.3.19
...
CARGO_CRATE_DEPENDS+=	winit-0.28.1
