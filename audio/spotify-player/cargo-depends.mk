# $NetBSD: cargo-depends.mk,v 1.43 2025/07/28 11:00:14 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.31
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.9
...
CARGO_CRATE_DEPENDS+=	cfg-expr-0.20.1
...
CARGO_CRATE_DEPENDS+=	gstreamer-0.23.7
CARGO_CRATE_DEPENDS+=	gstreamer-app-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-app-sys-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-audio-0.23.6
CARGO_CRATE_DEPENDS+=	gstreamer-audio-sys-0.23.6
CARGO_CRATE_DEPENDS+=	gstreamer-base-0.23.6
CARGO_CRATE_DEPENDS+=	gstreamer-base-sys-0.23.6
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.23.6
...
CARGO_CRATE_DEPENDS+=	redox_syscall-0.5.16
...
CARGO_CRATE_DEPENDS+=	rspotify-0.15.0
CARGO_CRATE_DEPENDS+=	rspotify-http-0.15.0
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.15.0
CARGO_CRATE_DEPENDS+=	rspotify-model-0.15.0
