# $NetBSD: cargo-depends.mk,v 1.50 2026/08/03 14:08:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	rspotify-0.15.3
CARGO_CRATE_DEPENDS+=	rspotify-http-0.15.3
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.15.3
CARGO_CRATE_DEPENDS+=	rspotify-model-0.15.3
...
CARGO_CRATE_DEPENDS+=	tokio-1.53.0
