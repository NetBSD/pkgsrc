# $NetBSD: cargo-depends.mk,v 1.51 2026/09/09 06:53:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	atomic_refcell-0.1.14
...
CARGO_CRATE_DEPENDS+=	config_parser2-0.1.7
...
CARGO_CRATE_DEPENDS+=	dbus-0.9.12
CARGO_CRATE_DEPENDS+=	dbus-crossroads-0.5.3
...
CARGO_CRATE_DEPENDS+=	encoding_rs-0.8.40
...
CARGO_CRATE_DEPENDS+=	gio-sys-0.21.5
CARGO_CRATE_DEPENDS+=	glib-0.21.5
CARGO_CRATE_DEPENDS+=	glib-macros-0.21.5
CARGO_CRATE_DEPENDS+=	glib-sys-0.21.5
CARGO_CRATE_DEPENDS+=	gobject-sys-0.21.5
CARGO_CRATE_DEPENDS+=	governor-0.10.4
CARGO_CRATE_DEPENDS+=	gstreamer-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-app-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-app-sys-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-audio-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-audio-sys-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-base-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-base-sys-0.24.5
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.24.5
...
CARGO_CRATE_DEPENDS+=	jack-0.13.5
...
CARGO_CRATE_DEPENDS+=	kstring-2.0.4
...
CARGO_CRATE_DEPENDS+=	multiversion-0.8.0
CARGO_CRATE_DEPENDS+=	multiversion-macros-0.8.0
...
CARGO_CRATE_DEPENDS+=	option-operations-0.6.1
...
CARGO_CRATE_DEPENDS+=	redox_syscall-0.9.4
...
CARGO_CRATE_DEPENDS+=	wide-1.7.0
