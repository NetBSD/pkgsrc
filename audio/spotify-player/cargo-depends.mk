# $NetBSD: cargo-depends.mk,v 1.36 2024/10/29 18:56:24 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cfg-expr-0.17.0
...
CARGO_CRATE_DEPENDS+=	clap_complete-4.5.35
...
CARGO_CRATE_DEPENDS+=	gio-sys-0.20.4
CARGO_CRATE_DEPENDS+=	glib-0.20.4
CARGO_CRATE_DEPENDS+=	glib-macros-0.20.4
CARGO_CRATE_DEPENDS+=	glib-sys-0.20.4
CARGO_CRATE_DEPENDS+=	glob-0.3.1
CARGO_CRATE_DEPENDS+=	gobject-sys-0.20.4
CARGO_CRATE_DEPENDS+=	governor-0.6.3
CARGO_CRATE_DEPENDS+=	gstreamer-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-app-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-app-sys-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-audio-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-audio-sys-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-base-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-base-sys-0.23.2
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.23.2
...
CARGO_CRATE_DEPENDS+=	librespot-connect-0.5.0
