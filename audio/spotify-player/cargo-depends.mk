# $NetBSD: cargo-depends.mk,v 1.27 2023/12/12 14:42:07 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	android-activity-0.5.0
...
CARGO_CRATE_DEPENDS+=	as-raw-xcb-connection-1.0.0
...
CARGO_CRATE_DEPENDS+=	bindgen-0.69.1
...
CARGO_CRATE_DEPENDS+=	block-sys-0.2.0
...
CARGO_CRATE_DEPENDS+=	num_enum-0.7.1
CARGO_CRATE_DEPENDS+=	num_enum_derive-0.5.11
CARGO_CRATE_DEPENDS+=	num_enum_derive-0.7.1
...
CARGO_CRATE_DEPENDS+=	rspotify-0.12.0
CARGO_CRATE_DEPENDS+=	rspotify-http-0.12.0
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.12.0
CARGO_CRATE_DEPENDS+=	rspotify-model-0.12.0
...
CARGO_CRATE_DEPENDS+=	sctk-adwaita-0.7.0
...
CARGO_CRATE_DEPENDS+=	web-time-0.2.3
...
CARGO_CRATE_DEPENDS+=	winit-0.29.4
CARGO_CRATE_DEPENDS+=	winnow-0.5.26
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.6.5
CARGO_CRATE_DEPENDS+=	zerocopy-0.7.30
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.6.5
