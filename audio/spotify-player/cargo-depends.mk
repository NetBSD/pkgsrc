# $NetBSD: cargo-depends.mk,v 1.35 2024/07/19 09:49:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	rgb-0.8.42
CARGO_CRATE_DEPENDS+=	ring-0.17.8
CARGO_CRATE_DEPENDS+=	rodio-0.15.0
CARGO_CRATE_DEPENDS+=	rpassword-7.3.1
CARGO_CRATE_DEPENDS+=	rspotify-0.13.2
CARGO_CRATE_DEPENDS+=	rspotify-http-0.13.2
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.13.2
CARGO_CRATE_DEPENDS+=	rspotify-model-0.13.2
...
CARGO_CRATE_DEPENDS+=	ttf-parser-0.24.0
...
CARGO_CRATE_DEPENDS+=	wayland-cursor-0.31.4
...
CARGO_CRATE_DEPENDS+=	winit-0.30.3
