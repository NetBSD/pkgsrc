# $NetBSD: cargo-depends.mk,v 1.41 2025/05/14 10:28:47 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gio-sys-0.20.9
CARGO_CRATE_DEPENDS+=	glib-0.20.9
CARGO_CRATE_DEPENDS+=	glib-macros-0.20.7
CARGO_CRATE_DEPENDS+=	glib-sys-0.20.9
CARGO_CRATE_DEPENDS+=	glob-0.3.2
CARGO_CRATE_DEPENDS+=	gobject-sys-0.20.9
CARGO_CRATE_DEPENDS+=	governor-0.6.3
CARGO_CRATE_DEPENDS+=	gstreamer-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-app-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-app-sys-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-audio-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-audio-sys-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-base-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-base-sys-0.23.5
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.23.5
...
CARGO_CRATE_DEPENDS+=	priority-queue-2.3.1
...
CARGO_CRATE_DEPENDS+=	ravif-0.11.12
...
CARGO_CRATE_DEPENDS+=	rspotify-0.14.0
CARGO_CRATE_DEPENDS+=	rspotify-http-0.14.0
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.14.0
CARGO_CRATE_DEPENDS+=	rspotify-model-0.14.0
...
CARGO_CRATE_DEPENDS+=	souvlaki-0.8.2
