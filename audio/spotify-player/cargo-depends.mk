# $NetBSD: cargo-depends.mk,v 1.31 2024/04/01 19:13:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	markup5ever-0.12.0
...
CARGO_CRATE_DEPENDS+=	rspotify-0.13.0
CARGO_CRATE_DEPENDS+=	rspotify-http-0.13.0
CARGO_CRATE_DEPENDS+=	rspotify-macros-0.13.0
CARGO_CRATE_DEPENDS+=	rspotify-model-0.13.0
