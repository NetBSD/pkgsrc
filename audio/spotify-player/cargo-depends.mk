# $NetBSD: cargo-depends.mk,v 1.24 2023/10/02 10:38:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	coreaudio-sys-0.2.13
...
CARGO_CRATE_DEPENDS+=	sharded-slab-0.1.6
...
CARGO_CRATE_DEPENDS+=	thread-id-4.2.0
...
CARGO_CRATE_DEPENDS+=	zerocopy-0.6.4
CARGO_CRATE_DEPENDS+=	zerocopy-derive-0.6.4
