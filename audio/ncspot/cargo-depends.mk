# $NetBSD: cargo-depends.mk,v 1.4 2021/01/14 12:18:08 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clang-sys-1.0.3
...
CARGO_CRATE_DEPENDS+=	const-random-0.1.13
CARGO_CRATE_DEPENDS+=	const-random-macro-0.1.13
...
CARGO_CRATE_DEPENDS+=	cursive-0.15.0
CARGO_CRATE_DEPENDS+=	cursive_core-0.1.1
...
CARGO_CRATE_DEPENDS+=	dbus-0.9.1
...
CARGO_CRATE_DEPENDS+=	futures-0.3.10
CARGO_CRATE_DEPENDS+=	futures-channel-0.3.10
CARGO_CRATE_DEPENDS+=	futures-core-0.3.10
CARGO_CRATE_DEPENDS+=	futures-cpupool-0.1.8
CARGO_CRATE_DEPENDS+=	futures-executor-0.3.10
CARGO_CRATE_DEPENDS+=	futures-io-0.3.10
CARGO_CRATE_DEPENDS+=	futures-macro-0.3.10
CARGO_CRATE_DEPENDS+=	futures-sink-0.3.10
CARGO_CRATE_DEPENDS+=	futures-task-0.3.10
CARGO_CRATE_DEPENDS+=	futures-util-0.3.10
...
CARGO_CRATE_DEPENDS+=	librespot-audio-0.1.3
CARGO_CRATE_DEPENDS+=	librespot-core-0.1.3
CARGO_CRATE_DEPENDS+=	librespot-metadata-0.1.3
CARGO_CRATE_DEPENDS+=	librespot-playback-0.1.3
CARGO_CRATE_DEPENDS+=	librespot-protocol-0.1.3
...
CARGO_CRATE_DEPENDS+=	notify-rust-4.2.2
...
CARGO_CRATE_DEPENDS+=	xi-unicode-0.2.1
