# $NetBSD: cargo-depends.mk,v 1.14 2021/10/16 11:47:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	notify-rust-4.5.4
...
CARGO_CRATE_DEPENDS+=	windows-0.21.1
CARGO_CRATE_DEPENDS+=	windows_gen-0.21.1
CARGO_CRATE_DEPENDS+=	windows_macros-0.21.1
CARGO_CRATE_DEPENDS+=	windows_quote-0.21.1
CARGO_CRATE_DEPENDS+=	windows_reader-0.21.1
CARGO_CRATE_DEPENDS+=	winreg-0.5.1
CARGO_CRATE_DEPENDS+=	winreg-0.7.0
CARGO_CRATE_DEPENDS+=	winrt-notification-0.4.0
...
CARGO_CRATE_DEPENDS+=	zvariant-2.9.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-2.9.0
