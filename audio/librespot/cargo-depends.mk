# $NetBSD: cargo-depends.mk,v 1.7 2022/05/22 16:38:02 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gstreamer-app-0.17.2
CARGO_CRATE_DEPENDS+=	gstreamer-app-sys-0.17.0
CARGO_CRATE_DEPENDS+=	gstreamer-audio-0.17.2
...
CARGO_CRATE_DEPENDS+=	simple_logger-1.16.0
