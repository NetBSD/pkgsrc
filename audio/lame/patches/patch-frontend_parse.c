$NetBSD: patch-frontend_parse.c,v 1.1 2026/07/15 07:09:51 adam Exp $

Avoid deprecated functions.

--- frontend/parse.c.orig	2026-07-15 06:37:56.422883463 +0000
+++ frontend/parse.c
@@ -414,10 +414,10 @@ set_id3v2tag(lame_global_flags* gfp, Tex
