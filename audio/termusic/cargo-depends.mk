# $NetBSD: cargo-depends.mk,v 1.40 2023/01/23 21:13:00 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-4.1.0
...
CARGO_CRATE_DEPENDS+=	glib-0.16.7
CARGO_CRATE_DEPENDS+=	glib-macros-0.16.3
CARGO_CRATE_DEPENDS+=	glib-sys-0.16.3
CARGO_CRATE_DEPENDS+=	glob-0.3.1
CARGO_CRATE_DEPENDS+=	gobject-sys-0.16.3
CARGO_CRATE_DEPENDS+=	gstreamer-0.19.5
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.19.4
CARGO_CRATE_DEPENDS+=	half-2.2.1
CARGO_CRATE_DEPENDS+=	hard-xml-1.21.0
CARGO_CRATE_DEPENDS+=	hard-xml-derive-1.21.0
...
CARGO_CRATE_DEPENDS+=	libaes-0.6.4
CARGO_CRATE_DEPENDS+=	libc-0.2.139
CARGO_CRATE_DEPENDS+=	libdbus-sys-0.2.3
...
CARGO_CRATE_DEPENDS+=	lofty-0.10.0
CARGO_CRATE_DEPENDS+=	lofty_attr-0.5.0
...
CARGO_CRATE_DEPENDS+=	ogg_pager-0.4.0
...
CARGO_CRATE_DEPENDS+=	souvlaki-0.5.3
...
CARGO_CRATE_DEPENDS+=	symphonia-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-bundle-flac-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-bundle-mp3-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-codec-aac-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-codec-alac-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-codec-pcm-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-codec-vorbis-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-core-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-format-isomp4-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-format-mkv-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-format-ogg-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-format-wav-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-metadata-0.5.1
CARGO_CRATE_DEPENDS+=	symphonia-utils-xiph-0.5.1
...
CARGO_CRATE_DEPENDS+=	ureq-2.6.1
