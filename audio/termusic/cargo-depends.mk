# $NetBSD: cargo-depends.mk,v 1.1 2021/07/12 15:06:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	tui-realm-treeview-0.2.0
CARGO_CRATE_DEPENDS+=	tui-tree-widget-0.6.0
CARGO_CRATE_DEPENDS+=	tuirealm-0.4.3
CARGO_CRATE_DEPENDS+=	unicode-bidi-0.3.5
CARGO_CRATE_DEPENDS+=	unicode-linebreak-0.1.1
...
CARGO_CRATE_DEPENDS+=	ytd-rs-0.1.2
