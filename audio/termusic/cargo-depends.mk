# $NetBSD: cargo-depends.mk,v 1.49 2025/12/11 11:49:29 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-ringbuf-0.3.4
...
CARGO_CRATE_DEPENDS+=	flexi_logger-0.31.5
...
CARGO_CRATE_DEPENDS+=	id3-1.16.3
...
CARGO_CRATE_DEPENDS+=	lofty-0.22.4
CARGO_CRATE_DEPENDS+=	lofty_attr-0.11.1
...
CARGO_CRATE_DEPENDS+=	mediatype-0.20.0
...
CARGO_CRATE_DEPENDS+=	orange-trees-0.1.3
...
CARGO_CRATE_DEPENDS+=	soundtouch-0.5.1
CARGO_CRATE_DEPENDS+=	soundtouch-ffi-0.3.0
CARGO_CRATE_DEPENDS+=	souvlaki-0.8.3
CARGO_CRATE_DEPENDS+=	stable_deref_trait-1.2.0
CARGO_CRATE_DEPENDS+=	static_assertions-1.1.0
CARGO_CRATE_DEPENDS+=	stream-download-0.22.4
...
CARGO_CRATE_DEPENDS+=	symphonia-adapter-libopus-0.2.0
...
CARGO_CRATE_DEPENDS+=	tonic-0.14.1
CARGO_CRATE_DEPENDS+=	tonic-build-0.14.1
CARGO_CRATE_DEPENDS+=	tonic-prost-0.14.1
CARGO_CRATE_DEPENDS+=	tonic-prost-build-0.14.1
...
CARGO_CRATE_DEPENDS+=	tui-realm-treeview-3.0.0
CARGO_CRATE_DEPENDS+=	tuirealm-3.2.0
