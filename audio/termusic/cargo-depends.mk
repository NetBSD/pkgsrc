# $NetBSD: cargo-depends.mk,v 1.36 2022/08/19 10:17:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	discord-rich-presence-0.2.2
...
CARGO_CRATE_DEPENDS+=	libaes-0.6.3
...
CARGO_CRATE_DEPENDS+=	lofty-0.8.0
