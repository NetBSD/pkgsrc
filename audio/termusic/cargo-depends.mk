# $NetBSD: cargo-depends.mk,v 1.38 2022/10/26 20:26:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cpal-0.14.1
...
CARGO_CRATE_DEPENDS+=	gio-sys-0.16.0
CARGO_CRATE_DEPENDS+=	glib-0.16.2
CARGO_CRATE_DEPENDS+=	glib-macros-0.16.0
CARGO_CRATE_DEPENDS+=	glib-sys-0.16.0
CARGO_CRATE_DEPENDS+=	glob-0.3.0
CARGO_CRATE_DEPENDS+=	gobject-sys-0.16.0
CARGO_CRATE_DEPENDS+=	gstreamer-0.19.1
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.19.0
...
CARGO_CRATE_DEPENDS+=	hound-3.5.0
...
CARGO_CRATE_DEPENDS+=	lofty-0.8.1
CARGO_CRATE_DEPENDS+=	lofty_attr-0.3.0
...
CARGO_CRATE_DEPENDS+=	souvlaki-0.5.2
