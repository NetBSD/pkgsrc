# $NetBSD: cargo-depends.mk,v 1.45 2024/08/22 12:19:45 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ogg_pager-0.6.1
...
CARGO_CRATE_DEPENDS+=	prost-0.13.1
CARGO_CRATE_DEPENDS+=	prost-build-0.13.1
CARGO_CRATE_DEPENDS+=	prost-derive-0.13.1
...
CARGO_CRATE_DEPENDS+=	quick-xml-0.36.0
...
CARGO_CRATE_DEPENDS+=	rusqlite-0.32.0
...
CARGO_CRATE_DEPENDS+=	tonic-0.12.1
CARGO_CRATE_DEPENDS+=	tonic-build-0.12.1
