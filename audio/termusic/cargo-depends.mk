# $NetBSD: cargo-depends.mk,v 1.25 2022/02/11 09:45:34 pin Exp $
...
CARGO_CRATE_DEPENDS+=	lofty-0.3.3
...
CARGO_CRATE_DEPENDS+=	ogg_pager-0.2.0
...
CARGO_CRATE_DEPENDS+=	tuirealm-1.4.2
