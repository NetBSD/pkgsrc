# $NetBSD: cargo-depends.mk,v 1.39 2022/12/26 22:06:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gstreamer-0.19.4
...
CARGO_CRATE_DEPENDS+=	lofty-0.9.0
CARGO_CRATE_DEPENDS+=	lofty_attr-0.4.0
