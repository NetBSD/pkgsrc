# $NetBSD: cargo-depends.mk,v 1.26 2022/03/10 08:05:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	coreaudio-sys-0.2.9
...
CARGO_CRATE_DEPENDS+=	glib-0.15.6
CARGO_CRATE_DEPENDS+=	glib-macros-0.15.6
CARGO_CRATE_DEPENDS+=	glib-sys-0.15.6
CARGO_CRATE_DEPENDS+=	glob-0.3.0
CARGO_CRATE_DEPENDS+=	gobject-sys-0.15.5
CARGO_CRATE_DEPENDS+=	gstreamer-0.18.5
...
CARGO_CRATE_DEPENDS+=	gstreamer-pbutils-0.18.0
CARGO_CRATE_DEPENDS+=	gstreamer-pbutils-sys-0.18.0
CARGO_CRATE_DEPENDS+=	gstreamer-player-0.18.0
CARGO_CRATE_DEPENDS+=	gstreamer-player-sys-0.18.0
CARGO_CRATE_DEPENDS+=	gstreamer-sys-0.18.0
CARGO_CRATE_DEPENDS+=	gstreamer-video-0.18.5
CARGO_CRATE_DEPENDS+=	gstreamer-video-sys-0.18.3
CARGO_CRATE_DEPENDS+=	half-1.8.2
CARGO_CRATE_DEPENDS+=	heck-0.4.0
CARGO_CRATE_DEPENDS+=	hermit-abi-0.1.19
CARGO_CRATE_DEPENDS+=	hex-0.4.3
CARGO_CRATE_DEPENDS+=	id3-1.0.2
...
CARGO_CRATE_DEPENDS+=	lofty-0.5.3
...
CARGO_CRATE_DEPENDS+=	ndk-context-0.1.0
CARGO_CRATE_DEPENDS+=	ndk-glue-0.6.1
...
CARGO_CRATE_DEPENDS+=	tuirealm-1.5.0
...
CARGO_CRATE_DEPENDS+=	viuer-0.6.0
