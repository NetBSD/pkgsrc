# $NetBSD: cargo-depends.mk,v 1.27 2022/04/02 07:11:59 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bytemuck-1.9.0
...
CARGO_CRATE_DEPENDS+=	gstreamer-0.18.6
...
CARGO_CRATE_DEPENDS+=	jpeg-decoder-0.2.3
