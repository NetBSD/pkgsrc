# $NetBSD: cargo-depends.mk,v 1.4 2021/08/20 11:25:19 pin Exp $
...
CARGO_CRATE_DEPENDS+=	httparse-1.5.0
...
CARGO_CRATE_DEPENDS+=	wasm-bindgen-futures-0.4.25
...
CARGO_CRATE_DEPENDS+=	web-sys-0.3.52
