# $NetBSD: cargo-depends.mk,v 1.41 2023/03/05 07:35:00 pin Exp $
...
CARGO_CRATE_DEPENDS+=	glib-0.17.1
CARGO_CRATE_DEPENDS+=	glib-macros-0.17.1
CARGO_CRATE_DEPENDS+=	glib-sys-0.17.0
CARGO_CRATE_DEPENDS+=	glob-0.3.1
CARGO_CRATE_DEPENDS+=	gobject-sys-0.17.0
CARGO_CRATE_DEPENDS+=	gstreamer-0.20.0
...
CARGO_CRATE_DEPENDS+=	lofty-0.11.0
CARGO_CRATE_DEPENDS+=	lofty_attr-0.6.0
...
CARGO_CRATE_DEPENDS+=	souvlaki-0.6.0
...
CARGO_CRATE_DEPENDS+=	symphonia-bundle-flac-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-bundle-mp3-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-codec-aac-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-codec-adpcm-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-codec-alac-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-codec-pcm-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-codec-vorbis-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-core-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-format-isomp4-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-format-mkv-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-format-ogg-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-format-wav-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-metadata-0.5.2
CARGO_CRATE_DEPENDS+=	symphonia-utils-xiph-0.5.2
