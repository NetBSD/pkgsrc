# $NetBSD: cargo-depends.mk,v 1.35 2022/08/08 06:04:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	discord-rich-presence-0.2.1
...
CARGO_CRATE_DEPENDS+=	hound-3.4.0
CARGO_CRATE_DEPENDS+=	id3-1.3.0
...
CARGO_CRATE_DEPENDS+=	lexopt-0.2.1
...
CARGO_CRATE_DEPENDS+=	lofty-0.7.3
...
CARGO_CRATE_DEPENDS+=	proc-macro-crate-1.2.0
