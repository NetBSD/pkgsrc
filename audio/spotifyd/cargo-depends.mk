# $NetBSD: cargo-depends.mk,v 1.2 2025/04/13 15:28:08 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aws-lc-fips-sys-0.13.3
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.12.6
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.27.0
...
CARGO_CRATE_DEPENDS+=	base64ct-1.7.2
...
CARGO_CRATE_DEPENDS+=	gethostname-1.0.0
...
CARGO_CRATE_DEPENDS+=	librespot-discovery-0.6.0
...
CARGO_CRATE_DEPENDS+=	once_cell-1.21.0
...
CARGO_CRATE_DEPENDS+=	prettyplease-0.2.30
CARGO_CRATE_DEPENDS+=	priority-queue-2.2.2
...
CARGO_CRATE_DEPENDS+=	vergen-9.0.4
CARGO_CRATE_DEPENDS+=	vergen-gitcl-1.0.5
