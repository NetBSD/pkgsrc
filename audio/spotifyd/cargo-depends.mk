# $NetBSD: cargo-depends.mk,v 1.3 2025/11/20 05:19:17 pin Exp $
...
CARGO_CRATE_DEPENDS+=	dbus-tokio-0.7.6
...
CARGO_CRATE_DEPENDS+=	governor-0.10.2
...
CARGO_CRATE_DEPENDS+=	libmdns-0.10.1
...
CARGO_CRATE_DEPENDS+=	librespot-audio-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-connect-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-core-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-discovery-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-metadata-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-oauth-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-playback-0.8.0
CARGO_CRATE_DEPENDS+=	librespot-protocol-0.8.0
...
CARGO_CRATE_DEPENDS+=	pledge-0.4.2
