# $NetBSD: cargo-depends.mk,v 1.1 2023/07/13 20:38:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	keyring-2.0.1
...
CARGO_CRATE_DEPENDS+=	libpulse-binding-2.27.1
CARGO_CRATE_DEPENDS+=	libpulse-simple-binding-2.27.1
CARGO_CRATE_DEPENDS+=	libpulse-simple-sys-1.20.1
CARGO_CRATE_DEPENDS+=	libpulse-sys-1.20.1
...
CARGO_CRATE_DEPENDS+=	priority-queue-1.3.1
...
CARGO_CRATE_DEPENDS+=	whoami-1.4.0
