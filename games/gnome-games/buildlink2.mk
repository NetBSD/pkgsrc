# $NetBSD: buildlink2.mk,v 1.8 2004/03/26 02:27:40 wiz Exp $
#
...
BUILDLINK_DEPENDS.gnome-games?=		gnome-games>=1.4.0.4nb9
BUILDLINK_RECOMMENDED.gnome-games?=		gnome-games>=1.4.0.4nb12
