...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.3
CARGO_CRATE_DEPENDS+=	async-executor-1.5.4
...
CARGO_CRATE_DEPENDS+=	async-task-4.4.1
...
CARGO_CRATE_DEPENDS+=	blocking-1.4.0
...
CARGO_CRATE_DEPENDS+=	davisjr-0.4.1
...
CARGO_CRATE_DEPENDS+=	parking-2.1.1
