# $NetBSD: cargo-depends.mk,v 1.3 2023/11/26 16:09:59 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-io-2.2.1
CARGO_CRATE_DEPENDS+=	async-lock-2.8.0
CARGO_CRATE_DEPENDS+=	async-lock-3.1.2
...
CARGO_CRATE_DEPENDS+=	davisjr-0.4.2
...
CARGO_CRATE_DEPENDS+=	event-listener-4.0.0
CARGO_CRATE_DEPENDS+=	event-listener-strategy-0.4.0
CARGO_CRATE_DEPENDS+=	fancy-duration-0.6.0
...
CARGO_CRATE_DEPENDS+=	gcal-0.1.5
...
CARGO_CRATE_DEPENDS+=	ttygrid-0.3.0
