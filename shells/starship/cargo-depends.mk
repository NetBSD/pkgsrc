# $NetBSD: cargo-depends.mk,v 1.16 2022/10/15 07:10:59 pin Exp $
...
CARGO_CRATE_DEPENDS+=	git-actor-0.13.0
CARGO_CRATE_DEPENDS+=	git-attributes-0.5.0
CARGO_CRATE_DEPENDS+=	git-bitmap-0.1.2
CARGO_CRATE_DEPENDS+=	git-chunk-0.3.2
CARGO_CRATE_DEPENDS+=	git-command-0.1.0
CARGO_CRATE_DEPENDS+=	git-config-0.9.0
CARGO_CRATE_DEPENDS+=	git-config-value-0.8.0
CARGO_CRATE_DEPENDS+=	git-credentials-0.6.0
CARGO_CRATE_DEPENDS+=	git-date-0.2.0
CARGO_CRATE_DEPENDS+=	git-diff-0.20.0
CARGO_CRATE_DEPENDS+=	git-discover-0.6.0
CARGO_CRATE_DEPENDS+=	git-features-0.23.0
CARGO_CRATE_DEPENDS+=	git-glob-0.4.0
CARGO_CRATE_DEPENDS+=	git-hash-0.9.11
CARGO_CRATE_DEPENDS+=	git-index-0.6.0
CARGO_CRATE_DEPENDS+=	git-lock-2.1.1
CARGO_CRATE_DEPENDS+=	git-mailmap-0.5.0
CARGO_CRATE_DEPENDS+=	git-object-0.22.0
CARGO_CRATE_DEPENDS+=	git-odb-0.34.0
CARGO_CRATE_DEPENDS+=	git-pack-0.24.0
CARGO_CRATE_DEPENDS+=	git-path-0.5.0
CARGO_CRATE_DEPENDS+=	git-prompt-0.1.0
CARGO_CRATE_DEPENDS+=	git-quote-0.3.0
CARGO_CRATE_DEPENDS+=	git-ref-0.17.0
CARGO_CRATE_DEPENDS+=	git-refspec-0.3.0
CARGO_CRATE_DEPENDS+=	git-repository-0.25.0
CARGO_CRATE_DEPENDS+=	git-revision-0.6.0
CARGO_CRATE_DEPENDS+=	git-sec-0.4.1
CARGO_CRATE_DEPENDS+=	git-tempfile-2.0.4
CARGO_CRATE_DEPENDS+=	git-traverse-0.18.0
CARGO_CRATE_DEPENDS+=	git-url-0.10.0
CARGO_CRATE_DEPENDS+=	git-validate-0.6.0
CARGO_CRATE_DEPENDS+=	git-worktree-0.6.0
...
CARGO_CRATE_DEPENDS+=	notify-rust-4.5.10
...
CARGO_CRATE_DEPENDS+=	open-3.0.3
...
CARGO_CRATE_DEPENDS+=	process_control-4.0.0
CARGO_CRATE_DEPENDS+=	prodash-20.2.0
...
CARGO_CRATE_DEPENDS+=	systemstat-0.2.1
...
CARGO_CRATE_DEPENDS+=	zbus-2.3.2
CARGO_CRATE_DEPENDS+=	zbus_macros-2.3.2
CARGO_CRATE_DEPENDS+=	zbus_names-2.2.0
CARGO_CRATE_DEPENDS+=	zvariant-3.6.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-3.6.0
