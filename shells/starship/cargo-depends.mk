# $NetBSD: cargo-depends.mk,v 1.4 2021/11/10 11:41:36 pin Exp $
...
CARGO_CRATE_DEPENDS+=	downcast-0.10.0
...
CARGO_CRATE_DEPENDS+=	mockall-0.10.2
CARGO_CRATE_DEPENDS+=	mockall_derive-0.10.2
...
CARGO_CRATE_DEPENDS+=	os_info-3.0.7
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.7.2
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.6.0
