# $NetBSD: cargo-depends.mk,v 1.5 2021/12/22 08:29:46 pin Exp $
...
CARGO_CRATE_DEPENDS+=	openssl-src-111.16.0+1.1.1l
CARGO_CRATE_DEPENDS+=	openssl-sys-0.9.66
CARGO_CRATE_DEPENDS+=	ordered-multimap-0.3.1
CARGO_CRATE_DEPENDS+=	os_info-3.0.8
...
CARGO_CRATE_DEPENDS+=	process_control-3.1.0
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.12.0
...
CARGO_CRATE_DEPENDS+=	versions-3.0.3
