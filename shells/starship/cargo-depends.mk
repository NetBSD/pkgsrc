# $NetBSD: cargo-depends.mk,v 1.19 2023/04/11 12:42:17 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap_lex-0.4.0
...
CARGO_CRATE_DEPENDS+=	fragile-1.2.2
...
CARGO_CRATE_DEPENDS+=	gix-0.43.1
...
CARGO_CRATE_DEPENDS+=	gix-config-0.20.1
CARGO_CRATE_DEPENDS+=	gix-config-value-0.10.2
CARGO_CRATE_DEPENDS+=	gix-credentials-0.12.0
CARGO_CRATE_DEPENDS+=	gix-date-0.4.3
CARGO_CRATE_DEPENDS+=	gix-diff-0.28.1
CARGO_CRATE_DEPENDS+=	gix-discover-0.16.2
...
CARGO_CRATE_DEPENDS+=	gix-index-0.15.1
CARGO_CRATE_DEPENDS+=	gix-lock-5.0.0
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.11.0
CARGO_CRATE_DEPENDS+=	gix-object-0.28.0
CARGO_CRATE_DEPENDS+=	gix-odb-0.43.1
CARGO_CRATE_DEPENDS+=	gix-pack-0.33.2
CARGO_CRATE_DEPENDS+=	gix-path-0.7.3
CARGO_CRATE_DEPENDS+=	gix-prompt-0.3.3
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.3
CARGO_CRATE_DEPENDS+=	gix-ref-0.27.2
CARGO_CRATE_DEPENDS+=	gix-refspec-0.9.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.12.1
CARGO_CRATE_DEPENDS+=	gix-sec-0.6.2
CARGO_CRATE_DEPENDS+=	gix-tempfile-5.0.0
CARGO_CRATE_DEPENDS+=	gix-traverse-0.24.0
CARGO_CRATE_DEPENDS+=	gix-url-0.16.0
CARGO_CRATE_DEPENDS+=	gix-validate-0.7.4
CARGO_CRATE_DEPENDS+=	gix-worktree-0.15.2
...
CARGO_CRATE_DEPENDS+=	prodash-23.1.0
