# $NetBSD: cargo-depends.mk,v 1.23 2023/12/30 17:11:19 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-0.56.0
CARGO_CRATE_DEPENDS+=	gix-actor-0.28.1
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.8
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.5
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.22.1
CARGO_CRATE_DEPENDS+=	gix-config-0.32.1
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.1
CARGO_CRATE_DEPENDS+=	gix-date-0.8.1
CARGO_CRATE_DEPENDS+=	gix-diff-0.38.0
CARGO_CRATE_DEPENDS+=	gix-discover-0.27.0
...
CARGO_CRATE_DEPENDS+=	gix-index-0.27.1
CARGO_CRATE_DEPENDS+=	gix-lock-11.0.1
CARGO_CRATE_DEPENDS+=	gix-macros-0.1.1
CARGO_CRATE_DEPENDS+=	gix-object-0.39.0
CARGO_CRATE_DEPENDS+=	gix-odb-0.55.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.45.0
CARGO_CRATE_DEPENDS+=	gix-path-0.10.1
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.8
CARGO_CRATE_DEPENDS+=	gix-ref-0.39.1
CARGO_CRATE_DEPENDS+=	gix-refspec-0.20.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.24.0
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.10.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.1
CARGO_CRATE_DEPENDS+=	gix-tempfile-11.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.4
CARGO_CRATE_DEPENDS+=	gix-traverse-0.35.0
CARGO_CRATE_DEPENDS+=	gix-url-0.25.2
CARGO_CRATE_DEPENDS+=	gix-utils-0.1.6
CARGO_CRATE_DEPENDS+=	gix-validate-0.8.1
...
CARGO_CRATE_DEPENDS+=	libz-ng-sys-1.1.12
...
CARGO_CRATE_DEPENDS+=	process_control-4.0.3
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.25.0
...
CARGO_CRATE_DEPENDS+=	versions-6.0.0
