# $NetBSD: cargo-depends.mk,v 1.22 2023/08/01 08:05:34 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-0.50.1
CARGO_CRATE_DEPENDS+=	gix-actor-0.24.1
CARGO_CRATE_DEPENDS+=	gix-attributes-0.16.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.6
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.4
CARGO_CRATE_DEPENDS+=	gix-command-0.2.8
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.18.1
CARGO_CRATE_DEPENDS+=	gix-config-0.26.1
CARGO_CRATE_DEPENDS+=	gix-config-value-0.12.5
CARGO_CRATE_DEPENDS+=	gix-credentials-0.17.1
CARGO_CRATE_DEPENDS+=	gix-date-0.7.1
CARGO_CRATE_DEPENDS+=	gix-diff-0.33.1
CARGO_CRATE_DEPENDS+=	gix-discover-0.22.1
CARGO_CRATE_DEPENDS+=	gix-features-0.31.1
CARGO_CRATE_DEPENDS+=	gix-features-0.32.1
CARGO_CRATE_DEPENDS+=	gix-filter-0.2.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.3.0
CARGO_CRATE_DEPENDS+=	gix-fs-0.4.1
CARGO_CRATE_DEPENDS+=	gix-glob-0.10.1
CARGO_CRATE_DEPENDS+=	gix-hash-0.11.4
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.2.4
CARGO_CRATE_DEPENDS+=	gix-ignore-0.5.1
CARGO_CRATE_DEPENDS+=	gix-index-0.21.1
CARGO_CRATE_DEPENDS+=	gix-lock-7.0.1
CARGO_CRATE_DEPENDS+=	gix-mailmap-0.16.1
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.5.1
CARGO_CRATE_DEPENDS+=	gix-object-0.33.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.50.1
CARGO_CRATE_DEPENDS+=	gix-pack-0.40.2
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.16.4
CARGO_CRATE_DEPENDS+=	gix-path-0.8.4
CARGO_CRATE_DEPENDS+=	gix-prompt-0.5.4
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.6
CARGO_CRATE_DEPENDS+=	gix-ref-0.33.2
CARGO_CRATE_DEPENDS+=	gix-refspec-0.14.1
CARGO_CRATE_DEPENDS+=	gix-revision-0.18.1
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.4.1
CARGO_CRATE_DEPENDS+=	gix-sec-0.8.4
CARGO_CRATE_DEPENDS+=	gix-tempfile-7.0.0
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.3
CARGO_CRATE_DEPENDS+=	gix-traverse-0.30.1
CARGO_CRATE_DEPENDS+=	gix-url-0.21.1
CARGO_CRATE_DEPENDS+=	gix-utils-0.1.5
CARGO_CRATE_DEPENDS+=	gix-validate-0.7.7
CARGO_CRATE_DEPENDS+=	gix-worktree-0.23.0
...
CARGO_CRATE_DEPENDS+=	prodash-25.0.0
...
CARGO_CRATE_DEPENDS+=	schemars-0.8.12
CARGO_CRATE_DEPENDS+=	schemars_derive-0.8.12
...
CARGO_CRATE_DEPENDS+=	starship-battery-0.8.1
...
CARGO_CRATE_DEPENDS+=	uom-0.34.0
