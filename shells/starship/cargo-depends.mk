# $NetBSD: cargo-depends.mk,v 1.24 2024/01/02 20:07:15 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-0.57.1
CARGO_CRATE_DEPENDS+=	gix-actor-0.29.1
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.10
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.7
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.23.1
CARGO_CRATE_DEPENDS+=	gix-config-0.33.1
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.3
CARGO_CRATE_DEPENDS+=	gix-date-0.8.3
CARGO_CRATE_DEPENDS+=	gix-diff-0.39.1
CARGO_CRATE_DEPENDS+=	gix-discover-0.28.1
CARGO_CRATE_DEPENDS+=	gix-features-0.37.1
CARGO_CRATE_DEPENDS+=	gix-fs-0.9.1
CARGO_CRATE_DEPENDS+=	gix-glob-0.15.1
CARGO_CRATE_DEPENDS+=	gix-hash-0.14.1
CARGO_CRATE_DEPENDS+=	gix-hashtable-0.5.1
CARGO_CRATE_DEPENDS+=	gix-index-0.28.1
CARGO_CRATE_DEPENDS+=	gix-lock-12.0.1
CARGO_CRATE_DEPENDS+=	gix-macros-0.1.3
CARGO_CRATE_DEPENDS+=	gix-object-0.40.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.56.1
CARGO_CRATE_DEPENDS+=	gix-pack-0.46.1
CARGO_CRATE_DEPENDS+=	gix-path-0.10.3
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.10
CARGO_CRATE_DEPENDS+=	gix-ref-0.40.1
CARGO_CRATE_DEPENDS+=	gix-refspec-0.21.1
CARGO_CRATE_DEPENDS+=	gix-revision-0.25.1
CARGO_CRATE_DEPENDS+=	gix-revwalk-0.11.1
CARGO_CRATE_DEPENDS+=	gix-sec-0.10.3
CARGO_CRATE_DEPENDS+=	gix-tempfile-12.0.1
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.6
CARGO_CRATE_DEPENDS+=	gix-traverse-0.36.1
CARGO_CRATE_DEPENDS+=	gix-url-0.26.1
