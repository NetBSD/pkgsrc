# $NetBSD: cargo-depends.mk,v 1.21 2023/06/06 19:27:29 pin Exp $

CARGO_CRATE_DEPENDS+=	adler-1.0.2
CARGO_CRATE_DEPENDS+=	ahash-0.8.3
CARGO_CRATE_DEPENDS+=	aho-corasick-1.0.0
...
CARGO_CRATE_DEPENDS+=	clap_complete-4.3.1
...
CARGO_CRATE_DEPENDS+=	enumflags2-0.7.6
CARGO_CRATE_DEPENDS+=	enumflags2_derive-0.7.6
...
CARGO_CRATE_DEPENDS+=	gix-path-0.8.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.5.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.4.3
CARGO_CRATE_DEPENDS+=	gix-ref-0.29.0
CARGO_CRATE_DEPENDS+=	gix-refspec-0.10.1
CARGO_CRATE_DEPENDS+=	gix-revision-0.13.0
CARGO_CRATE_DEPENDS+=	gix-sec-0.8.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-5.0.2
...
CARGO_CRATE_DEPENDS+=	gix-worktree-0.17.0
...
CARGO_CRATE_DEPENDS+=	rustix-0.37.13
...
CARGO_CRATE_DEPENDS+=	starship-battery-0.8.0
