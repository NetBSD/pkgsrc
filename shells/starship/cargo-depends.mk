# $NetBSD: cargo-depends.mk,v 1.15 2022/09/10 16:13:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	compact_str-0.4.1
...
CARGO_CRATE_DEPENDS+=	git-actor-0.11.4
CARGO_CRATE_DEPENDS+=	git-attributes-0.3.3
CARGO_CRATE_DEPENDS+=	git-bitmap-0.1.2
CARGO_CRATE_DEPENDS+=	git-chunk-0.3.1
CARGO_CRATE_DEPENDS+=	git-config-0.7.1
CARGO_CRATE_DEPENDS+=	git-date-0.1.0
CARGO_CRATE_DEPENDS+=	git-diff-0.18.1
CARGO_CRATE_DEPENDS+=	git-discover-0.4.2
CARGO_CRATE_DEPENDS+=	git-features-0.22.3
CARGO_CRATE_DEPENDS+=	git-glob-0.3.2
CARGO_CRATE_DEPENDS+=	git-hash-0.9.8
CARGO_CRATE_DEPENDS+=	git-index-0.4.3
CARGO_CRATE_DEPENDS+=	git-lock-2.1.1
CARGO_CRATE_DEPENDS+=	git-object-0.20.3
CARGO_CRATE_DEPENDS+=	git-odb-0.32.0
CARGO_CRATE_DEPENDS+=	git-pack-0.22.0
CARGO_CRATE_DEPENDS+=	git-path-0.4.1
CARGO_CRATE_DEPENDS+=	git-quote-0.2.1
CARGO_CRATE_DEPENDS+=	git-ref-0.15.4
CARGO_CRATE_DEPENDS+=	git-refspec-0.1.1
CARGO_CRATE_DEPENDS+=	git-repository-0.23.1
CARGO_CRATE_DEPENDS+=	git-revision-0.4.4
CARGO_CRATE_DEPENDS+=	git-sec-0.3.1
CARGO_CRATE_DEPENDS+=	git-tempfile-2.0.4
CARGO_CRATE_DEPENDS+=	git-traverse-0.16.4
CARGO_CRATE_DEPENDS+=	git-url-0.7.3
CARGO_CRATE_DEPENDS+=	git-validate-0.5.5
CARGO_CRATE_DEPENDS+=	git-worktree-0.4.3
...
CARGO_CRATE_DEPENDS+=	os_info-3.5.0
...
CARGO_CRATE_DEPENDS+=	process_control-3.5.1
CARGO_CRATE_DEPENDS+=	prodash-19.0.1
CARGO_CRATE_DEPENDS+=	quick-error-2.0.1
CARGO_CRATE_DEPENDS+=	quick-xml-0.24.0
...
CARGO_CRATE_DEPENDS+=	schemars-0.8.10
CARGO_CRATE_DEPENDS+=	schemars_derive-0.8.10
...
CARGO_CRATE_DEPENDS+=	systemstat-0.2.0
