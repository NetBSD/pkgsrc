# $NetBSD: cargo-depends.mk,v 1.8 2022/03/10 08:03:55 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-task-4.1.0
...
CARGO_CRATE_DEPENDS+=	ordered-multimap-0.4.2
...
CARGO_CRATE_DEPENDS+=	process_control-3.2.1
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.9.0
...
CARGO_CRATE_DEPENDS+=	windows-sys-0.30.0
