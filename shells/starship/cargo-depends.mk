# $NetBSD: cargo-depends.mk,v 1.14 2022/05/25 10:25:32 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fragile-1.2.0
...
CARGO_CRATE_DEPENDS+=	mockall-0.11.1
CARGO_CRATE_DEPENDS+=	mockall_derive-0.11.1
...
CARGO_CRATE_DEPENDS+=	os_info-3.4.0
...
CARGO_CRATE_DEPENDS+=	process_control-3.4.0
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.11.0
...
CARGO_CRATE_DEPENDS+=	vtparse-0.6.1
...
CARGO_CRATE_DEPENDS+=	zvariant-3.2.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-3.2.0
