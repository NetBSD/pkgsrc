# $NetBSD: cargo-depends.mk,v 1.59 2026/03/02 15:32:26 pin Exp $
...
CARGO_CRATE_DEPENDS+=	atoi_simd-0.16.0
...
CARGO_CRATE_DEPENDS+=	aws-config-1.8.5
CARGO_CRATE_DEPENDS+=	aws-credential-types-1.2.11
CARGO_CRATE_DEPENDS+=	aws-lc-rs-1.15.4
CARGO_CRATE_DEPENDS+=	aws-lc-sys-0.37.0
CARGO_CRATE_DEPENDS+=	aws-runtime-1.5.10
CARGO_CRATE_DEPENDS+=	aws-sdk-sso-1.82.0
CARGO_CRATE_DEPENDS+=	aws-sdk-ssooidc-1.83.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sts-1.84.0
CARGO_CRATE_DEPENDS+=	aws-sigv4-1.3.7
CARGO_CRATE_DEPENDS+=	aws-smithy-async-1.2.11
CARGO_CRATE_DEPENDS+=	aws-smithy-http-0.62.6
CARGO_CRATE_DEPENDS+=	aws-smithy-http-client-1.0.6
CARGO_CRATE_DEPENDS+=	aws-smithy-json-0.61.9
CARGO_CRATE_DEPENDS+=	aws-smithy-observability-0.1.5
CARGO_CRATE_DEPENDS+=	aws-smithy-query-0.60.9
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-1.8.6
...
CARGO_CRATE_DEPENDS+=	chrono-tz-0.10.0
...
CARGO_CRATE_DEPENDS+=	edtui-0.11.1
...
CARGO_CRATE_DEPENDS+=	heapless-0.9.1
...
CARGO_CRATE_DEPENDS+=	lz4-1.28.0
...
CARGO_CRATE_DEPENDS+=	object_store-0.12.1
...
CARGO_CRATE_DEPENDS+=	parse_datetime-0.13.2
...
CARGO_CRATE_DEPENDS+=	polars-arrow-format-0.2.0
...
CARGO_CRATE_DEPENDS+=	quick-xml-0.39.0
...
CARGO_CRATE_DEPENDS+=	raw-cpuid-11.2.0
...
CARGO_CRATE_DEPENDS+=	reedline-0.46.0
...
CARGO_CRATE_DEPENDS+=	rmcp-0.16.0
CARGO_CRATE_DEPENDS+=	rmcp-macros-0.16.0
...
CARGO_CRATE_DEPENDS+=	rustls-platform-verifier-0.5.3
...
CARGO_CRATE_DEPENDS+=	scraper-0.24.0
...
CARGO_CRATE_DEPENDS+=	shadow-rs-1.7.0
...
CARGO_CRATE_DEPENDS+=	sysinfo-0.38.0
CARGO_CRATE_DEPENDS+=	tabled-0.20.0
CARGO_CRATE_DEPENDS+=	tango-bench-0.6.0
...
CARGO_CRATE_DEPENDS+=	tzdb_data-0.2.1
...
CARGO_CRATE_DEPENDS+=	uu_cp-0.6.0
CARGO_CRATE_DEPENDS+=	uu_mkdir-0.6.0
CARGO_CRATE_DEPENDS+=	uu_mktemp-0.6.0
CARGO_CRATE_DEPENDS+=	uu_mv-0.6.0
CARGO_CRATE_DEPENDS+=	uu_touch-0.6.0
CARGO_CRATE_DEPENDS+=	uu_uname-0.6.0
CARGO_CRATE_DEPENDS+=	uu_whoami-0.6.0
CARGO_CRATE_DEPENDS+=	uucore-0.6.0
CARGO_CRATE_DEPENDS+=	uucore_procs-0.6.0
...
CARGO_CRATE_DEPENDS+=	webpki-root-certs-0.26.11
CARGO_CRATE_DEPENDS+=	webpki-root-certs-1.0.1
...
CARGO_CRATE_DEPENDS+=	win_uds-0.2.1
...
CARGO_CRATE_DEPENDS+=	winresource-0.1.19
