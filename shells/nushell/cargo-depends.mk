# $NetBSD: cargo-depends.mk,v 1.20 2023/04/27 07:16:17 pin Exp $
...
CARGO_CRATE_DEPENDS+=	arrow2-0.16.0
...
CARGO_CRATE_DEPENDS+=	halfbrown-0.1.18
...
CARGO_CRATE_DEPENDS+=	polars-0.27.2
CARGO_CRATE_DEPENDS+=	polars-arrow-0.27.2
CARGO_CRATE_DEPENDS+=	polars-core-0.27.2
CARGO_CRATE_DEPENDS+=	polars-io-0.27.2
CARGO_CRATE_DEPENDS+=	polars-lazy-0.27.2
CARGO_CRATE_DEPENDS+=	polars-ops-0.27.2
CARGO_CRATE_DEPENDS+=	polars-pipe-0.27.2
CARGO_CRATE_DEPENDS+=	polars-plan-0.27.2
CARGO_CRATE_DEPENDS+=	polars-time-0.27.2
CARGO_CRATE_DEPENDS+=	polars-utils-0.27.2
...
CARGO_CRATE_DEPENDS+=	reedline-0.19.0
