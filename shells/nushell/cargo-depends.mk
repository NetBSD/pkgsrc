# $NetBSD: cargo-depends.mk,v 1.57 2025/11/30 11:24:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bracoxide-0.1.7
...
CARGO_CRATE_DEPENDS+=	linux-raw-sys-0.12.0
...
CARGO_CRATE_DEPENDS+=	reedline-0.44.0
...
CARGO_CRATE_DEPENDS+=	uu_cp-0.4.0
CARGO_CRATE_DEPENDS+=	uu_mkdir-0.4.0
CARGO_CRATE_DEPENDS+=	uu_mktemp-0.4.0
CARGO_CRATE_DEPENDS+=	uu_mv-0.4.0
CARGO_CRATE_DEPENDS+=	uu_touch-0.4.0
CARGO_CRATE_DEPENDS+=	uu_uname-0.4.0
CARGO_CRATE_DEPENDS+=	uu_whoami-0.4.0
CARGO_CRATE_DEPENDS+=	uucore-0.4.0
CARGO_CRATE_DEPENDS+=	uucore_procs-0.4.0
