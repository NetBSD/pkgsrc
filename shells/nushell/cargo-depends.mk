# $NetBSD: cargo-depends.mk,v 1.19 2023/04/05 08:05:14 pin Exp $
...
CARGO_CRATE_DEPENDS+=	alphanumeric-sort-1.5.0
...
CARGO_CRATE_DEPENDS+=	async-stream-0.3.4
CARGO_CRATE_DEPENDS+=	async-stream-impl-0.3.4
...
CARGO_CRATE_DEPENDS+=	clang-sys-1.6.0
...
CARGO_CRATE_DEPENDS+=	fd-lock-3.0.10
...
CARGO_CRATE_DEPENDS+=	ghost-0.1.8
...
CARGO_CRATE_DEPENDS+=	inventory-0.3.4
...
CARGO_CRATE_DEPENDS+=	miette-5.6.0
CARGO_CRATE_DEPENDS+=	miette-derive-5.6.0
...
CARGO_CRATE_DEPENDS+=	mockito-1.0.0
...
CARGO_CRATE_DEPENDS+=	openssl-src-111.25.1+1.1.1t
...
CARGO_CRATE_DEPENDS+=	reedline-0.18.0
...
CARGO_CRATE_DEPENDS+=	rust-embed-6.6.0
...
CARGO_CRATE_DEPENDS+=	serde_yaml-0.9.19
...
CARGO_CRATE_DEPENDS+=	typetag-0.2.6
CARGO_CRATE_DEPENDS+=	typetag-impl-0.2.6
...
CARGO_CRATE_DEPENDS+=	unsafe-libyaml-0.2.7
