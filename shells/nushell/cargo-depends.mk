# $NetBSD: cargo-depends.mk,v 1.7 2021/11/17 11:20:32 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bigdecimal-rs-0.2.1
...
CARGO_CRATE_DEPENDS+=	insta-1.7.2
...
CARGO_CRATE_DEPENDS+=	lexical-6.0.0
CARGO_CRATE_DEPENDS+=	lexical-core-0.8.0
CARGO_CRATE_DEPENDS+=	lexical-parse-float-0.8.0
CARGO_CRATE_DEPENDS+=	lexical-parse-integer-0.8.0
CARGO_CRATE_DEPENDS+=	lexical-util-0.8.1
CARGO_CRATE_DEPENDS+=	lexical-write-float-0.8.0
...
CARGO_CRATE_DEPENDS+=	parking_lot_core-0.8.4
...
CARGO_CRATE_DEPENDS+=	s3handler-0.7.4
...
CARGO_CRATE_DEPENDS+=	serde_test-1.0.129
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.6.13
...
CARGO_CRATE_DEPENDS+=	siphasher-0.3.6
...
CARGO_CRATE_DEPENDS+=	sysinfo-0.20.2
