# $NetBSD: cargo-depends.mk,v 1.13 2022/10/19 09:42:32 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ansi-str-0.4.0
...
CARGO_CRATE_DEPENDS+=	json_to_table-0.1.0
...
CARGO_CRATE_DEPENDS+=	papergrid-0.6.0
...
CARGO_CRATE_DEPENDS+=	reedline-0.13.0
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.16.3
...
CARGO_CRATE_DEPENDS+=	tabled-0.9.0
