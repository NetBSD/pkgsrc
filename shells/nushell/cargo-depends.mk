...
CARGO_CRATE_DEPENDS+=	calamine-0.35.0
...
CARGO_CRATE_DEPENDS+=	fff-grep-0.9.6
CARGO_CRATE_DEPENDS+=	fff-notify-debouncer-full-0.9.4
CARGO_CRATE_DEPENDS+=	fff-query-parser-0.9.6
CARGO_CRATE_DEPENDS+=	fff-search-0.9.6
...
CARGO_CRATE_DEPENDS+=	lean_string-0.6.0
...
CARGO_CRATE_DEPENDS+=	lsp-server-0.8.0
...
CARGO_CRATE_DEPENDS+=	reedline-0.49.0
...
CARGO_CRATE_DEPENDS+=	uu_cp-0.9.0
CARGO_CRATE_DEPENDS+=	uu_mkdir-0.9.0
CARGO_CRATE_DEPENDS+=	uu_mktemp-0.9.0
CARGO_CRATE_DEPENDS+=	uu_mv-0.9.0
CARGO_CRATE_DEPENDS+=	uu_touch-0.9.0
CARGO_CRATE_DEPENDS+=	uu_uname-0.9.0
CARGO_CRATE_DEPENDS+=	uu_whoami-0.9.0
CARGO_CRATE_DEPENDS+=	uucore-0.9.0
CARGO_CRATE_DEPENDS+=	uucore_procs-0.9.0
