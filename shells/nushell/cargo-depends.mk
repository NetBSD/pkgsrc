# $NetBSD: cargo-depends.mk,v 1.33 2024/03/06 19:54:07 pin Exp $
...
CARGO_CRATE_DEPENDS+=	miette-7.1.0
CARGO_CRATE_DEPENDS+=	miette-derive-7.1.0
...
CARGO_CRATE_DEPENDS+=	mockito-1.3.0
...
CARGO_CRATE_DEPENDS+=	reedline-0.30.0
