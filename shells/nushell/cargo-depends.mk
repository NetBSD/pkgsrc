# $NetBSD: cargo-depends.mk,v 1.3 2021/09/03 10:29:52 pin Exp $
...
CARGO_CRATE_DEPENDS+=	arrow-5.1.0
...
CARGO_CRATE_DEPENDS+=	parquet-5.1.0
...
CARGO_CRATE_DEPENDS+=	serde_test-1.0.127
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.6.8
...
# Versions sysinfo <0.18.2 have no support for NetBSD
