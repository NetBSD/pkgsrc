# $NetBSD: cargo-depends.mk,v 1.32 2024/02/10 17:28:24 pin Exp $
...
CARGO_CRATE_DEPENDS+=	calamine-0.23.1
...
CARGO_CRATE_DEPENDS+=	ical-0.10.0
...
CARGO_CRATE_DEPENDS+=	openssl-src-300.2.1+3.2.0
...
CARGO_CRATE_DEPENDS+=	polars-0.36.2
CARGO_CRATE_DEPENDS+=	polars-arrow-0.36.2
CARGO_CRATE_DEPENDS+=	polars-compute-0.36.2
CARGO_CRATE_DEPENDS+=	polars-core-0.36.2
CARGO_CRATE_DEPENDS+=	polars-error-0.36.2
CARGO_CRATE_DEPENDS+=	polars-io-0.36.2
CARGO_CRATE_DEPENDS+=	polars-json-0.36.2
CARGO_CRATE_DEPENDS+=	polars-lazy-0.36.2
CARGO_CRATE_DEPENDS+=	polars-ops-0.36.2
CARGO_CRATE_DEPENDS+=	polars-parquet-0.36.2
CARGO_CRATE_DEPENDS+=	polars-pipe-0.36.2
CARGO_CRATE_DEPENDS+=	polars-plan-0.36.2
CARGO_CRATE_DEPENDS+=	polars-row-0.36.2
CARGO_CRATE_DEPENDS+=	polars-sql-0.36.2
CARGO_CRATE_DEPENDS+=	polars-time-0.36.2
CARGO_CRATE_DEPENDS+=	polars-utils-0.36.2
...
CARGO_CRATE_DEPENDS+=	reedline-0.29.0
...
CARGO_CRATE_DEPENDS+=	serde_json-1.0.112
...
CARGO_CRATE_DEPENDS+=	sqlparser-0.43.1
...
CARGO_CRATE_DEPENDS+=	uu_mv-0.0.23
CARGO_CRATE_DEPENDS+=	uu_whoami-0.0.23
CARGO_CRATE_DEPENDS+=	uucore-0.0.24
