# $NetBSD: cargo-depends.mk,v 1.4 2021/09/15 13:39:28 pin Exp $
...
CARGO_CRATE_DEPENDS+=	parquet-5.2.0
...
CARGO_CRATE_DEPENDS+=	polars-0.15.1
CARGO_CRATE_DEPENDS+=	polars-arrow-0.15.1
CARGO_CRATE_DEPENDS+=	polars-core-0.15.1
CARGO_CRATE_DEPENDS+=	polars-io-0.15.1
CARGO_CRATE_DEPENDS+=	polars-lazy-0.15.1
