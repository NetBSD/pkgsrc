# $NetBSD: cargo-depends.mk,v 1.21 2023/05/17 21:33:35 pin Exp $
...
CARGO_CRATE_DEPENDS+=	ctor-0.2.0
...
CARGO_CRATE_DEPENDS+=	inventory-0.3.5
...
CARGO_CRATE_DEPENDS+=	libgit2-sys-0.15.0+1.6.3
...
CARGO_CRATE_DEPENDS+=	miette-5.7.0
CARGO_CRATE_DEPENDS+=	miette-derive-5.7.0
...
CARGO_CRATE_DEPENDS+=	multiversion-0.7.1
CARGO_CRATE_DEPENDS+=	multiversion-macros-0.7.1
...
CARGO_CRATE_DEPENDS+=	omnipath-0.1.5
...
CARGO_CRATE_DEPENDS+=	os_pipe-1.1.3
...
CARGO_CRATE_DEPENDS+=	reedline-0.19.1
...
CARGO_CRATE_DEPENDS+=	rustix-0.36.12
...
CARGO_CRATE_DEPENDS+=	scraper-0.15.0
...
CARGO_CRATE_DEPENDS+=	shadow-rs-0.21.0
...
CARGO_CRATE_DEPENDS+=	sqlparser-0.32.0
...
CARGO_CRATE_DEPENDS+=	supports-hyperlinks-2.0.0
...
CARGO_CRATE_DEPENDS+=	target-features-0.1.3
...
CARGO_CRATE_DEPENDS+=	typetag-0.2.7
CARGO_CRATE_DEPENDS+=	typetag-impl-0.2.7
...
CARGO_CRATE_DEPENDS+=	uuid-1.3.1
CARGO_CRATE_DEPENDS+=	value-trait-0.6.0
