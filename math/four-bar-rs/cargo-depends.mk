# $NetBSD: cargo-depends.mk,v 1.2 2023/09/21 11:26:30 pin Exp $
...
CARGO_CRATE_DEPENDS+=	efd-4.0.1
CARGO_CRATE_DEPENDS+=	eframe-0.22.0
CARGO_CRATE_DEPENDS+=	egui-0.22.0
CARGO_CRATE_DEPENDS+=	egui-toast-0.8.1
CARGO_CRATE_DEPENDS+=	egui-winit-0.22.0
CARGO_CRATE_DEPENDS+=	egui_glow-0.22.0
...
CARGO_CRATE_DEPENDS+=	interp-1.0.1
