# $NetBSD: cargo-depends.mk,v 1.5 2023/11/21 12:09:22 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.23
CARGO_CRATE_DEPENDS+=	ab_glyph_rasterizer-0.1.8
CARGO_CRATE_DEPENDS+=	accesskit-0.11.2
CARGO_CRATE_DEPENDS+=	accesskit_consumer-0.15.2
CARGO_CRATE_DEPENDS+=	accesskit_macos-0.9.0
CARGO_CRATE_DEPENDS+=	accesskit_unix-0.5.2
CARGO_CRATE_DEPENDS+=	accesskit_windows-0.14.3
CARGO_CRATE_DEPENDS+=	accesskit_winit-0.14.4
...
CARGO_CRATE_DEPENDS+=	atspi-0.10.1
CARGO_CRATE_DEPENDS+=	atspi-macros-0.2.0
...
CARGO_CRATE_DEPENDS+=	efd-5.0.1
CARGO_CRATE_DEPENDS+=	eframe-0.23.0
CARGO_CRATE_DEPENDS+=	egui-0.23.0
CARGO_CRATE_DEPENDS+=	egui-winit-0.23.0
CARGO_CRATE_DEPENDS+=	egui_glow-0.23.0
...
CARGO_CRATE_DEPENDS+=	metaheuristics-nature-9.2.3
