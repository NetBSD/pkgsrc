$NetBSD: patch-src_config_param.nbsd110.h,v 1.1 2026/09/12 15:45:26 jakllsch Exp $

--- src/config/param.nbsd110.h.orig	2026-09-12 14:58:07.726467992 +0000
+++ src/config/param.nbsd110.h
@@ -0,0 +1,165 @@
