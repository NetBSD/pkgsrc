$NetBSD: patch-src_config_param.armv7__nbsd80.h,v 1.1 2026/09/12 15:45:26 jakllsch Exp $

- Add support for NetBSD 8 on armv6 based on filename but generic in content to be
  applicable to other generations of ARM

--- src/config/param.armv7_nbsd80.h.orig	2026-09-11 22:20:21.322347278 +0000
+++ src/config/param.armv7_nbsd80.h
@@ -0,0 +1,19 @@
+#ifndef        AFS_PARAM_H
+#define        AFS_PARAM_H
+
