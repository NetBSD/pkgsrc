$NetBSD: patch-security_nss_cmd_shlibsign_sign.sh,v 1.4 2012/04/28 22:48:07 ryoon Exp $
...
--- mozilla/security/nss/cmd/shlibsign/sign.sh.orig	2012-04-23 06:28:17.000000000 +0000
