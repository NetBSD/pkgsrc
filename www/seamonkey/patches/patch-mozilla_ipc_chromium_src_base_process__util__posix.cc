$NetBSD: patch-mozilla_ipc_chromium_src_base_process__util__posix.cc,v 1.2 2012/03/19 10:35:59 ryoon Exp $

--- mozilla/ipc/chromium/src/base/process_util_posix.cc.orig	2012-03-13 05:32:39.000000000 +0000
