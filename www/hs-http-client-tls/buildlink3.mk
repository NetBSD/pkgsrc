# $NetBSD: buildlink3.mk,v 1.1 2020/01/17 15:17:55 pho Exp $
...
BUILDLINK_API_DEPENDS.hs-http-client-tls+=	hs-http-client-tls>=0.3.5.3
BUILDLINK_ABI_DEPENDS.hs-http-client-tls+=	hs-http-client-tls>=0.3.5.3
