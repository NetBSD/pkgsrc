# $NetBSD: cargo-depends.mk,v 1.2 2023/10/22 19:31:10 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-compat-0.2.3
...
CARGO_CRATE_DEPENDS+=	crates-index-diff-21.0.0
...
CARGO_CRATE_DEPENDS+=	rustix-0.37.26
