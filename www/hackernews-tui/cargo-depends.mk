# $NetBSD: cargo-depends.mk,v 1.1 2021/03/18 21:57:35 pin Exp $
...
CARGO_CRATE_DEPENDS+=	libc-0.2.89
...
CARGO_CRATE_DEPENDS+=	mio-0.7.10
...
CARGO_CRATE_DEPENDS+=	signal-hook-0.3.7
...
CARGO_CRATE_DEPENDS+=	ureq-2.0.2
