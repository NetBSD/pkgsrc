# $NetBSD: cargo-depends.mk,v 1.3 2023/04/23 10:21:53 nikita Exp $
...
CARGO_CRATE_DEPENDS+=	elasticlunr-rs-3.0.1
...
CARGO_CRATE_DEPENDS+=	grass-0.12.3
CARGO_CRATE_DEPENDS+=	grass_compiler-0.12.3
...
CARGO_CRATE_DEPENDS+=	jieba-rs-0.6.7
...
CARGO_CRATE_DEPENDS+=	libwebp-sys-0.4.2
...
CARGO_CRATE_DEPENDS+=	minify-html-0.10.8
...
CARGO_CRATE_DEPENDS+=	plist-1.4.2
...
CARGO_CRATE_DEPENDS+=	svg_metadata-0.4.4
...
CARGO_CRATE_DEPENDS+=	webp-0.2.2
...
CARGO_CRATE_DEPENDS+=	zune-inflate-0.2.51
