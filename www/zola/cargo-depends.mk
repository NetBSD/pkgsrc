# $NetBSD: cargo-depends.mk,v 1.2 2022/10/04 10:53:05 wiz Exp $

CARGO_CRATE_DEPENDS+=	adler-1.0.2
CARGO_CRATE_DEPENDS+=	adler32-1.2.0
CARGO_CRATE_DEPENDS+=	ahash-0.8.0
CARGO_CRATE_DEPENDS+=	aho-corasick-0.7.18
CARGO_CRATE_DEPENDS+=	ammonia-3.2.0
...
CARGO_CRATE_DEPENDS+=	css-minify-0.2.2
...
CARGO_CRATE_DEPENDS+=	insta-1.18.2
...
CARGO_CRATE_DEPENDS+=	minify-html-0.9.2
CARGO_CRATE_DEPENDS+=	minify-js-0.1.5
...
CARGO_CRATE_DEPENDS+=	mockito-0.31.0
...
CARGO_CRATE_DEPENDS+=	serde_yaml-0.9.9
...
CARGO_CRATE_DEPENDS+=	test-case-2.2.1
