$NetBSD: patch-platform_media_ffvpx_config__unix__sparc64.h,v 1.1.2.2 2025/11/25 08:38:37 bsiegert Exp $

Add pregenerated config for sparc64.
This has been accepted upstream.

--- platform/media/ffvpx/config_unix_sparc64.h.orig	2025-11-23 10:49:11.451664185 +0000
+++ platform/media/ffvpx/config_unix_sparc64.h
@@ -0,0 +1,785 @@
+/* Automatically generated by configure - do not modify! */
+#ifndef FFMPEG_CONFIG_H
+#define FFMPEG_CONFIG_H
+#define FFMPEG_CONFIGURATION "--disable-all --enable-avcodec --enable-decoder='vp8,vp9,mp3,flac,av1' --enable-parser='vp8,vp9' --disable-static --enable-shared --disable-autodetect --disable-iconv"
