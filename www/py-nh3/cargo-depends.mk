# $NetBSD: cargo-depends.mk,v 1.3 2024/04/05 10:53:33 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	pyo3-0.21.0
CARGO_CRATE_DEPENDS+=	pyo3-build-config-0.21.0
CARGO_CRATE_DEPENDS+=	pyo3-ffi-0.21.0
CARGO_CRATE_DEPENDS+=	pyo3-macros-0.21.0
CARGO_CRATE_DEPENDS+=	pyo3-macros-backend-0.21.0
