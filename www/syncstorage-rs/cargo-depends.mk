# $NetBSD: cargo-depends.mk,v 1.2 2024/06/17 09:55:33 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	sentry-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-backtrace-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-contexts-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-core-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-debug-images-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-tracing-0.32.3
CARGO_CRATE_DEPENDS+=	sentry-types-0.32.3
