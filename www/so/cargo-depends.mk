# $NetBSD: cargo-depends.mk,v 1.1 2021/01/14 15:08:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	hyper-0.14.2
...
CARGO_CRATE_DEPENDS+=	reqwest-0.11.0
...
CARGO_CRATE_DEPENDS+=	termimad-0.9.2
...
CARGO_CRATE_DEPENDS+=	tokio-1.0.1
CARGO_CRATE_DEPENDS+=	tokio-macros-1.0.0
CARGO_CRATE_DEPENDS+=	tokio-native-tls-0.3.0
CARGO_CRATE_DEPENDS+=	tokio-stream-0.1.2
CARGO_CRATE_DEPENDS+=	tokio-util-0.6.1
