# $NetBSD: go-modules.mk,v 1.39 2026/09/02 14:49:34 taca Exp $
...
GO_MODULE_FILES+=	cloud.google.com/go/storage/@v/v1.57.2.mod
GO_MODULE_FILES+=	cloud.google.com/go/storage/@v/v1.57.2.zip
...
GO_MODULE_FILES+=	github.com/!johannes!kaufmann/dom/@v/v0.3.1.mod
GO_MODULE_FILES+=	github.com/!johannes!kaufmann/dom/@v/v0.3.1.zip
GO_MODULE_FILES+=	github.com/!johannes!kaufmann/html-to-markdown/v2/@v/v2.5.2.mod
GO_MODULE_FILES+=	github.com/!johannes!kaufmann/html-to-markdown/v2/@v/v2.5.2.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/@v/v1.41.6.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/@v/v1.41.6.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/config/@v/v1.32.2.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/config/@v/v1.32.2.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/credentials/@v/v1.19.2.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/credentials/@v/v1.19.2.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/feature/ec2/imds/@v/v1.18.14.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/feature/ec2/imds/@v/v1.18.14.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/configsources/@v/v1.4.22.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/configsources/@v/v1.4.22.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/endpoints/v2/@v/v2.7.22.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/endpoints/v2/@v/v2.7.22.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/cloudfront/@v/v1.61.1.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/cloudfront/@v/v1.61.1.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/signin/@v/v1.0.2.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/signin/@v/v1.0.2.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sso/@v/v1.30.5.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sso/@v/v1.30.5.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/ssooidc/@v/v1.35.10.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/ssooidc/@v/v1.35.10.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sts/@v/v1.41.2.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sts/@v/v1.41.2.zip
GO_MODULE_FILES+=	github.com/aws/smithy-go/@v/v1.25.0.mod
GO_MODULE_FILES+=	github.com/aws/smithy-go/@v/v1.25.0.zip
...
GO_MODULE_FILES+=	github.com/bep/gitmap/@v/v1.9.0.mod
GO_MODULE_FILES+=	github.com/bep/gitmap/@v/v1.9.0.zip
GO_MODULE_FILES+=	github.com/bep/goat/@v/v0.5.0.mod
GO_MODULE_FILES+=	github.com/bep/goat/@v/v0.5.0.zip
GO_MODULE_FILES+=	github.com/bep/godartsass/v2/@v/v2.5.0.mod
GO_MODULE_FILES+=	github.com/bep/godartsass/v2/@v/v2.5.0.zip
GO_MODULE_FILES+=	github.com/bep/golibsass/@v/v1.2.0.mod
GO_MODULE_FILES+=	github.com/bep/golibsass/@v/v1.2.0.zip
GO_MODULE_FILES+=	github.com/bep/golocales/@v/v0.2.0.mod
GO_MODULE_FILES+=	github.com/bep/golocales/@v/v0.2.0.zip
GO_MODULE_FILES+=	github.com/bep/goportabletext/@v/v0.2.0.mod
GO_MODULE_FILES+=	github.com/bep/goportabletext/@v/v0.2.0.zip
GO_MODULE_FILES+=	github.com/bep/helpers/@v/v0.12.0.mod
GO_MODULE_FILES+=	github.com/bep/helpers/@v/v0.12.0.zip
GO_MODULE_FILES+=	github.com/bep/imagemeta/@v/v1.0.0.mod
GO_MODULE_FILES+=	github.com/bep/imagemeta/@v/v1.0.0.zip
...
GO_MODULE_FILES+=	github.com/bep/mclib/@v/v1.20401.20400.mod
GO_MODULE_FILES+=	github.com/bep/mclib/@v/v1.20401.20400.zip
GO_MODULE_FILES+=	github.com/bep/overlayfs/@v/v0.11.0.mod
GO_MODULE_FILES+=	github.com/bep/overlayfs/@v/v0.11.0.zip
GO_MODULE_FILES+=	github.com/bep/simplecobra/@v/v0.7.0.mod
GO_MODULE_FILES+=	github.com/bep/simplecobra/@v/v0.7.0.zip
GO_MODULE_FILES+=	github.com/bep/textandbinarywriter/@v/v0.1.0.mod
GO_MODULE_FILES+=	github.com/bep/textandbinarywriter/@v/v0.1.0.zip
GO_MODULE_FILES+=	github.com/bep/tmc/@v/v0.6.0.mod
GO_MODULE_FILES+=	github.com/bep/tmc/@v/v0.6.0.zip
...
GO_MODULE_FILES+=	github.com/evanw/esbuild/@v/v0.28.2.mod
GO_MODULE_FILES+=	github.com/evanw/esbuild/@v/v0.28.2.zip
...
GO_MODULE_FILES+=	github.com/getkin/kin-openapi/@v/v0.146.0.mod
GO_MODULE_FILES+=	github.com/getkin/kin-openapi/@v/v0.146.0.zip
...
GO_MODULE_FILES+=	github.com/gohugoio/gift/@v/v0.2.0.mod
GO_MODULE_FILES+=	github.com/gohugoio/gift/@v/v0.2.0.zip
...
GO_MODULE_FILES+=	github.com/gohugoio/go-radix/@v/v1.2.0.zip
GO_MODULE_FILES+=	github.com/gohugoio/hashstructure/@v/v1.0.0.mod
GO_MODULE_FILES+=	github.com/gohugoio/hashstructure/@v/v1.0.0.zip
GO_MODULE_FILES+=	github.com/gohugoio/httpcache/@v/v0.8.0.mod
GO_MODULE_FILES+=	github.com/gohugoio/httpcache/@v/v0.8.0.zip
GO_MODULE_FILES+=	github.com/gohugoio/hugo-goldmark-extensions/extras/@v/v0.7.0.mod
GO_MODULE_FILES+=	github.com/gohugoio/hugo-goldmark-extensions/extras/@v/v0.7.0.zip
GO_MODULE_FILES+=	github.com/gohugoio/hugo-goldmark-extensions/passthrough/@v/v0.5.0.mod
GO_MODULE_FILES+=	github.com/gohugoio/hugo-goldmark-extensions/passthrough/@v/v0.5.0.zip
...
GO_MODULE_FILES+=	github.com/hairyhenderson/go-codeowners/@v/v0.7.0.mod
GO_MODULE_FILES+=	github.com/hairyhenderson/go-codeowners/@v/v0.7.0.zip
...
GO_MODULE_FILES+=	github.com/spf13/fsync/@v/v0.10.1.mod
GO_MODULE_FILES+=	github.com/spf13/fsync/@v/v0.10.1.zip
...
GO_MODULE_FILES+=	github.com/tdewolff/minify/v2/@v/v2.24.16.mod
GO_MODULE_FILES+=	github.com/tdewolff/minify/v2/@v/v2.24.16.zip
GO_MODULE_FILES+=	github.com/tdewolff/parse/v2/@v/v2.8.15.mod
GO_MODULE_FILES+=	github.com/tdewolff/parse/v2/@v/v2.8.15.zip
GO_MODULE_FILES+=	github.com/tdewolff/test/@v/v1.0.12.mod
...
GO_MODULE_FILES+=	google.golang.org/api/@v/v0.276.0.mod
GO_MODULE_FILES+=	google.golang.org/api/@v/v0.276.0.zip
...
GO_MODULE_FILES+=	software.sslmate.com/src/go-pkcs12/@v/v0.7.0.mod
GO_MODULE_FILES+=	software.sslmate.com/src/go-pkcs12/@v/v0.7.0.zip
