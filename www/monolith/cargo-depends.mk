# $NetBSD: cargo-depends.mk,v 1.2 2021/06/02 19:54:37 pin Exp $
...
CARGO_CRATE_DEPENDS+=	hyper-0.14.8
...
CARGO_CRATE_DEPENDS+=	reqwest-0.11.3
...
CARGO_CRATE_DEPENDS+=	tokio-1.6.1
...
CARGO_CRATE_DEPENDS+=	unicode-normalization-0.1.18
...
CARGO_CRATE_DEPENDS+=	vcpkg-0.2.13
