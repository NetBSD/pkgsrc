$NetBSD: patch-src_3rdparty_chromium_sandbox_policy_netbsd_sandbox__netbsd.cc,v 1.2 2026/04/30 06:39:42 adam Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- src/3rdparty/chromium/sandbox/policy/netbsd/sandbox_netbsd.cc.orig	2026-04-22 12:29:50.147732504 +0000
