$NetBSD: patch-src_3rdparty_chromium_chrome_browser_custom__handlers_chrome__protocol__handler__registry__delegate.cc,v 1.1 2025/12/21 09:38:18 markd Exp $
