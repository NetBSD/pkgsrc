$NetBSD: patch-src_3rdparty_chromium_components_user__education_views_help__bubble__view.cc,v 1.2 2026/04/30 06:39:39 adam Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- src/3rdparty/chromium/components/user_education/views/help_bubble_view.cc.orig	2026-03-16 11:40:07.000000000 +0000
