$NetBSD: patch-src_3rdparty_chromium_net_websockets_websocket__basic__stream__adapters__test.cc,v 1.1 2026/04/30 06:39:42 adam Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- src/3rdparty/chromium/net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-03-16 11:40:07.000000000 +0000
+++ src/3rdparty/chromium/net/websockets/websocket_basic_stream_adapters_test.cc
