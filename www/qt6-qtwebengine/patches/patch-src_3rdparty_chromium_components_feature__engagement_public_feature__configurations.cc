$NetBSD: patch-src_3rdparty_chromium_components_feature__engagement_public_feature__configurations.cc,v 1.2 2026/04/30 06:39:38 adam Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- src/3rdparty/chromium/components/feature_engagement/public/feature_configurations.cc.orig	2026-03-16 11:40:07.000000000 +0000
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   if (kIPHPasswordsManagementBubbleAfterSaveFeature.name == feature->name) {
     ...
     config.valid = true;
@@ -1956,7 +1956,7 @@ std::optional<FeatureConfig> GetClientSi
