$NetBSD: patch-printing_backend_cups__helper.cc,v 1.20 2026/08/09 06:31:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- printing/backend/cups_helper.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -970,7 +970,7 @@ ScopedHttpPtr HttpConnect2(const char* h
                            int blocking,
                            int msec,
                            int* cancel) {
-#if BUILDFLAG(IS_LINUX)
