$NetBSD: patch-remoting_host_webauthn_remote__webauthn__extension__notifier.cc,v 1.8 2025/10/16 19:43:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/webauthn/remote_webauthn_extension_notifier.cc.orig	2025-10-13 21:41:26.000000000 +0000
