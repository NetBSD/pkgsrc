$NetBSD: patch-remoting_signaling_ftl__host__device__id__provider.cc,v 1.8 2025/11/04 14:55:44 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/signaling/ftl_host_device_id_provider.cc.orig	2025-10-24 16:42:30.000000000 +0000
