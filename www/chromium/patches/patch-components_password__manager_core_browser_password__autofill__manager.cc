$NetBSD: patch-components_password__manager_core_browser_password__autofill__manager.cc,v 1.4 2025/10/16 19:43:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/password_manager/core/browser/password_autofill_manager.cc.orig	2025-10-13 21:41:26.000000000 +0000
+++ components/password_manager/core/browser/password_autofill_manager.cc
@@ -314,7 +314,7 @@ void PasswordAutofillManager::DidAcceptS
...
@@ -544,7 +544,7 @@ void PasswordAutofillManager::DidNavigat
