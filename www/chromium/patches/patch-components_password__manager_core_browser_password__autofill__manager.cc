$NetBSD: patch-components_password__manager_core_browser_password__autofill__manager.cc,v 1.22 2026/09/22 13:41:24 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/password_manager/core/browser/password_autofill_manager.cc.orig	2026-09-14 22:17:16.000000000 +0000
...
@@ -456,7 +456,7 @@ void PasswordAutofillManager::DidAcceptS
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
         cross_domain_confirmation_controller_ =
             password_client_->ShowCrossDomainConfirmationPopup(
                 last_popup_open_args_.element_bounds,
@@ -725,7 +725,7 @@ void PasswordAutofillManager::DidNavigat
