$NetBSD: patch-chrome_browser_ui_views_tabs_projects_projects__panel__tab__groups__item__view.cc,v 1.1 2026/04/10 17:31:51 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/views/tabs/projects/projects_panel_tab_groups_item_view.cc.orig	2026-04-06 16:25:54.000000000 +0000
+++ chrome/browser/ui/views/tabs/projects/projects_panel_tab_groups_item_view.cc
@@ -243,7 +243,7 @@ void ProjectsPanelTabGroupsItemView::OnM
