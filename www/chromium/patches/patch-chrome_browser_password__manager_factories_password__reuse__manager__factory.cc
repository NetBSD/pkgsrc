$NetBSD: patch-chrome_browser_password__manager_factories_password__reuse__manager__factory.cc,v 1.18 2026/07/06 13:06:44 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/password_manager/factories/password_reuse_manager_factory.cc.orig	2026-06-23 23:37:18.000000000 +0000
