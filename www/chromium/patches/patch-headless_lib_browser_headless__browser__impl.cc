$NetBSD: patch-headless_lib_browser_headless__browser__impl.cc,v 1.8 2026/04/21 15:21:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- headless/lib/browser/headless_browser_impl.cc.orig	2026-04-14 23:31:37.000000000 +0200
