$NetBSD: patch-headless_lib_browser_headless__browser__impl.cc,v 1.1 2025/12/11 09:13:39 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- headless/lib/browser/headless_browser_impl.cc.orig	2025-11-19 21:40:05.000000000 +0000
