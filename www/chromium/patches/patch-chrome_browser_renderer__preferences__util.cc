$NetBSD: patch-chrome_browser_renderer__preferences__util.cc,v 1.18 2026/04/21 15:21:10 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/renderer_preferences_util.cc.orig	2026-04-14 23:31:37.000000000 +0200
...
@@ -111,7 +111,7 @@ void UpdateFromSystemSettings(blink::Ren
                               Profile* profile) {
...
@@ -142,7 +142,7 @@ void UpdateFromSystemSettings(blink::Ren
