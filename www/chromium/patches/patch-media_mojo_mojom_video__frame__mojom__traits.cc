$NetBSD: patch-media_mojo_mojom_video__frame__mojom__traits.cc,v 1.24 2026/08/09 06:31:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/mojo/mojom/video_frame_mojom_traits.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -145,7 +145,7 @@ media::mojom::VideoFrameDataPtr MakeVide
...
@@ -189,7 +189,7 @@ std::string PlanesToString(const std::ve
