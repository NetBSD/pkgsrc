...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -899,7 +899,7 @@ inline constexpr char kShowUpdatePromoti
...
@@ -1477,7 +1477,7 @@ inline constexpr char kPinInfoBarTimesSh
...
@@ -1528,7 +1528,7 @@ static_assert(std::string_view(kDownload
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -1994,7 +1994,7 @@ inline constexpr char kMediaStorageIdSal
...
@@ -2008,7 +2008,7 @@ inline constexpr char kNetworkServiceSan
...
@@ -2105,7 +2105,7 @@ inline constexpr char kIsolatedWebAppUse
...
@@ -2398,7 +2398,7 @@ inline constexpr char kHardwareSecureDec
 #endif  // BUILDFLAG(IS_WIN)
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2819,7 +2819,7 @@ inline constexpr char kScreenCaptureWith
...
@@ -2968,7 +2968,7 @@ inline constexpr char kLensRegionSearchE
...
@@ -3058,7 +3058,7 @@ inline constexpr char
