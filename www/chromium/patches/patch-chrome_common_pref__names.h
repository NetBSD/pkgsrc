$NetBSD: patch-chrome_common_pref__names.h,v 1.13 2025/12/23 13:22:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/pref_names.h.orig	2025-12-17 23:05:18.000000000 +0000
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -1501,7 +1501,7 @@ inline constexpr char kShowUpdatePromoti
...
@@ -2113,7 +2113,7 @@ inline constexpr char kPinInfoBarTimesSh
...
@@ -2160,7 +2160,7 @@ inline constexpr char kDownloadDefaultDi
