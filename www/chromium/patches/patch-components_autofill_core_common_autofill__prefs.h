$NetBSD: patch-components_autofill_core_common_autofill__prefs.h,v 1.8 2025/10/16 19:43:25 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/autofill/core/common/autofill_prefs.h.orig	2025-10-13 21:41:26.000000000 +0000
...
@@ -255,7 +255,7 @@ bool IsFacilitatedPaymentsA2AEnabled(con
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 void SetAutofillBnplEnabled(PrefService* prefs, bool value);
         ...
         // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID)
@@ -263,7 +263,7 @@ void SetAutofillBnplEnabled(PrefService*
