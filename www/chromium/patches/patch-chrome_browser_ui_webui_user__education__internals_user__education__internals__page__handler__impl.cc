$NetBSD: patch-chrome_browser_ui_webui_user__education__internals_user__education__internals__page__handler__impl.cc,v 1.20 2026/06/08 13:12:36 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc.orig	2026-05-28 23:24:11.000000000 +0000
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
   return nullptr;
@@ -920,7 +920,7 @@ void UserEducationInternalsPageHandlerIm
 }
