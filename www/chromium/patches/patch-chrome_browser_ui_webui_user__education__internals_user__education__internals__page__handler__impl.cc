$NetBSD: patch-chrome_browser_ui_webui_user__education__internals_user__education__internals__page__handler__impl.cc,v 1.5 2025/09/08 13:24:21 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc.orig	2025-08-29 18:50:09.000000000 +0000
