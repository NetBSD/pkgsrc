$NetBSD: patch-chrome_browser_ui_tabs_tab__features.cc,v 1.22 2026/08/09 06:31:11 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/tabs/tab_features.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -635,7 +635,7 @@ void TabFeatures::Init(TabInterface& tab
...
@@ -644,7 +644,7 @@ void TabFeatures::Init(TabInterface& tab
 #endif
