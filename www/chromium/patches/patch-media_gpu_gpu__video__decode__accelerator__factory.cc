$NetBSD: patch-media_gpu_gpu__video__decode__accelerator__factory.cc,v 1.19 2026/06/01 10:09:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/gpu/gpu_video_decode_accelerator_factory.cc.orig	2026-05-26 20:39:02.000000000 +0000
