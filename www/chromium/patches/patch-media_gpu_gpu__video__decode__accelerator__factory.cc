$NetBSD: patch-media_gpu_gpu__video__decode__accelerator__factory.cc,v 1.16 2026/04/10 17:31:56 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/gpu/gpu_video_decode_accelerator_factory.cc.orig	2026-04-06 16:25:54.000000000 +0000
