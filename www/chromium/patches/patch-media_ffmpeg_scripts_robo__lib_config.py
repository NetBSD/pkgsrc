$NetBSD: patch-media_ffmpeg_scripts_robo__lib_config.py,v 1.23 2026/07/08 13:42:26 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/ffmpeg/scripts/robo_lib/config.py.orig	2026-07-06 22:58:46.000000000 +0000
