$NetBSD: patch-media_ffmpeg_scripts_robo__lib_config.py,v 1.20 2026/06/01 10:09:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/ffmpeg/scripts/robo_lib/config.py.orig	2026-05-26 20:39:02.000000000 +0000
