$NetBSD: patch-chrome_browser_ui_webui_management_management__ui.cc,v 1.17 2026/04/10 17:31:51 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/management/management_ui.cc.orig	2026-04-06 16:25:54.000000000 +0000
+++ chrome/browser/ui/webui/management/management_ui.cc
@@ -184,11 +184,11 @@ void ManagementUI::GetLocalizedStrings(
