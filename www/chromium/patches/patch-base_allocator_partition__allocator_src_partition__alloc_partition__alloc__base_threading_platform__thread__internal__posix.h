$NetBSD: patch-base_allocator_partition__allocator_src_partition__alloc_partition__alloc__base_threading_platform__thread__internal__posix.h,v 1.4 2025/07/25 16:17:09 kikadf Exp $
