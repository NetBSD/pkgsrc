$NetBSD: patch-base_allocator_partition__allocator_src_partition__alloc_partition__alloc__base_threading_platform__thread__internal__posix.h,v 1.16 2026/03/14 12:40:22 kikadf Exp $
