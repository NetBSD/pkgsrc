$NetBSD: patch-chrome_browser_enterprise_util_managed__browser__utils.cc,v 1.25 2026/09/22 13:41:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/enterprise/util/managed_browser_utils.cc.orig	2026-09-14 22:17:16.000000000 +0000
