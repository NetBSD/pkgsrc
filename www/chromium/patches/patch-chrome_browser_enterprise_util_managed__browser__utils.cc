$NetBSD: patch-chrome_browser_enterprise_util_managed__browser__utils.cc,v 1.21 2026/07/06 13:06:43 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/enterprise/util/managed_browser_utils.cc.orig	2026-06-23 23:37:18.000000000 +0000
