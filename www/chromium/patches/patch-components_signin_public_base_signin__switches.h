$NetBSD: patch-components_signin_public_base_signin__switches.h,v 1.20 2026/06/08 13:12:39 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/signin/public/base/signin_switches.h.orig	2026-05-28 23:24:11.000000000 +0000
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 COMPONENT_EXPORT(SIGNIN_SWITCHES)
@@ -349,7 +349,7 @@ extern const base::FeatureParam<base::Ti
...
@@ -403,7 +403,7 @@ extern const base::FeatureParam<FirstRun
...
@@ -580,7 +580,7 @@ extern const base::FeatureParam<int> kCo
 COMPONENT_EXPORT(SIGNIN_SWITCHES)
