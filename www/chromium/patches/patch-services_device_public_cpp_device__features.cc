$NetBSD: patch-services_device_public_cpp_device__features.cc,v 1.23 2026/08/09 06:31:21 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- services/device/public/cpp/device_features.cc.orig	2026-08-05 20:17:42.000000000 +0000
+++ services/device/public/cpp/device_features.cc
@@ -174,11 +174,11 @@ bool IsOsLevelGeolocationPermissionSuppo
