$NetBSD: patch-chrome_browser_screen__ai_screen__ai__install__state.cc,v 1.8 2025/10/16 19:43:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/screen_ai/screen_ai_install_state.cc.orig	2025-10-13 21:41:26.000000000 +0000
