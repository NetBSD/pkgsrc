$NetBSD: patch-chrome_common_chrome__features.cc,v 1.19 2026/05/10 15:29:54 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/chrome_features.cc.orig	2026-04-28 23:05:57.000000000 +0200
...
@@ -732,7 +732,7 @@ BASE_FEATURE(kGlicWarming, base::FEATURE
...
@@ -1200,7 +1200,7 @@ BASE_FEATURE(kIsolatedWebAppManagedGuest
...
+#if (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)) && !BUILDFLAG(IS_CHROMEOS)
 ...
 // portal API:
@@ -1211,7 +1211,7 @@ constexpr base::FeatureParam<int> kLinux
