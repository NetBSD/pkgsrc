$NetBSD: patch-chrome_common_chrome__features.cc,v 1.11 2025/12/11 09:13:34 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/chrome_features.cc.orig	2025-11-19 21:40:05.000000000 +0000
+++ chrome/common/chrome_features.cc
@@ -90,7 +90,7 @@ BASE_FEATURE(kUseKeychainKeyProvider, ba
...
@@ -102,7 +102,7 @@ BASE_FEATURE(kAutofillCardSurvey, base::
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 // discard memory.
@@ -218,7 +218,7 @@ BASE_FEATURE(kDesktopPWAsElidedExtension
...
@@ -255,7 +255,7 @@ BASE_FEATURE(kEnableFullscreenToAnyScree
...
@@ -790,7 +790,7 @@ BASE_FEATURE(kGlicWarming, base::FEATURE
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1295,7 +1295,7 @@ BASE_FEATURE(kKAnonymityServiceOHTTPRequ
 // public keys.
...
+#if (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)) && !BUILDFLAG(IS_CHROMEOS)
 ...
 // portal API:
@@ -1306,7 +1306,7 @@ constexpr base::FeatureParam<int> kLinux
