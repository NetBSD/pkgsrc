$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.22 2026/07/08 13:42:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-07-06 22:58:46.000000000 +0000
