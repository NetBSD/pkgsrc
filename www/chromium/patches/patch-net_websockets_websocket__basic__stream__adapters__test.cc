$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.23 2026/08/09 06:31:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-08-05 20:17:42.000000000 +0000
