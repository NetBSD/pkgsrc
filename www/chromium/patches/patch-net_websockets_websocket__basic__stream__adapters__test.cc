$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.24 2026/09/02 13:13:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-08-31 22:47:51.000000000 +0000
+++ net/websockets/websocket_basic_stream_adapters_test.cc
@@ -1104,10 +1104,10 @@ TEST_F(WebSocketSpdyStreamAdapterTest,
