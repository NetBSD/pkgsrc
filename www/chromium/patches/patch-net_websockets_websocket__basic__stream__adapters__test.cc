$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.19 2026/06/01 10:09:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-05-26 20:39:02.000000000 +0000
