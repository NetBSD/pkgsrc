$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.8 2025/11/04 14:55:43 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2025-10-24 16:42:30.000000000 +0000
