$NetBSD: patch-net_websockets_websocket__basic__stream__adapters__test.cc,v 1.25 2026/09/22 13:41:28 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/websockets/websocket_basic_stream_adapters_test.cc.orig	2026-09-14 22:17:16.000000000 +0000
