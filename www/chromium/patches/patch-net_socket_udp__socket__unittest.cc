$NetBSD: patch-net_socket_udp__socket__unittest.cc,v 1.25 2026/09/02 13:13:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/socket/udp_socket_unittest.cc.orig	2026-08-31 22:47:51.000000000 +0000
+++ net/socket/udp_socket_unittest.cc
@@ -520,7 +520,7 @@ TEST_F(UDPSocketTest, PartialRecv) {
...
@@ -832,7 +832,7 @@ TEST_F(UDPSocketTest, ClientSetDoNotFrag
     EXPECT_THAT(rv, IsOk());
...
+#if BUILDFLAG(IS_IOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
 ...
 #else
@@ -854,7 +854,7 @@ TEST_F(UDPSocketTest, ServerSetDoNotFrag
     EXPECT_THAT(rv, IsOk());
...
+#if BUILDFLAG(IS_IOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
     ...
     EXPECT_THAT(rv, IsError(ERR_NOT_IMPLEMENTED));
 #else
@@ -920,7 +920,7 @@ TEST_F(UDPSocketTest, JoinMulticastGroup
...
@@ -971,7 +971,7 @@ TEST_F(UDPSocketTest, MAYBE_SharedMultic
