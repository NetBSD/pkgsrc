$NetBSD: patch-components_autofill_core_common_autofill__payments__features.cc,v 1.13 2025/12/23 13:22:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/autofill/core/common/autofill_payments_features.cc.orig	2025-12-17 23:05:18.000000000 +0000
...
@@ -42,7 +42,7 @@ BASE_FEATURE(kAutofillEnableAmountExtrac
