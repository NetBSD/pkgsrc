$NetBSD: patch-chrome_services_speech_audio__source__fetcher__impl.cc,v 1.6 2025/09/08 13:24:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/services/speech/audio_source_fetcher_impl.cc.orig	2025-08-29 18:50:09.000000000 +0000
