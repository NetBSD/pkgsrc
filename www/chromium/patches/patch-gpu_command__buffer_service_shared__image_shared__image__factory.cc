$NetBSD: patch-gpu_command__buffer_service_shared__image_shared__image__factory.cc,v 1.17 2026/04/10 17:31:56 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- gpu/command_buffer/service/shared_image/shared_image_factory.cc.orig	2026-04-06 16:25:54.000000000 +0000
...
@@ -114,7 +114,7 @@ const char* GmbTypeToString(gfx::GpuMemo
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
     case gfx::NATIVE_PIXMAP:
       return "platform";
 #endif
@@ -135,7 +135,7 @@ gfx::GpuMemoryBufferType GetNativeBuffer
...
@@ -1028,7 +1028,7 @@ void SharedImageFactory::LogGetFactoryFa
   }
