$NetBSD: patch-gpu_command__buffer_service_shared__image_shared__image__factory.cc,v 1.21 2026/06/08 13:12:41 kikadf Exp $
...
@@ -123,7 +123,7 @@ const char* GmbTypeToString(gfx::GpuMemo
