$NetBSD: patch-chrome_browser_net_profile__network__context__service__factory.cc,v 1.5 2025/09/08 13:24:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/net/profile_network_context_service_factory.cc.orig	2025-08-29 18:50:09.000000000 +0000
