$NetBSD: patch-base_files_file__util__posix.cc,v 1.13 2025/12/23 13:22:10 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- base/files/file_util_posix.cc.orig	2025-12-17 23:05:18.000000000 +0000
...
@@ -952,8 +953,8 @@ bool CreateDirectoryAndGetError(const Fi
...
@@ -971,21 +972,14 @@ bool CreateDirectoryAndGetError(const Fi
     }
