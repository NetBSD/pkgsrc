$NetBSD: patch-chrome_browser_ui_views_tabs_shared_drop__arrow.cc,v 1.8 2026/09/22 13:41:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/views/tabs/shared/drop_arrow.cc.orig	2026-09-14 22:17:16.000000000 +0000
