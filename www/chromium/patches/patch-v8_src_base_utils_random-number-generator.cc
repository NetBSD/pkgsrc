$NetBSD: patch-v8_src_base_utils_random-number-generator.cc,v 1.21 2026/06/08 13:12:50 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/utils/random-number-generator.cc.orig	2026-05-28 23:24:11.000000000 +0000
