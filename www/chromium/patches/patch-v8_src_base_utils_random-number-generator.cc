$NetBSD: patch-v8_src_base_utils_random-number-generator.cc,v 1.24 2026/08/09 06:31:26 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/utils/random-number-generator.cc.orig	2026-08-05 20:17:42.000000000 +0000
