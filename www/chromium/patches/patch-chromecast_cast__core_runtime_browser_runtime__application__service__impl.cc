$NetBSD: patch-chromecast_cast__core_runtime_browser_runtime__application__service__impl.cc,v 1.6 2025/09/08 13:24:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chromecast/cast_core/runtime/browser/runtime_application_service_impl.cc.orig	2025-08-29 18:50:09.000000000 +0000
