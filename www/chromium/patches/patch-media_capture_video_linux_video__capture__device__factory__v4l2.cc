$NetBSD: patch-media_capture_video_linux_video__capture__device__factory__v4l2.cc,v 1.8 2025/10/16 19:43:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/video_capture_device_factory_v4l2.cc.orig	2025-10-13 21:41:26.000000000 +0000
