$NetBSD: patch-chrome_browser_devtools_devtools__window.cc,v 1.1 2025/11/04 14:55:31 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/devtools/devtools_window.cc.orig	2025-10-24 16:42:30.000000000 +0000
