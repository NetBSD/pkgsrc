$NetBSD: patch-components_policy_core_browser_url__blocklist__manager.cc,v 1.6 2025/10/16 19:43:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/browser/url_blocklist_manager.cc.orig	2025-10-13 21:41:26.000000000 +0000
