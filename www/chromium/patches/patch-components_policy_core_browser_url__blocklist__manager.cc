$NetBSD: patch-components_policy_core_browser_url__blocklist__manager.cc,v 1.7 2025/11/04 14:55:39 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/browser/url_blocklist_manager.cc.orig	2025-10-24 16:42:30.000000000 +0000
