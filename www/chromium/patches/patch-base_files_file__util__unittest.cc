$NetBSD: patch-base_files_file__util__unittest.cc,v 1.21 2026/06/08 13:12:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- base/files/file_util_unittest.cc.orig	2026-05-28 23:24:11.000000000 +0000
+++ base/files/file_util_unittest.cc
@@ -4410,7 +4410,7 @@ TEST_F(FileUtilTest, ReadFileToStringWit
 }
...
@@ -4993,6 +4993,19 @@ TEST_F(FileUtilTest, CreateDirectoryOnly
...
@@ -5159,7 +5172,7 @@ TEST(FileUtilMultiThreadedTest, MultiThr
                 NULL);
 #else
