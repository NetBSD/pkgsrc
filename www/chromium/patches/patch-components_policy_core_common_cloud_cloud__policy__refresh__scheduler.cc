$NetBSD: patch-components_policy_core_common_cloud_cloud__policy__refresh__scheduler.cc,v 1.13 2025/12/23 13:22:18 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/common/cloud/cloud_policy_refresh_scheduler.cc.orig	2025-12-17 23:05:18.000000000 +0000
