$NetBSD: patch-third__party_ipcz_src_reference__drivers_random.cc,v 1.13 2025/12/23 13:22:24 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/ipcz/src/reference_drivers/random.cc.orig	2025-12-17 23:05:18.000000000 +0000
