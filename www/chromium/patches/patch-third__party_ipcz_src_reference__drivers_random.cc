$NetBSD: patch-third__party_ipcz_src_reference__drivers_random.cc,v 1.24 2026/08/09 06:31:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/ipcz/src/reference_drivers/random.cc.orig	2026-08-05 20:17:42.000000000 +0000
