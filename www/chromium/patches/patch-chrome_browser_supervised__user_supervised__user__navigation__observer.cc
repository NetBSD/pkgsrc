$NetBSD: patch-chrome_browser_supervised__user_supervised__user__navigation__observer.cc,v 1.17 2026/04/10 17:31:49 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/supervised_user/supervised_user_navigation_observer.cc.orig	2026-04-06 16:25:54.000000000 +0000
