$NetBSD: patch-media_capture_video_video__capture__buffer__tracker__factory__impl.cc,v 1.8 2025/10/16 19:43:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/video_capture_buffer_tracker_factory_impl.cc.orig	2025-10-13 21:41:26.000000000 +0000
