$NetBSD: patch-media_capture_video_video__capture__buffer__tracker__factory__impl.cc,v 1.11 2025/12/11 09:13:40 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/video_capture_buffer_tracker_factory_impl.cc.orig	2025-11-19 21:40:05.000000000 +0000
