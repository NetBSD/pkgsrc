$NetBSD: patch-media_capture_video_video__capture__buffer__tracker__factory__impl.cc,v 1.26 2026/09/22 13:41:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/video_capture_buffer_tracker_factory_impl.cc.orig	2026-09-14 22:17:16.000000000 +0000
