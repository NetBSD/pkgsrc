$NetBSD: patch-media_capture_video_video__capture__buffer__tracker__factory__impl.cc,v 1.24 2026/08/09 06:31:18 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/video_capture_buffer_tracker_factory_impl.cc.orig	2026-08-05 20:17:42.000000000 +0000
