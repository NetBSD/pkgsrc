$NetBSD: patch-v8_src_base_platform_platform-posix.cc,v 1.23 2026/07/08 13:42:34 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/platform/platform-posix.cc.orig	2026-07-06 22:58:46.000000000 +0000
...
@@ -1229,7 +1239,11 @@ Thread::Thread(const Options& options)
...
@@ -1244,7 +1258,7 @@ static void SetThreadName(const char* na
...
+  pthread_setname_np(pthread_self(), "%s", (void *)name);
   ...
   // for it at runtime.
@@ -1423,7 +1437,7 @@ void Thread::SetThreadLocal(LocalStorage
