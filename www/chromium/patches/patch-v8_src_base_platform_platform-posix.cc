$NetBSD: patch-v8_src_base_platform_platform-posix.cc,v 1.6 2025/09/08 13:24:36 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/platform/platform-posix.cc.orig	2025-08-29 18:50:09.000000000 +0000
