$NetBSD: patch-components_policy_core_common_cloud_cloud__policy__client.cc,v 1.23 2026/07/08 13:42:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/common/cloud/cloud_policy_client.cc.orig	2026-07-06 22:58:46.000000000 +0000
