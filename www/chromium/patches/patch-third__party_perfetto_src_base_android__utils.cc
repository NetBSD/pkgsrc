$NetBSD: patch-third__party_perfetto_src_base_android__utils.cc,v 1.8 2026/07/08 13:42:31 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/android_utils.cc.orig	2026-07-06 22:58:46.000000000 +0000
