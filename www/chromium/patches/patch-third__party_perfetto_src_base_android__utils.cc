$NetBSD: patch-third__party_perfetto_src_base_android__utils.cc,v 1.11 2026/09/22 13:41:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/android_utils.cc.orig	2026-09-14 22:17:16.000000000 +0000
