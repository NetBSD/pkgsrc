$NetBSD: patch-components_feature__engagement_public_feature__list.h,v 1.19 2026/05/10 15:29:55 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/feature_engagement/public/feature_list.h.orig	2026-04-28 23:05:57.000000000 +0200
+++ components/feature_engagement/public/feature_list.h
@@ -380,7 +380,7 @@ DEFINE_VARIATION_PARAM(kIPHiOSPinMostVis
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -513,7 +513,7 @@ DEFINE_VARIATION_PARAM(kIPHTabGroupsShar
         // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA)
...
@@ -554,7 +554,7 @@ DEFINE_VARIATION_PARAM(kIPHLauncherSearc
...
@@ -778,7 +778,7 @@ inline constexpr flags_ui::FeatureEntry:
...
@@ -846,7 +846,7 @@ inline constexpr flags_ui::FeatureEntry:
         // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA)
...
@@ -872,7 +872,7 @@ inline constexpr flags_ui::FeatureEntry:
