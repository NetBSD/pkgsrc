$NetBSD: patch-remoting_host_host__power__save__blocker.cc,v 1.5 2025/12/23 13:22:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/host_power_save_blocker.cc.orig	2025-12-17 23:05:18.000000000 +0000
