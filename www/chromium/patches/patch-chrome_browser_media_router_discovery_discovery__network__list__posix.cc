$NetBSD: patch-chrome_browser_media_router_discovery_discovery__network__list__posix.cc,v 1.11 2025/12/11 09:13:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/media/router/discovery/discovery_network_list_posix.cc.orig	2025-11-19 21:40:05.000000000 +0000
