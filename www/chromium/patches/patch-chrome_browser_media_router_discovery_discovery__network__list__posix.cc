$NetBSD: patch-chrome_browser_media_router_discovery_discovery__network__list__posix.cc,v 1.21 2026/06/08 13:12:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/media/router/discovery/discovery_network_list_posix.cc.orig	2026-05-28 23:24:11.000000000 +0000
