$NetBSD: patch-third__party_libunwind_src_src_EHHeaderParser.hpp,v 1.9 2026/07/08 13:42:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/libunwind/src/src/EHHeaderParser.hpp.orig	2026-07-06 22:58:46.000000000 +0000
