$NetBSD: patch-chrome_updater_ipc_ipc__security__linux.cc,v 1.6 2026/04/10 17:31:52 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/updater/ipc/ipc_security_linux.cc.orig	2026-04-06 16:25:54.000000000 +0000
