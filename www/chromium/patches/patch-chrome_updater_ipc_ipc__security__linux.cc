$NetBSD: patch-chrome_updater_ipc_ipc__security__linux.cc,v 1.7 2026/04/21 15:21:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/updater/ipc/ipc_security_linux.cc.orig	2026-04-14 23:31:37.000000000 +0200
