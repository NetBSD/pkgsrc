$NetBSD: patch-chrome_browser_policy_configuration__policy__handler__list__factory.cc,v 1.21 2026/06/08 13:12:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/policy/configuration_policy_handler_list_factory.cc.orig	2026-05-28 23:24:11.000000000 +0000
...
@@ -627,7 +627,7 @@ const PolicyToPreferenceMapEntry kSimple
...
@@ -984,7 +984,7 @@ const PolicyToPreferenceMapEntry kSimple
...
+     || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
   { key::kRequireOnlineRevocationChecksForLocalAnchors,
     ...
     base::Value::Type::BOOLEAN },
@@ -996,7 +996,7 @@ const PolicyToPreferenceMapEntry kSimple
     base::Value::Type::LIST },
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kFullscreenAllowed,
     ...
     base::Value::Type::BOOLEAN },
@@ -1888,7 +1888,7 @@ const PolicyToPreferenceMapEntry kSimple
     base::Value::Type::INTEGER},
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kNetworkServiceSandboxEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -1970,12 +1970,12 @@ const PolicyToPreferenceMapEntry kSimple
...
+    || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   { key::kAutomatedPasswordChangeSettings,
     ...
     base::Value::Type::INTEGER },
@@ -2099,7 +2099,7 @@ const PolicyToPreferenceMapEntry kSimple
     base::Value::Type::BOOLEAN },
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
   { key::kAlternativeBrowserPath,
     ...
     base::Value::Type::STRING },
@@ -2207,7 +2207,7 @@ const PolicyToPreferenceMapEntry kSimple
     base::Value::Type::BOOLEAN },
 #endif  // BUILDFLAG(IS_CHROMEOS)
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   { key::kAuthNegotiateDelegateByKdcPolicy,
     ...
     base::Value::Type::BOOLEAN },
@@ -2284,7 +2284,7 @@ const PolicyToPreferenceMapEntry kSimple
...
+#if BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kOutOfProcessSystemDnsResolutionEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -2367,7 +2367,7 @@ const PolicyToPreferenceMapEntry kSimple
     base::Value::Type::INTEGER },
 #endif
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kExtensionInstallTypeBlocklist,
     ...
     base::Value::Type::LIST},
@@ -2395,7 +2395,7 @@ const PolicyToPreferenceMapEntry kSimple
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
   { key::kChromeForTestingAllowed,
     ...
     base::Value::Type::BOOLEAN },
@@ -2480,7 +2480,7 @@ const PolicyToPreferenceMapEntry kSimple
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kNTPFooterManagementNoticeEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -2491,7 +2491,7 @@ const PolicyToPreferenceMapEntry kSimple
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kEnableProxyOverrideRulesForAllUsers,
     ...
     base::Value::Type::INTEGER },
@@ -2668,7 +2668,7 @@ std::unique_ptr<ConfigurationPolicyHandl
...
@@ -2939,7 +2939,7 @@ std::unique_ptr<ConfigurationPolicyHandl
...
@@ -3040,7 +3040,7 @@ std::unique_ptr<ConfigurationPolicyHandl
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   signin_legacy_policies.push_back(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3057,7 +3057,7 @@ std::unique_ptr<ConfigurationPolicyHandl
           base::Value::Type::BOOLEAN)));
...
@@ -3430,7 +3430,7 @@ std::unique_ptr<ConfigurationPolicyHandl
 #endif
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   handlers->AddHandler(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3491,7 +3491,7 @@ std::unique_ptr<ConfigurationPolicyHandl
