$NetBSD: patch-chrome_browser_media_webrtc_chrome__screen__enumerator.cc,v 1.9 2025/11/04 14:55:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/media/webrtc/chrome_screen_enumerator.cc.orig	2025-10-24 16:42:30.000000000 +0000
