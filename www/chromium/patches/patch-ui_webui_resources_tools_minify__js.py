$NetBSD: patch-ui_webui_resources_tools_minify__js.py,v 1.4 2026/06/08 13:12:50 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- ui/webui/resources/tools/minify_js.py.orig	2026-05-28 23:24:11.000000000 +0000
