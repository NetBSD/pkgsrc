$NetBSD: patch-tools_gn_src_util_exe__path.cc,v 1.13 2025/12/23 13:22:26 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- tools/gn/src/util/exe_path.cc.orig	2025-12-17 23:05:18.000000000 +0000
