$NetBSD: patch-tools_gn_src_util_exe__path.cc,v 1.21 2026/06/08 13:12:48 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- tools/gn/src/util/exe_path.cc.orig	2026-05-28 23:24:11.000000000 +0000
