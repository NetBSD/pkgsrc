$NetBSD: patch-third__party_libunwind_src_src_AddressSpace.hpp,v 1.10 2026/08/09 06:31:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/libunwind/src/src/AddressSpace.hpp.orig	2026-08-05 20:17:42.000000000 +0000
...
+#include <sys/tree.h>
 ...
 #include "libunwind.h"
 #include "config.h"
@@ -157,6 +158,62 @@ struct UnwindInfoSections {
 #endif
 };
...
@@ -284,6 +341,10 @@ LocalAddressSpace::getEncodedP(pint_t &a
