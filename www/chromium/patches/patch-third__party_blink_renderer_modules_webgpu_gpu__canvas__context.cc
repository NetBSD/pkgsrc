$NetBSD: patch-third__party_blink_renderer_modules_webgpu_gpu__canvas__context.cc,v 1.18 2026/05/10 15:30:04 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/modules/webgpu/gpu_canvas_context.cc.orig	2026-04-28 23:05:57.000000000 +0200
+++ third_party/blink/renderer/modules/webgpu/gpu_canvas_context.cc
@@ -270,7 +270,7 @@ GPUCanvasContext::PaintRenderingResultsT
...
@@ -486,7 +486,7 @@ void GPUCanvasContext::configure(const G
   }
 #endif
