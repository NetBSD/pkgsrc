$NetBSD: patch-third__party_blink_renderer_platform_graphics_canvas__non__2d__resource__provider.cc,v 1.2 2026/09/22 13:41:31 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/platform/graphics/canvas_non_2d_resource_provider.cc.orig	2026-09-14 22:17:16.000000000 +0000
