$NetBSD: patch-components_permissions_prediction__service_prediction__common.cc,v 1.25 2026/09/02 13:13:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/permissions/prediction_service/prediction_common.cc.orig	2026-08-31 22:47:51.000000000 +0000
