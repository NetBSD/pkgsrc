$NetBSD: patch-components_permissions_prediction__service_prediction__common.cc,v 1.23 2026/07/08 13:42:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/permissions/prediction_service/prediction_common.cc.orig	2026-07-06 22:58:46.000000000 +0000
