$NetBSD: patch-components_permissions_prediction__service_prediction__common.cc,v 1.17 2026/04/10 17:31:53 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/permissions/prediction_service/prediction_common.cc.orig	2026-04-06 16:25:54.000000000 +0000
