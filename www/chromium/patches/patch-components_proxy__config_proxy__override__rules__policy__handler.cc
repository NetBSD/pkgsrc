$NetBSD: patch-components_proxy__config_proxy__override__rules__policy__handler.cc,v 1.10 2026/08/09 06:31:15 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/proxy_config/proxy_override_rules_policy_handler.cc.orig	2026-08-05 20:17:42.000000000 +0000
