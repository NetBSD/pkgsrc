$NetBSD: patch-third__party_webrtc_modules_desktop__capture_linux_x11_x__server__pixel__buffer.cc,v 1.24 2026/08/09 06:31:24 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/webrtc/modules/desktop_capture/linux/x11/x_server_pixel_buffer.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -224,21 +243,55 @@ void XServerPixelBuffer::InitShm(const X
...
+#endif
         ...
         if (error_trap.GetLastErrorAndDisable() != 0)
           xshm_attached_ = false;
@@ -263,7 +316,9 @@ void XServerPixelBuffer::InitShm(const X
   if (have_pixmaps)
