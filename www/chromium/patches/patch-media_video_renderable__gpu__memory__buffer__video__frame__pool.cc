$NetBSD: patch-media_video_renderable__gpu__memory__buffer__video__frame__pool.cc,v 1.2 2025/11/04 14:55:43 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/video/renderable_gpu_memory_buffer_video_frame_pool.cc.orig	2025-10-24 16:42:30.000000000 +0000
