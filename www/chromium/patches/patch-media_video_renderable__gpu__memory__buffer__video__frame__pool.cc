$NetBSD: patch-media_video_renderable__gpu__memory__buffer__video__frame__pool.cc,v 1.6 2025/12/23 13:22:21 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/video/renderable_gpu_memory_buffer_video_frame_pool.cc.orig	2025-12-17 23:05:18.000000000 +0000
