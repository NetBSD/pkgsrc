$NetBSD: patch-v8_src_base_platform_platform-freebsd.cc,v 1.22 2026/07/06 13:07:02 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/platform/platform-freebsd.cc.orig	2026-06-23 23:37:18.000000000 +0000
