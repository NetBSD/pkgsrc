$NetBSD: patch-v8_src_base_platform_platform-freebsd.cc,v 1.13 2025/12/23 13:22:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/platform/platform-freebsd.cc.orig	2025-12-17 23:05:18.000000000 +0000
