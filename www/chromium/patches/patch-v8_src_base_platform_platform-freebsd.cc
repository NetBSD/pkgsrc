$NetBSD: patch-v8_src_base_platform_platform-freebsd.cc,v 1.23 2026/07/08 13:42:34 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/base/platform/platform-freebsd.cc.orig	2026-07-06 22:58:46.000000000 +0000
