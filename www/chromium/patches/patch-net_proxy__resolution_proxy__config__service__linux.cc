$NetBSD: patch-net_proxy__resolution_proxy__config__service__linux.cc,v 1.20 2026/06/01 10:09:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/proxy_resolution/proxy_config_service_linux.cc.orig	2026-05-26 20:39:02.000000000 +0000
