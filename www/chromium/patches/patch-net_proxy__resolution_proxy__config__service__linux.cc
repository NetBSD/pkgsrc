$NetBSD: patch-net_proxy__resolution_proxy__config__service__linux.cc,v 1.10 2025/11/20 08:36:18 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/proxy_resolution/proxy_config_service_linux.cc.orig	2025-11-14 20:31:45.000000000 +0000
