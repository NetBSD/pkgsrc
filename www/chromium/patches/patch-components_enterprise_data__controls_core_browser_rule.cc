$NetBSD: patch-components_enterprise_data__controls_core_browser_rule.cc,v 1.16 2026/06/01 10:09:11 kikadf Exp $
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
           {
               ...
               {
@@ -625,7 +625,7 @@ bool Rule::AddUnsupportedRestrictionErro
           },
