$NetBSD: patch-chrome_browser_global__features.cc,v 1.24 2026/08/09 06:31:09 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/global_features.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -184,7 +184,7 @@ void GlobalFeatures::PostBrowserProcessI
   }
 #endif
...
@@ -259,7 +259,7 @@ void GlobalFeatures::PostMainMessageLoop
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -278,7 +278,7 @@ GlobalFeatures::CreateSystemPermissionsP
