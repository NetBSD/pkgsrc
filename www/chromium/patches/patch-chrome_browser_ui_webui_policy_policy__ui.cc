$NetBSD: patch-chrome_browser_ui_webui_policy_policy__ui.cc,v 1.1 2026/08/09 06:31:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/policy/policy_ui.cc.orig	2026-08-05 20:17:42.000000000 +0000
+++ chrome/browser/ui/webui/policy/policy_ui.cc
@@ -149,7 +149,7 @@ void CreateAndAddPolicyUIHtmlSource(Prof
