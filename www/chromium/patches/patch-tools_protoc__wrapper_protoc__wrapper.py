$NetBSD: patch-tools_protoc__wrapper_protoc__wrapper.py,v 1.17 2026/04/10 17:32:01 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- tools/protoc_wrapper/protoc_wrapper.py.orig	2026-04-06 16:25:54.000000000 +0000
