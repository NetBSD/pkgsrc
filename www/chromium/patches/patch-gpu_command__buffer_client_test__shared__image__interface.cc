$NetBSD: patch-gpu_command__buffer_client_test__shared__image__interface.cc,v 1.4 2025/10/16 19:43:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- gpu/command_buffer/client/test_shared_image_interface.cc.orig	2025-10-13 21:41:26.000000000 +0000
