$NetBSD: patch-gpu_command__buffer_client_test__shared__image__interface.cc,v 1.6 2025/11/20 08:36:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- gpu/command_buffer/client/test_shared_image_interface.cc.orig	2025-11-14 20:31:45.000000000 +0000
