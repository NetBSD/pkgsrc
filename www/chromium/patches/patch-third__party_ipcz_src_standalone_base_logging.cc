$NetBSD: patch-third__party_ipcz_src_standalone_base_logging.cc,v 1.9 2025/11/04 14:55:47 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/ipcz/src/standalone/base/logging.cc.orig	2025-10-24 16:42:30.000000000 +0000
