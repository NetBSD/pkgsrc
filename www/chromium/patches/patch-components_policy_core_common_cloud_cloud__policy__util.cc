$NetBSD: patch-components_policy_core_common_cloud_cloud__policy__util.cc,v 1.6 2025/09/08 13:24:24 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/common/cloud/cloud_policy_util.cc.orig	2025-08-29 18:50:09.000000000 +0000
