$NetBSD: patch-components_policy_core_common_cloud_cloud__policy__util.cc,v 1.21 2026/06/08 13:12:38 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/policy/core/common/cloud/cloud_policy_util.cc.orig	2026-05-28 23:24:11.000000000 +0000
