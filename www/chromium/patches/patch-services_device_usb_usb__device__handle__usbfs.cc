$NetBSD: patch-services_device_usb_usb__device__handle__usbfs.cc,v 1.25 2026/09/22 13:41:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- services/device/usb/usb_device_handle_usbfs.cc.orig	2026-09-14 22:17:16.000000000 +0000
