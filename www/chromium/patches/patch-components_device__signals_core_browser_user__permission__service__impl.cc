$NetBSD: patch-components_device__signals_core_browser_user__permission__service__impl.cc,v 1.11 2025/12/11 09:13:35 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/device_signals/core/browser/user_permission_service_impl.cc.orig	2025-11-19 21:40:05.000000000 +0000
