$NetBSD: patch-chrome_enterprise__companion_ipc__security__linux.cc,v 1.7 2026/04/21 15:21:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/enterprise_companion/ipc_security_linux.cc.orig	2026-04-14 23:31:37.000000000 +0200
