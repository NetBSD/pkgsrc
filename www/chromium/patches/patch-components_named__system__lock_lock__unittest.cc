$NetBSD: patch-components_named__system__lock_lock__unittest.cc,v 1.25 2026/09/22 13:41:24 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/named_system_lock/lock_unittest.cc.orig	2026-09-14 22:17:16.000000000 +0000
