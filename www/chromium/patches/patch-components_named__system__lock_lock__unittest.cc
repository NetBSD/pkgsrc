$NetBSD: patch-components_named__system__lock_lock__unittest.cc,v 1.5 2025/09/08 13:24:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/named_system_lock/lock_unittest.cc.orig	2025-08-29 18:50:09.000000000 +0000
