$NetBSD: patch-components_named__system__lock_lock__unittest.cc,v 1.9 2025/11/20 08:36:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/named_system_lock/lock_unittest.cc.orig	2025-11-14 20:31:45.000000000 +0000
