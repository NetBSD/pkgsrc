$NetBSD: patch-chrome_browser_safe__browsing_security__settings__bundle__pref__change__handler.cc,v 1.4 2026/08/09 06:31:09 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/safe_browsing/security_settings_bundle_pref_change_handler.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
   if (!profile_ ||
     ...
     return;
@@ -59,7 +59,7 @@ void SecuritySettingsBundlePrefChangeHan
 }
