$NetBSD: patch-components_supervised__user_core_browser_supervised__user__utils.cc,v 1.10 2026/09/02 13:13:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-08-31 22:47:51.000000000 +0000
