$NetBSD: patch-components_supervised__user_core_browser_supervised__user__utils.cc,v 1.8 2026/07/08 13:42:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-07-06 22:58:46.000000000 +0000
