$NetBSD: patch-components_supervised__user_core_browser_supervised__user__utils.cc,v 1.7 2026/07/06 13:06:50 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-06-23 23:37:18.000000000 +0000
