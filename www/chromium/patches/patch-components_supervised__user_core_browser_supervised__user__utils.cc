$NetBSD: patch-components_supervised__user_core_browser_supervised__user__utils.cc,v 1.9 2026/08/09 06:31:15 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-08-05 20:17:42.000000000 +0000
