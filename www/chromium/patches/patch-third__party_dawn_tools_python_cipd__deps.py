$NetBSD: patch-third__party_dawn_tools_python_cipd__deps.py,v 1.3 2026/09/22 13:41:31 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/dawn/tools/python/cipd_deps.py.orig	2026-09-14 22:17:16.000000000 +0000
