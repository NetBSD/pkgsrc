$NetBSD: patch-chrome_browser_enterprise_signals_signals__aggregator__factory.cc,v 1.15 2026/05/10 15:29:49 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/enterprise/signals/signals_aggregator_factory.cc.orig	2026-04-28 23:05:57.000000000 +0200
