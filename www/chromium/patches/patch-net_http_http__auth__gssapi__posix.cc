$NetBSD: patch-net_http_http__auth__gssapi__posix.cc,v 1.9 2025/11/04 14:55:43 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/http/http_auth_gssapi_posix.cc.orig	2025-10-24 16:42:30.000000000 +0000
