$NetBSD: patch-net_http_http__auth__gssapi__posix.cc,v 1.23 2026/07/08 13:42:26 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- net/http/http_auth_gssapi_posix.cc.orig	2026-07-06 22:58:46.000000000 +0000
