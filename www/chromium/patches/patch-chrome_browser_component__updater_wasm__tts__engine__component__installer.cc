$NetBSD: patch-chrome_browser_component__updater_wasm__tts__engine__component__installer.cc,v 1.25 2026/09/22 13:41:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/component_updater/wasm_tts_engine_component_installer.cc.orig	2026-09-14 22:17:16.000000000 +0000
...
@@ -53,7 +53,7 @@ constexpr std::array<uint8_t, 32> kWasmT
...
@@ -110,7 +110,7 @@ WasmTtsEngineComponentInstallerPolicy::W
 // static
...
@@ -143,7 +143,7 @@ void WasmTtsEngineComponentInstallerPoli
...
@@ -167,7 +167,7 @@ void WasmTtsEngineComponentInstallerPoli
...
@@ -293,7 +293,7 @@ void RegisterWasmTtsEngineComponent(Comp
...
@@ -301,7 +301,7 @@ void WasmTtsEngineComponentInstallerPoli
