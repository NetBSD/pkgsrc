$NetBSD: patch-components_feed_core_v2_feed__network__impl__unittest.cc,v 1.21 2026/06/08 13:12:37 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/feed/core/v2/feed_network_impl_unittest.cc.orig	2026-05-28 23:24:11.000000000 +0000
