$NetBSD: patch-third__party_blink_renderer_build_scripts_gperf.py,v 1.24 2026/08/09 06:31:21 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/build/scripts/gperf.py.orig	2026-08-05 20:17:42.000000000 +0000
