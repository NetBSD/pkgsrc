$NetBSD: patch-third__party_blink_renderer_build_scripts_gperf.py,v 1.26 2026/09/22 13:41:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/build/scripts/gperf.py.orig	2026-09-14 22:17:16.000000000 +0000
