$NetBSD: patch-third__party_blink_renderer_build_scripts_gperf.py,v 1.25 2026/09/02 13:13:35 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/build/scripts/gperf.py.orig	2026-08-31 22:47:51.000000000 +0000
