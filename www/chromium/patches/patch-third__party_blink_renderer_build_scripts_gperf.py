$NetBSD: patch-third__party_blink_renderer_build_scripts_gperf.py,v 1.23 2026/07/08 13:42:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/build/scripts/gperf.py.orig	2026-07-06 22:58:46.000000000 +0000
