$NetBSD: patch-third__party_blink_renderer_build_scripts_gperf.py,v 1.17 2026/04/10 17:31:59 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/blink/renderer/build/scripts/gperf.py.orig	2026-04-06 16:25:54.000000000 +0000
