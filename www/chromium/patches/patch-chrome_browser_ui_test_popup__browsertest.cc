$NetBSD: patch-chrome_browser_ui_test_popup__browsertest.cc,v 1.18 2026/04/21 15:21:11 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/test/popup_browsertest.cc.orig	2026-04-14 23:31:37.000000000 +0200
