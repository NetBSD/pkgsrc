$NetBSD: patch-chrome_browser_ui_test_popup__browsertest.cc,v 1.17 2026/04/10 17:31:50 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/test/popup_browsertest.cc.orig	2026-04-06 16:25:54.000000000 +0000
