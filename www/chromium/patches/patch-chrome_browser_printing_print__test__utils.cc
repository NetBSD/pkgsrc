$NetBSD: patch-chrome_browser_printing_print__test__utils.cc,v 1.8 2026/07/06 13:06:44 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/printing/print_test_utils.cc.orig	2026-06-23 23:37:18.000000000 +0000
