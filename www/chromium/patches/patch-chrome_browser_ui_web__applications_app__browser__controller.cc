$NetBSD: patch-chrome_browser_ui_web__applications_app__browser__controller.cc,v 1.16 2026/08/09 06:31:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/web_applications/app_browser_controller.cc.orig	2026-08-05 20:17:42.000000000 +0000
+++ chrome/browser/ui/web_applications/app_browser_controller.cc
@@ -562,7 +562,7 @@ std::u16string AppBrowserController::Get
