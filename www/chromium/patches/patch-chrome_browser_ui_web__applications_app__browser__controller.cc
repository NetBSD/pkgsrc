$NetBSD: patch-chrome_browser_ui_web__applications_app__browser__controller.cc,v 1.18 2026/09/22 13:41:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/web_applications/app_browser_controller.cc.orig	2026-09-14 22:17:16.000000000 +0000
+++ chrome/browser/ui/web_applications/app_browser_controller.cc
@@ -570,7 +570,7 @@ std::u16string AppBrowserController::Get
