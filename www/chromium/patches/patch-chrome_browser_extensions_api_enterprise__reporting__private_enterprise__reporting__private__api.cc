$NetBSD: patch-chrome_browser_extensions_api_enterprise__reporting__private_enterprise__reporting__private__api.cc,v 1.11 2025/12/11 09:13:30 kikadf Exp $
