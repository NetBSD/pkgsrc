$NetBSD: patch-components_sync__bookmarks_bookmark__model__view.cc,v 1.9 2026/04/10 17:31:54 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/sync_bookmarks/bookmark_model_view.cc.orig	2026-04-06 16:25:54.000000000 +0000
