$NetBSD: patch-remoting_host_session__policies__from__dict.cc,v 1.9 2025/11/20 08:36:19 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/session_policies_from_dict.cc.orig	2025-11-14 20:31:45.000000000 +0000
