$NetBSD: patch-remoting_host_remoting__me2me__host.cc,v 1.26 2026/09/22 13:41:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/remoting_me2me_host.cc.orig	2026-09-14 22:17:16.000000000 +0000
...
@@ -257,7 +257,7 @@ const char kApplicationName[] = "chromot
 // from stdin.
...
@@ -524,7 +524,7 @@ class HostProcess : public ConfigWatcher
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
@@ -590,7 +590,7 @@ class HostProcess : public ConfigWatcher
...
@@ -935,7 +935,7 @@ void HostProcess::StartOnNetworkThread()
...
@@ -1042,7 +1042,7 @@ void HostProcess::CreateAuthenticatorFac
...
@@ -1208,7 +1208,7 @@ void HostProcess::StartOnUiThread() {
...
@@ -1277,7 +1277,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1285,7 +1285,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1933,7 +1933,7 @@ void HostProcess::InitializeSignaling() 
...
@@ -2199,7 +2199,7 @@ void HostProcess::StartHost() {
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   if (cmd_line->HasSwitch(kEnableWtmpdb)) {
     host_wtmpdb_logger_ =
@@ -2237,7 +2237,7 @@ void HostProcess::StartHost() {
   // addresses.
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   // network process.
@@ -2394,7 +2394,7 @@ int HostProcessMain(bool multi_process) 
                                                    : " (single-process)");
   const base::CommandLine* cmd_line = base::CommandLine::ForCurrentProcess();
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!multi_process) {
@@ -2446,7 +2446,7 @@ int HostProcessMain(bool multi_process) 
...
@@ -2466,7 +2466,7 @@ int HostProcessMain(bool multi_process) 
