$NetBSD: patch-remoting_host_remoting__me2me__host.cc,v 1.19 2026/05/10 15:30:02 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/remoting_me2me_host.cc.orig	2026-04-28 23:05:57.000000000 +0200
...
@@ -200,7 +200,7 @@ const char kApplicationName[] = "chromot
 // from stdin.
...
@@ -424,7 +424,7 @@ class HostProcess : public ConfigWatcher
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_WIN)
@@ -456,7 +456,7 @@ class HostProcess : public ConfigWatcher
...
@@ -853,7 +853,7 @@ void HostProcess::StartOnNetworkThread()
...
@@ -937,7 +937,7 @@ void HostProcess::CreateAuthenticatorFac
...
@@ -1086,7 +1086,7 @@ void HostProcess::StartOnUiThread() {
...
@@ -1161,7 +1161,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1169,7 +1169,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1266,7 +1266,7 @@ void HostProcess::BindRemotingHostContro
...
@@ -2033,7 +2033,7 @@ void HostProcess::StartHost() {
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   if (cmd_line->HasSwitch(kEnableWtmpdb)) {
     host_wtmpdb_logger_ =
@@ -2068,7 +2068,7 @@ void HostProcess::StartHost() {
   // addresses.
