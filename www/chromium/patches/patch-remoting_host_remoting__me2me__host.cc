$NetBSD: patch-remoting_host_remoting__me2me__host.cc,v 1.22 2026/07/06 13:06:55 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/remoting_me2me_host.cc.orig	2026-06-23 23:37:18.000000000 +0000
...
@@ -202,7 +202,7 @@ const char kApplicationName[] = "chromot
 // from stdin.
...
@@ -426,7 +426,7 @@ class HostProcess : public ConfigWatcher
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_WIN)
@@ -457,7 +457,7 @@ class HostProcess : public ConfigWatcher
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
@@ -525,7 +525,7 @@ class HostProcess : public ConfigWatcher
...
@@ -854,7 +854,7 @@ void HostProcess::StartOnNetworkThread()
...
@@ -938,7 +938,7 @@ void HostProcess::CreateAuthenticatorFac
...
@@ -1087,7 +1087,7 @@ void HostProcess::StartOnUiThread() {
...
@@ -1162,7 +1162,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1170,7 +1170,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1267,7 +1267,7 @@ void HostProcess::BindRemotingHostContro
...
@@ -1825,7 +1825,7 @@ void HostProcess::InitializeSignaling() 
...
@@ -1920,7 +1920,7 @@ void HostProcess::StartHost() {
...
@@ -2022,7 +2022,7 @@ void HostProcess::StartHost() {
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   if (cmd_line->HasSwitch(kEnableWtmpdb)) {
     host_wtmpdb_logger_ =
@@ -2057,7 +2057,7 @@ void HostProcess::StartHost() {
   // addresses.
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   // network process.
@@ -2209,7 +2209,7 @@ int HostProcessMain(bool multi_process) 
                                                    : " (single-process)");
   const base::CommandLine* cmd_line = base::CommandLine::ForCurrentProcess();
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!multi_process) {
@@ -2260,7 +2260,7 @@ int HostProcessMain(bool multi_process) 
...
@@ -2280,7 +2280,7 @@ int HostProcessMain(bool multi_process) 
