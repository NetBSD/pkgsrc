$NetBSD: patch-chrome_browser_profiles_chrome__browser__main__extra__parts__profiles.cc,v 1.21 2026/06/08 13:12:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/profiles/chrome_browser_main_extra_parts_profiles.cc.orig	2026-05-28 23:24:11.000000000 +0000
...
@@ -867,7 +867,7 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -884,7 +884,7 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -943,11 +943,11 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -960,7 +960,7 @@ void ChromeBrowserMainExtraPartsProfiles
...
+    BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -968,14 +968,14 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -1022,7 +1022,7 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -1263,7 +1263,7 @@ void ChromeBrowserMainExtraPartsProfiles
 #if BUILDFLAG(IS_CHROMEOS)
...
@@ -1273,7 +1273,7 @@ void ChromeBrowserMainExtraPartsProfiles
 #else
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -1314,7 +1314,7 @@ void ChromeBrowserMainExtraPartsProfiles
...
@@ -1508,7 +1508,7 @@ void ChromeBrowserMainExtraPartsProfiles
 #endif
