$NetBSD: patch-remoting_host_webauthn_remote__webauthn__caller__security__utils.cc,v 1.6 2025/09/08 13:24:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/webauthn/remote_webauthn_caller_security_utils.cc.orig	2025-08-29 18:50:09.000000000 +0000
