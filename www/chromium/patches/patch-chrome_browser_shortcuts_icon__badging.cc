$NetBSD: patch-chrome_browser_shortcuts_icon__badging.cc,v 1.9 2025/11/04 14:55:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/shortcuts/icon_badging.cc.orig	2025-10-24 16:42:30.000000000 +0000
