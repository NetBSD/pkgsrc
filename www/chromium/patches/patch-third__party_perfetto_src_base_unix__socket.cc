$NetBSD: patch-third__party_perfetto_src_base_unix__socket.cc,v 1.11 2025/12/11 09:13:45 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/unix_socket.cc.orig	2025-11-19 21:40:05.000000000 +0000
