$NetBSD: patch-third__party_perfetto_src_base_unix__socket.cc,v 1.9 2025/11/04 14:55:48 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/unix_socket.cc.orig	2025-10-24 16:42:30.000000000 +0000
