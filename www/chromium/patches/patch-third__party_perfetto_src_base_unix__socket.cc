$NetBSD: patch-third__party_perfetto_src_base_unix__socket.cc,v 1.10 2025/11/20 08:36:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/unix_socket.cc.orig	2025-11-14 20:31:45.000000000 +0000
