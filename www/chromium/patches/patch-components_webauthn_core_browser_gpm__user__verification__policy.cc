$NetBSD: patch-components_webauthn_core_browser_gpm__user__verification__policy.cc,v 1.8 2026/06/08 13:12:39 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/webauthn/core/browser/gpm_user_verification_policy.cc.orig	2026-05-28 23:24:11.000000000 +0000
