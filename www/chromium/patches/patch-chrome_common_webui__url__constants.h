$NetBSD: patch-chrome_common_webui__url__constants.h,v 1.23 2026/07/08 13:42:20 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/webui_url_constants.h.orig	2026-07-06 22:58:46.000000000 +0000
+++ chrome/common/webui_url_constants.h
@@ -467,12 +467,12 @@ bool IsSystemWebUIHost(std::string_view 
...
@@ -495,11 +495,11 @@ inline constexpr char kChromeUILinuxProx
 #endif
...
@@ -535,7 +535,7 @@ inline constexpr char kChromeUIUpdaterHo
