$NetBSD: patch-chrome_browser_sync_chrome__sync__controller__builder.cc,v 1.8 2025/10/16 19:43:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/sync/chrome_sync_controller_builder.cc.orig	2025-10-13 21:41:26.000000000 +0000
