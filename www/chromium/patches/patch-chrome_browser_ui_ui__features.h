$NetBSD: patch-chrome_browser_ui_ui__features.h,v 1.8 2025/10/16 19:43:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/ui_features.h.orig	2025-10-13 21:41:26.000000000 +0000
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -336,7 +336,7 @@ BASE_DECLARE_FEATURE(kViewsFirstRunDialo
