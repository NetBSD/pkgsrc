$NetBSD: patch-third__party_webrtc_rtc__base_physical__socket__server.cc,v 1.18 2026/04/21 15:21:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/webrtc/rtc_base/physical_socket_server.cc.orig	2026-04-14 23:31:37.000000000 +0200
...
+#if defined(WEBRTC_LINUX) && !defined(WEBRTC_ANDROID) && !defined(WEBRTC_BSD)
                ...
                MSG_NOSIGNAL,
 #else
@@ -706,7 +706,7 @@ int PhysicalSocket::TranslateOption(Opti
       *slevel = IPPROTO_IP;
...
@@ -755,7 +755,7 @@ int PhysicalSocket::TranslateOption(Opti
       return -1;
 #endif
     case OPT_RECV_ECN:
...
@@ -775,10 +775,19 @@ int PhysicalSocket::TranslateOption(Opti
       *sopt = SO_KEEPALIVE;
       break;
...
+#else
       ...
       *sopt = TCP_KEEPIDLE;
@@ -786,12 +795,18 @@ int PhysicalSocket::TranslateOption(Opti
       *sopt = TCP_KEEPALIVE;
 #endif
       break;
+#endif
