$NetBSD: patch-chrome_browser_ui_ui__features.cc,v 1.20 2026/06/01 10:09:09 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/ui_features.cc.orig	2026-05-26 20:39:02.000000000 +0000
+++ chrome/browser/ui/ui_features.cc
@@ -40,7 +40,7 @@ BASE_FEATURE(kImportExportFlags, base::F
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 // to update Chrome.
@@ -247,7 +247,7 @@ BASE_FEATURE(kWebUITabStripContextMenuAf
