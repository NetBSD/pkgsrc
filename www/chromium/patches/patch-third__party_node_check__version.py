$NetBSD: patch-third__party_node_check__version.py,v 1.24 2026/09/22 13:41:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/node/check_version.py.orig	2026-09-14 22:17:16.000000000 +0000
