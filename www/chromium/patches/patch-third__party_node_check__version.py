$NetBSD: patch-third__party_node_check__version.py,v 1.6 2025/10/16 19:43:35 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/node/check_version.py.orig	2025-10-13 21:41:26.000000000 +0000
