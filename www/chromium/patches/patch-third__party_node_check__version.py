$NetBSD: patch-third__party_node_check__version.py,v 1.16 2026/04/21 15:21:22 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/node/check_version.py.orig	2026-04-14 23:31:37.000000000 +0200
