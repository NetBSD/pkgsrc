$NetBSD: patch-third__party_node_check__version.py,v 1.19 2026/06/08 13:12:47 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/node/check_version.py.orig	2026-05-28 23:24:11.000000000 +0000
