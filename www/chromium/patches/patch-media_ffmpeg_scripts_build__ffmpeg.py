$NetBSD: patch-media_ffmpeg_scripts_build__ffmpeg.py,v 1.10 2025/11/20 08:36:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/ffmpeg/scripts/build_ffmpeg.py.orig	2025-11-14 20:31:45.000000000 +0000
