$NetBSD: patch-media_ffmpeg_scripts_build__ffmpeg.py,v 1.13 2025/12/23 13:22:20 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/ffmpeg/scripts/build_ffmpeg.py.orig	2025-12-17 23:05:18.000000000 +0000
