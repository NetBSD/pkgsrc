$NetBSD: patch-v8_src_trap-handler_handler-inside-posix.cc,v 1.26 2026/09/22 13:41:35 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/trap-handler/handler-inside-posix.cc.orig	2026-09-14 22:17:16.000000000 +0000
