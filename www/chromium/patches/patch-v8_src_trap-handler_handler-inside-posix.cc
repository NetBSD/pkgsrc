$NetBSD: patch-v8_src_trap-handler_handler-inside-posix.cc,v 1.17 2026/04/10 17:32:03 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- v8/src/trap-handler/handler-inside-posix.cc.orig	2026-04-06 16:25:54.000000000 +0000
