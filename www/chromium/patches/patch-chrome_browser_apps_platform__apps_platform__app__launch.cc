$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.22 2026/07/06 13:06:42 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2026-06-23 23:37:18.000000000 +0000
