$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.18 2026/04/21 15:21:08 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2026-04-14 23:31:37.000000000 +0200
