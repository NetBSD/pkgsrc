$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.12 2025/12/13 14:53:48 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2025-11-19 21:40:05.000000000 +0000
