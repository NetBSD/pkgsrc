$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.10 2025/11/20 08:36:06 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2025-11-14 20:31:45.000000000 +0000
