$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.13 2025/12/23 13:22:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2025-12-17 23:05:18.000000000 +0000
