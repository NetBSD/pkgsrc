$NetBSD: patch-chrome_browser_apps_platform__apps_platform__app__launch.cc,v 1.6 2025/09/08 13:24:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/apps/platform_apps/platform_app_launch.cc.orig	2025-08-29 18:50:09.000000000 +0000
