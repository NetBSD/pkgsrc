$NetBSD: patch-components_autofill_core_browser_integrators_autofill__ai_management__utils.cc,v 1.1 2026/09/02 13:13:28 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/autofill/core/browser/integrators/autofill_ai/management_utils.cc.orig	2026-08-31 22:47:51.000000000 +0000
+++ components/autofill/core/browser/integrators/autofill_ai/management_utils.cc
@@ -35,7 +35,7 @@ EntityTypeResources GetResourcesForType(
...
@@ -46,7 +46,7 @@ EntityTypeResources GetResourcesForType(
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -59,7 +59,7 @@ EntityTypeResources GetResourcesForType(
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -71,7 +71,7 @@ EntityTypeResources GetResourcesForType(
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -83,7 +83,7 @@ EntityTypeResources GetResourcesForType(
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -95,7 +95,7 @@ EntityTypeResources GetResourcesForType(
