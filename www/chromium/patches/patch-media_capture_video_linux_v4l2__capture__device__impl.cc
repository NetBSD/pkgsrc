$NetBSD: patch-media_capture_video_linux_v4l2__capture__device__impl.cc,v 1.14 2026/01/19 16:14:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/v4l2_capture_device_impl.cc.orig	2026-01-07 00:50:30.000000000 +0000
