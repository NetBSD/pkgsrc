$NetBSD: patch-media_capture_video_linux_v4l2__capture__device__impl.cc,v 1.11 2025/12/11 09:13:40 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/v4l2_capture_device_impl.cc.orig	2025-11-19 21:40:05.000000000 +0000
