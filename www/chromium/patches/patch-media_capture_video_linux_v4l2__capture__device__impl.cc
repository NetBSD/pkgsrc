$NetBSD: patch-media_capture_video_linux_v4l2__capture__device__impl.cc,v 1.6 2025/09/08 13:24:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/v4l2_capture_device_impl.cc.orig	2025-08-29 18:50:09.000000000 +0000
