$NetBSD: patch-chrome_browser_signin_signin__hats__util.cc,v 1.17 2026/06/08 13:12:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/signin/signin_hats_util.cc.orig	2026-05-28 23:24:11.000000000 +0000
