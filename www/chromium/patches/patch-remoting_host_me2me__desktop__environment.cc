$NetBSD: patch-remoting_host_me2me__desktop__environment.cc,v 1.24 2026/08/09 06:31:20 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- remoting/host/me2me_desktop_environment.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
+#if (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)) && defined(REMOTING_USE_X11)
   ...
   capabilities += " ";
@@ -174,7 +174,7 @@ Me2MeDesktopEnvironment::Me2MeDesktopEnv
   // properly under Xvfb.
