$NetBSD: patch-components_trusted__vault_trusted__vault__connection__impl.cc,v 1.20 2026/06/01 10:09:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/trusted_vault/trusted_vault_connection_impl.cc.orig	2026-05-26 20:39:02.000000000 +0000
