$NetBSD: patch-components_trusted__vault_trusted__vault__connection__impl.cc,v 1.10 2025/11/20 08:36:14 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/trusted_vault/trusted_vault_connection_impl.cc.orig	2025-11-14 20:31:45.000000000 +0000
