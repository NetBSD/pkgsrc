$NetBSD: patch-chrome_test_chromedriver_chrome_chrome__finder.cc,v 1.25 2026/09/02 13:13:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/test/chromedriver/chrome/chrome_finder.cc.orig	2026-08-31 22:47:51.000000000 +0000
