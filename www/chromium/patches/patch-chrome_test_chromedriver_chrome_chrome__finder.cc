$NetBSD: patch-chrome_test_chromedriver_chrome_chrome__finder.cc,v 1.24 2026/08/09 06:31:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/test/chromedriver/chrome/chrome_finder.cc.orig	2026-08-05 20:17:42.000000000 +0000
