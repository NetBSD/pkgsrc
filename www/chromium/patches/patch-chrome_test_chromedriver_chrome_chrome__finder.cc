$NetBSD: patch-chrome_test_chromedriver_chrome_chrome__finder.cc,v 1.23 2026/07/08 13:42:20 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/test/chromedriver/chrome/chrome_finder.cc.orig	2026-07-06 22:58:46.000000000 +0000
