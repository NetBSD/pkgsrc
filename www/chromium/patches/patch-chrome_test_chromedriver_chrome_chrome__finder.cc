$NetBSD: patch-chrome_test_chromedriver_chrome_chrome__finder.cc,v 1.13 2025/12/23 13:22:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/test/chromedriver/chrome/chrome_finder.cc.orig	2025-12-17 23:05:18.000000000 +0000
