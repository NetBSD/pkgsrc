$NetBSD: patch-chrome_browser_ui_webui_settings_site__settings__handler.cc,v 1.11 2026/05/10 15:29:53 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/settings/site_settings_handler.cc.orig	2026-04-28 23:05:57.000000000 +0200
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -2088,7 +2088,7 @@ void SiteSettingsHandler::SendZoomLevels
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (web_app_provider) {
@@ -2190,7 +2190,7 @@ void SiteSettingsHandler::HandleRemoveZo
