$NetBSD: patch-chrome_browser_ui_webui_settings_site__settings__handler.cc,v 1.17 2026/09/02 13:13:27 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/settings/site_settings_handler.cc.orig	2026-08-31 22:47:51.000000000 +0000
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (web_app_provider) {
@@ -2202,7 +2202,7 @@ void SiteSettingsHandler::HandleRemoveZo
