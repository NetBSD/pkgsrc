$NetBSD: patch-chrome_browser_ui_webui_connectors__internals_connectors__internals__page__handler.cc,v 1.22 2026/08/09 06:31:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/webui/connectors_internals/connectors_internals_page_handler.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -196,7 +196,7 @@ void ConnectorsInternalsPageHandler::Get
...
@@ -337,7 +337,7 @@ void ConnectorsInternalsPageHandler::OnS
 #endif  // !BUILDFLAG(IS_ANDROID)
