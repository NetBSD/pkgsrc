$NetBSD: patch-base_process_process__metrics.h,v 1.18 2026/04/21 15:21:08 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- base/process/process_metrics.h.orig	2026-04-14 23:31:37.000000000 +0200
...
@@ -311,7 +311,7 @@ BASE_EXPORT void IncreaseFdLimitTo(unsig
...
@@ -403,7 +403,7 @@ BASE_EXPORT bool GetSystemMemoryInfo(Sys
         // BUILDFLAG(IS_FUCHSIA)
