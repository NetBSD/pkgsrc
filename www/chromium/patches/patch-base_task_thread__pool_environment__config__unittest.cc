$NetBSD: patch-base_task_thread__pool_environment__config__unittest.cc,v 1.9 2025/11/04 14:55:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- base/task/thread_pool/environment_config_unittest.cc.orig	2025-10-24 16:42:30.000000000 +0000
