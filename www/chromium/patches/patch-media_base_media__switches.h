$NetBSD: patch-media_base_media__switches.h,v 1.8 2025/10/16 19:43:30 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/base/media_switches.h.orig	2025-10-13 21:41:26.000000000 +0000
...
+    BUILDFLAG(IS_SOLARIS) || BUILDFLAG(IS_NETBSD)
 ...
 #endif
@@ -337,13 +337,26 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kMedia
...
@@ -362,7 +375,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kUnifi
...
@@ -378,7 +391,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kVaapi
...
@@ -499,7 +512,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kBackg
