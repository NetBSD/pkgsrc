$NetBSD: patch-third__party_perfetto_src_tracing_track.cc,v 1.6 2025/09/08 13:24:32 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/tracing/track.cc.orig	2025-08-29 18:50:09.000000000 +0000
