$NetBSD: patch-chrome_common_chrome__paths.cc,v 1.18 2026/04/21 15:21:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/chrome_paths.cc.orig	2026-04-14 23:31:37.000000000 +0200
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
     case chrome::DIR_STANDALONE_EXTERNAL_EXTENSIONS: {
       ...
       break;
@@ -460,7 +460,7 @@ bool PathProvider(int key, base::FilePat
