$NetBSD: patch-components_embedder__support_user__agent__utils__unittest.cc,v 1.10 2025/11/20 08:36:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/embedder_support/user_agent_utils_unittest.cc.orig	2025-11-14 20:31:45.000000000 +0000
