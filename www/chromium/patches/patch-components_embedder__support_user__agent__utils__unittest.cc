$NetBSD: patch-components_embedder__support_user__agent__utils__unittest.cc,v 1.13 2025/12/23 13:22:17 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/embedder_support/user_agent_utils_unittest.cc.orig	2025-12-17 23:05:18.000000000 +0000
