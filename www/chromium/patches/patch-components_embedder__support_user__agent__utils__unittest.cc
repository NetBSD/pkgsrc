$NetBSD: patch-components_embedder__support_user__agent__utils__unittest.cc,v 1.9 2025/11/04 14:55:37 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/embedder_support/user_agent_utils_unittest.cc.orig	2025-10-24 16:42:30.000000000 +0000
