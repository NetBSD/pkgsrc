$NetBSD: patch-components_embedder__support_user__agent__utils__unittest.cc,v 1.25 2026/09/02 13:13:28 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/embedder_support/user_agent_utils_unittest.cc.orig	2026-08-31 22:47:51.000000000 +0000
...
@@ -659,7 +659,7 @@ TEST_F(UserAgentUtilsTest, UserAgentMeta
 #endif
