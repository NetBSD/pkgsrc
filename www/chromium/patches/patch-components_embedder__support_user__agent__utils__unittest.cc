$NetBSD: patch-components_embedder__support_user__agent__utils__unittest.cc,v 1.12 2025/12/13 14:53:53 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/embedder_support/user_agent_utils_unittest.cc.orig	2025-11-19 21:40:05.000000000 +0000
