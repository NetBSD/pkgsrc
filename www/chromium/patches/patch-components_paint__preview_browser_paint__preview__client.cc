$NetBSD: patch-components_paint__preview_browser_paint__preview__client.cc,v 1.25 2026/09/02 13:13:29 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/paint_preview/browser/paint_preview_client.cc.orig	2026-08-31 22:47:51.000000000 +0000
+++ components/paint_preview/browser/paint_preview_client.cc
@@ -465,8 +465,8 @@ void PaintPreviewClient::CapturePaintPre
