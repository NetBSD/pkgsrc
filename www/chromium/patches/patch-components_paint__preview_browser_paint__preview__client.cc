$NetBSD: patch-components_paint__preview_browser_paint__preview__client.cc,v 1.6 2025/09/08 13:24:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/paint_preview/browser/paint_preview_client.cc.orig	2025-08-29 18:50:09.000000000 +0000
