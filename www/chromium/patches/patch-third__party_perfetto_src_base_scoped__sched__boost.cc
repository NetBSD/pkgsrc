$NetBSD: patch-third__party_perfetto_src_base_scoped__sched__boost.cc,v 1.6 2025/11/20 08:36:23 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/scoped_sched_boost.cc.orig	2025-11-14 20:31:45.000000000 +0000
