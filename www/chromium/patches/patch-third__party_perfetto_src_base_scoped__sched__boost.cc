$NetBSD: patch-third__party_perfetto_src_base_scoped__sched__boost.cc,v 1.9 2025/12/23 13:22:25 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/perfetto/src/base/scoped_sched_boost.cc.orig	2025-12-17 23:05:18.000000000 +0000
