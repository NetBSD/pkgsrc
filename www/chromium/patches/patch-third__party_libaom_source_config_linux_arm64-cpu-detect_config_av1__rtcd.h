$NetBSD: patch-third__party_libaom_source_config_linux_arm64-cpu-detect_config_av1__rtcd.h,v 1.4 2026/04/21 15:21:21 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- third_party/libaom/source/config/linux/arm64-cpu-detect/config/av1_rtcd.h.orig	2026-04-14 23:31:37.000000000 +0200
...
@@ -531,8 +533,10 @@ static void setup_rtcd_internal(void)
