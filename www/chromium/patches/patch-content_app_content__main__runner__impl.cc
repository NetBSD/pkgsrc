$NetBSD: patch-content_app_content__main__runner__impl.cc,v 1.8 2025/10/16 19:43:28 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- content/app/content_main_runner_impl.cc.orig	2025-10-13 21:41:26.000000000 +0000
...
@@ -381,7 +388,7 @@ void InitializeZygoteSandboxForBrowserPr
 }
...
@@ -634,7 +651,7 @@ NO_STACK_PROTECTOR int RunZygote(Content
...
@@ -851,11 +868,10 @@ int ContentMainRunnerImpl::Initialize(Co
...
@@ -1007,7 +1023,7 @@ int ContentMainRunnerImpl::Initialize(Co
     // SeatbeltExecServer.
...
@@ -1017,10 +1033,22 @@ int ContentMainRunnerImpl::Initialize(Co
...
@@ -1123,6 +1151,11 @@ NO_STACK_PROTECTOR int ContentMainRunner
