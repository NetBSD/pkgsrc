$NetBSD: patch-content_app_content__main__runner__impl.cc,v 1.26 2026/09/22 13:41:25 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- content/app/content_main_runner_impl.cc.orig	2026-09-14 22:17:16.000000000 +0000
...
+
 ...
 #include "base/system/sys_info.h"
@@ -370,7 +377,7 @@ void InitializeZygoteSandboxForBrowserPr
 }
...
@@ -389,7 +396,10 @@ void PreloadLibraryCdms() {
...
+#endif
   ...
   // files.
@@ -401,9 +411,16 @@ void PreSandboxInit() {
...
@@ -639,7 +656,7 @@ NO_STACK_PROTECTOR int RunZygote(Content
...
@@ -744,7 +761,7 @@ NO_STACK_PROTECTOR int RunOtherNamedProc
...
@@ -865,11 +882,10 @@ int ContentMainRunnerImpl::Initialize(Co
...
@@ -1003,7 +1019,7 @@ int ContentMainRunnerImpl::Initialize(Co
...
@@ -1038,7 +1054,7 @@ int ContentMainRunnerImpl::Initialize(Co
     // SeatbeltExecServer.
...
@@ -1052,6 +1068,16 @@ int ContentMainRunnerImpl::Initialize(Co
...
@@ -1170,6 +1196,11 @@ NO_STACK_PROTECTOR int ContentMainRunner
