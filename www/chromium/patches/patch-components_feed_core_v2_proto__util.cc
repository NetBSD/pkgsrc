$NetBSD: patch-components_feed_core_v2_proto__util.cc,v 1.22 2026/07/06 13:06:49 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/feed/core/v2/proto_util.cc.orig	2026-06-23 23:37:18.000000000 +0000
