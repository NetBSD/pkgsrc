$NetBSD: patch-chrome_renderer_chrome__content__renderer__client.cc,v 1.10 2026/04/21 15:21:12 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/renderer/chrome_content_renderer_client.cc.orig	2026-04-14 23:31:37.000000000 +0200
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -428,7 +428,7 @@ void ChromeContentRendererClient::Render
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
@@ -497,7 +497,7 @@ void ChromeContentRendererClient::Render
