$NetBSD: patch-chrome_renderer_chrome__content__renderer__client.cc,v 1.18 2026/09/22 13:41:23 kikadf Exp $
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -437,7 +437,7 @@ void ChromeContentRendererClient::Render
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
@@ -502,7 +502,7 @@ void ChromeContentRendererClient::Render
...
@@ -557,7 +557,7 @@ void ChromeContentRendererClient::Render
