$NetBSD: patch-chrome_common_media_cdm__registration.cc,v 1.10 2025/11/20 08:36:11 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/media/cdm_registration.cc.orig	2025-11-14 20:31:45.000000000 +0000
