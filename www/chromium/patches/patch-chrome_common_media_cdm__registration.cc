$NetBSD: patch-chrome_common_media_cdm__registration.cc,v 1.9 2025/11/04 14:55:36 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/media/cdm_registration.cc.orig	2025-10-24 16:42:30.000000000 +0000
