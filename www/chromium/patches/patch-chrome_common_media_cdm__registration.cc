$NetBSD: patch-chrome_common_media_cdm__registration.cc,v 1.24 2026/08/09 06:31:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/media/cdm_registration.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -62,7 +62,7 @@ using Robustness = content::CdmInfo::Rob
 #if BUILDFLAG(ENABLE_WIDEVINE)
...
@@ -104,7 +104,7 @@ std::unique_ptr<content::CdmInfo> Create
...
@@ -128,7 +128,7 @@ std::unique_ptr<content::CdmInfo> GetBun
         // (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS))
...
@@ -170,7 +170,7 @@ void AddSoftwareSecureWidevine(std::vect
