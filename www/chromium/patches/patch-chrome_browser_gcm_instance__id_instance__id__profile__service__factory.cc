$NetBSD: patch-chrome_browser_gcm_instance__id_instance__id__profile__service__factory.cc,v 1.20 2026/06/01 10:09:07 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/gcm/instance_id/instance_id_profile_service_factory.cc.orig	2026-05-26 20:39:02.000000000 +0000
