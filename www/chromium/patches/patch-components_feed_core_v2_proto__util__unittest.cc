$NetBSD: patch-components_feed_core_v2_proto__util__unittest.cc,v 1.14 2026/01/19 16:14:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/feed/core/v2/proto_util_unittest.cc.orig	2026-01-07 00:50:30.000000000 +0000
