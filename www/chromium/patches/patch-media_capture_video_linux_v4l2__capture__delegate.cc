$NetBSD: patch-media_capture_video_linux_v4l2__capture__delegate.cc,v 1.20 2026/06/01 10:09:16 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/v4l2_capture_delegate.cc.orig	2026-05-26 20:39:02.000000000 +0000
