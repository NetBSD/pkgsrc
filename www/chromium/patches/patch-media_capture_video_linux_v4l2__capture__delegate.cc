$NetBSD: patch-media_capture_video_linux_v4l2__capture__delegate.cc,v 1.9 2025/11/04 14:55:42 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- media/capture/video/linux/v4l2_capture_delegate.cc.orig	2025-10-24 16:42:30.000000000 +0000
