$NetBSD: patch-chrome_browser_ui_accelerator__table.cc,v 1.14 2026/06/08 13:12:33 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/accelerator_table.cc.orig	2026-05-28 23:24:11.000000000 +0000
...
@@ -316,7 +316,7 @@ std::vector<AcceleratorMapping> GetAccel
