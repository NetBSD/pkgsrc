$NetBSD: patch-chrome_browser_ui_accelerator__table.cc,v 1.17 2026/08/09 06:31:10 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/browser/ui/accelerator_table.cc.orig	2026-08-05 20:17:42.000000000 +0000
...
@@ -318,7 +318,7 @@ std::vector<AcceleratorMapping> GetAccel
