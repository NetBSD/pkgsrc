$NetBSD: patch-components_autofill_core_browser_foundations_browser__autofill__manager.cc,v 1.21 2026/07/08 13:42:20 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/autofill/core/browser/foundations/browser_autofill_manager.cc.orig	2026-07-06 22:58:46.000000000 +0000
