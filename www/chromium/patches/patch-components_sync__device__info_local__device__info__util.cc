$NetBSD: patch-components_sync__device__info_local__device__info__util.cc,v 1.20 2026/06/01 10:09:13 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- components/sync_device_info/local_device_info_util.cc.orig	2026-05-26 20:39:02.000000000 +0000
