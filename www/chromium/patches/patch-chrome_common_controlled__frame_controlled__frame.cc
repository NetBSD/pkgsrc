$NetBSD: patch-chrome_common_controlled__frame_controlled__frame.cc,v 1.1 2025/11/04 14:55:36 kikadf Exp $

* Part of patchset to build chromium on NetBSD
* Based on OpenBSD's chromium patches, and
  pkgsrc's qt5-qtwebengine patches

--- chrome/common/controlled_frame/controlled_frame.cc.orig	2025-10-24 16:42:30.000000000 +0000
