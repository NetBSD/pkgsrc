# $NetBSD: zopeversion.mk,v 1.12 2009/07/08 13:56:00 joerg Exp $
#
...
ZOPE_VERSION_SUPPORTED=	29 210 211 # 33 34
...
#BUILDLINK_API_DEPENDS.zope34?=		${PYPKGPREFIX}-zope34>=3.4.0
.else
...
#BUILDLINK_API_DEPENDS.zope34?=		zope34>=3.4.0
.endif
...
#ZOPE_FULL_VERSION=	${ZOPE33_VERSION}
...
#.elif ${_ZOPE_VERSION} == "34"
#ZOPE_FULL_VERSION=	${ZOPE34_VERSION}
#ZOPE_DEPENDENCY=	${BUILDLINK_API_DEPENDS.zope34}:${ZOPE_PKGSRC_DIR}
#EVAL_PREFIX+=		BUILDLINK_PREFIX.zope34=${ZOPE_PKG}
#BUILDLINK_PREFIX.zope34_DEFAULT= ${LOCALBASE}
.else
