# $NetBSD: options.mk,v 1.8 2009/07/01 01:36:45 taca Exp $
...
DL_SUPPORTED_LANGUAGES=	be ca cs da de el es fi fr gu he hu id it ja ko lt \
			nb nl pl pt-br ro ru sk sv tr uk uk-ua zh-cn zh-tw 

DL_TRANSLATIONS.be=	be-6.x-1.0.tar.gz		# 2009/05/28
DL_TRANSLATIONS.ca=	ca-6.x-1.5.tar.gz		# 2009/02/22
...
DL_TRANSLATIONS.el=	el-6.x-1.0-beta2.tar.gz		# 2009/05/05
...
DL_TRANSLATIONS.nl=	nl-6.x-1.4.tar.gz		# 2009/05/06
...
DL_TRANSLATIONS.sv=	sv-6.x-1.2.tar.gz		# 2009/05/19
...
DL_TRANSLATIONS.uk=	uk-6.x-1.1.tar.gz		# 2009/05/24
