# $NetBSD: buildlink2.mk,v 1.1.1.1 2003/09/12 17:20:02 xtraeme Exp $
#
...
BUILDLINK_DEPENDS.gtk-thinice-engine?=		gtk-thinice-engine>=2.0.2
BUILDLINK_PKGSRCDIR.gtk-thinice-engine?=		../../x11/gtk2-thinice-engine
