# $NetBSD: cargo-depends.mk,v 1.5 2021/05/25 16:18:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	crossfont-0.3.0
...
CARGO_CRATE_DEPENDS+=	embed-resource-1.6.2
...
CARGO_CRATE_DEPENDS+=	glutin-0.26.0
...
CARGO_CRATE_DEPENDS+=	notify-4.0.16
...
CARGO_CRATE_DEPENDS+=	wayland-client-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-commons-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-cursor-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-egl-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-protocols-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-scanner-0.28.5
CARGO_CRATE_DEPENDS+=	wayland-sys-0.28.5
...
CARGO_CRATE_DEPENDS+=	winit-0.24.0
