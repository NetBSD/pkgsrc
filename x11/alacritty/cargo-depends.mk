# $NetBSD: cargo-depends.mk,v 1.16 2024/10/23 03:37:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	glutin-0.32.0
...
CARGO_CRATE_DEPENDS+=	wayland-protocols-plasma-0.3.3
...
CARGO_CRATE_DEPENDS+=	winit-0.30.4
