# $NetBSD: cargo-depends.mk,v 1.3 2021/02/11 13:15:21 pin Exp $
...
CARGO_CRATE_DEPENDS+=	crossfont-0.2.0
...
CARGO_CRATE_DEPENDS+=	embed-resource-1.4.1
...
CARGO_CRATE_DEPENDS+=	wayland-egl-0.28.3
