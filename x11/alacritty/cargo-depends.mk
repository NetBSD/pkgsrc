# $NetBSD: cargo-depends.mk,v 1.6 2021/08/04 00:02:32 tnn Exp $
...
CARGO_CRATE_DEPENDS+=	crossfont-0.3.1
...
CARGO_CRATE_DEPENDS+=	embed-resource-1.6.3
...
CARGO_CRATE_DEPENDS+=	wayland-egl-0.28.6
