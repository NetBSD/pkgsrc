# $NetBSD: buildlink3.mk,v 1.8 2015/04/06 08:17:20 adam Exp $
...
BUILDLINK_API_DEPENDS.qt5-qtx11extras+=	qt5-qtx11extras>=5.4.0
BUILDLINK_ABI_DEPENDS.qt5-qtx11extras+=	qt5-qtx11extras>=5.4.0nb1
