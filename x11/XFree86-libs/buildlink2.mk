# $NetBSD: buildlink2.mk,v 1.1.1.1 2004/01/24 08:47:27 xtraeme Exp $
#
...
BUILDLINK_PREFIX.XFree86-libs_DEFAULT=	${X11BASE}
...
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/ximcp.*
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/xlcDef.*
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/xlcUTF8Load.*
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/xlibi18n.*
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/xlocale.*
BUILDLINK_FILES.XFree86-libs+=	lib/X11/locale/lib/common/xomGeneric.*
...
BUILDLINK_FILES.XFree86-libs+=	lib/libXrandr.*
BUILDLINK_FILES.XFree86-libs+=	lib/libXrender.*
