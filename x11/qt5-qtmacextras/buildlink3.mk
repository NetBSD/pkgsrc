# $NetBSD: buildlink3.mk,v 1.1 2014/12/30 17:23:46 adam Exp $
...
BUILDLINK_API_DEPENDS.qt5-qtmacextras+=	qt5-qtmacextras>=5.4.0
BUILDLINK_ABI_DEPENDS.qt5-qtmacextras+=	qt5-qtmacextras>=5.4.0
