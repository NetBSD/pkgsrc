# $NetBSD: cargo-depends.mk,v 1.3 2023/08/10 14:11:37 pin Exp $
...
CARGO_CRATE_DEPENDS+=	etagere-0.2.8
...
CARGO_CRATE_DEPENDS+=	freedesktop-icons-0.2.3
...
CARGO_CRATE_DEPENDS+=	glam-0.24.1
...
CARGO_CRATE_DEPENDS+=	iced-0.10.0
CARGO_CRATE_DEPENDS+=	iced_core-0.10.0
CARGO_CRATE_DEPENDS+=	iced_futures-0.7.0
CARGO_CRATE_DEPENDS+=	iced_graphics-0.9.0
CARGO_CRATE_DEPENDS+=	iced_renderer-0.1.0
CARGO_CRATE_DEPENDS+=	iced_runtime-0.1.1
CARGO_CRATE_DEPENDS+=	iced_style-0.9.0
CARGO_CRATE_DEPENDS+=	iced_tiny_skia-0.1.0
CARGO_CRATE_DEPENDS+=	iced_wgpu-0.11.1
CARGO_CRATE_DEPENDS+=	iced_widget-0.1.3
CARGO_CRATE_DEPENDS+=	iced_winit-0.10.0
...
CARGO_CRATE_DEPENDS+=	naga-0.12.3
...
CARGO_CRATE_DEPENDS+=	palette-0.7.2
CARGO_CRATE_DEPENDS+=	palette_derive-0.7.2
...
CARGO_CRATE_DEPENDS+=	profiling-1.0.9
...
CARGO_CRATE_DEPENDS+=	softbuffer-0.2.1
...
CARGO_CRATE_DEPENDS+=	wayland-backend-0.1.2
CARGO_CRATE_DEPENDS+=	wayland-client-0.29.5
CARGO_CRATE_DEPENDS+=	wayland-client-0.30.2
...
CARGO_CRATE_DEPENDS+=	wayland-scanner-0.30.1
...
CARGO_CRATE_DEPENDS+=	wgpu-0.16.3
CARGO_CRATE_DEPENDS+=	wgpu-core-0.16.1
CARGO_CRATE_DEPENDS+=	wgpu-hal-0.16.2
CARGO_CRATE_DEPENDS+=	wgpu-types-0.16.1
...
CARGO_CRATE_DEPENDS+=	window_clipboard-0.3.0
...
CARGO_CRATE_DEPENDS+=	x11rb-0.11.1
CARGO_CRATE_DEPENDS+=	x11rb-protocol-0.11.1
CARGO_CRATE_DEPENDS+=	xcursor-0.3.4
CARGO_CRATE_DEPENDS+=	xdg-2.5.2
CARGO_CRATE_DEPENDS+=	xdg-home-1.0.0
CARGO_CRATE_DEPENDS+=	xdg-mime-0.3.3
