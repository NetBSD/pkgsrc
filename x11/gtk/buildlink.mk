# $NetBSD: buildlink.mk,v 1.12.4.1 2002/07/22 17:04:18 agc Exp $
#
...
PKGNAME.gtk!= cd ../../x11/gtk; ${MAKE} show-var VARNAME=PKGNAME
BUILDLINK_PREFIX.gtk_DEFAULT=	${LOCALBASE:S|${PKGNAME}|${PKGNAME.gtk}|}
.else
