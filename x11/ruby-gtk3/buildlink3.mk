# $NetBSD: buildlink3.mk,v 1.12 2023/06/02 16:43:30 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.1.7
BUILDLINK_ABI_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.1.7
