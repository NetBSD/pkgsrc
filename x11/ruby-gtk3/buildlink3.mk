# $NetBSD: buildlink3.mk,v 1.27 2025/02/09 09:19:11 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.2.7
BUILDLINK_ABI_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.2.7
