# $NetBSD: buildlink3.mk,v 1.37 2026/02/07 08:41:19 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.3.5
BUILDLINK_ABI_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.3.5
