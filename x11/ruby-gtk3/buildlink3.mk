# $NetBSD: buildlink3.mk,v 1.29 2025/05/31 20:18:18 tsutsui Exp $
...
BUILDLINK_API_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.2.9
BUILDLINK_ABI_DEPENDS.ruby-gtk3+=	${RUBY_PKGPREFIX}-gtk3>=4.2.9
