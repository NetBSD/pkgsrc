$NetBSD: patch-configure.pri,v 1.4 2025/06/30 15:05:11 adam Exp $

Always build on Darwin.

--- configure.pri.orig	2024-04-03 09:31:09.000000000 +0000
+++ configure.pri
@@ -455,28 +455,6 @@ defineTest(qtwebengine_isWindowsPlatform
 }
