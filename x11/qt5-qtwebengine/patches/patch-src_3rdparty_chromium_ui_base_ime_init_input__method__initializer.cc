$NetBSD: patch-src_3rdparty_chromium_ui_base_ime_init_input__method__initializer.cc,v 1.1 2021/08/03 21:04:36 markd Exp $

--- src/3rdparty/chromium/ui/base/ime/init/input_method_initializer.cc.orig	2020-11-07 01:22:36.000000000 +0000
