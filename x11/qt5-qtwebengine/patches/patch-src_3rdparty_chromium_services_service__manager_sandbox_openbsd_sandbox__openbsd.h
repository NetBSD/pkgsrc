$NetBSD: patch-src_3rdparty_chromium_services_service__manager_sandbox_openbsd_sandbox__openbsd.h,v 1.1 2021/08/03 21:04:35 markd Exp $

Index: src/3rdparty/chromium/services/service_manager/sandbox/openbsd/sandbox_openbsd.h
--- src/3rdparty/chromium/services/service_manager/sandbox/openbsd/sandbox_openbsd.h.orig
+++ src/3rdparty/chromium/services/service_manager/sandbox/openbsd/sandbox_openbsd.h
@@ -0,0 +1,265 @@
...
+  bool SetUnveil(const std::string process_type, SandboxType sandbox_type);
+
...
+  // a fork().
+  void PreinitializeSandbox(SandboxType sandbox_type);
+
