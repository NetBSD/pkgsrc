# $NetBSD: buildlink3.mk,v 1.10 2005/12/31 12:32:48 wiz Exp $
...
BUILDLINK_DEPENDS.gnome-panel+=		gnome-panel>=2.10.0
BUILDLINK_RECOMMENDED.gnome-panel?=	gnome-panel>=2.12.1nb2
