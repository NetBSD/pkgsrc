# $NetBSD: buildlink.mk,v 1.1 2001/07/06 06:46:51 jlam Exp $
#
...
BUILDLINK_PREFIX.kdebase2=	${X11PREFIX}
BUILDLINK_FILES.kdebase2!=	${GREP} "^\(include\|lib\)" ${.CURDIR}/../../x11/kdebase2/pkg/PLIST
