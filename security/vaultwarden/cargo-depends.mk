# $NetBSD: cargo-depends.mk,v 1.5 2024/12/01 00:04:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bigdecimal-0.4.6
...
CARGO_CRATE_DEPENDS+=	diesel-2.2.4
...
CARGO_CRATE_DEPENDS+=	dsl_auto_type-0.1.2
CARGO_CRATE_DEPENDS+=	either-1.13.0
CARGO_CRATE_DEPENDS+=	email-encoding-0.3.0
...
CARGO_CRATE_DEPENDS+=	html5gum-0.6.1
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.10
...
CARGO_CRATE_DEPENDS+=	pq-sys-0.6.3
