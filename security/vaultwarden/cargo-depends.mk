# $NetBSD: cargo-depends.mk,v 1.11 2026/02/11 20:35:38 adam Exp $
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.39
...
CARGO_CRATE_DEPENDS+=	cached-0.56.0
CARGO_CRATE_DEPENDS+=	cached_proc_macro-0.25.0
...
CARGO_CRATE_DEPENDS+=	libc-0.2.181
...
CARGO_CRATE_DEPENDS+=	mini-moka-0.10.3
...
CARGO_CRATE_DEPENDS+=	mysqlclient-sys-0.5.0
...
CARGO_CRATE_DEPENDS+=	svg-hush-0.9.5
...
CARGO_CRATE_DEPENDS+=	zmij-1.0.20
