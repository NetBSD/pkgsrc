# $NetBSD: cargo-depends.mk,v 1.7 2025/05/27 07:51:06 adam Exp $
...
CARGO_CRATE_DEPENDS+=	diesel-2.2.10
CARGO_CRATE_DEPENDS+=	diesel-derive-newtype-2.1.2
CARGO_CRATE_DEPENDS+=	diesel_derives-2.2.5
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.16
...
CARGO_CRATE_DEPENDS+=	migrations_internals-2.2.0
...
CARGO_CRATE_DEPENDS+=	mysqlclient-sys-0.4.5
...
CARGO_CRATE_DEPENDS+=	pq-sys-0.7.1
