# $NetBSD: cargo-depends.mk,v 1.6 2025/02/24 08:59:37 adam Exp $
...
CARGO_CRATE_DEPENDS+=	chrono-tz-0.10.1
...
CARGO_CRATE_DEPENDS+=	email-encoding-0.3.1
...
CARGO_CRATE_DEPENDS+=	job_scheduler_ng-2.0.5
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.12
...
CARGO_CRATE_DEPENDS+=	raw-cpuid-11.3.0
...
#CARGO_CRATE_DEPENDS+=	yubico-0.12.0
