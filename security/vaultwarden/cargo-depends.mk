# $NetBSD: cargo-depends.mk,v 1.15.2.1 2026/07/30 01:43:38 maya Exp $
...
CARGO_CRATE_DEPENDS+=	opendal-0.57.0
CARGO_CRATE_DEPENDS+=	opendal-core-0.57.0
CARGO_CRATE_DEPENDS+=	opendal-service-fs-0.57.0
CARGO_CRATE_DEPENDS+=	opendal-service-s3-0.57.0
...
CARGO_CRATE_DEPENDS+=	reqsign-aws-v4-3.0.2
CARGO_CRATE_DEPENDS+=	reqsign-core-3.1.0
CARGO_CRATE_DEPENDS+=	reqsign-file-read-tokio-3.0.2
...
CARGO_CRATE_DEPENDS+=	value-bag-1.13.1
...
CARGO_CRATE_DEPENDS+=	yubico_ng-0.15.0
