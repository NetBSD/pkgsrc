# $NetBSD: cargo-depends.mk,v 1.8 2025/08/07 11:12:18 adam Exp $
...
CARGO_CRATE_DEPENDS+=	aws-config-1.8.3
CARGO_CRATE_DEPENDS+=	aws-credential-types-1.2.4
CARGO_CRATE_DEPENDS+=	aws-runtime-1.5.9
CARGO_CRATE_DEPENDS+=	aws-sdk-sso-1.78.0
CARGO_CRATE_DEPENDS+=	aws-sdk-ssooidc-1.79.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sts-1.80.0
CARGO_CRATE_DEPENDS+=	aws-sigv4-1.3.3
CARGO_CRATE_DEPENDS+=	aws-smithy-async-1.2.5
CARGO_CRATE_DEPENDS+=	aws-smithy-http-0.62.2
CARGO_CRATE_DEPENDS+=	aws-smithy-json-0.61.4
CARGO_CRATE_DEPENDS+=	aws-smithy-observability-0.1.3
CARGO_CRATE_DEPENDS+=	aws-smithy-query-0.60.7
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-1.8.5
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-api-1.8.5
CARGO_CRATE_DEPENDS+=	aws-smithy-types-1.3.2
CARGO_CRATE_DEPENDS+=	aws-smithy-xml-0.60.10
CARGO_CRATE_DEPENDS+=	aws-types-1.3.8
CARGO_CRATE_DEPENDS+=	backon-1.5.1
...
CARGO_CRATE_DEPENDS+=	governor-0.10.0
...
CARGO_CRATE_DEPENDS+=	html5gum-0.7.0
...
CARGO_CRATE_DEPENDS+=	job_scheduler_ng-2.2.0
...
CARGO_CRATE_DEPENDS+=	opendal-0.54.0
...
CARGO_CRATE_DEPENDS+=	resolv-conf-0.7.4
...
CARGO_CRATE_DEPENDS+=	rust-ini-0.21.2
...
CARGO_CRATE_DEPENDS+=	rustls-0.23.30
...
CARGO_CRATE_DEPENDS+=	yubico_ng-0.13.0
