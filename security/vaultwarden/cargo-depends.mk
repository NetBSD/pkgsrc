# $NetBSD: cargo-depends.mk,v 1.18 2026/09/23 09:20:02 adam Exp $
...
CARGO_CRATE_DEPENDS+=	argon2-0.6.0
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.45
...
CARGO_CRATE_DEPENDS+=	asyncband-0.6.7
...
CARGO_CRATE_DEPENDS+=	cached-4.0.0
CARGO_CRATE_DEPENDS+=	cached_proc_macro-3.0.1
CARGO_CRATE_DEPENDS+=	cached_proc_macro_types-3.0.0
...
CARGO_CRATE_DEPENDS+=	compression-codecs-0.4.40
...
CARGO_CRATE_DEPENDS+=	core_detect-1.0.0
...
CARGO_CRATE_DEPENDS+=	diesel-2.3.13
CARGO_CRATE_DEPENDS+=	diesel-derive-newtype-2.1.3
CARGO_CRATE_DEPENDS+=	diesel_derives-2.3.10
...
CARGO_CRATE_DEPENDS+=	encoding_rs-0.8.41
...
CARGO_CRATE_DEPENDS+=	handlebars-6.4.4
...
CARGO_CRATE_DEPENDS+=	hickory-net-0.26.2
CARGO_CRATE_DEPENDS+=	hickory-proto-0.26.2
CARGO_CRATE_DEPENDS+=	hickory-resolver-0.26.2
...
CARGO_CRATE_DEPENDS+=	job_scheduler_ng-2.5.0
CARGO_CRATE_DEPENDS+=	jobserver-0.1.35
CARGO_CRATE_DEPENDS+=	js-sys-0.3.105
CARGO_CRATE_DEPENDS+=	jsonwebtoken-11.0.0
...
CARGO_CRATE_DEPENDS+=	multiversion-0.9.0
CARGO_CRATE_DEPENDS+=	multiversion-macros-0.9.0
CARGO_CRATE_DEPENDS+=	multiversion_no_op-1.0.0
CARGO_CRATE_DEPENDS+=	mysqlclient-sys-0.5.2
...
CARGO_CRATE_DEPENDS+=	num-derive-0.5.1
CARGO_CRATE_DEPENDS+=	num-integer-0.1.47
CARGO_CRATE_DEPENDS+=	num-iter-0.1.46
CARGO_CRATE_DEPENDS+=	num-modular-0.6.5
...
CARGO_CRATE_DEPENDS+=	opendal-0.59.1
CARGO_CRATE_DEPENDS+=	opendal-core-0.59.1
CARGO_CRATE_DEPENDS+=	opendal-http-transport-reqwest-0.59.1
CARGO_CRATE_DEPENDS+=	opendal-service-fs-0.59.1
CARGO_CRATE_DEPENDS+=	opendal-service-s3-0.59.1
...
CARGO_CRATE_DEPENDS+=	reqsign-aws-core-3.1.1
CARGO_CRATE_DEPENDS+=	reqsign-aws-v4-3.3.0
CARGO_CRATE_DEPENDS+=	reqsign-core-3.3.1
CARGO_CRATE_DEPENDS+=	reqsign-file-read-tokio-3.0.6
...
CARGO_CRATE_DEPENDS+=	rustls-0.23.44
...
CARGO_CRATE_DEPENDS+=	serde_with-3.23.0
CARGO_CRATE_DEPENDS+=	serde_with_macros-3.23.0
...
CARGO_CRATE_DEPENDS+=	svg-hush-0.9.7
...
CARGO_CRATE_DEPENDS+=	value-bag-1.14.1
...
CARGO_CRATE_DEPENDS+=	yubico_ng-1.0.0
