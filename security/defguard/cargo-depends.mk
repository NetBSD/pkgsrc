...
CARGO_CRATE_DEPENDS+=	base64urlsafedata-0.5.2
CARGO_CRATE_DEPENDS+=	bitfields-0.12.4
CARGO_CRATE_DEPENDS+=	bitfields-impl-0.9.4
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.18
...
CARGO_CRATE_DEPENDS+=	pgp-0.16.0
...
CARGO_CRATE_DEPENDS+=	security-framework-3.5.0
...
CARGO_CRATE_DEPENDS+=	serde_cbor_2-0.12.0-dev
...
CARGO_CRATE_DEPENDS+=	serde_qs-0.15.0
...
CARGO_CRATE_DEPENDS+=	tonic-health-0.14.2
...
CARGO_CRATE_DEPENDS+=	webauthn-attestation-ca-0.5.2
CARGO_CRATE_DEPENDS+=	webauthn-authenticator-rs-0.5.2
CARGO_CRATE_DEPENDS+=	webauthn-rs-0.5.2
CARGO_CRATE_DEPENDS+=	webauthn-rs-core-0.5.2
CARGO_CRATE_DEPENDS+=	webauthn-rs-proto-0.5.2
