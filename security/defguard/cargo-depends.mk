# $NetBSD: cargo-depends.mk,v 1.1 2025/07/14 05:35:36 adam Exp $
...
CARGO_CRATE_DEPENDS+=	base64urlsafedata-0.5.1
...
CARGO_CRATE_DEPENDS+=	compact_jwt-0.4.3
...
CARGO_CRATE_DEPENDS+=	iter-read-1.1.0
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.17
...
CARGO_CRATE_DEPENDS+=	openidconnect-4.0.0
...
CARGO_CRATE_DEPENDS+=	pgp-0.15.0
...
CARGO_CRATE_DEPENDS+=	serde_html_form-0.2.7
...
CARGO_CRATE_DEPENDS+=	serde_qs-0.13.0
...
CARGO_CRATE_DEPENDS+=	tonic-health-0.12.3
...
CARGO_CRATE_DEPENDS+=	webauthn-attestation-ca-0.5.1
CARGO_CRATE_DEPENDS+=	webauthn-authenticator-rs-0.5.1
CARGO_CRATE_DEPENDS+=	webauthn-rs-0.5.1
CARGO_CRATE_DEPENDS+=	webauthn-rs-core-0.5.1
CARGO_CRATE_DEPENDS+=	webauthn-rs-proto-0.5.1
