# $NetBSD: cargo-depends.mk,v 1.4 2026/05/05 18:00:35 adam Exp $
...
CARGO_CRATE_DEPENDS+=	css-inline-0.20.2
...
CARGO_CRATE_DEPENDS+=	serde_qs-1.1.1
...
CARGO_CRATE_DEPENDS+=	struct-patch-0.10.5
CARGO_CRATE_DEPENDS+=	struct-patch-derive-0.10.5
...
CARGO_CRATE_DEPENDS+=	tonic-build-0.14.5
CARGO_CRATE_DEPENDS+=	tonic-health-0.14.5
