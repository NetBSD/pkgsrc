# $NetBSD: cargo-depends.mk,v 1.6 2026/07/13 07:29:18 adam Exp $
...
CARGO_CRATE_DEPENDS+=	ammonia-4.1.3
...
CARGO_CRATE_DEPENDS+=	css-inline-0.21.0
...
CARGO_CRATE_DEPENDS+=	exr-1.74.1
...
CARGO_CRATE_DEPENDS+=	qrforge-0.1.1
...
CARGO_CRATE_DEPENDS+=	serde_qs-1.1.2
...
CARGO_CRATE_DEPENDS+=	struct-patch-0.12.6
CARGO_CRATE_DEPENDS+=	struct-patch-derive-0.12.6
