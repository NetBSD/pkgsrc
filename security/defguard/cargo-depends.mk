# $NetBSD: cargo-depends.mk,v 1.7 2026/09/05 05:08:23 adam Exp $
...
CARGO_CRATE_DEPENDS+=	bon-3.10.0
CARGO_CRATE_DEPENDS+=	bon-macros-3.10.0
...
CARGO_CRATE_DEPENDS+=	css-inline-0.21.2
...
CARGO_CRATE_DEPENDS+=	email-encoding-0.4.2
CARGO_CRATE_DEPENDS+=	email_address-0.2.9
CARGO_CRATE_DEPENDS+=	encoding_rs-0.8.35
CARGO_CRATE_DEPENDS+=	enum-as-inner-0.7.0
...
CARGO_CRATE_DEPENDS+=	htmlparser-0.2.1
...
CARGO_CRATE_DEPENDS+=	jsonwebkey-0.4.0
...
CARGO_CRATE_DEPENDS+=	lettre-0.11.23
...
CARGO_CRATE_DEPENDS+=	mrml-6.0.1
...
CARGO_CRATE_DEPENDS+=	parse_link_header-0.4.1
...
CARGO_CRATE_DEPENDS+=	prettyplease-0.3.0
...
CARGO_CRATE_DEPENDS+=	selectors-0.40.0
...
CARGO_CRATE_DEPENDS+=	serde_qs-1.1.3
...
CARGO_CRATE_DEPENDS+=	tonic-health-0.14.6
...
CARGO_CRATE_DEPENDS+=	tower_governor-0.8.0
...
CARGO_CRATE_DEPENDS+=	trait-variant-0.1.3
...
CARGO_CRATE_DEPENDS+=	vergen-10.0.3
CARGO_CRATE_DEPENDS+=	vergen-git2-10.0.3
CARGO_CRATE_DEPENDS+=	vergen-lib-10.0.3
...
CARGO_CRATE_DEPENDS+=	webauthn-authenticator-rs-0.5.5
