# $NetBSD: cargo-depends.mk,v 1.2 2025/07/03 13:34:05 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	openpgp-cert-d-0.3.4
...
CARGO_CRATE_DEPENDS+=	sequoia-cert-store-0.7.0
CARGO_CRATE_DEPENDS+=	sequoia-gpg-agent-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-ipc-0.36.0
CARGO_CRATE_DEPENDS+=	sequoia-net-0.30.0
CARGO_CRATE_DEPENDS+=	sequoia-openpgp-2.0.0
CARGO_CRATE_DEPENDS+=	sequoia-policy-config-0.8.0
CARGO_CRATE_DEPENDS+=	sequoia-wot-0.14.0
