# $NetBSD: cargo-depends.mk,v 1.1 2025/07/14 05:36:04 adam Exp $
...
CARGO_CRATE_DEPENDS+=	axum-macros-0.5.0
...
CARGO_CRATE_DEPENDS+=	defguard_wireguard_rs-0.7.5
...
CARGO_CRATE_DEPENDS+=	netlink-packet-generic-0.3.3
CARGO_CRATE_DEPENDS+=	netlink-packet-route-0.22.0
CARGO_CRATE_DEPENDS+=	netlink-packet-utils-0.5.2
CARGO_CRATE_DEPENDS+=	netlink-packet-wireguard-0.2.3
