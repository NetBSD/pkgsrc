# $NetBSD: cargo-depends.mk,v 1.8 2026/09/01 10:40:58 adam Exp $
...
CARGO_CRATE_DEPENDS+=	netlink-packet-wireguard-0.4.2
CARGO_CRATE_DEPENDS+=	netlink-sys-0.8.8
CARGO_CRATE_DEPENDS+=	nftnl-0.9.3
...
CARGO_CRATE_DEPENDS+=	redox_syscall-0.9.1
