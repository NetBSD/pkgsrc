# $NetBSD: cargo-depends.mk,v 1.5 2026/07/13 07:29:18 adam Exp $
...
CARGO_CRATE_DEPENDS+=	defguard_wireguard_rs-0.10.0
...
CARGO_CRATE_DEPENDS+=	netlink-packet-route-0.30.0
...
CARGO_CRATE_DEPENDS+=	uniffi-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_bindgen-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_build-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_core-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_internal_macros-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_macros-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_meta-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_pipeline-0.31.2
CARGO_CRATE_DEPENDS+=	uniffi_udl-0.31.2
