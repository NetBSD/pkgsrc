# $NetBSD: cargo-depends.mk,v 1.6 2024/03/22 12:06:44 pin Exp $

CARGO_CRATE_DEPENDS+=	abscissa_core-0.7.0
CARGO_CRATE_DEPENDS+=	abscissa_derive-0.7.0
...
CARGO_CRATE_DEPENDS+=	basic-toml-0.1.8
...
CARGO_CRATE_DEPENDS+=	comrak-0.21.0
...
CARGO_CRATE_DEPENDS+=	display-error-chain-0.2.0
...
CARGO_CRATE_DEPENDS+=	gix-attributes-0.22.0
CARGO_CRATE_DEPENDS+=	gix-bitmap-0.2.10
CARGO_CRATE_DEPENDS+=	gix-chunk-0.4.7
CARGO_CRATE_DEPENDS+=	gix-command-0.3.3
CARGO_CRATE_DEPENDS+=	gix-commitgraph-0.24.0
CARGO_CRATE_DEPENDS+=	gix-config-0.34.0
CARGO_CRATE_DEPENDS+=	gix-config-value-0.14.4
CARGO_CRATE_DEPENDS+=	gix-credentials-0.24.0
...
CARGO_CRATE_DEPENDS+=	gix-packetline-0.17.3
CARGO_CRATE_DEPENDS+=	gix-packetline-blocking-0.17.3
CARGO_CRATE_DEPENDS+=	gix-path-0.10.5
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.6.0
CARGO_CRATE_DEPENDS+=	gix-prompt-0.8.2
CARGO_CRATE_DEPENDS+=	gix-protocol-0.44.0
...
CARGO_CRATE_DEPENDS+=	maybe-async-0.2.9
...
CARGO_CRATE_DEPENDS+=	rustsec-0.28.6
...
CARGO_CRATE_DEPENDS+=	tame-index-0.9.3
...
CARGO_CRATE_DEPENDS+=	time-0.3.32
...
CARGO_CRATE_DEPENDS+=	winnow-0.5.36
