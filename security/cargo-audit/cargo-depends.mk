# $NetBSD: cargo-depends.mk,v 1.10 2025/04/01 12:10:15 adam Exp $

CARGO_CRATE_DEPENDS+=	abscissa_core-0.8.2
CARGO_CRATE_DEPENDS+=	abscissa_derive-0.8.2
...
CARGO_CRATE_DEPENDS+=	rustc-stable-hash-0.1.1
...
CARGO_CRATE_DEPENDS+=	tame-index-0.18.1
...
CARGO_CRATE_DEPENDS+=	toml-span-0.4.1
