# $NetBSD: cargo-depends.mk,v 1.7 2021/08/07 14:38:20 pin Exp $
...
CARGO_CRATE_DEPENDS+=	rust-embed-6.0.0
CARGO_CRATE_DEPENDS+=	rust-embed-impl-6.0.0
CARGO_CRATE_DEPENDS+=	rust-embed-utils-6.0.0
...
CARGO_CRATE_DEPENDS+=	wayland-client-0.28.3
CARGO_CRATE_DEPENDS+=	wayland-commons-0.28.3
CARGO_CRATE_DEPENDS+=	wayland-cursor-0.28.3
CARGO_CRATE_DEPENDS+=	wayland-protocols-0.28.3
CARGO_CRATE_DEPENDS+=	wayland-scanner-0.28.3
CARGO_CRATE_DEPENDS+=	wayland-sys-0.28.3
CARGO_CRATE_DEPENDS+=	which-4.0.2
...
CARGO_CRATE_DEPENDS+=	xcursor-0.3.3
