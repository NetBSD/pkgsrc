# $NetBSD: cargo-depends.mk,v 1.6 2025/07/03 13:23:15 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	botan-0.11.1
CARGO_CRATE_DEPENDS+=	botan-sys-0.11.1
...
CARGO_CRATE_DEPENDS+=	culpa-1.0.2
CARGO_CRATE_DEPENDS+=	culpa-macros-1.0.2
...
CARGO_CRATE_DEPENDS+=	descape-2.0.3
...
CARGO_CRATE_DEPENDS+=	marked-yaml-0.7.2
...
CARGO_CRATE_DEPENDS+=	pikchr-0.1.4
...
CARGO_CRATE_DEPENDS+=	roadmap-0.7.0
...
CARGO_CRATE_DEPENDS+=	sequoia-autocrypt-0.26.0
...
CARGO_CRATE_DEPENDS+=	sequoia-keystore-0.7.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-backend-0.7.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-gpg-agent-0.5.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-softkeys-0.7.0
CARGO_CRATE_DEPENDS+=	sequoia-man-0.3.1
...
CARGO_CRATE_DEPENDS+=	subplot-0.12.0
CARGO_CRATE_DEPENDS+=	subplot-build-0.12.0
CARGO_CRATE_DEPENDS+=	subplotlib-0.12.0
CARGO_CRATE_DEPENDS+=	subplotlib-derive-0.12.0
