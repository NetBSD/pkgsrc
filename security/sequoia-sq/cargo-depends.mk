# $NetBSD: cargo-depends.mk,v 1.3 2024/10/22 18:56:51 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	async-generic-1.1.1
...
CARGO_CRATE_DEPENDS+=	buffered-reader-1.3.1
...
CARGO_CRATE_DEPENDS+=	capnp-0.19.6
CARGO_CRATE_DEPENDS+=	capnp-futures-0.19.0
CARGO_CRATE_DEPENDS+=	capnp-rpc-0.19.2
...
CARGO_CRATE_DEPENDS+=	enumber-0.3.1
...
CARGO_CRATE_DEPENDS+=	hickory-client-0.24.1
...
CARGO_CRATE_DEPENDS+=	normpath-1.1.0
...
CARGO_CRATE_DEPENDS+=	openpgp-cert-d-0.3.2
...
CARGO_CRATE_DEPENDS+=	sequoia-cert-store-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-directories-0.1.0
CARGO_CRATE_DEPENDS+=	sequoia-gpg-agent-0.4.1
CARGO_CRATE_DEPENDS+=	sequoia-ipc-0.35.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-0.6.1
CARGO_CRATE_DEPENDS+=	sequoia-keystore-backend-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-gpg-agent-0.4.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-softkeys-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-net-0.28.0
CARGO_CRATE_DEPENDS+=	sequoia-openpgp-1.21.2
CARGO_CRATE_DEPENDS+=	sequoia-policy-config-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-wot-0.12.0
