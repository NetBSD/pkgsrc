# $NetBSD: cargo-depends.mk,v 1.4 2024/11/25 07:10:27 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	async-generic-1.1.2
...
CARGO_CRATE_DEPENDS+=	remove_dir_all-0.8.4
...
CARGO_CRATE_DEPENDS+=	sequoia-cert-store-0.6.1
CARGO_CRATE_DEPENDS+=	sequoia-directories-0.1.0
CARGO_CRATE_DEPENDS+=	sequoia-gpg-agent-0.4.2
...
CARGO_CRATE_DEPENDS+=	sequoia-wot-0.13.0
