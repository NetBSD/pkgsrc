# $NetBSD: cargo-depends.mk,v 1.2 2024/02/29 22:13:39 pin Exp $
...
CARGO_CRATE_DEPENDS+=	capnp-0.19.2
CARGO_CRATE_DEPENDS+=	capnp-futures-0.19.0
CARGO_CRATE_DEPENDS+=	capnp-rpc-0.19.0
CARGO_CRATE_DEPENDS+=	capnpc-0.19.0
...
CARGO_CRATE_DEPENDS+=	clap_mangen-0.2.19
...
CARGO_CRATE_DEPENDS+=	dircpy-0.3.16
...
CARGO_CRATE_DEPENDS+=	generator-0.7.6
...
CARGO_CRATE_DEPENDS+=	indexmap-2.2.4
...
CARGO_CRATE_DEPENDS+=	sequoia-cert-store-0.5.0
CARGO_CRATE_DEPENDS+=	sequoia-ipc-0.33.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-0.2.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-backend-0.2.0
CARGO_CRATE_DEPENDS+=	sequoia-keystore-softkeys-0.2.0
CARGO_CRATE_DEPENDS+=	sequoia-net-0.28.0
CARGO_CRATE_DEPENDS+=	sequoia-openpgp-1.19.0
CARGO_CRATE_DEPENDS+=	sequoia-policy-config-0.6.0
CARGO_CRATE_DEPENDS+=	sequoia-wot-0.11.0
...
CARGO_CRATE_DEPENDS+=	sha1collisiondetection-0.3.3
...
CARGO_CRATE_DEPENDS+=	windows-0.53.0
CARGO_CRATE_DEPENDS+=	windows-core-0.52.0
CARGO_CRATE_DEPENDS+=	windows-core-0.53.0
