# $NetBSD: cargo-depends.mk,v 1.10 2023/04/27 06:12:50 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	clap-4.2.2
CARGO_CRATE_DEPENDS+=	clap_builder-4.2.2
...
CARGO_CRATE_DEPENDS+=	pest-2.5.7
CARGO_CRATE_DEPENDS+=	pest_derive-2.5.7
CARGO_CRATE_DEPENDS+=	pest_generator-2.5.7
CARGO_CRATE_DEPENDS+=	pest_meta-2.5.7
