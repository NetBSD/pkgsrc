# $NetBSD: cargo-depends.mk,v 1.2 2021/06/28 10:42:49 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	cstree-0.5.0
...
CARGO_CRATE_DEPENDS+=	html2md-0.2.11
...
CARGO_CRATE_DEPENDS+=	inotify-0.9.2
CARGO_CRATE_DEPENDS+=	inotify-sys-0.1.5
CARGO_CRATE_DEPENDS+=	insta-1.7.1
...
CARGO_CRATE_DEPENDS+=	lalrpop-0.19.5
CARGO_CRATE_DEPENDS+=	lalrpop-util-0.19.5
CARGO_CRATE_DEPENDS+=	lasso-0.5.0
...
CARGO_CRATE_DEPENDS+=	lsp-server-0.5.1
CARGO_CRATE_DEPENDS+=	lsp-types-0.89.1
...
CARGO_CRATE_DEPENDS+=	notify-5.0.0-pre.9
...
CARGO_CRATE_DEPENDS+=	pico-args-0.4.1
...
CARGO_CRATE_DEPENDS+=	smol_str-0.1.17
...
CARGO_CRATE_DEPENDS+=	syn-1.0.65
...
CARGO_CRATE_DEPENDS+=	triomphe-0.1.2
CARGO_CRATE_DEPENDS+=	typed-builder-0.9.0
