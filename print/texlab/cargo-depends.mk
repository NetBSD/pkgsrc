# $NetBSD: cargo-depends.mk,v 1.3 2021/11/01 11:53:25 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	fsevent-sys-4.0.0
...
CARGO_CRATE_DEPENDS+=	inotify-0.9.3
...
CARGO_CRATE_DEPENDS+=	lsp-types-0.90.0
...
CARGO_CRATE_DEPENDS+=	notify-5.0.0-pre.10
...
CARGO_CRATE_DEPENDS+=	smartstring-0.2.6
...
CARGO_CRATE_DEPENDS+=	triomphe-0.1.3
CARGO_CRATE_DEPENDS+=	typed-builder-0.9.1
...
CARGO_CRATE_DEPENDS+=	v_escape-0.13.2
CARGO_CRATE_DEPENDS+=	v_escape_derive-0.8.4
CARGO_CRATE_DEPENDS+=	v_htmlescape-0.10.4
