# $NetBSD: cargo-depends.mk,v 1.17 2025/01/31 18:45:44 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	fern-0.7.0
...
CARGO_CRATE_DEPENDS+=	logos-0.14.2
CARGO_CRATE_DEPENDS+=	logos-codegen-0.14.2
CARGO_CRATE_DEPENDS+=	logos-derive-0.14.2
