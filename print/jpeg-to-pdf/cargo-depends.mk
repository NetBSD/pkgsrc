# $NetBSD: cargo-depends.mk,v 1.1 2021/02/23 18:18:53 pin Exp $
...
CARGO_CRATE_DEPENDS+=	crossbeam-epoch-0.9.2
...
CARGO_CRATE_DEPENDS+=	image-0.23.13
...
CARGO_CRATE_DEPENDS+=	kamadak-exif-0.5.3
