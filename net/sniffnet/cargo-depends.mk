# $NetBSD: cargo-depends.mk,v 1.11 2024/04/09 17:01:12 pin Exp $

CARGO_CRATE_DEPENDS+=	ab_glyph-0.2.24
...
CARGO_CRATE_DEPENDS+=	drm-0.11.1
CARGO_CRATE_DEPENDS+=	drm-ffi-0.7.1
CARGO_CRATE_DEPENDS+=	drm-fourcc-2.2.0
CARGO_CRATE_DEPENDS+=	drm-sys-0.6.1
...
CARGO_CRATE_DEPENDS+=	etherparse-0.14.3
...
CARGO_CRATE_DEPENDS+=	font-types-0.5.2
...
CARGO_CRATE_DEPENDS+=	iced-0.12.1
CARGO_CRATE_DEPENDS+=	iced_core-0.12.3
CARGO_CRATE_DEPENDS+=	iced_futures-0.12.0
CARGO_CRATE_DEPENDS+=	iced_graphics-0.12.1
CARGO_CRATE_DEPENDS+=	iced_renderer-0.12.1
CARGO_CRATE_DEPENDS+=	iced_runtime-0.12.1
CARGO_CRATE_DEPENDS+=	iced_style-0.12.1
CARGO_CRATE_DEPENDS+=	iced_tiny_skia-0.12.1
CARGO_CRATE_DEPENDS+=	iced_wgpu-0.12.1
CARGO_CRATE_DEPENDS+=	iced_widget-0.12.3
CARGO_CRATE_DEPENDS+=	iced_winit-0.12.2
...
CARGO_CRATE_DEPENDS+=	pcap-1.3.0
...
CARGO_CRATE_DEPENDS+=	plotters-iced-0.10.0
...
CARGO_CRATE_DEPENDS+=	read-fonts-0.19.0
...
CARGO_CRATE_DEPENDS+=	rodio-0.17.3
...
CARGO_CRATE_DEPENDS+=	rustrict-0.7.24
...
CARGO_CRATE_DEPENDS+=	tiny-xlib-0.2.2
