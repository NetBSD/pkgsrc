# $NetBSD: cargo-depends.mk,v 1.14 2025/07/18 17:00:44 pin Exp $
...
CARGO_CRATE_DEPENDS+=	etherparse-0.18.0
...
CARGO_CRATE_DEPENDS+=	lyon_path-1.0.7
...
CARGO_CRATE_DEPENDS+=	pcap-2.2.0
...
CARGO_CRATE_DEPENDS+=	rustrict-0.7.35
