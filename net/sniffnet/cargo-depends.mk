# $NetBSD: cargo-depends.mk,v 1.15 2025/11/10 09:35:01 pin Exp $
...
CARGO_CRATE_DEPENDS+=	iced-0.13.1
CARGO_CRATE_DEPENDS+=	iced_core-0.13.2
CARGO_CRATE_DEPENDS+=	iced_futures-0.13.2
CARGO_CRATE_DEPENDS+=	iced_glyphon-0.6.0
CARGO_CRATE_DEPENDS+=	iced_graphics-0.13.0
CARGO_CRATE_DEPENDS+=	iced_renderer-0.13.0
CARGO_CRATE_DEPENDS+=	iced_runtime-0.13.2
CARGO_CRATE_DEPENDS+=	iced_tiny_skia-0.13.0
CARGO_CRATE_DEPENDS+=	iced_wgpu-0.13.5
CARGO_CRATE_DEPENDS+=	iced_widget-0.13.4
...
CARGO_CRATE_DEPENDS+=	lyon-1.0.16
CARGO_CRATE_DEPENDS+=	lyon_algorithms-1.0.16
CARGO_CRATE_DEPENDS+=	lyon_geom-1.0.17
CARGO_CRATE_DEPENDS+=	lyon_path-1.0.16
CARGO_CRATE_DEPENDS+=	lyon_tessellation-1.0.16
...
CARGO_CRATE_DEPENDS+=	pcap-2.3.0
...
CARGO_CRATE_DEPENDS+=	plotters-iced-0.11.0
...
CARGO_CRATE_DEPENDS+=	rustrict-0.7.36
