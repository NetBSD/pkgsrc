# $NetBSD: cargo-depends.mk,v 1.12 2024/07/23 08:07:35 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-signal-0.2.9
...
CARGO_CRATE_DEPENDS+=	etherparse-0.15.0
...
CARGO_CRATE_DEPENDS+=	font-types-0.5.5
...
CARGO_CRATE_DEPENDS+=	pcap-2.0.0
...
CARGO_CRATE_DEPENDS+=	read-fonts-0.19.3
...
CARGO_CRATE_DEPENDS+=	skrifa-0.19.3
...
CARGO_CRATE_DEPENDS+=	swash-0.1.17
...
CARGO_CRATE_DEPENDS+=	xcursor-0.3.6
...
CARGO_CRATE_DEPENDS+=	xxhash-rust-0.8.11
