# $NetBSD: cargo-depends.mk,v 1.9 2023/06/08 18:50:36 pin Exp $
...
CARGO_CRATE_DEPENDS+=	iced-0.9.0
CARGO_CRATE_DEPENDS+=	iced_core-0.9.0
...
CARGO_CRATE_DEPENDS+=	naga-0.11.1
...
CARGO_CRATE_DEPENDS+=	plotters-iced-0.8.0
...
CARGO_CRATE_DEPENDS+=	wgpu-0.15.1
CARGO_CRATE_DEPENDS+=	wgpu-core-0.15.1
CARGO_CRATE_DEPENDS+=	wgpu-hal-0.15.4
CARGO_CRATE_DEPENDS+=	wgpu-types-0.15.2
CARGO_CRATE_DEPENDS+=	wgpu_glyph-0.19.0
