# $NetBSD: cargo-depends.mk,v 1.1 2022/08/28 16:20:17 pin Exp $
...
SITES.curl-sys-0.4.56+curl-7.83.1.crate+= ${MASTER_SITE_CRATESIO:S,^,-,:=curl-sys/0.4.56+curl-7.83.1/download}
