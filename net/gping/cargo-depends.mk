# $NetBSD: cargo-depends.mk,v 1.2 2023/08/02 18:22:13 pin Exp $
...
CARGO_CRATE_DEPENDS+=	deranged-0.3.6
...
CARGO_CRATE_DEPENDS+=	serde-1.0.179
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.179
...
CARGO_CRATE_DEPENDS+=	time-0.3.24
