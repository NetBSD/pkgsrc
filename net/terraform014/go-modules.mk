# $NetBSD: go-modules.mk,v 1.1 2026/08/27 20:36:15 leot Exp $
...
GO_MODULE_FILES+=	github.com/!azure/azure-sdk-for-go/@v/v45.0.0+incompatible.zip
...
GO_MODULE_FILES+=	github.com/!azure/go-autorest/autorest/@v/v0.11.3.zip
...
GO_MODULE_FILES+=	github.com/dgrijalva/jwt-go/@v/v0.0.0-20160705203006-01aeca54ebda.mod
...
GO_MODULE_FILES+=	github.com/gogo/protobuf/@v/v1.2.2-0.20190723190241-65acae22fc9d.zip
...
GO_MODULE_FILES+=	github.com/google/btree/@v/v0.0.0-20160524151835-7d79101e329e.mod
...
GO_MODULE_FILES+=	github.com/gophercloud/gophercloud/@v/v0.0.0-20190126172459-c818fa66e4c8.mod
...
GO_MODULE_FILES+=	github.com/gregjones/httpcache/@v/v0.0.0-20170728041850-787624de3eb7.zip
...
GO_MODULE_FILES+=	github.com/hashicorp/go-azure-helpers/@v/v0.12.0.zip
...
GO_MODULE_FILES+=	github.com/hashicorp/go-getter/@v/v1.5.1.zip
...
GO_MODULE_FILES+=	github.com/tombuildsstuff/giovanni/@v/v0.12.0.mod
GO_MODULE_FILES+=	github.com/tombuildsstuff/giovanni/@v/v0.12.0.zip
...
GO_MODULE_FILES+=	github.com/zclconf/go-cty/@v/v1.8.0.zip
...
GO_MODULE_FILES+=	golang.org/x/crypto/@v/v0.0.0-20181025213731-e84da0312774.mod
...
GO_MODULE_FILES+=	golang.org/x/time/@v/v0.0.0-20161028155119-f51c12702a4d.mod
...
GO_MODULE_FILES+=	golang.org/x/tools/@v/v0.0.0-20201028111035-eafbe7b904eb.zip
...
GO_MODULE_FILES+=	gopkg.in/inf.v0/@v/v0.9.0.zip
...
GO_MODULE_FILES+=	k8s.io/api/@v/v0.0.0-20190620084959-7cf5895f2711.mod
GO_MODULE_FILES+=	k8s.io/api/@v/v0.0.0-20190620084959-7cf5895f2711.zip
GO_MODULE_FILES+=	k8s.io/apimachinery/@v/v0.0.0-20190612205821-1799e75a0719.mod
GO_MODULE_FILES+=	k8s.io/apimachinery/@v/v0.0.0-20190913080033-27d36303b655.mod
GO_MODULE_FILES+=	k8s.io/apimachinery/@v/v0.0.0-20190913080033-27d36303b655.zip
GO_MODULE_FILES+=	k8s.io/client-go/@v/v0.0.0-20190620085101-78d2af792bab.mod
GO_MODULE_FILES+=	k8s.io/client-go/@v/v0.0.0-20190620085101-78d2af792bab.zip
...
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20190221042446-c2654d5206da.mod
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20200411171748-3d5a2fe318e4.mod
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20200411171748-3d5a2fe318e4.zip
