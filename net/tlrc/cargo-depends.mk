# $NetBSD: cargo-depends.mk,v 1.11 2025/05/06 19:32:09 pin Exp $
...
CARGO_CRATE_DEPENDS+=	rustls-platform-verifier-0.5.2
...
CARGO_CRATE_DEPENDS+=	ureq-3.0.11
CARGO_CRATE_DEPENDS+=	ureq-proto-0.4.1
...
CARGO_CRATE_DEPENDS+=	webpki-root-certs-0.26.10
