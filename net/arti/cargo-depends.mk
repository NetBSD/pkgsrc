# $NetBSD: cargo-depends.mk,v 1.17 2026/05/08 07:43:53 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	cmov-0.5.2
...
CARGO_CRATE_DEPENDS+=	const-hex-1.18.1
...
CARGO_CRATE_DEPENDS+=	ctutils-0.4.0
...
CARGO_CRATE_DEPENDS+=	derive-deftly-1.11.0
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-1.11.0
...
CARGO_CRATE_DEPENDS+=	dynasm-5.0.0
CARGO_CRATE_DEPENDS+=	dynasmrt-5.0.0
...
CARGO_CRATE_DEPENDS+=	hybrid-array-0.4.9
...
CARGO_CRATE_DEPENDS+=	js-sys-0.3.92
...
CARGO_CRATE_DEPENDS+=	liblzma-0.4.6
CARGO_CRATE_DEPENDS+=	liblzma-sys-0.4.5
...
CARGO_CRATE_DEPENDS+=	metrics-0.24.3
CARGO_CRATE_DEPENDS+=	metrics-exporter-prometheus-0.18.1
CARGO_CRATE_DEPENDS+=	metrics-util-0.20.1
...
CARGO_CRATE_DEPENDS+=	opentelemetry-otlp-0.31.1
...
CARGO_CRATE_DEPENDS+=	rand_jitter-0.5.0
...
CARGO_CRATE_DEPENDS+=	rdrand-0.8.3
...
CARGO_CRATE_DEPENDS+=	saturating-time-0.3.0
...
CARGO_CRATE_DEPENDS+=	snapbox-1.2.0
...
CARGO_CRATE_DEPENDS+=	toml_edit-0.25.8+spec-1.1.0
...
CARGO_CRATE_DEPENDS+=	tracing-opentelemetry-0.32.1
...
CARGO_CRATE_DEPENDS+=	typed-index-collections-3.3.0
...
CARGO_CRATE_DEPENDS+=	wasix-0.13.1
CARGO_CRATE_DEPENDS+=	wasm-bindgen-0.2.115
CARGO_CRATE_DEPENDS+=	wasm-bindgen-futures-0.4.65
CARGO_CRATE_DEPENDS+=	wasm-bindgen-macro-0.2.115
CARGO_CRATE_DEPENDS+=	wasm-bindgen-macro-support-0.2.115
CARGO_CRATE_DEPENDS+=	wasm-bindgen-shared-0.2.115
...
CARGO_CRATE_DEPENDS+=	web-sys-0.3.92
