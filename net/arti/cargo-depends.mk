# $NetBSD: cargo-depends.mk,v 1.12 2025/12/03 23:27:40 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	criterion-cycles-per-byte-0.7.0
...
CARGO_CRATE_DEPENDS+=	derive-deftly-1.5.1
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-1.5.1
...
CARGO_CRATE_DEPENDS+=	metrics-exporter-prometheus-0.17.2
CARGO_CRATE_DEPENDS+=	metrics-util-0.20.0
...
CARGO_CRATE_DEPENDS+=	value-bag-1.11.1
...
CARGO_CRATE_DEPENDS+=	webpki-root-certs-1.0.3
