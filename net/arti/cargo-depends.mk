# $NetBSD: cargo-depends.mk,v 1.13 2026/01/14 12:34:21 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.34
...
CARGO_CRATE_DEPENDS+=	base16ct-0.3.0
...
CARGO_CRATE_DEPENDS+=	coarsetime-0.1.36
CARGO_CRATE_DEPENDS+=	colorchoice-1.0.4
CARGO_CRATE_DEPENDS+=	combine-4.6.7
CARGO_CRATE_DEPENDS+=	compression-codecs-0.4.33
...
CARGO_CRATE_DEPENDS+=	criterion-0.8.0
CARGO_CRATE_DEPENDS+=	criterion-cycles-per-byte-0.8.0
CARGO_CRATE_DEPENDS+=	criterion-plot-0.8.0
...
CARGO_CRATE_DEPENDS+=	dynasm-4.0.1
CARGO_CRATE_DEPENDS+=	dynasmrt-4.0.1
...
CARGO_CRATE_DEPENDS+=	metrics-exporter-prometheus-0.18.0
...
CARGO_CRATE_DEPENDS+=	r2d2_sqlite-0.31.0
...
CARGO_CRATE_DEPENDS+=	rangemap-1.7.0
...
CARGO_CRATE_DEPENDS+=	secmem-proc-0.3.7
