# $NetBSD: cargo-depends.mk,v 1.18 2026/06/05 22:16:09 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	const-hex-1.19.0
...
CARGO_CRATE_DEPENDS+=	derive-deftly-1.11.1
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-1.11.1
...
CARGO_CRATE_DEPENDS+=	liblzma-sys-0.4.6
...
CARGO_CRATE_DEPENDS+=	metrics-util-0.20.3
...
CARGO_CRATE_DEPENDS+=	reseeding_rng-0.10.6
...
CARGO_CRATE_DEPENDS+=	snapbox-1.2.1
