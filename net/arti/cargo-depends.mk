# $NetBSD: cargo-depends.mk,v 1.9 2025/08/29 21:38:24 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	async-compression-0.4.28
...
CARGO_CRATE_DEPENDS+=	compression-codecs-0.4.28
CARGO_CRATE_DEPENDS+=	compression-core-0.4.28
...
CARGO_CRATE_DEPENDS+=	derive-deftly-1.2.0
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-0.14.6
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-1.2.0
...
CARGO_CRATE_DEPENDS+=	downcast-rs-2.0.1
...
CARGO_CRATE_DEPENDS+=	liblzma-0.4.4
