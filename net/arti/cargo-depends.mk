# $NetBSD: cargo-depends.mk,v 1.2 2023/03/02 07:49:22 nikita Exp $
...
CARGO_CRATE_DEPENDS+=	darling-0.14.3
CARGO_CRATE_DEPENDS+=	darling_core-0.14.3
CARGO_CRATE_DEPENDS+=	darling_macro-0.14.3
...
CARGO_CRATE_DEPENDS+=	winnow-0.3.3
