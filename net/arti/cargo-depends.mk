# $NetBSD: cargo-depends.mk,v 1.7 2025/03/04 10:25:13 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	asn1-rs-0.7.0
...
CARGO_CRATE_DEPENDS+=	derive-deftly-1.0.0
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-0.14.6
CARGO_CRATE_DEPENDS+=	derive-deftly-macros-1.0.0
...
CARGO_CRATE_DEPENDS+=	inventory-0.3.19
...
CARGO_CRATE_DEPENDS+=	priority-queue-2.1.2
...
CARGO_CRATE_DEPENDS+=	zerovec-0.11.1
