# $NetBSD: cargo-depends.mk,v 1.5 2023/04/19 20:42:52 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bitflags-2.2.0
...
CARGO_CRATE_DEPENDS+=	linux-raw-sys-0.3.2
...
CARGO_CRATE_DEPENDS+=	remotefs-ssh-0.1.6
