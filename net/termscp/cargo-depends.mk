# $NetBSD: cargo-depends.mk,v 1.1 2022/10/21 11:40:40 pin Exp $
...
CARGO_CRATE_DEPENDS+=	async-io-1.9.0
...
CARGO_CRATE_DEPENDS+=	keyring-1.2.0
...
CARGO_CRATE_DEPENDS+=	magic-crypt-3.1.10
...
CARGO_CRATE_DEPENDS+=	remotefs-ssh-0.1.2
...
CARGO_CRATE_DEPENDS+=	whoami-1.2.3
