# $NetBSD: cargo-depends.mk,v 1.18 2026/06/22 07:50:30 pin Exp $
...
CARGO_CRATE_DEPENDS+=	bytestring-1.5.1
...
CARGO_CRATE_DEPENDS+=	curve25519-dalek-5.0.0-rc.0
...
CARGO_CRATE_DEPENDS+=	dbus-secret-service-keyring-store-1.0.0
...
CARGO_CRATE_DEPENDS+=	elliptic-curve-0.14.0-rc.33
...
CARGO_CRATE_DEPENDS+=	generic-array-1.4.3
...
CARGO_CRATE_DEPENDS+=	gloo-timers-0.4.0
...
CARGO_CRATE_DEPENDS+=	keyring-core-1.0.0
...
CARGO_CRATE_DEPENDS+=	mac-notification-sys-0.6.13
...
CARGO_CRATE_DEPENDS+=	notify-rust-4.17.0
...
CARGO_CRATE_DEPENDS+=	p256-0.14.0-rc.10
CARGO_CRATE_DEPENDS+=	p384-0.13.1
CARGO_CRATE_DEPENDS+=	p384-0.14.0-rc.10
CARGO_CRATE_DEPENDS+=	p521-0.13.3
CARGO_CRATE_DEPENDS+=	p521-0.14.0-rc.10
...
CARGO_CRATE_DEPENDS+=	pkcs5-0.8.0
...
CARGO_CRATE_DEPENDS+=	poly1305-0.9.0
...
CARGO_CRATE_DEPENDS+=	primefield-0.14.0-rc.10
CARGO_CRATE_DEPENDS+=	primeorder-0.13.6
CARGO_CRATE_DEPENDS+=	primeorder-0.14.0-rc.10
...
CARGO_CRATE_DEPENDS+=	remotefs-ssh-0.8.5
...
CARGO_CRATE_DEPENDS+=	rfc6979-0.5.0
...
CARGO_CRATE_DEPENDS+=	russh-0.61.2
CARGO_CRATE_DEPENDS+=	russh-cryptovec-0.48.0
CARGO_CRATE_DEPENDS+=	russh-cryptovec-0.61.0
CARGO_CRATE_DEPENDS+=	russh-keys-0.49.2
CARGO_CRATE_DEPENDS+=	russh-sftp-2.3.0
...
CARGO_CRATE_DEPENDS+=	ssh-cipher-0.3.0-rc.9
CARGO_CRATE_DEPENDS+=	ssh-encoding-0.2.0
CARGO_CRATE_DEPENDS+=	ssh-encoding-0.3.0-rc.9
CARGO_CRATE_DEPENDS+=	ssh-key-0.6.7
CARGO_CRATE_DEPENDS+=	ssh-key-0.7.0-rc.10
CARGO_CRATE_DEPENDS+=	ssh2-config-0.7.1
...
CARGO_CRATE_DEPENDS+=	suppaftp-8.0.4
...
CARGO_CRATE_DEPENDS+=	tui-realm-stdlib-4.1.0
CARGO_CRATE_DEPENDS+=	tui-term-0.3.4
CARGO_CRATE_DEPENDS+=	tuirealm-4.1.0
CARGO_CRATE_DEPENDS+=	tuirealm_derive-4.1.0
...
CARGO_CRATE_DEPENDS+=	windows-native-keyring-store-1.1.0
