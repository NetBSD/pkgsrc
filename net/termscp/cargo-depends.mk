# $NetBSD: cargo-depends.mk,v 1.16 2025/12/20 20:05:18 pin Exp $
...
CARGO_CRATE_DEPENDS+=	aws-sdk-s3-1.118.0
...
CARGO_CRATE_DEPENDS+=	redox_syscall-0.6.0
...
CARGO_CRATE_DEPENDS+=	ssh2-config-0.6.2
...
CARGO_CRATE_DEPENDS+=	suppaftp-7.0.7
