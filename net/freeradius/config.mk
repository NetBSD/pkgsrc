# $NetBSD: config.mk,v 1.6 2023/04/05 09:16:42 adam Exp $
...
EGFILES+=	mods-available/cache_auth
...
EGFILES+=	mods-available/json
EGFILES+=	mods-available/krb5
EGFILES+=	mods-available/ldap
EGFILES+=	mods-available/ldap_google
...
EGFILES+=	mods-config/realm/freeradius-naptr-to-home-server.sh
...
EGFILES+=	mods-config/sql/main/sqlite/process-radacct-close-after-reload.pl
EGFILES+=	mods-config/sql/main/sqlite/process-radacct-new-data-usage-period.sh
...
EGFILES+=	sites-available/aws-nlb
...
EGFILES+=	sites-available/google-ldap-auth
...
EGFILES+=	sites-available/tls-cache
