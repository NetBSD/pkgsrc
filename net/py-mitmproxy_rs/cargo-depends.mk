# $NetBSD: cargo-depends.mk,v 1.6 2025/12/12 12:07:03 adam Exp $
...
CARGO_CRATE_DEPENDS+=	aya-build-0.1.2
...
CARGO_CRATE_DEPENDS+=	pyo3-async-runtimes-macros-0.25.0
...
CARGO_CRATE_DEPENDS+=	tun-0.7.22
