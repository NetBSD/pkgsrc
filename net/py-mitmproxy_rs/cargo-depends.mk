# $NetBSD: cargo-depends.mk,v 1.3 2025/02/04 12:10:02 adam Exp $
...
CARGO_CRATE_DEPENDS+=	defmt-0.3.10
CARGO_CRATE_DEPENDS+=	defmt-macros-0.4.0
CARGO_CRATE_DEPENDS+=	defmt-parser-0.4.1
...
CARGO_CRATE_DEPENDS+=	hickory-server-0.24.2
...
CARGO_CRATE_DEPENDS+=	prost-types-0.13.4
CARGO_CRATE_DEPENDS+=	pyo3-0.23.3
CARGO_CRATE_DEPENDS+=	pyo3-async-runtimes-0.23.0
CARGO_CRATE_DEPENDS+=	pyo3-async-runtimes-macros-0.23.0
...
CARGO_CRATE_DEPENDS+=	tun-0.7.10
...
CARGO_CRATE_DEPENDS+=	winreg2-0.53.1
CARGO_CRATE_DEPENDS+=	winres-0.1.12
CARGO_CRATE_DEPENDS+=	winsafe-0.0.19
CARGO_CRATE_DEPENDS+=	wintun-bindings-0.7.27
