# $NetBSD: cargo-depends.mk,v 1.7 2024/01/24 14:13:23 he Exp $
...
CARGO_CRATE_DEPENDS+=	bcder-0.7.4
...
CARGO_CRATE_DEPENDS+=	chrono-0.4.32
...
CARGO_CRATE_DEPENDS+=	rpki-0.18.1
