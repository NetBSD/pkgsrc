# $NetBSD: cargo-depends.mk,v 1.17 2026/08/03 14:13:27 pin Exp $
...
CARGO_CRATE_DEPENDS+=	fastbloom-0.17.0
...
CARGO_CRATE_DEPENDS+=	mdns-sd-0.20.2
...
CARGO_CRATE_DEPENDS+=	socket-pktinfo-0.4.0
