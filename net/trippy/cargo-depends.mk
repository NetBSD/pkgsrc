# $NetBSD: cargo-depends.mk,v 1.14 2025/05/06 20:09:56 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap_complete-4.5.48
...
CARGO_CRATE_DEPENDS+=	maxminddb-0.25.0
...
CARGO_CRATE_DEPENDS+=	resolv-conf-0.7.3
...
CARGO_CRATE_DEPENDS+=	wintun-bindings-0.7.31
