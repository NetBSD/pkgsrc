# $NetBSD: cargo-depends.mk,v 1.25 2024/11/13 08:46:55 pin Exp $
...
CARGO_CRATE_DEPENDS+=	serde_json_path-0.7.1
CARGO_CRATE_DEPENDS+=	serde_json_path_core-0.2.1
CARGO_CRATE_DEPENDS+=	serde_json_path_macros-0.1.5
...
CARGO_CRATE_DEPENDS+=	wiremock-0.6.2
