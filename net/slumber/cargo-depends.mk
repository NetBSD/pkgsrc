# $NetBSD: cargo-depends.mk,v 1.33 2025/09/19 13:52:09 pin Exp $
...
CARGO_CRATE_DEPENDS+=	env-lock-1.0.1
...
CARGO_CRATE_DEPENDS+=	kasuari-0.4.7
...
CARGO_CRATE_DEPENDS+=	libsqlite3-sys-0.33.0
...
CARGO_CRATE_DEPENDS+=	mdbook-0.4.52
...
CARGO_CRATE_DEPENDS+=	persisted-1.0.0
CARGO_CRATE_DEPENDS+=	persisted_derive-1.0.0
...
CARGO_CRATE_DEPENDS+=	ratatui-0.30.0-alpha.5
CARGO_CRATE_DEPENDS+=	ratatui-core-0.1.0-alpha.6
CARGO_CRATE_DEPENDS+=	ratatui-crossterm-0.1.0-alpha.5
CARGO_CRATE_DEPENDS+=	ratatui-termwiz-0.1.0-alpha.5
CARGO_CRATE_DEPENDS+=	ratatui-widgets-0.3.0-alpha.5
...
CARGO_CRATE_DEPENDS+=	rest_parser-0.1.7
CARGO_CRATE_DEPENDS+=	ring-0.17.14
CARGO_CRATE_DEPENDS+=	rstest-0.24.0
CARGO_CRATE_DEPENDS+=	rstest_macros-0.24.0
CARGO_CRATE_DEPENDS+=	rusqlite-0.35.0
CARGO_CRATE_DEPENDS+=	rusqlite_migration-2.1.0
...
CARGO_CRATE_DEPENDS+=	terminput-0.5.3
CARGO_CRATE_DEPENDS+=	terminput-crossterm-0.3.3
...
CARGO_CRATE_DEPENDS+=	tree-sitter-highlight-0.25.4
