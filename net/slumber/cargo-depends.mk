# $NetBSD: cargo-depends.mk,v 1.39 2026/04/02 12:13:25 pin Exp $
...
CARGO_CRATE_DEPENDS+=	env-lock-1.0.2
...
CARGO_CRATE_DEPENDS+=	mdbook-core-0.5.2
CARGO_CRATE_DEPENDS+=	mdbook-preprocessor-0.5.2
...
CARGO_CRATE_DEPENDS+=	proptest-derive-0.7.0
...
CARGO_CRATE_DEPENDS+=	rusqlite_migration-2.4.0
...
CARGO_CRATE_DEPENDS+=	terminput-0.5.12
CARGO_CRATE_DEPENDS+=	terminput-crossterm-0.4.8
...
CARGO_CRATE_DEPENDS+=	tree-sitter-highlight-0.26.3
