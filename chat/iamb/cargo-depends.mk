# $NetBSD: cargo-depends.mk,v 1.7 2026/09/25 05:15:35 pin Exp $

CARGO_CRATE_DEPENDS+=	accessory-2.1.1
...
CARGO_CRATE_DEPENDS+=	avif-serialize-0.8.9
...
CARGO_CRATE_DEPENDS+=	bytemuck_derive-1.12.1
...
CARGO_CRATE_DEPENDS+=	clap_complete-4.6.11
...
CARGO_CRATE_DEPENDS+=	deadpool-0.13.1
CARGO_CRATE_DEPENDS+=	deadpool-runtime-0.3.1
CARGO_CRATE_DEPENDS+=	deadpool-sync-0.2.0
CARGO_CRATE_DEPENDS+=	decancer-3.3.3
CARGO_CRATE_DEPENDS+=	delegate-display-3.0.1
...
CARGO_CRATE_DEPENDS+=	editor-types-0.0.4
CARGO_CRATE_DEPENDS+=	editor-types-macros-0.0.4
CARGO_CRATE_DEPENDS+=	editor-types-parser-0.0.4
CARGO_CRATE_DEPENDS+=	either-1.18.0
CARGO_CRATE_DEPENDS+=	emojis-0.8.2
CARGO_CRATE_DEPENDS+=	emojis-0.9.0
...
CARGO_CRATE_DEPENDS+=	eyeball-im-0.8.0
...
CARGO_CRATE_DEPENDS+=	icu_segmenter-2.3.0
CARGO_CRATE_DEPENDS+=	icu_segmenter_data-2.3.0
CARGO_CRATE_DEPENDS+=	icy_sixel-0.5.1
...
CARGO_CRATE_DEPENDS+=	imbl-6.1.0
CARGO_CRATE_DEPENDS+=	imbl-sized-chunks-0.1.3
CARGO_CRATE_DEPENDS+=	imgref-1.12.3
CARGO_CRATE_DEPENDS+=	impartial-ord-2.0.0
...
CARGO_CRATE_DEPENDS+=	js_option-0.2.0
CARGO_CRATE_DEPENDS+=	kasuari-0.4.12
CARGO_CRATE_DEPENDS+=	keybindings-0.0.4
CARGO_CRATE_DEPENDS+=	konst-0.4.3
...
CARGO_CRATE_DEPENDS+=	linkify-0.11.0
...
CARGO_CRATE_DEPENDS+=	macroific-2.0.0
CARGO_CRATE_DEPENDS+=	macroific-3.1.0
CARGO_CRATE_DEPENDS+=	macroific_attr_parse-2.0.0
CARGO_CRATE_DEPENDS+=	macroific_attr_parse-3.1.0
CARGO_CRATE_DEPENDS+=	macroific_core-2.0.0
CARGO_CRATE_DEPENDS+=	macroific_core-3.1.0
CARGO_CRATE_DEPENDS+=	macroific_macro-2.0.0
CARGO_CRATE_DEPENDS+=	macroific_macro-3.1.0
CARGO_CRATE_DEPENDS+=	maplit-1.0.2
CARGO_CRATE_DEPENDS+=	markup5ever-0.39.0
CARGO_CRATE_DEPENDS+=	markup5ever_rcdom-0.39.0+unofficial
...
CARGO_CRATE_DEPENDS+=	matrix-sdk-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-base-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-common-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-crypto-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-indexeddb-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-qrcode-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-sqlite-0.18.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-store-encryption-0.18.0
CARGO_CRATE_DEPENDS+=	matrix_indexed_db_futures-0.7.0
CARGO_CRATE_DEPENDS+=	matrix_indexed_db_futures_macros_internal-1.0.0
...
CARGO_CRATE_DEPENDS+=	modalkit-0.0.28
CARGO_CRATE_DEPENDS+=	modalkit-ratatui-0.0.28
...
CARGO_CRATE_DEPENDS+=	no_std_io2-0.9.4
...
CARGO_CRATE_DEPENDS+=	oauth2-reqwest-0.1.0-alpha.3
...
CARGO_CRATE_DEPENDS+=	profiling-procmacros-1.0.18
...
CARGO_CRATE_DEPENDS+=	rand_xoshiro-0.8.1
...
CARGO_CRATE_DEPENDS+=	readlock-0.1.11
CARGO_CRATE_DEPENDS+=	readlock-tokio-0.1.6
...
CARGO_CRATE_DEPENDS+=	rpassword-7.5.4
CARGO_CRATE_DEPENDS+=	rtoolbox-0.0.6
CARGO_CRATE_DEPENDS+=	ruma-0.16.0
CARGO_CRATE_DEPENDS+=	ruma-client-api-0.24.0
CARGO_CRATE_DEPENDS+=	ruma-common-0.19.0
CARGO_CRATE_DEPENDS+=	ruma-events-0.34.0
CARGO_CRATE_DEPENDS+=	ruma-html-0.8.0
CARGO_CRATE_DEPENDS+=	ruma-identifiers-validation-0.12.1
CARGO_CRATE_DEPENDS+=	ruma-macros-0.19.0
...
CARGO_CRATE_DEPENDS+=	sealed-0.7.0
...
CARGO_CRATE_DEPENDS+=	serde_html_form-0.4.1
...
CARGO_CRATE_DEPENDS+=	textwrap-0.16.4
...
CARGO_CRATE_DEPENDS+=	unicode-canonical-combining-class-1.0.0
...
CARGO_CRATE_DEPENDS+=	vergen-gitcl-9.1.0
...
CARGO_CRATE_DEPENDS+=	wasm_evt_listener-0.1.0
...
CARGO_CRATE_DEPENDS+=	wide-1.7.1
...
CARGO_CRATE_DEPENDS+=	xml5ever-0.39.0
