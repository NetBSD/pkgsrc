# $NetBSD: cargo-depends.mk,v 1.6 2026/01/21 14:46:58 pin Exp $
...
CARGO_CRATE_DEPENDS+=	comrak-0.22.0
...
CARGO_CRATE_DEPENDS+=	deadpool-sqlite-0.12.1
...
CARGO_CRATE_DEPENDS+=	editor-types-0.0.2
CARGO_CRATE_DEPENDS+=	editor-types-macros-0.0.2
CARGO_CRATE_DEPENDS+=	editor-types-parser-0.0.2
...
CARGO_CRATE_DEPENDS+=	eyeball-im-0.7.0
...
CARGO_CRATE_DEPENDS+=	feruca-0.10.1
...
CARGO_CRATE_DEPENDS+=	imbl-5.0.0
...
CARGO_CRATE_DEPENDS+=	keybindings-0.0.2
...
CARGO_CRATE_DEPENDS+=	matrix-pickle-0.2.2
CARGO_CRATE_DEPENDS+=	matrix-pickle-derive-0.2.2
CARGO_CRATE_DEPENDS+=	matrix-sdk-0.14.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-base-0.14.1
CARGO_CRATE_DEPENDS+=	matrix-sdk-common-0.14.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-crypto-0.14.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-indexeddb-0.14.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-sqlite-0.14.0
CARGO_CRATE_DEPENDS+=	matrix-sdk-store-encryption-0.14.0
...
CARGO_CRATE_DEPENDS+=	modalkit-0.0.24
CARGO_CRATE_DEPENDS+=	modalkit-ratatui-0.0.24
...
CARGO_CRATE_DEPENDS+=	ratatui-image-8.0.2
...
CARGO_CRATE_DEPENDS+=	readlock-0.1.10
CARGO_CRATE_DEPENDS+=	readlock-tokio-0.1.5
...
CARGO_CRATE_DEPENDS+=	ruma-0.13.0
CARGO_CRATE_DEPENDS+=	ruma-client-api-0.21.0
CARGO_CRATE_DEPENDS+=	ruma-common-0.16.0
CARGO_CRATE_DEPENDS+=	ruma-events-0.31.0
CARGO_CRATE_DEPENDS+=	ruma-federation-api-0.12.0
CARGO_CRATE_DEPENDS+=	ruma-html-0.5.0
CARGO_CRATE_DEPENDS+=	ruma-identifiers-validation-0.11.0
CARGO_CRATE_DEPENDS+=	ruma-macros-0.16.0
CARGO_CRATE_DEPENDS+=	ruma-signatures-0.18.0
...
CARGO_CRATE_DEPENDS+=	vodozemac-0.9.0
