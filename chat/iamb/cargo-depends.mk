# $NetBSD: cargo-depends.mk,v 1.3 2023/07/08 20:14:16 pin Exp $
...
CARGO_CRATE_DEPENDS+=	clap-4.1.12
...
CARGO_CRATE_DEPENDS+=	constant_time_eq-0.2.5
...
CARGO_CRATE_DEPENDS+=	futures-signals-0.3.32
...
CARGO_CRATE_DEPENDS+=	gensym-0.1.0
...
CARGO_CRATE_DEPENDS+=	mandown-0.1.3
...
CARGO_CRATE_DEPENDS+=	modalkit-0.0.16
...
CARGO_CRATE_DEPENDS+=	prost-0.11.8
CARGO_CRATE_DEPENDS+=	prost-derive-0.11.8
...
CARGO_CRATE_DEPENDS+=	ruma-identifiers-validation-0.9.1
...
CARGO_CRATE_DEPENDS+=	vergen-8.2.1
