# $NetBSD: cargo-depends.mk,v 1.12 2023/08/30 13:50:59 gdt Exp $
...
CARGO_CRATE_DEPENDS+=	pyo3-log-0.8.3
...
CARGO_CRATE_DEPENDS+=	serde-1.0.184
CARGO_CRATE_DEPENDS+=	serde_derive-1.0.184
