# $NetBSD: cargo-depends.mk,v 1.4 2026/07/27 15:57:39 wiz Exp $
...
CARGO_CRATE_DEPENDS+=	core-models-0.0.5
...
CARGO_CRATE_DEPENDS+=	crokey-1.5.0
CARGO_CRATE_DEPENDS+=	crokey-proc_macros-1.5.0
...
CARGO_CRATE_DEPENDS+=	hax-lib-0.3.6
CARGO_CRATE_DEPENDS+=	hax-lib-macros-0.3.6
CARGO_CRATE_DEPENDS+=	hax-lib-macros-types-0.3.6
...
CARGO_CRATE_DEPENDS+=	hpke-rs-0.6.1
CARGO_CRATE_DEPENDS+=	hpke-rs-crypto-0.6.1
...
CARGO_CRATE_DEPENDS+=	libcrux-hmac-0.0.6
CARGO_CRATE_DEPENDS+=	libcrux-intrinsics-0.0.6
CARGO_CRATE_DEPENDS+=	libcrux-macros-0.0.3
CARGO_CRATE_DEPENDS+=	libcrux-ml-kem-0.0.8
CARGO_CRATE_DEPENDS+=	libcrux-platform-0.0.3
CARGO_CRATE_DEPENDS+=	libcrux-secrets-0.0.5
CARGO_CRATE_DEPENDS+=	libcrux-sha2-0.0.6
CARGO_CRATE_DEPENDS+=	libcrux-sha3-0.0.8
CARGO_CRATE_DEPENDS+=	libcrux-traits-0.0.6
...
#CARGO_CRATE_DEPENDS+=	libsignal-debug-0.94.4
...
CARGO_CRATE_DEPENDS+=	phonenumber-0.3.10+9.0.33
...
CARGO_CRATE_DEPENDS+=	sorted-vec-0.8.11
CARGO_CRATE_DEPENDS+=	spin-0.9.9
#CARGO_CRATE_DEPENDS+=	spqr-1.5.1
...
CARGO_CRATE_DEPENDS+=	zbus-5.18.0
CARGO_CRATE_DEPENDS+=	zbus_macros-5.18.0
...
CARGO_CRATE_DEPENDS+=	zvariant-5.13.1
CARGO_CRATE_DEPENDS+=	zvariant_derive-5.13.1
CARGO_CRATE_DEPENDS+=	zvariant_utils-3.5.0
