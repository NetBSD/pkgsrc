# $NetBSD: cargo-depends.mk,v 1.4 2022/03/30 16:13:55 pin Exp $
...
CARGO_CRATE_DEPENDS+=	geo-0.19.0
CARGO_CRATE_DEPENDS+=	geo-types-0.7.3
CARGO_CRATE_DEPENDS+=	geographiclib-rs-0.2.0
CARGO_CRATE_DEPENDS+=	geojson-0.22.3
...
CARGO_CRATE_DEPENDS+=	wkt-0.10.0
