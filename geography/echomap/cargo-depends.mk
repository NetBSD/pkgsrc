# $NetBSD: cargo-depends.mk,v 1.6 2023/04/11 08:39:19 pin Exp $
...
CARGO_CRATE_DEPENDS+=	atomic-polyfill-0.1.7
...
CARGO_CRATE_DEPENDS+=	critical-section-0.2.6
...
CARGO_CRATE_DEPENDS+=	geo-0.24.1
CARGO_CRATE_DEPENDS+=	geo-types-0.7.9
CARGO_CRATE_DEPENDS+=	geographiclib-rs-0.2.3
CARGO_CRATE_DEPENDS+=	geojson-0.23.0
...
CARGO_CRATE_DEPENDS+=	polyline-0.10.0
...
CARGO_CRATE_DEPENDS+=	topojson-0.5.1
...
CARGO_CRATE_DEPENDS+=	wkt-0.10.3
