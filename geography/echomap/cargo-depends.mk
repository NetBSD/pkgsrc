# $NetBSD: cargo-depends.mk,v 1.2 2021/10/14 13:09:03 pin Exp $
...
CARGO_CRATE_DEPENDS+=	dbase-0.2.1
...
CARGO_CRATE_DEPENDS+=	rstar-0.8.3
CARGO_CRATE_DEPENDS+=	rstar-0.9.1
